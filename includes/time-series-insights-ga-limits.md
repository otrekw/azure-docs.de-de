...
REST-API-Grenzwerte für Azure Time Series Insights Gen1 sind in der [Referenzdokumentation zur REST-API](/rest/api/time-series-insights/gen1-reference-data-api#current-limits) angegeben.
