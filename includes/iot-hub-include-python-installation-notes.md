...
* Installieren Sie bei Bedarf das Paket [azure-iot-device](https://pypi.org/project/azure-iot-device/) mithilfe des Befehls `pip install azure-iot-device`.
