...
ms.locfileid: "76964297"
---
## <a name="azure-resource-manager-template"></a>Azure Resource Manager-Vorlage

In diesem Artikel verwenden Sie eine Azure Resource Manager-Vorlage, um eine Ressourcengruppe, ein Speicherkonto und einen Container, einen Event Hub, einen Azure Data Explorer-Cluster und eine Datenbank zu erstellen. Speichern Sie den folgenden Inhalt in einer Datei mit dem Namen `template.json`. Sie verwenden diese Datei zum Ausführen des Codebeispiels.
