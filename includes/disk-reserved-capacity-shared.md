...
Azure Disk Storage-Reservierungen können über das [Azure-Portal](https://portal.azure.com/) erworben werden. Sie können die Reservierung im Voraus oder monatlich bezahlen. Weitere Informationen zum Erwerb mit monatlicher Zahlung finden Sie unter [Erwerben von Reservierungen mit monatlicher Zahlung](../articles/cost-management-billing/reservations/monthly-payments-reservations.md).
