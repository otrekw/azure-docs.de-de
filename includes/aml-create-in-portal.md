...
1. Wählen Sie im Azure-Portal oben links die Option **+ Ressource erstellen** aus.
    ...
    ![Screenshot: Option „Ressource erstellen“.](media/aml-create-in-portal/create-workspace.gif)
...
1. Geben Sie die folgenden Informationen an, um den neuen Arbeitsbereich zu konfigurieren:
   ...
   Arbeitsbereichs-Edition | Wählen Sie **Basic** als Arbeitsbereichstyp für dieses Tutorial aus. Der Arbeitsbereichstyp bestimmt die Features, auf die Sie zugreifen können, sowie die entsprechenden Preise. Alles in diesem Tutorial kann entweder mit einem Basic- oder Enterprise-Arbeitsbereich ausgeführt werden.
