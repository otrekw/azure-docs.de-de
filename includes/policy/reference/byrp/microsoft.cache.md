...
ms.locfileid: "98807937"
---
|Name<br /><sub>(Azure-Portal)</sub> |BESCHREIBUNG |Auswirkungen |Version<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Azure Cache for Redis muss sich in einem virtuellen Netzwerk befinden.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7d092e0a-7acd-40d2-a975-dca21cae48c4) |Die Bereitstellung von Azure Virtual Network (VNet) bietet erweiterte Sicherheit und Isolierung für Ihren Azure Cache for Redis sowie für Subnetze, Zugriffskontrollrichtlinien und andere Funktionen zur weiteren Einschränkung des Zugriffs. Wenn eine Azure Cache for Redis-Instanz mit einem VNet konfiguriert ist, ist sie nicht öffentlich adressierbar und kann nur von virtuellen Computern und Anwendungen innerhalb des VNet aufgerufen werden. |Audit, Deny, Disabled |[1.0.2](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Cache/RedisCache_CacheInVnet_Audit.json) |
