...
![Erstellen eines neuen Speicherkontos](./media/active-directory-msi-tut-enable/identity.png)
...
2. [Erstellen eines virtuellen Computers mit aktivierter systemseitig zugewiesener Identität](/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm#system-assigned-managed-identity)
