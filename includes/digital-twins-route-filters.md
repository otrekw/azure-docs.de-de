...
| `Source` | Der Name der Azure Digital Twins-Instanz. | `source = '<host-name>'`| Dies sind die möglichen Werte für Hostnamen: <br> **Für Benachrichtigungen**: `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net` <br> **Für Telemetrie**: `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net/<twinId>`|
