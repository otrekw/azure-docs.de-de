---
title: 'Voraussetzungen: Gemeinsame Verwendung einer Datei auf zwei Registerkarten in derselben Datei | Microsoft-Dokumentation'
description: 'Bestellung einer Azure Data Box-Bereitstellung: Voraussetzungen'
services: databox
author: priestlg
ms.service: databox
ms.subservice: pod
...
* Sie verfügen über einen Hostcomputer, der mit dem Netzwerk des Datencenters verbunden ist. Data Box kopiert die Daten von diesem Computer. Auf dem Hostcomputer muss ein unterstütztes Betriebssystem ausgeführt werden (siehe [Azure Data Box – Systemanforderungen](../articles/databox/data-box-system-requirements.md)).
