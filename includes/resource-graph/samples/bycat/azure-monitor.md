...
ms.locfileid: "114438964"
---
### <a name="list-all-azure-arc-enabled-kubernetes-clusters-with-azure-monitor-extension"></a>Auflisten aller Azure Arc-fähigen Kubernetes-Cluster mit Azure Monitor-Erweiterung

Gibt die verbundene Cluster-ID jedes Azure Arc-fähigen Kubernetes-Clusters zurück, auf dem die Azure Monitor-Erweiterung installiert ist.
...
Gibt die verbundene Cluster-ID jedes Azure Arc-fähigen Kubernetes-Clusters zurück, auf dem die Azure Monitor-Erweiterung nicht vorhanden ist.
