...
Weitere Informationen zur Problembehandlung finden Sie unter [Behandeln von Problemen bei Remotedesktopverbindungen mit einem virtuellen Azure-Computer](/troubleshoot/azure/virtual-machines/troubleshoot-rdp-connection).