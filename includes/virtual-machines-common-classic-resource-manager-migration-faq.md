...
[Azure Resource Manager](https://docs.microsoft.com/azure/azure-resource-manager/management/overview) ist die aktuelle Steuerungsebene von Azure, über die VMs erstellt, verwaltet und gelöscht werden und über die weitere Steuerungsebenenvorgänge durchgeführt werden können. 
