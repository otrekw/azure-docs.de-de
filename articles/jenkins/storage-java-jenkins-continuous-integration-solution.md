...
keywords: Jenkins, Azure, DevOps, Speicher, CICD
ms.topic: article
ms.date: 08/13/2019
...
* Ein Azure-Speicherkonto. Wenn Sie noch kein Speicherkonto haben, können Sie eines erstellen, indem Sie die Schritte unter [Erstellen eines Speicherkontos](../storage/common/storage-account-create.md)befolgen.
