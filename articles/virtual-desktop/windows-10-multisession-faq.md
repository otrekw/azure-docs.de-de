...
## <a name="can-i-upgrade-a-windows-10-vm-to-windows-10-enterprise-multi-session"></a>Kann ich eine Windows 10-VM auf Windows 10 Enterprise (mehrere Sitzungen) aktualisieren?
