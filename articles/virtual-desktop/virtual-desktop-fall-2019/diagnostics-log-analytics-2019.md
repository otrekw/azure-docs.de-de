...
Um Log Analytics mit der Diagnosefunktion verwenden zu können, müssen Sie zunächst [einen Arbeitsbereich erstellen](../../azure-monitor/logs/quick-create-workspace.md).
