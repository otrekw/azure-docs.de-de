...
> [Use a microservices approach for building applications (Verwenden eines Microservices-Ansatzes zum Erstellen von Anwendungen)](/azure/devops/pipelines/release/define-multistage-release-process)