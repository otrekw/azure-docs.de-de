...
* Der *Anforderungs-URI* für das Gerät neben der [API-Version](https://docs.aws.amazon.com/cli/latest/reference/iot1click-devices/invoke-device-method.html):
