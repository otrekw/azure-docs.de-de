---
title: 'Tutorial: Konfigurieren des Nachrichtenroutings für Azure IoT Hub mithilfe einer Azure Resource Manager-Vorlage'
description: 'Tutorial: Konfigurieren des Nachrichtenroutings für Azure IoT Hub mithilfe einer Azure Resource Manager-Vorlage'
author: robinsh
...
![Cloud Shell-Menüleiste mit hervorgehobener Option zum Hoch-/Herunterladen von Ergebnissen](media/tutorial-routing-config-message-routing-RM-template/CloudShell_upload_results.png)
