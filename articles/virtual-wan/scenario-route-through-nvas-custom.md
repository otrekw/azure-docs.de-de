...
:::image type="content" source="./media/routing-scenarios/nva-custom/figure-2.png" alt-text="Abbildung 2" lightbox="./media/routing-scenarios/nva-custom/figure-2.png":::
