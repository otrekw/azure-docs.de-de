...
![Anwendungen mit direkter lokaler Verbindung](media/migrate-adfs-apps-to-azure/migrate1.png)

![Anwendungen, die über Azure AD in einen Verbund eingefügt sind](media/migrate-adfs-apps-to-azure/migrate2.png)
...
![Zeigt die Liste der Attribute an, die Sie als Ansprüche senden können.](media/migrate-adfs-apps-to-azure/migrate4.png)
...
![Zeigt den Bereich „Attribut bearbeiten“ an.](media/migrate-adfs-apps-to-azure/migrate5.png)
...
![Zeigt den Bereich „Zuweisung hinzufügen“ an.](media/migrate-adfs-apps-to-azure/migrate7.png)
...
#### <a name="example-support-for-multiple-identity-providers"></a>Beispiel: Unterstützung für mehrere Identitätsanbieter
