...
Der vorstehende Codeausschnitt wurde aus dem [inkrementellen Tutorial zu ASP.NET Core-Web-API](https://github.com/Azure-Samples/active-directory-dotnet-native-aspnetcore-v2/blob/63087e83326e6a332d05fee6e1586b66d840b08f/1.%20Desktop%20app%20calls%20Web%20API/TodoListService/Startup.cs#L23-L28) extrahiert. Die Details zu **AddMicrosoftIdentityWebApiAuthentication** sind in [Microsoft.Identity.Web](microsoft-identity-web.md) verfügbar. Diese Methode ruft die [AddMicrosoftIdentityWebAPI](/dotnet/api/microsoft.identity.web.microsoftidentitywebapiauthenticationbuilderextensions.addmicrosoftidentitywebapi) auf, die wiederum die Middleware anweist, wie das Token überprüft werden soll.
