...
Clouddienste senden ein `AuthnRequest` -Element an Azure AD, um eine Benutzerauthentifizierung anzufordern. Eine `AuthnRequest` für SAML 2.0 könnte wie im folgenden Beispiel aussehen:
