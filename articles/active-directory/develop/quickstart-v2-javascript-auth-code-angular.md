...
> Damit das Codebeispiel in dieser Schnellstartanleitung funktioniert, muss `http://localhost:4200/` als Umleitungs-URI (`redirectUri`) hinzugefügt werden.
