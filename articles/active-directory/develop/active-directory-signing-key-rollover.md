...
Aus Sicherheitsgründen wird für den Signaturschlüssel von Microsoft Identity Platform regelmäßig ein Rollover durchgeführt, das im Notfall auch sofort erfolgen kann. Jede in Microsoft Identity Platform integrierte Anwendung muss darauf vorbereitet sein, unabhängig von der Häufigkeit ein Schlüsselrolloverereignis zu verarbeiten. Wenn dies nicht der Fall ist und die Anwendung versucht, einen abgelaufenen Schlüssel zum Überprüfen der Signatur auf einem Token zu verwenden, schlägt die Anmeldeanforderung fehl.
