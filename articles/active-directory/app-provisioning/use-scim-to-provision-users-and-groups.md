...
Fügen Sie dieser Methode dann den folgenden Code hinzu, damit alle Anforderungen an die Endpunkte des Diensts als Anforderungen authentifiziert werden, die über ein Token verfügen, das von Azure Active Directory für einen angegebenen Mandanten ausgestellt wurde, um auf den Microsoft Graph-API-Dienst zugreifen zu können: 
