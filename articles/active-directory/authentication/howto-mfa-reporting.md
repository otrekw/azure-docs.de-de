...
Stellen Sie zunächst sicher, dass das [MSOnline-V1-PowerShell-Modul](/powershell/azure/active-directory/overview?view=azureadps-1.0) installiert ist.
