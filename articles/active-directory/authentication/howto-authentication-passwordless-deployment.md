...
ms.locfileid: "77505607"
---
# <a name="complete-a-passwordless-authentication-deployment-in-azure-active-directory"></a>Bereitstellen einer kennwortlosen Authentifizierung in Azure Active Directory

Die meisten Cyberangriffe beginnen mit einem Benutzernamen und einem Kennwort, die von einer Person in einer Organisation gestohlen wurden. Organisationen versuchen, der Bedrohung mit folgenden Konzepten zu begegnen:
...
- Höhere Benutzerfreundlichkeit. Ermöglichen Sie es Benutzern, mühelos von jedem Ort aus auf Daten zuzugreifen, und bieten Sie unkomplizierten mobilen Zugriff auf Anwendungen und Dienste wie Outlook, OneDrive oder Office.
...
Um die Windows 10-Anmeldung mit FIDO2-Sicherheitsschlüsseln zu ermöglichen, muss die Anmeldeinformationsanbieter-Funktion in Windows 10 aktiviert werden. Dazu gibt es folgende Möglichkeiten:
...
| Benutzer kann auf eine App mit Anmeldung per Telefon zugreifen | Benutzer durchläuft die Anmeldung per Telefon und erreicht die angegebene Anwendung |
