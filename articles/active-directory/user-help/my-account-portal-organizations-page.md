...
1. Wählen Sie im linken Navigationsbereich **Organisationen** aus, oder wählen Sie im Block **Organisationen** den Link **Organisationen verwalten** aus.
...
1. Überprüfen Sie die Informationen für Ihre **Eigene Organisation**.

    ![Seite „Organisationen“](media/my-account-portal/my-account-portal-organization-page.png)

1. Überprüfen Sie Ihre anderen Organisationen, und stellen Sie sicher, dass Sie alle Organisationen kennen, auf die Sie Zugriff haben.
