---
title: 'Tutorial: Integrieren einer vorhandenen Gesamtstruktur und einer neuen Gesamtstruktur in einen einzelnen Azure AD-Mandanten unter Verwendung der Azure AD Connect-Cloudsynchronisierung'
description: Hier erfahren Sie, wie Sie einer vorhandenen Hybrididentitätsumgebung die Cloudsynchronisierung hinzufügen.
...
![Erstellen](media/tutorial-existing-forest/existing-forest-new-forest-2.png)
...
3. Wählen Sie auf der linken Seite **Azure Active Directory** aus, klicken Sie auf **Azure AD Connect**, und wählen Sie im mittleren Bereich **Manage cloud sync** (Cloudsynchronisierung verwalten) aus.</br>
...
![Screenshot: Bildschirm „Konfiguration abgeschlossen“](media/how-to-install/install-4a.png)</br>
   ...
   > [!NOTE]
   > Das gruppenverwaltete Dienstkonto (z. B. CONTOSO\provAgentgMSA$) wird in derselben Active Directory-Domäne erstellt, in die der Hostserver eingebunden wurde.
