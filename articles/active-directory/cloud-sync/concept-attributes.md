...
![Objektbereitstellung](media/concept-attributes/attribute-1.png)
...
> [!WARNING]
> Bei der Konfiguration der Cloudsynchronisierung wird ein Dienstprinzipal erstellt. Der Dienstprinzipal ist im Azure-Portal sichtbar. Die Attributzuordnungen dürfen nicht mithilfe des Dienstprinzipals im Azure-Portal geändert werden.  Dieser Vorgang wird nicht unterstützt.
...
1. Mit dieser Abfrage wird das Schema zurückgegeben.
   ...
   ![Zurückgegebenes Schema](media/concept-attributes/schema-1.png)
