...
1. Entfernen der zugewiesenen Benutzer und Gruppen
1. Löschen der Testbenutzer  
...
1. **Ausschließen eines Benutzers/einer Gruppe aus einer Richtlinie:** Falls ein Benutzer nicht auf die App zugreifen kann, können Sie ihn aus der Richtlinie ausschließen.
...
1. **Löschen der Richtlinie:** Löschen Sie die Richtlinie, wenn Sie sie nicht mehr benötigen.
