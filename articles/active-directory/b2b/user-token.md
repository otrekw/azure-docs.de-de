---
title: Informationen zu Benutzertoken bei der B2B-Zusammenarbeit – Azure AD
...
## <a name="microsoft-account-guest-token"></a>Microsoft-Kontogasttoken
```
