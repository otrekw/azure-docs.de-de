---
title: Veröffentlichen von Apps in separaten Netzwerken über Connectorgruppen – Azure Active Directory
description: Hier wird das Erstellen und Verwalten von Connectorgruppen im Azure Active Directory-Anwendungsproxy erläutert.
...
ms.author: kenwith
ms.reviewer: japere
ms.openlocfilehash: f6ddda8b777424f526d74c9a6115fc57eded40a2
ms.sourcegitcommit: 516eb79d62b8dbb2c324dff2048d01ea50715aa1
ms.translationtype: HT
ms.contentlocale: de-DE
ms.lasthandoff: 04/28/2021
ms.locfileid: "108186385"
---
...
1. Wählen Sie im Dropdownmenü **Connectorgruppe** die Gruppe aus, die die Anwendung verwenden soll.
...
![Beispiel für Azure AD – keine Connectorgruppen und ein isoliertes Netzwerk](./media/application-proxy-connector-groups/application-proxy-sample-config-2.png)
...
[Verstehen von Azure AD-Anwendungsproxyconnectors](application-proxy-connectors.md)
[Aktivieren des einmaligen Anmeldens](../manage-apps/what-is-single-sign-on.md)
