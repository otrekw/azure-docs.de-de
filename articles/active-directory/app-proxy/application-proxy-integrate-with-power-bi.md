---
title: Aktivieren des Remotezugriffs auf Power BI mit dem Azure Active Directory-Anwendungsproxy
description: Hier werden die Grundlagen für die Integration einer lokalen Power BI-Instanz mit dem Azure Active Directory-Anwendungsproxy erläutert.
...
ms.locfileid: "108229849"
---
# <a name="enable-remote-access-to-power-bi-mobile-with-azure-active-directory-application-proxy"></a>Aktivieren des Remotezugriffs auf Power BI Mobile mit dem Azure Active Directory-Anwendungsproxy
...
In diesem Artikel wird davon ausgegangen, dass Sie bereits Berichtsdienste bereitgestellt und den [Anwendungsproxy aktiviert](../app-proxy/application-proxy-add-on-premises-application.md) haben.

- Zur Aktivierung des Anwendungsproxys müssen Sie einen Connector auf einem Windows-Server installieren und die [Voraussetzungen](../app-proxy/application-proxy-add-on-premises-application.md#prepare-your-on-premises-environment) erfüllen, damit der Connector mit Azure AD-Diensten kommunizieren kann.
