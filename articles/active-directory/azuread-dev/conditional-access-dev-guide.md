...
Dabei werden Kenntnisse über [Apps mit einem oder mehreren Mandaten](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json) sowie über [allgemeine Authentifizierungsmuster](v1-authentication-scenarios.md) vorausgesetzt.
