...
- Bereitstellen Ihrer App mit dem Legacyportal für Azure Active Directory (Azure AD). Weitere Informationen finden Sie unter [Registrieren einer App](../develop/quickstart-register-app.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json).
