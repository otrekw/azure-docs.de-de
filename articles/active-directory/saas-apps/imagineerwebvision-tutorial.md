...
* Sie können es Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch bei Imagineer WebVision angemeldet werden (einmaliges Anmelden).
...
* Imagineer WebVision-Abonnement, für das einmaliges Anmelden aktiviert ist

## <a name="scenario-description"></a>Beschreibung des Szenarios

In diesem Tutorial konfigurieren und testen Sie das einmalige Anmelden von Azure AD in einer Testumgebung.

* Imagineer WebVision unterstützt **SP** -initiiertes einmaliges Anmelden
...
4. Geben Sie im Suchfeld **Imagineer WebVision** ein, wählen Sie im Ergebnisbereich **Imagineer WebVision** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen** , um die Anwendung hinzuzufügen.
    ...
    ![Imagineer WebVision in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Imagineer WebVision eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Imagineer WebVision](#configure-imagineer-webvision-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Imagineer WebVision-Testbenutzers](#create-imagineer-webvision-test-user)** , um eine Entsprechung von Britta Simon in Imagineer WebVision zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Imagineer WebVision** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Imagineer WebVision](common/sp-identifier.png)

    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<YOUR SERVER URL>/<yourapplicationloginpage>`.

    b. Geben Sie im Textfeld **Bezeichner (Entitäts-ID)** eine URL im folgenden Format ein: `https://<YOUR SERVER URL>/<yourapplicationloginpage>`.

    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Wenden Sie sich an das [Clientsupportteam von Imagineer WebVision](mailto:support@itgny.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
### <a name="configure-imagineer-webvision-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Imagineer WebVision

Zum Konfigurieren des einmaligen Anmeldens bei **Imagineer WebVision** müssen Sie die **Verbundmetadaten-URL der App** an das [Imagineer WebVision-Supportteam](mailto:support@itgny.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen**  > **Alle Anwendungen**  > **Imagineer WebVision** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Imagineer WebVision** aus.

    ![Der Imagineer WebVision-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-imagineer-webvision-test-user"></a>Erstellen eines Imagineer WebVision-Testbenutzers
...
Wenn Sie im Zugriffsbereich auf die Kachel „Imagineer WebVision“ klicken, sollten Sie automatisch bei der Imagineer WebVision-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
