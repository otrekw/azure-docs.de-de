...
In diesem Tutorial werden die Schritte beschrieben, die Sie sowohl in Shopify Plus als auch in Azure Active Directory (Azure AD) ausführen müssen, um die automatische Benutzerbereitstellung zu konfigurieren. Nach der Konfiguration stellt Azure AD mithilfe des Azure AD-Bereitstellungsdiensts automatisch Benutzer und Gruppen für [Shopify Plus](https://www.shopify.com) bereit bzw. hebt die Bereitstellung von Benutzern und Gruppen auf. Wichtige Details zum Zweck und zur Funktionsweise dieses Diensts sowie häufig gestellte Fragen finden Sie unter [Automatisieren der Bereitstellung und Bereitstellungsaufhebung von Benutzern für SaaS-Anwendungen mit Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
> * [Einmaliges Anmelden](./shopify-plus-tutorial.md) bei Shopify Plus (empfohlen)
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und Shopify Plus zugeordnet werden sollen](../app-provisioning/customize-application-attributes.md). 
