...
## <a name="adding-vmware-horizon---unified-access-gateway-from-the-gallery"></a>Hinzufügen von VMware Horizon - Unified Access Gateway aus dem Katalog
...
In diesem Abschnitt erstellen Sie in VMware Horizon - Unified Access Gateway einen Benutzer namens B. Simon. Arbeiten Sie mit dem  [Supportteam von VMware Horizon - Unified Access Gateway](mailto:support@vmware.com) zusammen, um die Benutzer auf der Plattform für VMware Horizon - Unified Access Gateway hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
