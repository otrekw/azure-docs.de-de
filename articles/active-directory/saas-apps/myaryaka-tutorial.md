...
In diesem Abschnitt erstellen Sie in MyAryaka einen Benutzer namens B. Simon. Wenden Sie sich zum Hinzufügen der Benutzer auf der MyAryaka-Plattform an das [MyAryaka-Supportteam](mailto:support@aryaka.com). Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
