...
## <a name="configure-and-test-azure-ad-sso-for-easysso-for-confluence"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für EasySSO for Confluence
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **EasySSO for Confluence** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Wenn Sie die Konfiguration in EasySSO for Confluence automatisieren möchten, müssen Sie die **Browsererweiterung „Meine Apps“ für die sichere Anmeldung** installieren, indem Sie auf **Erweiterung installieren** klicken.

    ![Erweiterung „Meine Apps“](common/install-myappssecure-extension.png)

2. Klicken Sie nach dem Hinzufügen der Erweiterung zum Browser auf **EasySSO for Confluence einrichten**, um zur Anwendung EasySSO for Confluence weitergeleitet zu werden. Geben Sie dort die Administratoranmeldeinformationen ein, um sich bei EasySSO for Confluence anzumelden. Die Browsererweiterung konfiguriert die Anwendung automatisch für Sie und automatisiert die Schritte 3 bis 9.

    ![Einrichtungskonfiguration](common/setup-sso.png)

1. Wenn Sie EasySSO for Confluence manuell einrichten möchten, melden Sie sich mit Administratorrechten bei der Atlassian Confluence-Instanz an, und navigieren Sie zum Abschnitt **Verwalten von Apps**. 
...
Wenn Sie unter „Meine Apps“ auf die Kachel „EasySSO for Confluence“ klicken, sollten Sie automatisch bei der Confluence-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
