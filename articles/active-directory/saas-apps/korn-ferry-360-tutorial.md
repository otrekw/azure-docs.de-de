---
title: 'Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure Active Directory mit Korn Ferry 360 | Microsoft-Dokumentation'
...
ms.locfileid: "92458879"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-korn-ferry-360"></a>Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure Active Directory mit Korn Ferry 360
...
## <a name="adding-korn-ferry-360-from-the-gallery"></a>Hinzufügen von Korn Ferry 360 über den Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-korn-ferry-360"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Korn Ferry 360
...
1. **[Konfigurieren des einmaligen Anmeldens für Korn Ferry 360](#configure-korn-ferry-360-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
    * **[Erstellen eines Korn Ferry 360-Testbenutzers](#create-korn-ferry-360-test-user)** , um in Korn Ferry 360 eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Korn Ferry 360** zum Abschnitt **Verwalten** , und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://surveys.kornferry.com/<customidentifier>`

    b. Geben Sie im Textfeld **Bezeichner** eine URL im folgenden Format ein: `https://<customidentifier>.kornferry.com/`
...
Wenn Sie im Zugriffsbereich auf die Kachel „Korn Ferry 360“ klicken, sollten Sie automatisch bei der Korn Ferry 360-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
...
- [Ausprobieren von Korn Ferry 360 mit Azure AD](https://aad.portal.azure.com/)
