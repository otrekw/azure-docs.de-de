...
## <a name="adding-iwt-procurement-suite-from-the-gallery"></a>Hinzufügen von IWT Procurement Suite aus dem Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-iwt-procurement-suite"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für IWT Procurement Suite
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **IWT Procurement Suite** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
In diesem Abschnitt erstellen Sie in IWT Procurement Suite einen Benutzer namens Britta Simon. Arbeiten Sie mit dem  [IWT Procurement Suite-Supportteam](mailto:support@ionwave.net) zusammen, um die Benutzer auf der IWT Procurement Suite-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „IWT Procurement Suite“ klicken, sollten Sie automatisch bei der IWT Procurement Suite-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [IWT Procurement Suite mit Azure AD ausprobieren](https://aad.portal.azure.com/)
