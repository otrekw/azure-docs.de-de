...
> * [Einmaliges Anmelden](./oracle-cloud-tutorial.md) bei der Oracle Cloud Infrastructure-Konsole (empfohlen)
...
* Ein Oracle Cloud Infrastructure Console-[Mandant](https://www.oracle.com/cloud/sign-in.html?intcmp=OcomFreeTier&source=:ow:o:p:nav:0916BCButton)
...
3. Legen Sie fest, welche Daten zwischen [Azure AD und der Oracle Cloud Infrastructure-Konsole zugeordnet werden sollen](../app-provisioning/customize-application-attributes.md). 
