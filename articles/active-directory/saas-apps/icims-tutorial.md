...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für ICIMS
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **ICIMS** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    b. Geben Sie im Textfeld **Bezeichner** eine URL ein: `icims.com`

    c. Geben Sie im Textfeld **Antwort-URL** eine URL ein: `https://.icims.com/`.
...
- [ICIMS mit Azure AD ausprobieren](https://aad.portal.azure.com/)
