...
* Nach dem Konfigurieren von Titanfile können Sie eine Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.

## <a name="adding-titanfile-from-the-gallery"></a>Hinzufügen von Titanfile aus dem Katalog
...
Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Titanfile die folgenden Bausteine aus:
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Titanfile** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
In diesem Abschnitt erstellen Sie in Titanfile einen Benutzer namens B. Simon. Arbeiten Sie mit dem  [Titanfile-Supportteam](mailto:support@titanfile.com) zusammen, um die Benutzer auf der Titanfile-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „Titanfile“ klicken, sollten Sie automatisch bei der Titanfile-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Testen von Titanfile mit Azure AD](https://aad.portal.azure.com/)
