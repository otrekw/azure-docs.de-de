---
title: 'Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure Active Directory mit Smart Global Governance | Microsoft-Dokumentation'
...
* Steuern Sie in Azure AD, wer Zugriff auf Smart Global Governance hat.
...
* Ein Smart Global Governance-Abonnement, für das einmaliges Anmelden (Single Sign-On, SSO) aktiviert ist
...
## <a name="adding-smart-global-governance-from-the-gallery"></a>Hinzufügen von Smart Global Governance aus dem Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-smart-global-governance"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Smart Global Governance

Konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Smart Global Governance mithilfe eines Testbenutzers mit dem Namen **B. Simon**. Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Smart Global Governance eingerichtet werden.

Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Smart Global Governance die folgenden Schritte aus:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    1. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    1. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren des einmaligen Anmeldens für Smart Global Governance](#configure-smart-global-governance-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    1. **[Erstellen eines Smart Global Governance-Testbenutzers](#create-smart-global-governance-test-user)** , um in Smart Global Governance eine Entsprechung von B. Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Smart Global Governance** müssen Sie das heruntergeladene **Zertifikat (Rohdaten)** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Smart Global Governance](mailto:support.tech@smartglobal.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-smart-global-governance-test-user"></a>Erstellen eines Smart Global Governance-Testbenutzers

In diesem Abschnitt erstellen Sie in Smart Global Governance einen Benutzer namens Britta Simon. Wenden Sie sich an das [Smart Global Governance-Supportteam](mailto:support.tech@smartglobal.com), um die Benutzer auf der Smart Global Governance-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „Smart Global Governance“ klicken, sollten Sie automatisch bei der Smart Global Governance-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
