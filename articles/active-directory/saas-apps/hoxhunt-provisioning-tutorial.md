...
> * Synchronisieren von Benutzerattributen zwischen Azure AD und Hoxhunt
> * [Einmaliges Anmelden](hoxhunt-tutorial.md) bei Hoxhunt (empfohlen)
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und Hoxhunt zugeordnet werden sollen](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-hoxhunt-to-support-provisioning-with-azure-ad"></a>Schritt 2: Konfigurieren von Hoxhunt für die Unterstützung der Bereitstellung mit Azure AD
Wenden Sie sich an [Support von Hoxhunt](mailto:support@hoxhunt.com), um den SCIM-API-Schlüssel und die SCIM-Endpunkt-URL zu erhalten und damit die Bereitstellung mit Azure AD zu konfigurieren.
## <a name="step-3-add-hoxhunt-from-the-azure-ad-application-gallery"></a>Schritt 3: Hinzufügen von Hoxhunt aus dem Azure AD-Anwendungskatalog

Fügen Sie Hoxhunt aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in Hoxhunt zu beginnen. Wenn Sie Hoxhunt zuvor für einmaliges Anmelden (Single Sign-On, SSO) eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
...
* Beim Zuweisen von Benutzern und Gruppen zu Hoxhunt müssen Sie eine andere Rolle als **Standardzugriff** auswählen. Benutzer mit der Rolle „Standardzugriff“ werden von der Bereitstellung ausgeschlossen und in den Bereitstellungsprotokollen als „nicht effektiv berechtigt“ gekennzeichnet. Wenn für die Anwendung nur die Rolle „Standardzugriff“ verfügbar ist, können Sie das [Anwendungsmanifest aktualisieren](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) und weitere Rollen hinzufügen. 
...
## <a name="step-5-configure-automatic-user-provisioning-to-hoxhunt"></a>Schritt 5: Konfigurieren der automatischen Benutzerbereitstellung in Hoxhunt 

In diesem Abschnitt werden die Schritte zum Konfigurieren des Azure AD-Bereitstellungsdiensts zum Erstellen, Aktualisieren und Deaktivieren von Benutzern bzw. Gruppen in ServiceNow auf der Grundlage von Benutzer- oder Gruppenzuweisungen in Azure AD erläutert.

### <a name="to-configure-automatic-user-provisioning-for-hoxhunt-in-azure-ad"></a>So konfigurieren Sie die automatische Benutzerbereitstellung für Hoxhunt in Azure AD

1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Wählen Sie **Unternehmensanwendungen** und dann **Alle Anwendungen**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Hoxhunt** aus.

    ![Hoxhunt-Link in der Anwendungsliste](common/all-applications.png)
...
11. Um den Azure AD-Bereitstellungsdienst für Hoxhunt zu aktivieren, ändern Sie den **Bereitstellungsstatus** im Abschnitt **Einstellungen** in **Ein**.

    ![Aktivierter Bereitstellungsstatus](common/provisioning-toggle-on.png)

12. Legen Sie die Benutzer und/oder Gruppen fest, die in Hoxhunt bereitgestellt werden sollen, indem Sie im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte auswählen.
