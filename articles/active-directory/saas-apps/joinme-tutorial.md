...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihrem Azure AD-Konto automatisch bei join.me anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* SSO-fähiges join.me-Abonnement

## <a name="scenario-description"></a>Beschreibung des Szenarios

In diesem Tutorial konfigurieren und testen Sie das einmalige Anmelden von Azure AD in einer Testumgebung.

* join.me unterstützt **IDP**-initiiertes einmaliges Anmelden.
...
4. Geben Sie im Suchfeld **join.me** ein, wählen Sie im Ergebnisbereich **join.me** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![join.me in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD bei join.me mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in join.me eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für join.me](#configure-joinme-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines join.me-Testbenutzers](#create-joinme-test-user)** , um in join.me ein Pendant von Britta Simon zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit join.me zu konfigurieren:
...
4. Im Abschnitt **Grundlegende SAML-Konfiguration** muss der Benutzer keine Schritte ausführen, weil die App bereits in Azure integriert ist.
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für join.me](common/preintegrated.png)
...
### <a name="configure-joinme-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für join.me

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **join.me** müssen Sie die **App-Verbundmetadaten-URL** an das [join.me-Supportteam](https://help.join.me/s/?language) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** > **join.me** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **join.me** aus.

    ![join.me-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Erstellen eines join.me-Testbenutzers
