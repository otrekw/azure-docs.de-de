...
2. Klicken Sie auf **Tools** -> **Account** (Extras > Konten).
    ...
    ![WhosOnLocation-Konfiguration](./media/WhosOnLocation-tutorial/config1.png)

3. Wählen Sie im Navigationsbereich auf der linken Seite **Employee Access** (Zugriff für Mitarbeiter) aus.

    ![WhosOnLocation-Konfiguration](./media/WhosOnLocation-tutorial/config2.png)

4. Führen Sie auf der folgenden Seite die folgenden Schritte aus:

    ![WhosOnLocation-Konfiguration](./media/WhosOnLocation-tutorial/config3.png)
...
In diesem Abschnitt erstellen Sie in WhosOnLocation einen Benutzer namens B. Simon. Wenden Sie sich an das  [WhosOnLocation-Supportteam](mailto:support@whosonlocation.com), um die Benutzer auf der WhosOnLocation-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
