---
title: 'Tutorial: Azure Active Directory-Integration von Greenhouse | Microsoft-Dokumentation'
...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihrem Azure AD-Konto automatisch bei Greenhouse anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* SSO-fähiges Greenhouse-Abonnement
...
4. Geben Sie im Suchfeld **Greenhouse** ein, wählen Sie im Ergebnisbereich **Greenhouse** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![Greenhouse in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD bei Greenhouse mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Greenhouse eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Greenhouse](#configure-greenhouse-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Greenhouse-Testbenutzers](#create-greenhouse-test-user)** , um in Greenhouse ein Pendant von Britta Simon zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit Greenhouse zu konfigurieren:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Greenhouse** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Greenhouse](common/sp-identifier.png)
...
### <a name="configure-greenhouse-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Greenhouse

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Greenhouse** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Greenhouse](https://www.greenhouse.io/contact) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** > **Greenhouse** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **Greenhouse** aus.

    ![Greenhouse-Link in der Anwendungsliste](common/all-applications.png)
