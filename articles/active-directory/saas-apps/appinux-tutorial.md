---
title: 'Tutorial: Integration von Appinux in das einmalige Anmelden (Single Sign-On, SSO) von Azure Active Directory | Microsoft-Dokumentation'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-appinux"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Appinux
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit Appinux zu konfigurieren und zu testen:
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Appinux** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
In diesem Abschnitt ermöglichen Sie B. Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihm Zugriff auf Appinux gewähren.

1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** aus.
1. Wählen Sie in der Anwendungsliste **Appinux** aus.
...
## <a name="configure-appinux-sso"></a>Konfigurieren des einmaligen Anmeldens für Appinux

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Appinux** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Appinux](https://support.appinux.com/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-appinux-test-user"></a>Erstellen eines Appinux-Testbenutzers

In diesem Abschnitt wird ein Benutzer mit dem Namen Britta Simon in Appinux erstellt. Appinux unterstützt die Just-in-Time-Benutzerbereitstellung, die standardmäßig aktiviert ist. Für Sie steht in diesem Abschnitt kein Aktionselement zur Verfügung. Ist ein Benutzer noch nicht in Appinux vorhanden, wird nach der Authentifizierung ein neuer Benutzer erstellt.
...
Wenn Sie im Zugriffsbereich auf die Kachel „Appinux“ klicken, sollten Sie automatisch bei der Appinux-Anwendung angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Probieren Sie Appinux mit Azure AD aus.](https://aad.portal.azure.com/)
