...
## <a name="configure-and-test-azure-ad-single-sign-on-for-dotcom-monitor"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Dotcom-Monitor
...
1. **[Konfigurieren des einmaligen Anmeldens für Dotcom-Monitor](#configure-dotcom-monitor-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines Dotcom-Monitor-Testbenutzers](#create-dotcom-monitor-test-user)** , um eine Entsprechung von B. Simon in Dotcom-Monitor zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Dotcom-Monitor** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Darüber hinaus wird von der Dotcom-Monitor-Anwendung erwartet, dass in der SAML-Antwort noch einige weitere Attribute zurückgegeben werden (siehe unten). Diese Attribute werden ebenfalls vorab aufgefüllt, Sie können sie jedoch nach Bedarf überprüfen.
    ...
    > [!NOTE]
    > Weitere Informationen zum Erstellen von benutzerdefinierten Rollen in Azure AD finden Sie [hier](https://docs.microsoft.com/azure/active-directory/active-directory-enterprise-app-role-management).
...
Wenn Sie im Zugriffsbereich auf die Kachel „Dotcom-Monitor“ klicken, sollten Sie automatisch bei der Dotcom-Monitor-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Dotcom-Monitor mit Azure AD ausprobieren](https://aad.portal.azure.com/)