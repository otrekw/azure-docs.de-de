---
title: 'Tutorial: Integration des einmaligen Anmeldens von Azure Active Directory in Harmony | Microsoft-Dokumentation'
description: Hier erfahren Sie, wie Sie das einmalige Anmelden zwischen Azure Active Directory und Harmony konfigurieren.
...
In diesem Tutorial erfahren Sie, wie Sie Harmony in Azure Active Directory (Azure AD) integrieren. Die Integration von Harmony in Azure AD ermöglicht Folgendes:
...
* Ein Harmony-Abonnement, das für das einmalige Anmelden (Single Sign-On, SSO) aktiviert ist.
...
Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Harmony die folgenden Schritte aus:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    1. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    1. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren des einmaligen Anmeldens für Harmony](#configure-harmony-sso)** , um die Einstellungen für das einmalige Anmelden auf der Anwendungsseite zu konfigurieren.
    1. **[Erstellen eines Harmony-Testbenutzers](#create-harmony-test-user)** , um eine Entsprechung von B. Simon in Harmony zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Die Harmony-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Daher müssen Sie benutzerdefinierte Attributzuordnungen zu Ihrer Konfiguration der SAML-Tokenattribute hinzufügen. Der folgende Screenshot zeigt die Liste der Standardattribute.

    ![image](common/default-attributes.png)

1. Darüber hinaus erwartet die Harmony-Anwendung, dass in der SAML-Antwort noch einige weitere Attribute zurückgegeben werden (siehe unten). Diese Attribute werden ebenfalls vorab aufgefüllt, Sie können sie jedoch nach Bedarf überprüfen.
...
1. Kopieren Sie im Abschnitt **Harmony einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
In diesem Abschnitt ermöglichen Sie B. Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihr Zugriff auf Harmony gewähren.
...
## <a name="configure-harmony-sso"></a>Konfigurieren des einmaligen Anmeldens für Harmony

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Harmony** müssen Sie das heruntergeladene **Zertifikat (Base64)** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Harmony](https://us.moodmedia.com/contact-us/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-harmony-test-user"></a>Erstellen eines Harmony-Testbenutzers

In diesem Abschnitt erstellen Sie in Harmony eine Benutzerin namens Britta Simon. Wenden Sie sich an das  [Harmony-Supportteam](https://us.moodmedia.com/contact-us/), um die Benutzer auf der Harmony-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
