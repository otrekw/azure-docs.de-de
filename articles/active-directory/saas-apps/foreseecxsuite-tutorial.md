...
* Sie können Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei ForeSee CX Suite anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* ForeSee CX Suite-Abonnement, für das einmaliges Anmelden aktiviert ist

## <a name="scenario-description"></a>Beschreibung des Szenarios

In diesem Tutorial konfigurieren und testen Sie das einmalige Anmelden von Azure AD in einer Testumgebung.

* ForeSee CX Suite unterstützt das **SP-initiierte** einmalige Anmelden.

* ForeSee CX Suite unterstützt die **Just-in-Time** -Benutzerbereitstellung.
...
4. Geben Sie im Suchfeld **ForeSee CX Suite** ein, wählen Sie im Ergebnisbereich **ForeSee CX Suite** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen** , um die Anwendung hinzuzufügen.

     ![ForeSee CX Suite in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in ForeSee CX Suite eingerichtet werden.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **ForeSee CX Suite** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie über eine **Dienstanbieter-Metadatendatei** verfügen:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für ForeSee CX Suite](common/sp-identifier.png)
...
6. Kopieren Sie im Abschnitt **ForeSee CX Suite einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-foresee-cx-suite-single-sign-on"></a>Konfigurieren des einmaliges Anmeldens für ForeSee CX Suite

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **ForeSee CX Suite** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von ForeSee CX Suite](mailto:support@foresee.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **ForeSee CX Suite** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **ForeSee CX Suite** aus.

    ![ForeSee CX Suite-Link in der Anwendungsliste](common/all-applications.png)
...
Wenn Sie im Zugriffsbereich auf die Kachel „ForeSee CX Suite“ klicken, sollten Sie automatisch bei der ForeSee CX Suite-Anwendung angemeldet werden, für die Sie SSO eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
