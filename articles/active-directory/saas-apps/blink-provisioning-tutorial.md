...
1. Reichen Sie eine [Supportanfrage](https://help.joinblink.com/hc/requests/new) ein, oder senden Sie eine E-Mail an den **Blink-Support** (support@joinblink.com), um ein SCIM-Token anzufordern. erforderlich.
