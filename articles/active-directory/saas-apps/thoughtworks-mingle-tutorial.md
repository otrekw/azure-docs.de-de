...
3. Führen Sie im Abschnitt **SSO Config** die folgenden Schritte aus:
    ...
    a. Um die Metadatendatei hochzuladen, klicken Sie auf **Choose file**. 
...
5. Führen Sie auf der Dialogfeldseite **Neuer Benutzer** die folgenden Schritte aus:
    ...
    b. Wählen Sie als **User type** die Option **Full user** aus.

    c. Klicken Sie auf **Create This Profile**.
