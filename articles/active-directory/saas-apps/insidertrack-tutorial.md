...
* Sie können Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Insider Track anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* Insider Track unterstützt **SP**-initiiertes einmaliges Anmelden.
...
4. Geben Sie im Suchfeld **Insider Track** ein, wählen Sie im Ergebnisbereich **Insider Track** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![Insider Track in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Insider Track eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Insider Track](#configure-insider-track-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Insider Track-Testbenutzers](#create-insider-track-test-user)** , um eine Entsprechung von Britta Simon in Insider Track zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Insider Track** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Insider Track](common/sp-signonurl.png)

    Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<companyname>/InsiderTrack.Portal.<companyname>/Sso/`

    > [!NOTE]
    > Dieser Wert entspricht nicht dem tatsächlichen Wert. Ersetzen Sie diesen Wert durch die tatsächliche Anmelde-URL. Wenden Sie sich an das [Supportteam für den Insider Track-Client](https://cytecsolutions.com/contact/), um den Wert zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
### <a name="configure-insider-track-single-sign-on"></a>Einmaliges Anmelden für Insider Track konfigurieren

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Insider Track** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Insider Track](https://cytecsolutions.com/contact/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **Insider Track** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Insider Track** aus.

    ![Insider Track-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-insider-track-test-user"></a>Erstellen eines Insider Track-Testbenutzers
...
Wenn Sie im Zugriffsbereich auf die Kachel „Insider Track“ klicken, sollten Sie automatisch bei Ihrer Insider Track-Anwendung angemeldet werden. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
