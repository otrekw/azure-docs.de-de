---
title: 'Tutorial: Azure Active Directory-Integration von Clever Nelly| Microsoft-Dokumentation'
...
ms.locfileid: "88520092"
---
# <a name="tutorial-integrate-clever-nelly-with-azure-active-directory"></a>Tutorial: Integrieren von Clever Nelly in Azure Active Directory
...
In diesem Tutorial konfigurieren und testen Sie das einmalige Anmelden von Azure AD in einer Testumgebung. Clever Nelly unterstützt **SP- und IDP-initiiertes** einmaliges Anmelden.

## <a name="adding-clever-nelly-from-the-gallery"></a>Hinzufügen von Clever Nelly aus dem Katalog
...
Zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD bei Clever Nelly müssen Sie die folgenden Bausteine ausführen:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
2. **[Konfigurieren des einmaligen Anmeldens für Clever Nelly](#configure-clever-nelly-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Clever Nelly-Testbenutzers](#create-clever-nelly-test-user)** , um ein Pendant von Britta Simon in Clever Nelly zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Suchen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Clever Nelly** den Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Klicken Sie auf **Zusätzliche URLs festlegen**, und führen Sie den folgenden Schritt aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Sie müssen diese Werte mit dem tatsächlichen Bezeichner, der Antwort-URL und der Anmelde-URL aktualisieren. Wenden Sie sich an das [Supportteam für den Clever Nelly-Client](mailto:support@elephantsdontforget.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
In diesem Abschnitt erstellen Sie in Clever Nelly einen Benutzer namens Britta Simon. Arbeiten Sie mit dem  [Supportteam von Clever Nelly](mailto:support@elephantsdontforget.com) zusammen, um die Benutzer der Clever Nelly-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-sso"></a>Testen des einmaligen Anmeldens

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „Clever Nelly“ klicken, sollten Sie automatisch bei der Clever Nelly-Instanz angemeldet werden, für die Sie SSO eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
