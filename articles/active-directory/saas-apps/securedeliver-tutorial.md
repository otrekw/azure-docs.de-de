...
* Sie können Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei SECURE DELIVER anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* SECURE DELIVER unterstützt **SP**-initiiertes einmaliges Anmelden.
...
4. Geben Sie im Suchfeld den Namen **SECURE DELIVER** ein, wählen Sie im Ergebnisbereich den Eintrag **SECURE DELIVER** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![SECURE DELIVER in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in SECURE DELIVER eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für SECURE DELIVER](#configure-secure-deliver-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines SECURE DELIVER-Testbenutzers](#create-secure-deliver-test-user)** , um eine Entsprechung von Britta Simon in SECURE DELIVER zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD bei SECURE DELIVER die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **SECURE DELIVER** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für SECURE DELIVER](common/sp-identifier.png)
...
### <a name="configure-secure-deliver-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für SECURE DELIVER
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **SECURE DELIVER** aus.
...
In diesem Abschnitt erstellen Sie in SECURE DELIVER einen Benutzer namens Britta Simon. Lassen Sie sich beim Hinzufügen von Benutzern zur SECURE DELIVER-Plattform vom  [Supportteam von SECURE DELIVER](mailto:iw-sd-support@fujifilm.com) unterstützen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-single-sign-on"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „SECURE DELIVER“ klicken, sollten Sie automatisch bei der SECURE DELIVER-Anwendung angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
