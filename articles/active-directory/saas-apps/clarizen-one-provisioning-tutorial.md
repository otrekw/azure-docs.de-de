...
In diesem Tutorial werden die Schritte beschrieben, die Sie sowohl in Clarizen One als auch in Azure Active Directory (Azure AD) ausführen müssen, um die automatische Benutzerbereitstellung zu konfigurieren. Bei der Konfiguration stellt Azure AD mithilfe des Azure AD-Bereitstellungsdiensts automatisch Benutzer und Gruppen in [Clarizen One](https://www.clarizen.com/) bereit bzw. hebt die Bereitstellung von Benutzern und Gruppen auf. Wichtige Details zum Zweck und zur Funktionsweise dieses Diensts sowie häufig gestellte Fragen finden Sie unter [Automatisieren der Bereitstellung und Bereitstellungsaufhebung von Benutzern für SaaS-Anwendungen mit Azure Active Directory](../manage-apps/user-provisioning.md). 
...
> * [Einmaliges Anmelden](https://docs.microsoft.com/azure/active-directory/saas-apps/clarizen-tutorial) bei Clarizen One (empfohlen)
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und Clarizen One zugeordnet werden sollen](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
2. Generieren Sie einen [API-Schlüssel](https://success.clarizen.com/hc/articles/360011833079-API-Keys-Support). Dieser Wert wird auf der Registerkarte „Bereitstellung“ für Ihre Clarizen One-Anwendung im Azure-Portal in das Feld **Geheimes Token** eingegeben.
...
Fügen Sie Clarizen One aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in Clarizen One zu beginnen. Wenn Sie Clarizen One zuvor für das einmalige Anmelden (SSO) eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
...
### <a name="to-configure-automatic-user-provisioning-for-clarizen-one-in-azure-ad"></a>So konfigurieren Sie die automatische Benutzerbereitstellung für Clarizen One in Azure AD

1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Wählen Sie **Unternehmensanwendungen** und dann **Alle Anwendungen**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Clarizen One** aus.

    ![Clarizen One-Link in der Anwendungsliste](common/all-applications.png)
...
10. Wählen Sie im Abschnitt **Zuordnungen** die Option **Azure Active Directory-Gruppen mit Clarizen One synchronisieren** aus.
...
13. Um den Azure AD-Bereitstellungsdienst für Clarizen One zu aktivieren, ändern Sie den **Bereitstellungsstatus** im Abschnitt **Einstellungen** in **Ein**.

    ![Aktivierter Bereitstellungsstatus](common/provisioning-toggle-on.png)

14. Legen Sie die Benutzer und/oder Gruppen fest, die in Clarizen One bereitgestellt werden sollen. Wählen Sie dazu im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte aus.
...
Wenn Sie der Katalog-App von Clarizen One einen Benutzer zuweisen, wählen Sie nur die Rolle **User** (Benutzer) aus. Die unten gezeigten Rollen sind ungültig.

* Administrator (Admin)
* Email Reporting User (Benutzer mit Berichterstattung per E-Mail)
* External User (Externer Benutzer)
* Financial User (Benutzer für Finanzdaten)
* Social User (Benutzer für Social Media)
* Administrator
* Time & Expense User (Zeit- und Ausgabenbenutzer)
