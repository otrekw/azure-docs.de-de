...
## <a name="add-euromonitor-passport-from-the-gallery"></a>Hinzufügen von Euromonitor Passport über den Katalog
...
## <a name="configure-and-test-azure-ad-sso-for-euromonitor-passport"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Euromonitor Passport
...
1. **[Konfigurieren des einmaligen Anmeldens für Euromonitor Passport](#configure-euromonitor-passport-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
    1. **[Erstellen eines Euromonitor Passport-Testbenutzers](#create-euromonitor-passport-test-user)** , um in Euromonitor Passport eine Entsprechung von B.Simon zu erhalten, die mit der Benutzerdarstellung in Azure AD verknüpft ist.
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **Euromonitor Passport** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für Euromonitor Passport weitergeleitet, wo Sie den Anmeldeflow initiieren können.  

* Rufen Sie direkt die Euromonitor Passport-Anmelde-URL auf, und initiieren Sie den Anmeldeflow.

#### <a name="idp-initiated"></a>IDP-initiiert:

* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch sollten Sie automatisch bei der Euromonitor Passport-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. 

Sie können auch den Microsoft-Bereich „Meine Apps“ verwenden, um die Anwendung in einem beliebigen Modus zu testen. Beim Klicken auf die Kachel „Euromonitor Passport“ in „Meine Apps“ geschieht Folgendes: Wenn Sie den SP-Modus konfiguriert haben, werden Sie zum Initiieren des Anmeldeflows zur Anmeldeseite der Anwendung weitergeleitet. Wenn Sie den IDP-Modus konfiguriert haben, sollten Sie automatisch bei der Euromonitor Passport-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## <a name="next-steps"></a>Nächste Schritte

Nach dem Konfigurieren von Euromonitor Passport können Sie die Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.
