...
* WalkMe SAML2.0 unterstützt **IDP**-initiiertes einmaliges Anmelden.
...
## <a name="configure-walkme-saml20-sso"></a>Konfigurieren des einmaligen Anmeldens für WalkMe SAML2.0
