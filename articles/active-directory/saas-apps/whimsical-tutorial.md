...
Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Whimsical die folgenden Schritte aus:
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **Whimsical** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Wenn Sie die Konfiguration in Whimsical automatisieren möchten, müssen Sie die **Browsererweiterung „Meine Apps“ für die sichere Anmeldung** installieren, indem Sie auf **Erweiterung installieren** klicken.

    ![Erweiterung „Meine Apps“](common/install-myappssecure-extension.png)

2. Klicken Sie nach dem Hinzufügen der Erweiterung zum Browser auf **Whimsical einrichten**, um zur Anwendung Whimsical weitergeleitet zu werden. Geben Sie dort die Administratoranmeldeinformationen ein, um sich bei Whimsical anzumelden. Die Browsererweiterung konfiguriert die Anwendung automatisch für Sie und automatisiert die Schritte 3 und 4.

    ![Einrichtungskonfiguration](common/setup-sso.png)

3. Wenn Sie Whimsical manuell einrichten möchten, melden Sie sich in einem anderen Webbrowserfenster als Administrator bei der Whimsical-Unternehmenswebsite an.

4. Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Whimsical** müssen Sie die **Verbundmetadaten-XML-Datei**, die Sie gerade heruntergeladen haben, in Ihre [Arbeitsbereichseinstellungen](https://whimsical.com/workspace/settings) hochladen.
...
* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für Whimsical weitergeleitet, wo Sie den Anmeldeflow initiieren können.

* Rufen Sie direkt die Whimsical-Anmelde-URL auf, und initiieren Sie den Anmeldeflow.

#### <a name="idp-initiated"></a>IDP-initiiert:

* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch sollten Sie automatisch bei der Whimsical-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben.

Sie können auch den Microsoft-Bereich „Meine Apps“ verwenden, um die Anwendung in einem beliebigen Modus zu testen. Beim Klicken auf die Kachel „Whimsical“ in „Meine Apps“ geschieht Folgendes: Wenn Sie die Anwendung im SP-Modus konfiguriert haben, werden Sie zum Initiieren des Anmeldeflows zur Anmeldeseite der Anwendung weitergeleitet. Wenn Sie die Anwendung im IDP-Modus konfiguriert haben, sollten Sie automatisch bei der Whimsical-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](../user-help/my-apps-portal-end-user-access.md).
