...
In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Boxcryptor mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Boxcryptor eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Boxcryptor](#configure-boxcryptor-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Boxcryptor-Testbenutzers](#create-boxcryptor-test-user)** , um eine Entsprechung von Britta Simon in Boxcryptor zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Boxcryptor die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Boxcryptor** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Boxcryptor](common/sp-identifier.png)

    a. Geben Sie im Textfeld **Anmelde-URL** die URL wie folgt ein: `https://www.boxcryptor.com/app`.
...
### <a name="configure-boxcryptor-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Boxcryptor
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **Boxcryptor** aus.
