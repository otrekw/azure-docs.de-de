...
* LoginRadius-Abonnement, für das einmaliges Anmelden aktiviert ist
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** die URL wie folgt ein: `https://secure.loginradius.com/login`.

    b. Geben Sie im Textfeld **Bezeichner (Entitäts-ID)** eine URL ein: `https://LoginRadius.hub.loginradius.com/`.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **LoginRadius** müssen Sie die heruntergeladene **Metadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von LoginRadius](mailto:support@loginradius.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
In diesem Abschnitt erstellen Sie in LoginRadius einen Benutzer namens Britta Simon. Lassen Sie sich beim Hinzufügen von Benutzern zur LoginRadius-Plattform vom  [LoginRadius-Supportteam](mailto:support@loginradius.com) unterstützen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-single-sign-on"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „LoginRadius“ klicken, sollten Sie automatisch bei der LoginRadius-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
