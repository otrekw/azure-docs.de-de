...
ms.locfileid: "100374557"
---
# <a name="tutorial-azure-active-directory-integration-with-ariba"></a>Tutorial: Azure Active Directory-Integration mit Ariba

In diesem Tutorial erfahren Sie, wie Sie Ariba in Azure Active Directory (Azure AD) integrieren. Die Integration von Ariba in Azure AD ermöglicht Folgendes:

* Steuern Sie in Azure AD, wer Zugriff auf Ariba hat.
* Ermöglichen Sie es Ihren Benutzern, sich mit ihren Azure AD-Konten automatisch bei Ariba anzumelden.
...
* Ein Ariba-Abonnement, für das einmaliges Anmelden (Single Sign-On, SSO) aktiviert ist
...
## <a name="configure-and-test-azure-ad-sso-for-ariba"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Ariba

Konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Ariba mithilfe eines Testbenutzers mit dem Namen **B. Simon**. Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Ariba eingerichtet werden.

Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Ariba die folgenden Schritte aus:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    1. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    1. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren des einmaligen Anmeldens für Ariba](#configure-ariba-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    1. **[Erstellen eines Ariba-Testbenutzers](#create-ariba-test-user)** , um eine Entsprechung von B. Simon in Ariba zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **Ariba** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für Ariba weitergeleitet, wo Sie den Anmeldeflow initiieren können. 

* Navigieren Sie direkt zur Anmelde-URL für Ariba, und initiieren Sie den Anmeldeflow.

* Sie können „Meine Apps“ von Microsoft verwenden. Wenn Sie unter „Meine Apps“auf die Kachel „Ariba“ klicken, werden Sie zur Anmelde-URL für Ariba weitergeleitet. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
