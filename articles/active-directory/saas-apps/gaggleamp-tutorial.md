...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei GaggleAMP anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
4. Geben Sie im Suchfeld **GaggleAMP** ein, wählen Sie im Ergebnisbereich **GaggleAMP** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![GaggleAMP in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit GaggleAMP mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in GaggleAMP eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für GaggleAMP](#configure-gaggleamp-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines GaggleAMP-Testbenutzers](#create-gaggleamp-test-user)** , um ein Pendant von Britta Simon in GaggleAMP zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit GaggleAMP die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **GaggleAMP**die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für GaggleAMP](common/idp-identifier.png)

    Geben Sie im Textfeld **Bezeichner** eine URL ein: `https://accounts.gaggleamp.com/auth/saml/callback`.
...
### <a name="configure-gaggleamp-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für GaggleAMP
...
2. Führen Sie auf der Seite **SAML-SSO** die folgenden Schritte aus:  
    ...
    ![Einmaliges Anmelden in GaggleAMP](./media/gaggleamp-tutorial/tutorial_gaggleamp_06.png)
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, und wählen Sie dann **Alle Anwendungen** und **GaggleAMP** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **GaggleAMP**aus.

    ![GaggleAMP-Link in der Anwendungsliste](common/all-applications.png)
