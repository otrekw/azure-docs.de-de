...
* Sie können es Ihren Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch bei GlassFrog angemeldet werden (einmaliges Anmelden; Single Sign-On, SSO).
...
4. Geben Sie im Suchfeld **GlassFrog** ein, wählen Sie im Ergebnisbereich **GlassFrog** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![GlassFrog in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in GlassFrog eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für GlassFrog](#configure-glassfrog-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines GlassFrog-Testbenutzers](#create-glassfrog-test-user)** , um eine Entsprechung von Britta Simon in GlassFrog zu erhalten, die mit der Darstellung des Benutzers in Azure AD verknüpft ist.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für GlassFrog](common/sp-signonurl.png)
...
### <a name="configure-glassfrog-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für GlassFrog
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **GlassFrog**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **GlassFrog** aus.

    ![GlassFrog-Link in der Anwendungsliste](common/all-applications.png)
...
In diesem Abschnitt erstellen Sie in GlassFrog einen Benutzer namens Britta Simon. Lassen Sie sich beim Hinzufügen der Benutzer auf der GlassFrog-Plattform ggf. vom  [GlassFrog-Supportteam](mailto:support@glassfrog.com) unterstützen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-single-sign-on"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „GlassFrog“ klicken, sollten Sie automatisch bei der GlassFrog-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
