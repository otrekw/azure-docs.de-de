...
## <a name="add-vtiger-crm-saml-from-the-gallery"></a>Hinzufügen von Vtiger CRM (SAML) aus dem Katalog
...
* Sie können „Meine Apps“ von Microsoft verwenden. Wenn Sie in „Meine Apps“auf die Kachel „Vtiger CRM (SAML)“ klicken, werden Sie zur Anmelde-URL für Vtiger CRM (SAML) weitergeleitet. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](../user-help/my-apps-portal-end-user-access.md).
