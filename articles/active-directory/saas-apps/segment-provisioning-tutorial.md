---
title: 'Tutorial: Konfigurieren von Segment für die automatische Benutzerbereitstellung in Azure Active Directory | Microsoft-Dokumentation'
...
In diesem Tutorial werden die Schritte beschrieben, die Sie sowohl in Segment als auch in Azure Active Directory (Azure AD) ausführen müssen, um die automatische Benutzerbereitstellung zu konfigurieren. Bei der Konfiguration stellt Azure AD automatisch mithilfe des Azure AD-Bereitstellungsdiensts Benutzer und Gruppen für [Segment](https://www.segment.com/) bereit bzw. hebt deren Bereitstellung auf. Wichtige Details zum Zweck und zur Funktionsweise dieses Diensts sowie häufig gestellte Fragen finden Sie unter [Automatisieren der Bereitstellung und Bereitstellungsaufhebung von Benutzern für SaaS-Anwendungen mit Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Unterstützte Funktionen
> [!div class="checklist"]
> * Erstellen von Benutzern in Segment
> * Entfernen von Benutzern aus Segment, wenn diese keinen Zugriff mehr benötigen
> * Synchronisieren von Benutzerattributen zwischen Azure AD und Segment
> * Bereitstellen von Gruppen und Gruppenmitgliedschaften in Segment
> * [Einmaliges Anmelden](https://docs.microsoft.com/azure/active-directory/saas-apps/segment-tutorial) bei Segment (empfohlen)
...
* Ein Benutzerkonto in Segment mit Besitzerberechtigungen.
* Für Ihren Arbeitsbereich muss das einmalige Anmelden aktiviert sein (erfordert ein Abonnement auf Geschäftsebene).
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und Segment zugeordnet werden sollen](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-segment-to-support-provisioning-with-azure-ad"></a>Schritt 2: Konfigurieren von Segment die Unterstützung der Bereitstellung mit Azure AD

1. Die Mandanten-URL lautet `http://scim.segmentapis.com/scim/v2`. Dieser Wert wird auf der Registerkarte „Bereitstellung“ im Feld **Mandanten-URL** der Segment-Anwendung im Azure-Portal eingegeben.

2. Melden Sie sich bei der[Segment](https://www.segment.com/)-App an.

3. Navigieren Sie im linken Bereich zu **Einstellungen**  >  **Authentifizierung**  >  **Erweiterte Einstellungen**.

    ![panel](media/segment-provisioning-tutorial/left.png)

4. Scrollen Sie nach unten zu **SSO Sync** und klicken Sie auf **SSO-Token generieren**.

    ![access](media/segment-provisioning-tutorial/token.png)

5. Kopieren und speichern Sie das Bearertoken. Dieser Wert wird im Azure-Portal auf der Registerkarte „Bereitstellung“ Ihrer Segment-Anwendung im Feld **Geheimes Token** eingegeben.

    ![token](media/segment-provisioning-tutorial/access.png)

## <a name="step-3-add-segment-from-the-azure-ad-application-gallery"></a>Schritt 3: Hinzufügen von Segment aus dem Azure AD-Anwendungskatalog

Fügen Sie Segment aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in Segment zu beginnen. Wenn Sie Segment zuvor für einmaliges Anmelden (Single Sign-On, SSO) eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
...
* Beim Zuweisen von Benutzern und Gruppen zu Segment müssen Sie eine andere Rolle als **Standardzugriff** auswählen. Benutzer mit der Rolle „Standardzugriff“ werden von der Bereitstellung ausgeschlossen und in den Bereitstellungsprotokollen als „nicht effektiv berechtigt“ gekennzeichnet. Wenn für die Anwendung nur die Rolle „Standardzugriff“ verfügbar ist, können Sie das [Anwendungsmanifest aktualisieren](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) und weitere Rollen hinzufügen. 
...
## <a name="step-5-configure-automatic-user-provisioning-to-segment"></a>Schritt 5: Konfigurieren der automatischen Benutzerbereitstellung für Segment 

In diesem Abschnitt werden die Schritte zum Konfigurieren des Azure AD-Bereitstellungsdiensts zum Erstellen, Aktualisieren und Deaktivieren von Benutzern bzw. Gruppen in ServiceNow auf der Grundlage von Benutzer- oder Gruppenzuweisungen in Azure AD erläutert.

### <a name="to-configure-automatic-user-provisioning-for-segment-in-azure-ad"></a>So konfigurieren Sie die automatische Benutzerbereitstellung für Segment in Azure AD

1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Wählen Sie **Unternehmensanwendungen** und dann **Alle Anwendungen**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Segment** aus.

    ![Segment-Link in der Anwendungsliste](common/all-applications.png)
...
5. Geben Sie im Abschnitt **Administratoranmeldeinformationen** die in Schritt 2 abgerufenen Werte für die Segment-Mandanten-URL und das geheime Token ein. Klicken Sie auf **Verbindung testen**, um sicherzustellen, dass Azure AD eine Verbindung mit Segment herstellen kann. Vergewissern Sie sich im Fall eines Verbindungsfehlers, dass Ihr Segment-Konto über Administratorberechtigungen verfügt, und versuchen Sie es noch mal.
...
10. Wählen Sie im Abschnitt **Zuordnungen** die Option **Azure Active Directory-Gruppen mit Segment synchronisieren** aus.
...
13. Um den Azure AD-Bereitstellungsdienst für Segment zu aktivieren, ändern Sie den **Bereitstellungsstatus** im Abschnitt **Einstellungen** in **Ein**.

    ![Aktivierter Bereitstellungsstatus](common/provisioning-toggle-on.png)

14. Legen Sie die Benutzer und/oder Gruppen fest, die in Segment bereitgestellt werden sollen, indem Sie im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte auswählen.
