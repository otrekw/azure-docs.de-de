...
## <a name="configure-and-test-azure-ad-single-sign-on-for-lessonly"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Lesson.ly
...
1. **[Konfigurieren des einmaligen Anmeldens für Lesson.ly](#configure-lessonly-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines Lesson.ly-Testbenutzers](#create-lessonly-test-user)** , um eine Entsprechung von B. Simon in Lesson.ly zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Lesson.ly** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Geben Sie im Abschnitt **Grundlegende SAML-Konfiguration** die Werte für die folgenden Felder ein:
     ...
     a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<companyname>.lessonly.com/signin`.
...
Wenn Sie im Zugriffsbereich auf die Kachel „Lesson.ly“ klicken, sollten Sie automatisch bei der Lesson.ly-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Lesson.ly mit Azure AD ausprobieren](https://aad.portal.azure.com/)
