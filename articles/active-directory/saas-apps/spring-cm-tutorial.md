...
In diesem Tutorial erfahren Sie, wie Sie SpringCM in Azure Active Directory (Azure AD) integrieren. Die Integration von SpringCM in Azure AD ermöglicht Folgendes:

* Sie können in Azure AD steuern, wer Zugriff auf SpringCM besitzt.
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei SpringCM anzumelden.
...
## <a name="add-springcm-from-the-gallery"></a>Hinzufügen von SpringCM aus dem Katalog
...
1. Geben Sie im Abschnitt **Aus Katalog hinzufügen** den Suchbegriff **SpringCM** in das Suchfeld ein.
1. Wählen Sie im Ergebnisbereich **SpringCM** aus, und fügen Sie die App dann hinzu. Warten Sie einige Sekunden, während die App Ihrem Mandanten hinzugefügt wird.

## <a name="configure-and-test-azure-ad-sso-for-springcm"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für SpringCM

Konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit SpringCM mithilfe eines Testbenutzers mit dem Namen **B. Simon**. Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in SpringCM eingerichtet werden.

Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit SpringCM die folgenden Schritte aus:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    1. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    1. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren von SpringCM-SSO](#configure-springcm-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
    1. **[Erstellen eines SpringCM-Testbenutzers](#create-springcm-test-user)** , um eine Entsprechung von B. Simon in SpringCM zu erhalten, die mit der Darstellung des Benutzers in Azure AD verknüpft ist.
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **SpringCM** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    > [!NOTE]
    > Dieser Wert entspricht nicht dem tatsächlichen Wert. Ersetzen Sie diesen Wert durch die tatsächliche Anmelde-URL. Wenden Sie sich an das [Kundensupportteam von SpringCM](https://knowledge.springcm.com/support), um den Wert zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
6. Kopieren Sie im Abschnitt **SpringCM einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
In diesem Abschnitt ermöglichen Sie B. Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie Zugriff auf SpringCM gewähren.

1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** aus.
1. Wählen Sie in der Anwendungsliste **SpringCM** aus.
...
## <a name=&quot;configure-springcm-sso&quot;></a>Konfigurieren von SpringCM-SSO
...
1. Führen Sie im Abschnitt „Identitätsanbieterkonfiguration“ die folgenden Schritte aus:
    ...
    ![Identitätsanbieterkonfiguration](./media/spring-cm-tutorial/configuration.png "Identitätsanbieterkonfiguration")
...
### <a name="create-springcm-test-user"></a>Erstellen eines SpringCM-Testbenutzers
...
> [!NOTE]
> Weitere Informationen finden Sie unter [Create and Edit a SpringCM User](http://community.springcm.com/s/article/Create-and-Edit-a-SpringCM-User-1619481053) (Erstellen und Bearbeiten eines SpringCM-Benutzers). 
...
1. Klicken Sie auf **GOTO** (GEHE ZU) und dann auf **ADDRESS BOOK** (ADRESSBUCH).
    ...
    ![Benutzer erstellen](./media/spring-cm-tutorial/user.png "Benutzer erstellen")
...
* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für SpringCM weitergeleitet. Dort können Sie den Anmeldeflow initiieren. 

* Rufen Sie direkt die SpringCM-Anmelde-URL auf, und initiieren Sie den Anmeldeflow.

* Sie können „Meine Apps“ von Microsoft verwenden. Wenn Sie unter „Meine Apps“auf die Kachel „SpringCM“ klicken, werden Sie zur Anmelde-URL für SpringCM weitergeleitet. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](../user-help/my-apps-portal-end-user-access.md).
