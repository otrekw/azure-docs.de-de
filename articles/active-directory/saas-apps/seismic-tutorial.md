...
**Führen Sie zum Hinzufügen von Seismic aus dem Katalog die folgenden Schritte aus:**
...
4. Geben Sie im Suchfeld **Seismic** ein, wählen Sie im Ergebnisbereich **Seismic** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![Seismic in der Ergebnisliste](common/search-new-app.png)
...
2. **[Konfigurieren des einmaligen Anmeldens für Seismic](#configure-seismic-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Seismic-Testbenutzers](#create-seismic-test-user)** , um eine Entsprechung von Britta Simon in Seismic zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit Seismic zu konfigurieren:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Seismic** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Diesen Wert erhalten Sie vom [Supportteam für den Seismic-Client](mailto:support@seismic.com). Sie können auch die **Metadaten des Dienstanbieters** hochladen, um den Wert „Bezeichner“ automatisch aufzufüllen. Weitere Informationen zu den **Metadaten des Dienstanbieters** erhalten Sie vom [Supportteam für den Seismic-Client](mailto:support@seismic.com).
...
### <a name="configure-seismic-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Seismic
...
In diesem Abschnitt ermöglichen Sie Britta Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihr Zugriff auf Seismic gewähren.

1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **Seismic** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Seismic** aus.

    ![Seismic-Link in der Anwendungsliste](common/all-applications.png)
...
In diesem Abschnitt erstellen Sie in Seismic einen Benutzer namens Britta Simon. Wenden Sie sich an das  [Seismic-Supportteam](mailto:support@seismic.com), um die Benutzer auf der Seismic-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
