---
title: 'Tutorial: Konfigurieren von Cofense für die automatische Benutzerbereitstellung in Azure Active Directory | Microsoft-Dokumentation'
description: Erfahren Sie, wie Sie Benutzerkonten aus Azure AD für Cofense automatisch bereitstellen und die Bereitstellung aufheben.
...
ms.locfileid: "90761417"
---
# <a name="tutorial-configure-cofense-for-automatic-user-provisioning"></a>Tutorial: Konfigurieren von Cofense für die automatische Benutzerbereitstellung

In diesem Tutorial werden die Schritte beschrieben, die Sie sowohl in Cofense als auch in Azure Active Directory (Azure AD) ausführen müssen, um die automatische Benutzerbereitstellung zu konfigurieren. Bei der Konfiguration stellt Azure AD automatisch mithilfe des Azure AD-Bereitstellungsdiensts Benutzer für [Cofense](https://cofense.com/) bereit bzw. hebt deren Bereitstellung auf. Wichtige Details zum Zweck und zur Funktionsweise dieses Diensts sowie häufig gestellte Fragen finden Sie unter [Automatisieren der Bereitstellung und Bereitstellungsaufhebung von Benutzern für SaaS-Anwendungen mit Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Unterstützte Funktionen
> [!div class="checklist"]
> * Erstellen von Benutzern in Cofense
> * Entfernen von Benutzern aus Cofense, wenn diese keinen Zugriff mehr benötigen
> * Synchronisieren von Benutzerattributen zwischen Azure AD und Cofense
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und Cofense zugeordnet werden sollen](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-cofense-to-support-provisioning-with-azure-ad"></a>Schritt 2: Konfigurieren von Cofense für die Unterstützung der Bereitstellung mit Azure AD
...
## <a name="step-3-add-cofense-from-the-azure-ad-application-gallery"></a>Schritt 3: Hinzufügen von Cofense aus dem Azure AD-Anwendungskatalog

Fügen Sie Cofense aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in Cofense zu beginnen. Wenn Sie Cofense zuvor für einmaliges Anmelden (Single Sign-On, SSO) eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
...
## <a name="step-5-configure-automatic-user-provisioning-to-cofense"></a>Schritt 5: Konfigurieren der automatischen Benutzerbereitstellung für Cofense 

In diesem Abschnitt werden die Schritte zum Konfigurieren des Azure AD-Bereitstellungsdiensts zum Erstellen, Aktualisieren und Deaktivieren von Benutzern in Cofense auf der Grundlage der Benutzer in Azure AD erläutert.

### <a name="to-configure-automatic-user-provisioning-for-cofense-in-azure-ad"></a>Gehen Sie wie folgt vor, um die automatische Benutzerbereitstellung für Cofense in Azure AD zu konfigurieren:

1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Wählen Sie **Unternehmensanwendungen** und dann **Alle Anwendungen**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste die Anwendung **Cofense** aus.
...
5. Geben Sie im Abschnitt **Administratoranmeldeinformationen** die zuvor in Schritt 2 für die **SCIM 2.0-Basis-URL und das SCIM-Authentifizierungstoken** abgerufenen Werte ein. Klicken Sie auf **Verbindung testen**, um sicherzustellen, dass Azure AD eine Verbindung mit Cofense herstellen kann. Vergewissern Sie sich im Falle eines Verbindungsfehlers, dass Ihr Cofense-Konto über Administratorberechtigungen verfügt, und versuchen Sie es noch mal.
...
8. Wählen Sie im Abschnitt **Zuordnungen** die Option **Azure Active Directory-Benutzer mit Cofense synchronisieren** aus.

9. Überprüfen Sie im Abschnitt **Attributzuordnung** die Benutzerattribute, die aus Azure AD mit Cofense synchronisiert werden. Die als **übereinstimmende** Eigenschaften ausgewählten Attribute werden für den Abgleich der Benutzerkonten in Cofense für Aktualisierungsvorgänge verwendet.  Wählen Sie die Schaltfläche **Speichern**, um alle Änderungen zu übernehmen.
...
11. Um den Azure AD-Bereitstellungsdienst für Cofense zu aktivieren, ändern Sie im Abschnitt **Einstellungen** den **Bereitstellungsstatus** in **Ein**.

    ![Aktivierter Bereitstellungsstatus](common/provisioning-toggle-on.png)

12. Legen Sie die Benutzer und/oder Gruppen fest, die in Cofense bereitgestellt werden sollen, indem Sie im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte auswählen.
