...
* Nach dem Konfigurieren von Raketa können Sie eine Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.
...
1. Geben Sie im Abschnitt **Aus Katalog hinzufügen** den Suchbegriff **Raketa** im Suchfeld ein.
1. Wählen Sie im Ergebnisbereich **Raketa** aus, und fügen Sie dann die App hinzu. Warten Sie einige Sekunden, während die App Ihrem Mandanten hinzugefügt wird.
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Raketa** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Geben Sie im Abschnitt **Grundlegende SAML-Konfiguration** die Werte für die folgenden Felder ein:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** die URL ein: `https://raketa.travel/`.

    b. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://raketa.travel/sso/acs?clientId=<CLIENT_ID>`
...
1. Wählen Sie in der Anwendungsliste **Raketa** aus.
