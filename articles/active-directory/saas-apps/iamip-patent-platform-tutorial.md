...
* Steuern Sie in Azure AD, wer Zugriff auf IamIP Patent Platform hat.
...
## <a name="adding-iamip-patent-platform-from-the-gallery"></a>Hinzufügen von IamIP Patent Platform aus dem Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-iamip-patent-platform"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für IamIP Patent Platform
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit IamIP Patent Platform zu konfigurieren und zu testen:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    * **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    * **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren des einmaligen Anmeldens für IamIP Patent Platform](#configure-iamip-patent-platform-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines IamIP Patent Platform-Testbenutzers](#create-iamip-patent-platform-test-user)** , um ein Pendant von B. Simon in IamIP Patent Platform zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Kopieren Sie im Abschnitt **IamIP Patent Platform einrichten** die entsprechenden URLs basierend auf Ihren Anforderungen.
...
In diesem Abschnitt ermöglichen Sie B. Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihr Zugriff auf IamIP Patent Platform gewähren.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **IamIP Patent Platform** müssen Sie das heruntergeladene **Zertifikat (Rohdaten)** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von IamIP Patent Platform](mailto:info@iamip.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-iamip-patent-platform-test-user"></a>Erstellen eines IamIP Patent Platform-Testbenutzers

In diesem Abschnitt erstellen Sie in IamIP Patent Platform einen Benutzer namens B. Simon. Wenden Sie sich an das  [IamIP Patent Platform-Supportteam](mailto:info@iamip.com), um die Benutzer auf der IamIP Patent Platform-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „IamIP Patent Platform“ klicken, sollten Sie automatisch bei der IamIP Patent Platform-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
