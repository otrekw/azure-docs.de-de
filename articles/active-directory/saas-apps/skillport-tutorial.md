...
4. Geben Sie **Skillport** in das Suchfeld ein, wählen Sie im Ergebnisbereich den Eintrag **Skillport** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen** , um die Anwendung hinzuzufügen.

    ![Skillport in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Skillport eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Skillport](#configure-skillport-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Skillport-Testbenutzers](#create-skillport-test-user)** , um eine Entsprechung von Britta Simon in Skillport zu erhalten, die mit ihrer Repräsentation in Azure AD verknüpft ist.
...
1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Skillport** die Option **Einmaliges Anmelden** aus.
...
1. Wählen Sie im Azure-Portal die Option **Unternehmensanwendungen** aus, wählen Sie **Alle Anwendungen** aus, und wählen Sie dann **Skillport** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste den Eintrag **Skillport** aus.

    ![Skillport-Link in der Anwendungsliste](common/all-applications.png)
