...
In diesem Tutorial werden die Schritte erläutert, die in iProva und Azure Active Directory (Azure AD) ausgeführt werden müssen, um Azure AD zum automatischen Bereitstellen und Aufheben der Bereitstellung von Benutzern und/oder Gruppen in [iProva](https://www.iProva.com/) zu konfigurieren. Wichtige Details zum Zweck und zur Funktionsweise dieses Diensts sowie häufig gestellte Fragen finden Sie unter [Automatisieren der Bereitstellung und Bereitstellungsaufhebung von Benutzern für SaaS-Anwendungen mit Azure Active Directory](../manage-apps/user-provisioning.md). 
...
> * [Einmaliges Anmelden](https://docs.microsoft.com/azure/active-directory/saas-apps/iprova-tutorial) bei iProva (empfohlen)
...
3. Legen Sie fest, welche Daten [zwischen Azure AD und iProva zugeordnet werden sollen](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-iprova-to-support-provisioning-with-azure-ad"></a>Schritt 2: Konfigurieren von iProva für die Unterstützung der Bereitstellung mit Azure AD
...
## <a name="step-3-add-iprova-from-the-azure-ad-application-gallery"></a>Schritt 3: Hinzufügen von iProva aus dem Azure AD-Anwendungskatalog

Fügen Sie iProva aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in iProva zu beginnen. Wenn Sie das einmalige Anmelden (Single Sign-On, SSO) zuvor für iProva eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
...
* Beim Zuweisen von Benutzern und Gruppen zu iProva müssen Sie eine andere Rolle als den **Standardzugriff** auswählen. Benutzer mit der Rolle „Standardzugriff“ werden von der Bereitstellung ausgeschlossen und in den Bereitstellungsprotokollen als „nicht effektiv berechtigt“ gekennzeichnet. Wenn für die Anwendung nur die Rolle „Standardzugriff“ verfügbar ist, können Sie das [Anwendungsmanifest aktualisieren](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) und weitere Rollen hinzufügen. 
...
## <a name="step-5-configure-automatic-user-provisioning-to-iprova"></a>Schritt 5: Konfigurieren der automatischen Benutzerbereitstellung in iProva 
...
* 17. Juni 2020: Das Attribut „Manager“ der Unternehmenserweiterung wurde entfernt.
