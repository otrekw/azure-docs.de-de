...
* Imperva Data Security unterstützt **IDP-initiiertes** einmaliges Anmelden.
...
1. Geben Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** die Werte für die folgenden Felder ein:
    ...
    a. Geben Sie im Textfeld **Bezeichner** eine URL im folgenden Format ein: `https://<IMPERVA_DNS_NAME>:8443`
...
* Sie können „Meine Apps“ von Microsoft verwenden. Wenn Sie auf die Kachel „Imperva Data Security“ in „Meine Apps“ klicken, sollten Sie automatisch bei Imperva Data Security angemeldet werden, für das Sie das einmalige Anmelden eingerichtet haben. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
