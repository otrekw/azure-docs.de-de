...
Wenn Sie im Zugriffsbereich auf die Kachel „Britive“ klicken, sollten Sie automatisch bei Ihrer Britive-Anwendung angemeldet werden. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
