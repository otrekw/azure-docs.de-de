...
* Sie können es Ihren Benutzern ermöglichen, dass sie mit ihren Azure AD-Konten automatisch bei Anaplan angemeldet werden (einmaliges Anmelden; Single Sign-On, SSO).
...
* Anaplan-Abonnement, für das einmaliges Anmelden aktiviert ist
...
In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Anaplan mithilfe eines Testbenutzers namens **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Anaplan eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Anaplan](#configure-anaplan-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Anaplan-Testbenutzers](#create-anaplan-test-user)** , um ein Pendant von Britta Simon in Anaplan zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Anaplan die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Anaplan** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Anaplan](common/sp-identifier.png)
...
### <a name="configure-anaplan-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Anaplan
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **Anaplan**.
