...
Fügen Sie Workplace by Facebook aus dem Azure AD-Anwendungskatalog hinzu, um die Verwaltung der Bereitstellung für Workplace by Facebook zu beginnen. Wenn Sie Workplace by Facebook zuvor für das einmalige Anmelden (SSO) eingerichtet haben, können Sie dieselbe Anwendung verwenden. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](../manage-apps/add-application-portal.md) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog.
...
12. Legen Sie die Benutzer fest, die in Workplace by Facebook bereitgestellt werden sollen, indem Sie im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte auswählen.
