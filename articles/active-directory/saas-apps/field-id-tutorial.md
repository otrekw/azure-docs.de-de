...
* Ermöglichen Sie Ihren Benutzern, sich mit ihren Azure AD-Konten automatisch bei Field iD anzumelden.
...
* Field iD unterstützt das über **IDP** initiierte einmalige Anmelden
...
## <a name="adding-field-id-from-the-gallery"></a>Hinzufügen von Field iD aus dem Katalog
...
1. Wählen Sie im Ergebnisbereich **Field iD** aus, und fügen Sie dann die App hinzu. Warten Sie einige Sekunden, während die App Ihrem Mandanten hinzugefügt wird.
...
Konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Field iD mithilfe eines Testbenutzers mit dem Namen **B. Simon**. Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Field iD eingerichtet werden.

Führen Sie zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD mit Field iD die folgenden Bausteine aus:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-sso)** , um Ihren Benutzern die Verwendung dieses Features zu ermöglichen.
    1. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden von Azure AD mit dem Testbenutzer B. Simon zu testen.
    1. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um B. Simon die Verwendung des einmaligen Anmeldens von Azure AD zu ermöglichen.
1. **[Konfigurieren des einmaligen Anmeldens für Field iD](#configure-field-id-sso)** , um die Einstellungen für einmaliges Anmelden aufseiten der Anwendung zu konfigurieren.
    1. **[Erstellen eines Field iD-Testbenutzers](#create-field-id-test-user)** , um eine Entsprechung von B. Simon in Field iD zu erhalten, das mit der Darstellung des Benutzers in Azure AD verknüpft ist.
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Field iD** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
   ...
   b. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://<tenantname>.fieldid.com/fieldid/saml/SSO/alias/tmna`
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Field iD** müssen Sie die **App-Verbundmetadaten-URL** an das [Supportteam von Field iD](mailto:support@ecompliance.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-field-id-test-user"></a>Erstellen eines Field iD-Testbenutzers

In diesem Abschnitt erstellen Sie in Field iD einen Benutzer namens Britta Simon. Arbeiten Sie mit dem  [Supportteam von Field iD](mailto:support@ecompliance.com) zusammen, um die Benutzer der Field iD-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „Field iD“ klicken, sollten Sie automatisch bei der Field iD-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
