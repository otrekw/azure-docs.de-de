...
* AppDynamics-Abonnement, für das einmaliges Anmelden aktiviert ist
...
* AppDynamics unterstützt die **bedarfsabhängige** Benutzerbereitstellung.
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in AppDynamics eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für AppDynamics](#configure-appdynamics-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren.
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines AppDynamics-Testbenutzers](#create-appdynamics-test-user)** , um eine Entsprechung von Britta Simon in AppDynamics zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD in AppDynamics die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **AppDynamics** die Option **Einmaliges Anmelden**.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für AppDynamics](common/sp-identifier.png)
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen**, **Alle Anwendungen** und **AppDynamics**.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Geben Sie in der Anwendungsliste **AppDynamics** ein, und wählen Sie den Eintrag aus.

    ![AppDynamics-Link in der Anwendungsliste](common/all-applications.png)
