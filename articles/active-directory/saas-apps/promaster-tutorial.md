...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei ProMaster (von Inlogik) anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* Ein Abonnement für ProMaster (von Inlogik), für das einmaliges Anmelden aktiviert ist

## <a name="scenario-description"></a>Beschreibung des Szenarios

In diesem Tutorial konfigurieren und testen Sie das einmalige Anmelden von Azure AD in einer Testumgebung.

* ProMaster (von Inlogik) unterstützt **SP-** und **IDP-initiiertes** einmaliges Anmelden.
...
4. Geben Sie im Suchfeld **ProMaster (von Inlogik)** ein, wählen Sie im Ergebnisbereich **ProMaster (von Inlogik)** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
     ...
     ![ProMaster (von Inlogik) in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in ProMaster (von Inlogik) eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für ProMaster (von Inlogik)](#configure-promaster-by-inlogik-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines ProMaster (von Inlogik)-Testbenutzers](#create-promaster-by-inlogik-test-user)** , um eine Entsprechung von Britta Simon in ProMaster (von Inlogik) zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit ProMaster (von Inlogik) die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **ProMaster (von Inlogik)** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für ProMaster (von Inlogik)](common/idp-intiated.png)
...
5. Klicken Sie auf **Zusätzliche URLs festlegen**, und führen Sie den folgenden Schritt aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für ProMaster (von Inlogik)](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Sie müssen diese Werte mit dem tatsächlichen Bezeichner, der Antwort-URL und der Anmelde-URL aktualisieren. Wenden Sie sich an das [Supportteam von ProMaster (von Inlogik)](mailto:michael.boldiston@inlogik.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
### <a name="configure-promaster-by-inlogik-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für ProMaster (von Inlogik)
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** > **ProMaster (von Inlogik)** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **ProMaster (von Inlogik)** aus.

    ![Der Link von ProMaster (von Inlogik) in der Anwendungsliste](common/all-applications.png)
...
In diesem Abschnitt erstellen Sie in ProMaster (von Inlogik) einen Benutzer namens Britta Simon. Wenden Sie sich an das  [Supportteam von ProMaster (von Inlogik)](mailto:michael.boldiston@inlogik.com), um die Benutzer auf der Plattform für ProMaster (von Inlogik) hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-single-sign-on"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „ProMaster (von Inlogik)“ klicken, sollten Sie automatisch bei der Instanz von ProMaster (von Inlogik) angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
