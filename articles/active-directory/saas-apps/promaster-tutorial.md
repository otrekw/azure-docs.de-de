...
* Nach dem Konfigurieren von ProMaster (von Inlogik) können Sie die Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.
...
In diesem Abschnitt konfigurieren und testen Sie anhand eines Testbenutzers namens **B. Simon** das einmalige Anmelden von Azure AD mit ProMaster (von Inlogik).
...
1. **[Konfigurieren des einmaligen Anmeldens für ProMaster (von Inlogik)](#configure-promaster-by-inlogik-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines Testbenutzers für ProMaster (von Inlogik)](#create-promaster-by-inlogik-test-user)** , um eine Entsprechung von B. Simon in ProMaster (von Inlogik) zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
- [ProMaster (von Inlogik) mit Azure AD ausprobieren](https://aad.portal.azure.com/)
