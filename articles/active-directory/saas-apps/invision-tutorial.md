...
## <a name="configure-and-test-azure-ad-single-sign-on-for-invision"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für InVision
...
1. **[Konfigurieren des einmaligen Anmeldens für InVision](#configure-invision-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines InVision-Testbenutzers](#create-invision-test-user)** , um in InVision eine Entsprechung von B. Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **InVision** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie auf der Seite **Single sign-on** (Einmaliges Anmelden) die folgenden Schritte aus:
    ...
    f. Wählen Sie im Dropdownmenü **HASH Algorithm** (Hashalgorithmus) die Option **SHA-256** aus.

    g. Geben Sie unter **SSO Button Label** (Bezeichnung für Schaltfläche „SSO“) einen entsprechenden Namen ein.

    h. Aktivieren Sie die Option **Allow Just-in-Time provisioning** (Just-in-Time-Bereitstellung zulassen).
...
Wenn Sie im Zugriffsbereich auf die Kachel „InVision“ klicken, sollten Sie automatisch bei der InVision-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [InVision mit Azure AD ausprobieren](https://aad.portal.azure.com/)
