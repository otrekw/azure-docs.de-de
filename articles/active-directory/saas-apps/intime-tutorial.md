...
* Sie können Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei InTime anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
* InTime unterstützt **SP** -initiiertes einmaliges Anmelden.
...
4. Geben Sie im Suchfeld **InTime** ein, wählen Sie im Ergebnisbereich **InTime** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen** , um die Anwendung hinzuzufügen.
     ...
     ![InTime in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in InTime eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für InTime](#configure-intime-single-sign-on)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)** , um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)** , um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines InTime-Testbenutzers](#create-intime-test-user)** , um eine Entsprechung von Britta Simon in InTime zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit InTime die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **InTime** die Option **Einmaliges Anmelden** aus.
...
7. Kopieren Sie im Abschnitt **InTime einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
### <a name="configure-intime-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für InTime

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **InTime** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von InTime](mailto:hdollard@intimesoft.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie im Azure-Portal nacheinander die Optionen **Unternehmensanwendungen** , **Alle Anwendungen** und **InTime** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **InTime** aus.

    ![InTime-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-intime-test-user"></a>Erstellen eines InTime-Testbenutzers
