...
* BrowserStack Single Sign-On unterstützt **SP- und IdP** -initiiertes einmaliges Anmelden
...
## <a name="adding-browserstack-single-sign-on-from-the-gallery"></a>Hinzufügen von BrowserStack Single Sign-On aus dem Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-browserstack-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für BrowserStack Single Sign-On
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit BrowserStack Single Sign-On zu konfigurieren und zu testen:
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **BrowserStack Single Sign-On** zum Abschnitt **Verwalten** , und wählen Sie **Einmaliges Anmelden** aus.
...
- [Testen von BrowserStack Single Sign-On mit Azure AD](https://aad.portal.azure.com/)
