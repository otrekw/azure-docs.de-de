...
## <a name="adding-community-spark-from-the-gallery"></a>Hinzufügen von Community Spark aus dem Katalog
...
Zum Konfigurieren und Testen des einmaligen Anmeldens von Azure AD bei Community Spark müssen Sie die folgenden Bausteine ausführen:
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Community Spark** zum Abschnitt **Verwalten** , und wählen Sie **Einmaliges Anmelden** aus.
...
1. Geben Sie im Abschnitt **Grundlegende SAML-Konfiguration** die Werte für die folgenden Felder ein:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<SUBDOMAIN>.communityspark.co/`.

    b. Geben Sie im Textfeld **Bezeichner (Entitäts-ID)** eine URL im folgenden Format ein: `https://<SUBDOMAIN>.communityspark.co/saml/metadata`.

    c. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://<SUBDOMAIN>.communityspark.co/saml/consume`

    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächlichen Werte für die Anmelde-URL, die Antwort-URL und den Bezeichner. Wenden Sie sich an das [Kundensupportteam von Community Spark](mailto:support@socialassurance.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
Wenn Sie im Zugriffsbereich auf die Kachel „Community Spark“ klicken, sollten Sie automatisch bei der Community Spark-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
...
- [Community Spark mit Azure AD ausprobieren](https://aad.portal.azure.com/)
