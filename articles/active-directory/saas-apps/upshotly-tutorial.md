...
## <a name="configure-and-test-azure-ad-single-sign-on-for-upshotly"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Upshotly
...
1. **[Konfigurieren des einmaligen Anmeldens für Upshotly](#configure-upshotly-sso)** , um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines Upshotly-Testbenutzers](#create-upshotly-test-user)** , um eine Entsprechung von B. Simon in Upshotly zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Upshotly** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Melden Sie sich in einem anderen Webbrowserfenster bei der Upshotly-Unternehmenswebsite als Administrator an.
...
Wenn Sie im Zugriffsbereich auf die Kachel „Upshotly“ klicken, sollten Sie automatisch bei der Upshotly-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Upshotly mit Azure AD ausprobieren](https://aad.portal.azure.com/)