---
title: 'Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure Active Directory mit ColorTokens ZTNA | Microsoft-Dokumentation'
description: Hier erfahren Sie, wie Sie einmaliges Anmelden zwischen Azure Active Directory und ColorTokens ZTNA konfigurieren.
...
* Nach dem Konfigurieren von ColorTokens ZTNA können Sie die Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.

## <a name="adding-colortokens-ztna-from-the-gallery"></a>Hinzufügen von ColorTokens ZTNA aus dem Katalog

Zum Konfigurieren der Integration von ColorTokens ZTNA in Azure AD müssen Sie ColorTokens ZTNA über den Katalog der Liste mit den verwalteten SaaS-Apps hinzufügen.

1. Melden Sie sich mit einem Geschäfts-, Schul- oder Unikonto oder mit einem persönlichen Microsoft-Konto beim [Azure-Portal](https://portal.azure.com) an.
1. Wählen Sie im linken Navigationsbereich den Dienst **Azure Active Directory** aus.
1. Navigieren Sie zu **Unternehmensanwendungen**, und wählen Sie dann **Alle Anwendungen** aus.
1. Wählen Sie zum Hinzufügen einer neuen Anwendung **Neue Anwendung** aus.
1. Geben Sie im Abschnitt **Aus Katalog hinzufügen** den Suchbegriff **ColorTokens ZTNA** in das Suchfeld ein.
1. Wählen Sie **ColorTokens ZTNA** im Ergebnisbereich aus, und fügen Sie dann die App hinzu. Warten Sie einige Sekunden, während die App Ihrem Mandanten hinzugefügt wird.

## <a name="configure-and-test-azure-ad-single-sign-on-for-colortokens-ztna"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für ColorTokens ZTNA

Konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit ColorTokens ZTNA mithilfe einer Testbenutzerin mit dem Namen **B. Simon**. Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in ColorTokens ZTNA eingerichtet werden.
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **ColorTokens ZTNA** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Geben Sie im Abschnitt **Grundlegende SAML-Konfiguration** die Werte für die folgenden Felder ein:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<COLORMASTER_HOST>/colormaster/api/v1/<TENANT_NAME>/saml/login?resourceId=<RESOURCEID>&iwa=<TRUE/FALSE>`.

    b. Geben Sie im Textfeld **Bezeichner (Entitäts-ID)** eine URL im folgenden Format ein: `https://<COLORMASTER_HOST>.com/<TENANT_NAME>`.

    c. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://<COLORMASTER_HOST>.com/<TENANT_NAME>`
...
In diesem Abschnitt ermöglichen Sie B. Simon die Verwendung des einmaligen Anmeldens von Azure, indem Sie ihr Zugriff auf ColorTokens ZTNA gewähren.

1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** aus.
1. Wählen Sie in der Anwendungsliste **ColorTokens ZTNA**aus.
...
## <a name="configure-colortokens-ztna-sso"></a>Konfigurieren des einmaligen Anmeldens für ColorTokens ZTNA

Zum Konfigurieren des einmaligen Anmeldens aufseiten von **ColorTokens ZTNA** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von ColorTokens ZTNA](mailto:support@colortokens.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.

### <a name="create-colortokens-ztna-test-user"></a>Erstellen eines ColorTokens ZTNA-Testbenutzers

In diesem Abschnitt erstellen Sie in ColorTokens ZTNA eine Benutzerin namens Britta Simon. Lassen Sie sich beim Hinzufügen der Benutzer auf der ColorTokens ZTNA-Plattform ggf. vom  [-Supportteam](mailto:support@colortokens.com) unterstützen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „ColorTokens ZTNA“ klicken, sollten Sie automatisch bei der ColorTokens ZTNA-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Testen von ColorTokens ZTNA mit Azure AD](https://aad.portal.azure.com/)

- [Was ist Sitzungssteuerung in Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Schützen von ColorTokens ZTNA mit erweiterter Sichtbarkeit und komplexeren Kontrollen](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)