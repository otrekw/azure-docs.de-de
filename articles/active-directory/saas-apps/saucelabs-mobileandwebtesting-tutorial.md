...
2. Klicken Sie auf das **Benutzersymbol**, und wählen Sie die Registerkarte **Team Management** (Teamverwaltung) aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/saucelabs-mobileandwebtesting-tutorial/configure1.png)

3. Geben Sie in das Textfeld Ihren **Domänennamen** ein.

    ![Einmaliges Anmelden konfigurieren](./media/saucelabs-mobileandwebtesting-tutorial/configure2.png)

4. Klicken Sie auf die Registerkarte **Configure** (Konfigurieren).

    ![Einmaliges Anmelden konfigurieren](./media/saucelabs-mobileandwebtesting-tutorial/configure3.png)
