...
## <a name="adding-apex-portal-from-the-gallery"></a>Hinzufügen von Apex Portal aus dem Katalog
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-apex-portal"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für Apex Portal
...
1. **[Konfigurieren des einmaligen Anmeldens für Apex Portal](#configure-apex-portal-sso)**, um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
    * **[Erstellen eines Apex Portal-Testbenutzers](#create-apex-portal-test-user)**, um in Apex Portal ein Pendant von B. Simon zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Navigieren Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Apex Portal** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
Wenn Sie im Zugriffsbereich auf die Kachel „Apex Portal“ klicken, sollten Sie automatisch bei der Apex Portal-Anwendung angemeldet werden, für die Sie SSO eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/my-apps-portal-end-user-access.md).
...
- [Apex Portal mit Azure AD ausprobieren](https://aad.portal.azure.com/)