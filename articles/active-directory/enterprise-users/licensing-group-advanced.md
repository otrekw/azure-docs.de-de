...
Sie können [Azure AD-Überwachungsprotokolle](../reports-monitoring/concept-audit-logs.md) verwenden, um alle Aktivitäten für die gruppenbasierte Lizenzierung anzuzeigen, z. B.:
