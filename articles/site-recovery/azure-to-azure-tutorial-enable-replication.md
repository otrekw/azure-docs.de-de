...
2. Wählen Sie im Menü des Azure-Portals oder auf der **Startseite** die Option **Ressource erstellen** aus. Wählen Sie anschließend **Verwaltungsprogramme** > **Backup und Site Recovery** aus.
