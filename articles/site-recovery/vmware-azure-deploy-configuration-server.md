...
1. Melden Sie sich über den VMware vSphere-Client beim VMware vCenter-Server oder beim vSphere ESXi-Host an.
...
1. Schalten Sie die VM über die Konsole des VMware vSphere-Clients ein.
