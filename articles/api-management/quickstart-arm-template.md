...
1. Wählen Sie die folgenden Werte aus, bzw. geben Sie sie ein.
 ...
 1. Nach der erfolgreichen Erstellung der Instanz erhalten Sie eine Benachrichtigung:
    ...
    :::image type="content" source="media/quickstart-arm-template/deployment-notification.png" alt-text="Eigenschaften von API Management-Vorlagen":::
...
:::image type="content" source="media/quickstart-arm-template/service-instance-created.png" alt-text="Eigenschaften von API Management-Vorlagen":::
...
1. Wählen Sie auf der Ressourcengruppenseite die Option **Ressourcengruppe löschen** aus.
    ...
    :::image type="content" source="media/quickstart-arm-template/delete-resource-group.png" alt-text="Eigenschaften von API Management-Vorlagen":::
