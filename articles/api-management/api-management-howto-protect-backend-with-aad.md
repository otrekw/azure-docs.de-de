...
```
> [!NOTE]
> Diese `openid-config`-URL entspricht dem v1-Endpunkt. Verwenden Sie als `openid-config` des v2-Endpunkts `https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration`.
