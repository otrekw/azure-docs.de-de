...
### <a name="controls"></a>Kontrollen  
 In der Vorlage `API list` können die folgenden [Seitensteuerelemente](api-management-page-controls.md) verwendet werden.  
...
### <a name="controls"></a>Kontrollen  
 Mit der Vorlage `Operation` können keine [Seitensteuerelemente](api-management-page-controls.md) verwendet werden.  
...
#### <a name="controls"></a>Kontrollen  
 Die Codebeispielvorlagen lassen die Verwendung von [Seitensteuerelementen](api-management-page-controls.md) nicht zu.  
  
#### <a name="data-model"></a>Datenmodell  
 Entität [Code sample](api-management-template-data-model-reference.md#Sample).  
