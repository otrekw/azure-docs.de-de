...
ms.locfileid: "84233048"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-database-for-postgresql"></a>Integrierte Azure Policy-Richtliniendefinitionen für Azure Database for PostgreSQL

Diese Seite enthält einen Index der integrierten [Azure Policy](../governance/policy/overview.md)-Richtliniendefinitionen für Azure Database for PostgreSQL. Weitere Azure Policy-Integrationen für andere Dienste finden Sie unter [Integrierte Azure Policy-Richtliniendefinitionen](../governance/policy/samples/built-in-policies.md).
