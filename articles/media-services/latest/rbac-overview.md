...
- [Media Services-Ressourcenanbietervorgänge](https://docs.microsoft.com/azure/role-based-access-control/resource-provider-operations#microsoftmedia)
