...
Laden Sie Ihren Inhalt hoch, und verarbeiten Sie ihn, wie unter [Schnellstart: Hochladen, Codieren und Streamen von Inhalten mithilfe des Portals](asset-create-asset-upload-portal-quickstart.md) beschrieben.
