...
Beim Erstellen Ihres Media Services-Kontos wird dem Konto ein **Standard**[-Streamingendpunkt](streaming-endpoint-concept.md) im Zustand **Beendet** hinzugefügt. Um mit dem Streamen Ihrer Inhalte zu beginnen und die [dynamische Paketerstellung](encode-dynamic-packaging-concept.md) und [dynamische Verschlüsselung](drm-content-protection-concept.md) zu nutzen, muss der Streamingendpunkt, von dem Sie Inhalte streamen möchten, den Zustand **Wird ausgeführt** aufweisen.
