...
1. Erstellen und konfigurieren Sie eine [Richtlinie für Inhaltsschlüssel](drm-content-key-policy-concept.md).
   ...
   * Konfigurieren Sie die Lizenzen [PlayReady](drm-playready-license-template-concept.md), [Widevine](drm-widevine-license-template-concept.md) und/oder [FairPlay](drm-fairplay-license-overview.md). Mit den Vorlagen können Sie die Rechte und Berechtigungen für die einzelnen DRMs konfigurieren.
