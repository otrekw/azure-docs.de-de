---
title: 'Media Services: Apple FairPlay-Lizenzunterstützung'
...
Im folgenden Beispiel wird das [Media Services .NET SDK](/dotnet/api/microsoft.azure.management.media.models) für die Lizenzkonfiguration verwendet.
