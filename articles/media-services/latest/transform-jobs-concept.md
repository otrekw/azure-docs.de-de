...
Titel: Transformationen und Aufträge in Media Services: Azure Media Services Beschreibung: Transformationen beschreiben die Regeln, gemäß denen Ihre Videos in Azure Media Services verarbeitet werden.
