...
Um das Streamen zu ermöglichen, muss zunächst der [Streamingendpunkt](./stream-streaming-endpoint-concept.md) gestartet werden, von dem aus Sie das Video streamen möchten.
