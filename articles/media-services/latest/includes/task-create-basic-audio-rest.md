...
ms.locfileid: "92524991"
---
<!--Create a basic audio transform REST-->

Der folgende Azure-REST-Befehl erstellt ein einfaches Audio-Medienobjekt. Ersetzen Sie die Werte `subscriptionID`, `resourceGroup` und `amsAccountName` durch aktuell verwendete Werte. Benennen Sie Ihr Medienobjekt, indem Sie hier `assetName` festlegen.
