...
- **EncoderNamedPreset.AdaptiveStreaming** (empfohlen): unterstützt die adaptive Bitratencodierung H.264. Weitere Informationen finden Sie unter [Automatisches Generieren einer Reihe von Bitraten-/Auflösungspaaren](autogen-bitrate-ladder.md).
