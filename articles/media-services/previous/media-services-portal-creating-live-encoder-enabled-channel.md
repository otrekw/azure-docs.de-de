...
> [!WARNING]
> Ein Medienobjekt **darf nicht** gelöscht werden, wenn es von einem Ereignis verwendet wird. Zuerst muss das betreffende Ereignis gelöscht werden.
