---
title: Importieren der Postman-Sammlung mit Azure On-Demand-Streaming-Vorgängen
description: Erfahren Sie mehr über die Postman-Sammlung, die gruppierte HTTP-Anforderungen enthält, die REST-APIs von Azure Media Services aufrufen.
