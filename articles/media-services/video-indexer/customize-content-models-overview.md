...
* [Anpassen des Markenmodells mit der Video Indexer-Website](customize-brands-model-with-website.md)
* [Anpassen des Markenmodells mit der Video Indexer-API](customize-brands-model-with-api.md)
...
* [Anpassen von Sprachmodellen mit der Video Indexer-API](customize-language-model-with-api.md)
