...
Ja. Melden Sie sich bei Ihrem Cluster als Azure Red Hat OpenShift-Administrator an, und führen Sie den folgenden Befehl aus:
...
Weitere Informationen finden Sie in der OpenShift-Dokumentation unter [Deaktivieren der eigenständigen Bereitstellung](https://docs.openshift.com/container-platform/3.11/admin_guide/managing_projects.html#disabling-self-provisioning).
