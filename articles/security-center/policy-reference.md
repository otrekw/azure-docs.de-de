...
- Die Gruppe [Standardinitiative](#azure-security-center-initiatives) listet alle Azure Policy-Definitionen auf, die Teil der [Azure Security Center](./index.yml)-Standardinitiative sind.
