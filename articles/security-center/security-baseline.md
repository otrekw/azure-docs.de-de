...
ms.locfileid: "107285773"
---
# <a name="azure-security-baseline-for-security-center"></a>Azure-Sicherheitsbaseline für Security Center

Diese Sicherheitsbaseline wendet Empfehlungen des [Azure-Sicherheitsvergleichstests Version 1.0](../security/benchmarks/overview-v1.md) auf Azure Security Center an. Der Azure-Sicherheitsvergleichstest enthält Empfehlungen zum Schutz Ihrer Cloudlösungen in Azure. Der Inhalt wird nach den **Sicherheitssteuerungen** gruppiert, die durch den Azure-Sicherheitsvergleichstest und durch die entsprechenden für Azure Security Center geltenden Empfehlungen definiert werden. 

> [!NOTE]
> Nicht auf Security Center anwendbare **Kontrollen** oder Kontrollen, für die Microsoft die Verantwortung trägt, wurden ausgeschlossen. Die vollständige Zuordnung zwischen Security Center und dem Azure-Sicherheitsvergleichstest finden Sie in der **[vollständigen Zuordnungsdatei der Security Center-Sicherheitsbaseline](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/security-center-security-baseline-v1.1.xlsx)** .
...
- [Filtern des Netzwerkdatenverkehrs bei einer Netzwerksicherheitsgruppe](../virtual-network/tutorial-filter-network-traffic.md)

- [Firewallanforderungen für die Verwendung des Log Analytics-Agents](/azure/azure-monitor/platform/log-analytics-agent#firewall-requirements)
...
**Integrierte Azure Policy-Definitionen – Microsoft.Security**:
...
- [Senden von Aktivitätsprotokollen an einen Log Analytics-Arbeitsbereich](/azure/azure-monitor/platform/activity-log#send-to-log-analytics-workspace)
...
- [Protokollwarnungen in Azure Monitor](/azure/azure-monitor/platform/alerts-unified-log)
...
**Leitfaden**: Aktivieren Sie die mehrstufige Azure Active Directory (Azure AD)-Authentifizierung (Multifactor Authentication, MFA) für den Zugriff auf Azure Security Center und das Azure-Portal, und befolgen Sie alle Security Center-Empfehlungen für Identität und Zugriff.
...
- [Sicheres Senden von Daten an Log Analytics](/azure/azure-monitor/platform/data-security#sending-data-securely-using-tls-12)
...
### <a name="46-use-azure-role-based-access-controls-to-control-access-to-resources"></a>4.6: Verwenden der rollenbasierten Zugriffssteuerung in Azure zum Steuern des Zugriffs auf Ressourcen 
...
- [Berechtigungen für den Azure Log Analytics-Arbeitsbereich](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#log-analytics-reader)
...
- [Kundenseitig verwaltete Schlüssel in Azure Monitor](/azure/azure-monitor/platform/customer-managed-keys)
...
- [Verwalten von Log Analytics-Arbeitsbereichen mithilfe von Azure Resource Manager-Vorlagen](/azure/azure-monitor/samples/resource-manager-workspace)
...
- [Aktivieren des vorläufigen Löschens und des Löschschutzes in Key Vault](https://docs.microsoft.com/azure/storage/blobs/soft-delete-blob-overview?tabs=azure-portal)
