...
Security Center-Empfehlungen beruhen auf dem Azure Security-Vergleichstest. 
...
Informieren Sie sich über [Azure Security-Vergleichstests](../security/benchmarks/introduction.md).
