...
**Total disks read ops** (Gesamte Lesevorgänge für Datenträger) | Nein | Lesevorgänge pro Sekunde für alle Datenträger zusammen. <br/> Verwenden Sie dieses Feld, wenn keine Daten auf Datenträgerebene bereitgestellt werden können. 
**Total disks write ops** (Gesamte Schreibvorgänge für Datenträger) | Nein | Schreibvorgänge pro Sekunde für alle Datenträger zusammen. <br/> Verwenden Sie dieses Feld, wenn keine Daten auf Datenträgerebene bereitgestellt werden können.
**Total disks read throughput** (Gesamter Lesedurchsatz für Datenträger) | Nein | Von allen Datenträgern gelesene Daten (in MB pro Sekunde). <br/> Verwenden Sie dieses Feld, wenn keine Daten auf Datenträgerebene bereitgestellt werden können. 
**Total disks write throughput** (Gesamter Schreibdurchsatz für Datenträger) | Nein | Auf allen Datenträgern geschriebene Daten (in MB pro Sekunde). <br/> Verwenden Sie dieses Feld, wenn keine Daten auf Datenträgerebene bereitgestellt werden können.
...
Wenn Sie keine Daten auf Datenträgerebene bereitstellen können, können Sie Datenträgerleistungsdaten pro Server mithilfe der folgenden Felder angeben. Ausführliche Informationen zu den einzelnen Feldern finden Sie in [diesem Abschnitt](#add-server-information).
- Total disks read ops (Gesamte Lesevorgänge für Datenträger)
- Total disks write ops (Gesamte Schreibvorgänge für Datenträger)
- Total disks read throughput (Gesamter Lesedurchsatz für Datenträger)
- Total disks write throughput (Gesamter Schreibdurchsatz für Datenträger)
