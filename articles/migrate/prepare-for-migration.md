...
In diesem Artikel erfahren Sie, wie Sie lokale Computer vorbereiten, bevor Sie sie mithilfe von [Azure Migrate: Servermigration](migrate-services-overview.md#azure-migrate-server-migration-tool)).
