---
title: Bewerten von Hyper-V-VMs für die Migration zu virtuellen Azure-Computern mit Azure Migrate
description: Hier erfahren Sie, wie Sie Hyper-V-VMs für die Migration zu virtuellen Azure-Computern mit Azure Migrate bewerten.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
In diesem Artikel wird veranschaulicht, wie Sie ermittelte Server aus Ihrer Hyper-V-Umgebung für die Migration zu Azure bewerten, indem Sie das Azure Migrate-Tool für die Ermittlung und Bewertung verwenden.
...
- Stellen Sie sicher, dass Sie die zu bewertenden Server richtig ermittelt haben, bevor Sie dieses Tutorial zum Bewerten Ihrer Server für die Migration zu virtuellen Azure-Computern durcharbeiten:
    - Arbeiten Sie [dieses Tutorial](tutorial-discover-hyper-v.md) durch, um Server mit der Azure Migrate-Appliance zu ermitteln. 
