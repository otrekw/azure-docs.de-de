...
1. Wählen Sie unter **Gruppe auswählen oder erstellen** die Option **Neu erstellen** aus, und geben Sie einen Namen für die Gruppe ein. 
    ...
    :::image type="content" source="./media/tutorial-assess-hyper-v/assess-machines.png" alt-text="Erstellen einer neuen Gruppe und Hinzufügen von Computern":::
