---
title: Bewerten von AWS-Instanzen für die Migration zu Azure mit Azure Migrate
description: Hier erfahren Sie, wie Sie mit Azure Migrate AWS-Instanzen für die Migration zu Azure bewerten.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
In diesem Artikel wird veranschaulicht, wie Sie AWS-Instanzen (Amazon Web Services) für die Migration zu Azure mithilfe des Azure Migrate-Tools zur Ermittlung und Bewertung bewerten.
...
- Stellen Sie sicher, dass auf AWS-Instanzen nicht Windows Server 2003 oder SUSE Linux ausgeführt wird. Die Bewertung wird für diese Server nicht unterstützt.
