...
1. [Erstellen Sie einen IoT Hub](../iot-hub/iot-hub-create-through-portal.md), [registrieren sie ein IoT Edge-Gerät](how-to-register-device.md) und notieren sie die Verbindungszeichenfolge.
