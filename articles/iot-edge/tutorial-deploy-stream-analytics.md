---
title: 'Tutorial: Stream Analytics im Edgebereich: Azure IoT Edge'
...
1. Wenn das Stream Analytics-Modul der Modulliste hinzugefügt wurde, wählen Sie **Konfigurieren** aus, um dessen Struktur anzuzeigen. 

   Der Image-URI verweist auf ein Azure Stream Analytics-Standardimage. Dieses einzelne Image wird für jedes Stream Analytics-Modul verwendet, das für ein IoT Edge-Gerät bereitgestellt wird. 

   Der Modulzwilling ist mit einer gewünschten Eigenschaft namens **ASAJobInfo** konfiguriert. Der Wert dieser Eigenschaft verweist auf die Auftragsdefinition in Ihrem Speichercontainer. Mithilfe dieser Eigenschaft wird das Stream Analytics-Image mit Ihren individuellen Auftragsdetails konfiguriert. 
...
1. Schließen Sie die Konfigurationsseite für das Modul.
...
1. Im Schritt **Bereitstellung überprüfen** sehen Sie, wie die Informationen, die Sie im Assistenten angegeben haben, in ein JSON-Bereitstellungsmanifest konvertiert werden. Wählen Sie nach Abschluss der Manifestüberprüfung die Option **Übermitteln** aus.
