...
Sie können Bereitstellungen über die [Azure-Befehlszeilenschnittstelle](how-to-deploy-monitor-cli.md#monitor-a-deployment) (Azure CLI) oder das [Azure-Portal](how-to-deploy-monitor.md#monitor-a-deployment) überwachen, ändern und löschen. Beide liefern Metriken für Ihre Bereitstellungen.
