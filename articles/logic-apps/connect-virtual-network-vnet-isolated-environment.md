...
|---------|-----------|-------------------|--------------------|-------------------------|-------|
| Subnetzinterne Kommunikation | Ein- und ausgehend | * | - | - | **Wichtig**: Für die Kommunikation zwischen Komponenten innerhalb von Subnetzen müssen Sie sicherstellen, dass Sie alle Ports in diesen Subnetzen öffnen. |
