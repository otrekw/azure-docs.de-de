...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Anleitung mit den ersten Schritten für Azure-Entwickler</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Cloud Adoption Framework für Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Kostenlose Azure-Kurse von Pluralsight</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Microsoft Azure-Dokumentation</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Erste Schritte mit Azure</h2>
                                    <p>Entdecken Sie anhand von Schnellstarts, Beispielen und Tutorials unsere beliebtesten Dienste.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Bereitstellen der Infrastruktur</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/virtual-machines/linux/">Virtuelle Linux-Computer</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/">Virtuelle Windows-Computer</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Sichern und Verwalten von Ressourcen</h3>
                                                <ul class="noBullet">
                                            ...
                                            <div class="cardText">
                                               ...
                                               <h4>App-Modelle</h4>
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/aks/">Microservices mit Kubernetes</a></li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">SQL-Datenbank für den Edgebereich</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server auf einem virtuellen Azure-Computer</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (ehemals SQL DW)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/cli/azure">
                                                            <img src="media/index/azure_dev-7.svg" alt=""> Azure-Befehlszeilenschnittstelle </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Mobile Azure-App</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Erweitern Ihrer Fähigkeiten mit Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Tour: Azure-Dienste und -Features</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Cloud Computing-Prinzipien </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Steuern der Azure-Dienste mit der Befehlszeilenschnittstelle </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Automatisieren von Azure-Aufgaben mithilfe von Skripts über PowerShell </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Mehr interaktives Lernen...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Alle Azure-Dienste anzeigen<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                        ...
                        <ul id="all" class="directory">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/linguisticanalysisapi/home">
                                                ...
                                                <p>API für linguistische Analyse</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/entitylinking/home">
                                                ...
                                                <p>API für den Entity Linking-Analysedienst</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (ehemals SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-machines/linux/">
                                                ...
                                                <p>Virtuelle Linux-Computer</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Virtuelle Windows-Computer</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SQL Server auf virtuellen Computern</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/workloads/sap/hana-overview-architecture">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SAP HANA in Azure (große Instanzen)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Integration von Entwicklertools</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory für Domain Services</p>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <h3>Verwaltung und Governance</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/backup/">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Live- und On-Demand-Streaming</p>
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <li>
                        <a href="#ai">KI und Machine Learning</a>
                        <ul id="ai" class="cardsA">
                            <li class="fullSpan">
                                <h2>Künstliche Intelligenz und Machine Learning</h2>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fügen Sie Ihren Apps, Websites und Bots intelligente Algorithmen hinzu, um zu sehen, zu hören, auszusprechen und zu verstehen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen, Bereitstellen und Verwalten von Machine Learning- und KI-Modellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen eines Azure Databricks-Arbeitsbereichs mit Spark-Clustern</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Open Datasets</h3>
                                                    <p>Zusammengestellte öffentliche Datasets zur Verbesserung von Machine Learning-Modellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (ehemals SQL DW)</h3>
                                                    <p>Grenzenloser Analysedienst mit unerreichter Time-to-Insight</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure-Daten-Explorer</h3>
                                                    <p>Schneller und hochgradig skalierbarer Dienst zur Untersuchung von Daten (Protokoll- und Telemetriedaten)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Echtzeitanalyse schneller Datenströme von Anwendungen und Geräten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verteilter Analysedienst zur vereinfachten Analyse von Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Hubs</h3>
                                                    <p>Empfangen von Telemetriedaten von Millionen von Geräten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Interaktive, beeindruckende Datenvisualisierungen in Ihre Anwendungen einbetten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark für Azure HDInsight</h3>
                                                    <p>Apache Spark in der Cloud für unternehmenskritische Bereitstellungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm für Azure HDInsight</h3>
                                                    <p>Streamverarbeitung in Echtzeit für Big Data leicht gemacht</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>R Server für Azure HDInsight</h3>
                                                    <p>Predictive Analytics, maschinelles Lernen und statistische Modellierung für Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hochgradig skalierbarer, sicherer Data Lake-Speicher auf Blobspeicherbasis</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>NFS-Dateidienst auf Unternehmensniveau unterstützt von NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ein einfacher und sicherer Dienst, um Big Data für externe Organisationen freizugeben</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Blockchain-Dienst</h3>
                                                    <p>Erstellen, Verwalten und Erweitern von Konsortiums-Blockchainnetzwerken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Einfaches Definieren, Erstellen und Verwalten Ledger-basierter Token</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuelle Linux-Computer</h3>
                                                    <p>Virtuelle Computer für Ubuntu, Red Hat und weitere bereitstellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuelle Windows-Computer</h3>
                                                    <p>Virtuelle Computer für SQL Server, SharePoint und weitere bereitstellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Batch</h3>
                                                    <p>Skalieren der Auftragsplanung und Computeverwaltung in der Cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Einfaches Ausführen von Containern mit einem einzigen Befehl</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Entwickeln von Microservices und Verwalten von Containern unter Windows oder Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server auf virtuellen Computern</h3>
                                                    <p>Hosten von SQL Server-Unternehmens-Apps in der Cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sie können größere SAP HANA-Workloads ausführen als bei jedem anderen Anbieter von hyperskalierbaren Clouds.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CycleCloud</h3>
                                                    <p>Erstellen, Verwalten, Betreiben und Optimieren von HPC- und Big Compute-Clustern mit beliebiger Skalierung</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ausführen der VMware-Plattform in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vollständig verwalteter OpenShift-Dienst, der gemeinsam mit Red Hat betrieben wird</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Verwenden von Azure Cognitive Services-Containern mit Docker, Kubernetes, AKS und Container Instances</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web-App für Container</h3>
                                                    <p>Containerbasierte Web-Apps, die mit Ihrem Business mitwachsen, ganz einfach bereitstellen und ausführen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schnelle Kubernetes-Entwicklung mit Containern und Microservices</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure SQL-Datenbank</h3>
                                                    <p>Verwaltete relationale SQL-Datenbank als DaaS-Lösung (Database as a Service)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure SQL-Datenbank-Edge</h3>
                                                    <p>Relationale, für IoT- und Edgebereitstellungen optimierte Datenbank-Engine</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verwalteter PostgreSQL-Datenbankdienst für App-Entwickler</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verwalteter MySQL-Datenbankdienst für App-Entwickler</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Verwalteter MariaDB-Datenbankdienst für App-Entwickler</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vereinfachen der Cloudmigration</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#devtools">Entwicklertools</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Integrierte Entwicklungsumgebung (IDE) mit vollem Funktionsumfang für Android, iOS, Windows, das Web und die Cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DevOps</h3>
                                                    <p>Dienste für Teams, die gemeinsamen Code nutzen, Arbeitsschritte nachverfolgen und Software bereitstellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio Code ist ein schlanker, aber dennoch leistungsfähiger Quellcode-Editor, der auf Ihrem Desktop ausgeführt wird und für Windows, macOS und Linux verfügbar ist.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>APIs für Entwickler, Partner und Mitarbeiter sicher und im erforderlichen Umfang veröffentlichen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDKs</h3>
                                                    <p>Erstellen von Cloud-Apps mit Ihnen bereits bekannten Programmiersprachen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integration von Entwicklertools</h3>
                                                    <p>Drittanbietertools zur Unterstützung bei der Azure-Entwicklung</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schneller, skalierbarer Parameterspeicher zur App-Konfiguration</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ermitteln, selektieren und diagnostizieren Sie Probleme in Ihren Web-Apps und -diensten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen Sie Labs in der Cloud für Classrooms, Entwicklung und Tests und andere Szenarien (zuvor DevTest Labs).</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schnellere Auslieferung von Apps durch Automatisierung des Lebenszyklus</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integration von Entwicklertools</h3>
                                                    <p>Erweitern von Azure mit beliebten Erweiterungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Mobile Apps bereitstellen, Feedback und Absturzberichte sammeln und die Nutzung überwachen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schnelles Bereitstellen einer beliebigen Sprache auf jeder Plattform in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lokale Verzeichnisse synchronisieren und einmaliges Anmelden aktivieren</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen und Bereitstellen von Unternehmensrichtlinien für den Umgang mit vertraulichen Informationen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory für Domain Services</h3>
                                                    <p>Virtuelle Azure-Computer ohne Domänencontroller in eine Domäne einbinden</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Identitäten und Zugriff von Endverbrauchern in der Cloud verwalten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Informationen zur Sicherheit</h3>
                                                    <p>Anhand unserer bewährten Methoden und Anleitungen erfahren Sie, wie Sie Ihre Cloudlösungen in Azure schützen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schnelle Entwicklung digitaler Agrarlösungen in der Cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lösungen und Anwendungsfälle für die Finanzdienstleistungsbranche</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lösungen und Anwendungsfälle für Gesundheitswesen und Biowissenschaften</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Herstellung</h3>
                                                    <p>Lösungen und Anwendungsfälle für die Fertigungsbranche</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Einzelhandel</h3>
                                                    <p>Lösungen und Anwendungsfälle für die Einzelhandelsbranche</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Central</h3>
                                                    <p>Beschleunigen der Erstellung von IoT-Lösungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Hub</h3>
                                                    <p>Verbinden, überwachen und kontrollieren von Milliarden von IoT-Geräten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Plug & Play</h3>
                                                    <p>Verbinden von Geräten mit Ihrer IoT-Lösung, ohne Gerätecode zu schreiben</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erfassen und Analysieren bisher ungenutzter Daten, um Geschäftsergebnisse zu verbessern</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen digitaler Replikate von Plätzen und Infrastruktur</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>JIT-Bereitstellung ohne manuelles Eingreifen für Azure IoT Hub</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sofortiges Erkunden und Analysieren von Zeitreihendaten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Stream Analytics</h3>
                                                    <p>Echtzeitverarbeitung von Datenströmen von Millionen von IoT-Geräten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Sphere</h3>
                                                    <p>Erstellen äußerst sicherer, vernetzter Geräte mit MPUs</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Verwaltung und Governance</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Scheduler</h3>
                                                    <p>Aufträge nach einfachen oder komplexen Wiederholungszeitplänen ausführen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automation</h3>
                                                    <p>Vereinfachen der Cloudverwaltung mit Prozessautomatisierung</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Weiterleiten von eingehendem Datenverkehr für hohe Leistung und Verfügbarkeit</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Hochgradig anpassbare Überwachungsdaten in Echtzeit zu jeder beliebigen Azure-Ressource</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sicherheit &amp; Konformität</h3>
                                                    <p>Ermöglichen der Bedrohungserkennung und -verhinderung über erweiterte Cloudsicherheit</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure-Portal</h3>
                                                    <p>Erstellen, Verwalten und Überwachen sämtlicher Azure-Produkte in einer einzigen einheitlichen Konsole</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vereinfachen der Verwaltung Ihrer App-Ressourcen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Optimieren der Azure-Verwaltung durch eine browserbasierte Shell</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mobile Azure-App</h3>
                                                    <p>Jederzeit und überall mit Ihren Azure Ressourcen in Verbindung bleiben</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bereitstellen und Aktualisieren von Cloudumgebungen auf wiederholbare Weise mit zusammensetzbaren Artefakten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bedarfsabhängiges Untersuchen von Ressourcen mit einer umfassenden Abfragesprache</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>Ermitteln, bewerten und migrieren Sie Ihre lokalen virtuellen Computer in bzw. nach Azure, und passen Sie sie an Ihre Größenanforderungen an.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Abrechnung</h3>
                                                    <p>Erfahren Sie, wie Sie die Nutzung und Abrechnung Ihres Azure-Abonnements anzeigen und verstehen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bedarfsorientierte Verwaltung von Kundenressourcen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Audio- und Videoinhalte nach Maß verschlüsseln, speichern und streamen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Codieren</h3>
                                                    <p>Codierung in Studioqualität für die Cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Live- und On-Demand-Streaming</h3>
                                                    <p>Inhalte auf praktisch allen Geräten bereitstellen – mit Skalierungsoptionen, um die verschiedensten Geschäftsanforderungen zu erfüllen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ein einzelner Player für alle Wiedergabeanforderungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Inhaltsschutz</h3>
                                                    <p>Sichere Bereitstellung von Inhalten mit AES, PlayReady, Widevine und Fairplay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gewinnen von Erkenntnissen aus Videodateien mit Sprach- und Bildanalysediensten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Verbessern der Auffindbarkeit und des Zugriffs auf Ihre Multimediainhalte</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Digital Twins</h3>
                                                    <p>Erstellen moderner IoT-Lösungen für intelligente Umgebungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen von Mixed Reality-Erfahrungen für mehrere Benutzer mit räumlichem Bezug</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Flexible Erstellung mit einem vielseitigen Sensorgerät</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API-Apps</h3>
                                                    <p>Einfaches Erstellen und Nutzen von Cloud-APIs</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin</h3>
                                                    <p>Schnelleres Erstellen von herausragenden, cloudfähigen mobilen Apps</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Das Back-End für jede beliebige mobile App erstellen und hosten</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Eine integrierte Ansicht der Netzwerkdienste in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ExpressRoute</h3>
                                                    <p>Dedizierte private Glasfasernetzverbindungen mit Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>Hosten von DNS-Domänen in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schützen Ihrer Anwendungen vor  verteilten Denial-of-Service-Angriffen (Distributed Denial of Service, DDoS)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hoch verfügbarer und skalierbarer cloudbasierter Netzwerksicherheitsdienst</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuelles WAN</h3>
                                                    <p>Erstellen einer sicheren Branch-Konnektivität mit globaler Reichweite</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skalierbarer und sicherer Einstiegspunkt für die Bereitstellung von globalen Web-Apps</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Bastion</h3>
                                                    <p>Sichere nahtlose Konnektivität mit virtuellen Computern über SSL im Azure-Portal ohne öffentliche IP-Adresse</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zentralisierter Schutz Ihrer Webanwendungen vor verbreiteten Exploits und Sicherheitsrisiken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Optimale Internetkonnektivität für den Zugriff auf das Microsoft-Netzwerk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bewerten Sie, wie sich Änderungen an der Netzwerkinfrastruktur auf die Leistung aufseiten Ihrer Kunden auswirken.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Privater Zugriff auf in Azure gehostete Dienste, sodass Ihre Daten das Microsoft-Netzwerk nicht verlassen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ein global verteilter Sicherheitsverwaltungsdienst</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dediziertes HSM</h3>
                                                    <p>Verwenden des kryptografischen Schlüsselspeichers in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schützen Ihres Unternehmens vor Bedrohungen in der Cloud und der lokalen Umgebung</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen und Hosten von Anwendungen für US Government-Aufträge in einer dedizierten Instanz von Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft Azure Deutschland</h3>
                                                    <p>Erstellen und Hosten von Anwendungen in Übereinstimmung mit deutschen Bestimmungen sowie wichtige internationale Standards mit zusätzlicher Kontrolle durch einen Datentreuhänder</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Erstellen und Hosten von Anwendungen, die den Richtlinien und Datenverarbeitungsvorschriften der Regierung in China entsprechen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>StorSimple</h3>
                                                    <p>Senken von Kosten mit einer Unternehmenslösung für Hybrid Cloud-Speicher</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Managed Disks</h3>
                                                    <p>Persistente, gesicherte Datenträgerspeicher für virtuelle Azure-Computer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Box-Familie</h3>
                                                    <p>Familie von Speichergeräten, die die Offlinedatenübertragung oder netzwerkbasierte Datenübertragung ermöglichen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ausführen flexibler, dateibasierter Workloads in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Führen Sie dateibasierte Hochleistungsworkloads in Azure aus.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hybridspeicher-Optimierungslösung für HPC-Umgebungen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Speicher ganz einfach überall verwalten – über Windows, MacOS und Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Archivspeicher</h3>
                                                    <p>Preisgünstiger, sicherer Cloudspeicher für Daten, auf die nicht häufig zugegriffen wird</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Netzwerkdateidienste auf Unternehmensniveau unterstützt von NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Schnell unternehmenskritische Web-Apps nach Maß erstellen und bereitstellen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Einfaches Hinzufügen von Echtzeit-Webfunktionen</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>Bereitstellen einer cloudbasierten virtuellen Desktopumgebung auf jedem beliebigen Gerät</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure für .NET-Entwickler </h3>
                                                <p>
                                                    <a href="/dotnet/azure">Erste Schritte</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure für Python-Entwickler </h3>
                                                <p>
                                                    <a href="/azure/python">Erste Schritte</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure für Node.js-Entwickler </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Erste Schritte</a>
                                                </p>
                                                <p>
                                                    <a href="/javascript/api/overview/azure/">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure für Java-Entwickler </h3>
                                                <p>
                                                    <a href="/java/azure">Erste Schritte</a>
                                                </p>
                                                <p>
                                                    <a href="/java/api">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure für Go-Entwickler </h3>
                                                <p>
                                                    <a href="/azure/go/">Erste Schritte</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure-REST-APIs </h3>
                                                <p>
                                                    <a href="/rest/api">API-Referenz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure-Befehlszeilenschnittstelle </h3>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure-Portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Erste Schritte</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Mobile Azure-App</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Erste Schritte</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Herunterladen für Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Herunterladen für Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Docker </h3>
                                                <p>
                                                    <a href="/aspnet/core/host-and-deploy/docker/visual-studio-tools-for-docker">Visual Studio-Tools für Docker</a>
                                                </p>
                                                <p>
                                                    <a href="https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017">Herunterladen für Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780681">Herunterladen für Visual Studio Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Herunterladen für Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Java-Tools </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Maven-Plug-Ins</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/azure/java-azure-tools">IntelliJ und Eclipse</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Herunterladen für Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Herunterladen für Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Herunterladen für Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Service Fabric-SDK und -Tools </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Herunterladen für Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Herunterladen für Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Herunterladen von Mac OS X</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-cli">Herunterladen der Service Fabric-Befehlszeilenschnittstelle </a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
SQL-Tools </h3>
                                                <p>
                                                    <a href="/sql/azure-data-studio/download">Azure Data Studio <sup>VORSCHAUVERSION</sup></a>
                                                </p>
                                                <p>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Eine Gruppe empfohlener Architekturen für die Cloud. Jede Architektur umfasst bewährte Vorgehensweisen, Anweisungen und eine bereitstellbare Lösung.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
