---
title: Bereitstellen von Zuordnungen für verwaltete Azure-Anwendungen mithilfe einer Richtlinie
...
- Verwaltete AnwendungsID: Diese ID ist die Ressourcen-ID der verwalteten Anwendung, der die Ressourcen zugeordnet werden müssen.
...
Weitere Informationen Zuordnungen finden Sie unter [Ressourcenonboarding mit benutzerdefinierten Azure-Anbietern](./concepts-custom-providers-resourceonboarding.md).
...
![Zuweisen der integrierten Richtlinie](media/builtin-policy/assign-builtin-policy-managedapp.png)
...
- [Konzepte: Ressourcenonboarding mit benutzerdefinierten Azure-Anbietern](./concepts-custom-providers-resourceonboarding.md)
