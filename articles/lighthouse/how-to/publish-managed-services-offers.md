...
Geben Sie abschließend Ihre **Datenschutzrichtlinien-URL** und die **Nutzungsbedingungen** im Abschnitt **Rechtliche Hinweise** an. Sie können hier auch angeben, ob der [Standardvertrag](../../marketplace/standard-contract.md) für dieses Angebot verwendet werden soll oder nicht.
