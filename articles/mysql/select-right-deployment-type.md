...
| attribute          | Azure Database for MySQL | MySQL auf Azure-VMs    |
|:-------------------|:-----------------------------|:--------------------|
