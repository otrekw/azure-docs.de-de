...
description: Azure-Sicherheitsbaseline für Azure Database for MySQL
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 03/23/2020
...
Konfigurieren von Private Link für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-privatelink-portal

Erstellen und Verwalten von VNET-Dienstendpunkten und VNET-Regeln im Azure Database for MySQL-Server: https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Konfigurieren von Azure Database for MySQL-Firewallregeln: https://docs.microsoft.com/azure/mysql/howto-manage-firewall-using-portal
...
Konfigurieren von Advanced Threat Protection für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Grundlegendes zur Verwendung von Diensttags für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-and-security-vnet#terminology-and-description
...
Grundlegendes zu Serverprotokollen für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-monitoring#server-logs
...
Konfigurieren von und Zugreifen auf Protokolle zu langsamen Abfragen für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-server-logs-in-portal

Konfigurieren von und Zugreifen auf Überwachungsprotokolle für Azure Database for MySQL im Azure-Portal: https://docs.microsoft.com/azure/mysql/howto-configure-audit-logs-portal
...
Aktivieren von Advanced Threat Protection für Azure Database for MySQL (Vorschau): https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Grundlegendes zu Vorgängen bei Azure Database for MySQL-Ressourcenanbietern: https://docs.microsoft.com/azure/role-based-access-control/resource-provider-operations#microsoftdbformysql

Grundlegendes zur Zugriffsverwaltung für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-security#access-management
...
Erstellen zusätzlicher Konten für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-create-users

Aktualisieren des Administratorkennworts: https://docs.microsoft.com/azure/mysql/howto-create-manage-server-portal#update-admin-password
...
Grundlegendes zum Erstellen von Administratorbenutzern in Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-create-users
...
Verwenden von Azure Active Directory für die Authentifizierung bei Microsoft Azure Active Directory: https://docs.microsoft.com/azure/mysql/howto-configure-sign-in-azure-ad-authentication

Grundlegendes zur REST-API für Azure Database for MySQL: https://docs.microsoft.com/rest/api/mysql/
...
Konfigurieren von und Zugreifen auf Überwachungsprotokolle für Azure Database for MySQL: https://docs.microsoft.com/Azure/mysql/howto-configure-audit-logs-portal
...
Konfigurieren von Private Link für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link

Erstellen und Verwalten von VNET-Dienstendpunkten und VNET-Regeln im Azure Database for MySQL-Server: https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Konfigurieren von Azure Database for MySQL-Firewallregeln: https://docs.microsoft.com/azure/mysql/concepts-firewall-rules
...
Mindern der Datenexfiltrierung für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link#data-exfiltration-prevention
...
Konfigurieren der Verschlüsselung während der Übertragung für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-ssl-connection-security
...
Grundlegendes zur Verschlüsselung von ruhenden Daten für MySQL: https://docs.microsoft.com/azure/mysql/concepts-security

Konfigurieren von Kunden verwalteter Schlüssel für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-encryption-mysql
...
**Leitfaden**: Zurzeit nicht verfügbar. Azure Security Center unterstützt noch keine Sicherheitsrisikobewertung für Azure Database for MySQL.
...
**Leitfaden**: Nutzen Sie Azure Repos, um Code sicher zu speichern und zu verwalten, wenn Sie benutzerdefinierte Azure-Richtliniendefinitionen für Azure Database for MySQL-Instanzen oder zugehörige Ressourcen verwenden.
...
Grundlegendes zu Sicherungen für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-backup

Grundlegendes zur Erstkonfiguration für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/tutorial-design-database-using-portal
...
Grundlegendes zu Sicherungen für Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-restore-server-portal 
...
Grundlegendes zu Sicherung und Wiederherstellung in Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-backup
