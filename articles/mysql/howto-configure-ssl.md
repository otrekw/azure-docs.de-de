...
* Weitere Informationen zu Ablauf und Rotation von Zertifikaten finden Sie in der [Dokumentation zur Zertifikatrotation](concepts-certificate-rotation.md).
