...
Weitere Informationen finden Sie unter [Verwenden von Azure Data Lake Storage mit Azure Databricks](/azure/databricks/data/data-sources/azure/azure-datalake).
...
Ausführlichere Anweisungen finden Sie unter [Ressourcenanbieter und -typen](../azure-resource-manager/management/resource-providers-and-types.md).
