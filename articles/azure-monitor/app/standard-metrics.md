...
* Informieren Sie sich über [Protokollbasierte und vorab aggregierte Metriken](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics).
* [Protokollbasierte Metriken in Abfragen und Metrikdefinitionen](https://docs.microsoft.com/azure/azure-monitor/platform/app-insights-metrics).