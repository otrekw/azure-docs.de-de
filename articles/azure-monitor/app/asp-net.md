...
Veröffentlichen Sie Ihre App auf Ihrem IIS-Server oder in Azure. Sehen Sie sich [Live Metrics Stream](../../azure-monitor/app/live-stream.md) an, um sicherzustellen, dass alles reibungslos funktioniert.
