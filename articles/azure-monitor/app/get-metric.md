...
* `seriesCountLimit` ist die maximale Anzahl von Datenzeitreihen, die eine Metrik enthalten kann. Sobald dieser Grenzwert erreicht ist, werden Aufrufe an `TrackValue()` gerichtet.
