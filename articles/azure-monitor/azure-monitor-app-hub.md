...
">Config .xml</a><br>
                                                        ...
                                                        <br><br>
                                                          <h3>.NET Core-Anwendungen</h3>
                                                        <p>
                                                            <a href="./app/asp-net-core.md">Umfassende Überwachungskonfiguration</a><br>
                                                            <a href="./app/profiler-aspnetcore-linux.md">ASP.NET Core-Profilerstellung</a><br>
                                                            <a href="./app/api-custom-events-metrics.md">Benutzerdefinierte Ereignisse und Metriken</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-aspnetcore">Open Source SDK für .NET Core – GitHub-Repository</a>
                                                        </p>
                                                        <br><br>
                                                          <h3>Node.js-Anwendungen</h3>
                                                        <p>
                                                            <a href="./app/nodejs.md">Umfassende Überwachungskonfiguration</a><br>
                                                            <a href="./app/api-custom-events-metrics.md">Benutzerdefinierte Ereignisse und Metriken</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-node.js">Open Source SDK für Node.js – GitHub-Repository</a>
                                                        </p>
                                                        <br><br>
                                                        <h3>Client-/browserseitige Überwachung</h3>
                                                        <p>
                                                            <a href="./app/javascript.md">Umfassende Überwachungskonfiguration</a><br>
                                                            <a href="./app/api-custom-events-metrics.md">Benutzerdefinierte Ereignisse und Metriken</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-JS">Open Source SDK für JavaScript – GitHub-Repository</a><br>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        <h3>Analyse des Benutzerverhaltens</h3>
                                                        <p>
                                                            <a href="./app/usage-overview.md">Übersicht</a><br>
                                                            <a href="./app/usage-send-user-context.md">Senden von Benutzerkontext-IDs</a><br>
                                                            <a href="./app/usage-segmentation.md">Benutzer, Sitzungen und Ereignisse</a><br>
                                                        ...
                                                        <p>
                                                            <a href="./app/overview-dashboard.md">Übersichtsdashboard und Anwendungsdashboard</a><br>
                                                            <a href="./app/monitor-web-app-availability.md">Überwachung der globalen Verfügbarkeit</a><br>
                                                            <a href="./app/live-stream.md">Live Metrics Stream</a><br>
                                                            <a href="./app/app-map.md">Verteilte App-Zuordnung</a><br>
                                                            <a href="../monitoring-and-diagnostics/resource-group-insights.md">Überwachung auf Ressourcengruppenebene</a><br>
                                                            <a href="./app/usage-workbooks.md">Interaktive Berichterstellung</a><br>
                                                            <a href="./app/export-power-bi.md">Power BI-Integration</a><br>
                                                            <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-metric-charts">Untersuchen von Metriken</a>
                                                        </p>
                                                        <br><br>
                                                        ...
                                                        <h3>Datenmodell</h3>
                                                        <p>
                                                            <a href="./app/data-model.md">Übersicht</a><br>
