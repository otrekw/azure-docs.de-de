...
Zum Erstellen einer Diagnoseeinstellung fügen Sie der Vorlage eine Ressource vom Typ „<resource namespace>/providers/diagnosticSettings“ hinzu. Dieser Artikel enthält Beispiele für zwei verschiedene Ressourcentypen, doch kann das gleiche Muster auch auf andere Ressourcentypen angewendet werden. Die Sammlung zulässiger Protokolle und Metriken variiert je nach Ressourcentyp.

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]


## <a name="diagnostic-setting-for-azure-key-vault"></a>Diagnoseeinstellung für Azure Key Vault 
Im folgenden Beispiel werden einer Azure Key Vault-Instanz zwei Protokollabfragen hinzugefügt.
...
Im folgenden Beispiel werden einer Azure SQL-Datenbank zwei Protokollabfragen hinzugefügt.
### <a name="template-file"></a>Vorlagendatei
