...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Vorlage für Ergebnisanzahl (bis Version 2018-04-16)
Im folgenden Beispiel wird eine [Warnungsregel des Typs „Anzahl von Ergebnissen“](../platform/alerts-unified-log.md#count-of-the-results-table-rows) erstellt.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Vorlage für metrische Maßeinheit (bis Version 2018-04-16)
Im folgenden Beispiel wird eine [Warnungsregel des Typs „Metrische Maßeinheit“](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value) erstellt.
