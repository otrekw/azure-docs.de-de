...
| | Diagnose-<br>erweiterung (WAD) | Log Analytics-<br>Agent | Dependency-<br>Agent |
|:---|:---|:---|:---|
...
| | Diagnose-<br>erweiterung (LAD) | Telegraf-<br>Agent | Log Analytics-<br>Agent | Dependency-<br>Agent |
|:---|:---|:---|:---|:---|
