...
1. Die Nutzdaten der Warnung werden von einer „Sicherer Webhook“-Aktion an das ITSM-Tool gesendet.
1. Die ITSM-Anwendung überprüft mit Azure AD, ob die Warnung autorisiert ist und vom ITSM-Tool empfangen werden darf.
1. Wenn die Warnung autorisiert ist, führt die Anwendung folgende Schritte aus:
   
   1. Erstellen eines Arbeitselements (z. B. einen Incident) im ITSM-Tool.
   1. Binden der ID des Konfigurationselements an die Kundenverwaltungsdatenbank (Customer Management Database, CMDB).
...
## <a name="connection-with-bmc-helix"></a>Verbindung mit BMC Helix

Secure Export bietet Unterstützung für BMC Helix. Nachfolgend sind einige Vorteile der Integration aufgeführt:
...
1. Legen Sie folgende Einstellungen fest:
   ...
   1. Fügen Sie die Webhook-URL, die Sie aus der BMC Helix-Umgebung kopiert haben, als URI ein.
   1. Legen Sie für **Allgemeines Warnungsschema aktivieren** die Option **Ja** fest. 
...
## <a name="configure-the-partner-environment"></a>Konfigurieren der Partnerumgebung
...
1. Wechseln Sie bei der Konfiguration der Verbindung in BMC Helix zu Ihrer BMC-Integrationsinstanz, und führen Sie folgende Schritte aus:
   ...
   1. Wählen Sie **Azure-Warnungen** aus.
   1. Wählen Sie **Connectors** aus.
   1. Wählen Sie eine **Konfiguration** aus.
   1. Wählen Sie die Konfiguration **	Neue Verbindung hinzufügen** aus.
   1. Geben Sie im Abschnitt zur Konfiguration die folgenden Informationen ein:
