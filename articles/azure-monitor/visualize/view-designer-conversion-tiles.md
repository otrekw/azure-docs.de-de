...
description: Details zum Umwandeln von Kacheln in Arbeitsmappen beim Übergang von Ansichten in Azure Monitor.
author: austonli
ms.author: aul
ms.topic: conceptual
ms.date: 02/07/2020
...
**Option 2:** Wählen Sie in der Dropdownliste **Visualisierung** den Eintrag **Festgelegt nach Abfrage** aus, und fügen Sie der Abfrage `| render piechart` hinzu:
...
**Option 2:** Wählen Sie in der Dropdownliste **Visualisierung** den Eintrag **Festgelegt nach Abfrage** aus, und fügen Sie der Abfrage `| render linechart` hinzu:
...
**Option 2:** Wählen Sie in der Dropdownliste **Visualisierung** den Eintrag **Festgelegt nach Abfrage** aus, und fügen Sie der Abfrage `| render barchart` hinzu:
