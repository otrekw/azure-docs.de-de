...
Im folgenden Beispiel für eine Datensammlungsregel wird eine Außerkraftsetzung zum Konfigurieren der Überwachung veranschaulicht.
...
- Informieren Sie sich über [Datensammlungsregeln](../platform/data-collection-rule-overview.md).