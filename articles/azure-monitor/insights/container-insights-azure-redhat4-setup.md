...
Führen Sie für einen vorhandenen Cluster dieses [Bash-Skript in der Azure CLI](https://docs.microsoft.com/cli/azure/openshift?view=azure-cli-latest#az-openshift-create) aus.
