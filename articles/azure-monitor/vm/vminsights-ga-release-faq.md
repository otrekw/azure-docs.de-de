...
## <a name="updates-for-vm-insights"></a>Updates für VM Insights
...
Bei der vorherigen Methode zum Aktivieren von VM Insights wurden Leistungsindikatoren in Ihrem Arbeitsbereich verwendet. Die aktuelle Version speichert diese Daten in einer Tabelle mit dem Namen `InsightsMetrics`. Sie können diese Leistungsindikatoren in Ihrem Arbeitsbereich deaktivieren, wenn Sie sie nicht mehr benötigen. 
