...
Im folgenden Beispiel wird eine [Warnungsregel des Typs „Anzahl von Ergebnissen“](../alerts/alerts-unified-log.md#count-of-the-results-table-rows) erstellt.

### <a name="notes"></a>Hinweise

- Dieses Beispiel umfasst eine [Webhooknutzlast](../alerts/alerts-log-webhook.md). Wenn die Warnungsregel keinen Webhook auslösen soll, entfernen Sie das Element **customWebhookPayload**.
...
Im folgenden Beispiel wird eine [Warnungsregel des Typs „Metrische Maßeinheit“](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value) erstellt.
