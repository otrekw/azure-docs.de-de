...
> - Um benutzerdefinierte [Vorlagen](./itsmc-definition.md#define-a-template) als Teil der Aktionen zu verwenden, muss der Parameter „ProjectionType“ in der SCSM-Vorlage „IncidentManagement!System.WorkItem.Incident.ProjectionType“ zugeordnet werden.
...
2. Klicken Sie unter **ARBEITSBEREICHSDATENQUELLEN** auf **ITSM-Verbindungen**.
    ...
    ![Neue Verbindung](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Service Manager-Verbindung](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. Klicken Sie unter **Hybrid Connections** auf **Endpunkte der Hybridverbindung konfigurieren**.
    ...
    ![Hybridverbindung – Netzwerk](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. Klicken Sie auf dem Blatt **Hybrid Connections** auf **Hybridverbindung hinzufügen**.

    ![Hybridverbindung hinzufügen](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. Klicken Sie auf dem Blatt **Hybridverbindungen hinzufügen** auf **Neue Hybridverbindung erstellen**.

    ![Neue Hybridverbindung](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Geben Sie die folgenden Werte ein:
   ...
   - **Name**: Legen Sie einen Namen für den Service Bus fest, falls Sie ihn erstellen.
     ...
     ![Hybridverbindungswerte](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. Nachdem die Hybridverbindung erstellt wurde, wählen Sie die Verbindung aus, und klicken Sie auf **Ausgewählte Hybridverbindung hinzufügen**.
    ...
    ![Neue Hybridverbindung](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![erfolgreiche Hybridverbindung](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Hybridverbindungstest](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)
