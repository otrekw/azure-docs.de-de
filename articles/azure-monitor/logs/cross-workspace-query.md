...
Um einen anderen Arbeitsbereich in der Abfrage anzugeben, verwenden Sie die [*Arbeitsbereichs*](../logs/workspace-expression.md)-ID, und verwenden Sie für eine App in Application Insights die [*App*](../log-query/app-expression.md)-ID.  
...
- Eine Übersicht über Protokollabfragen und die Strukturierung von Azure Monitor-Protokolldaten erhalten Sie unter [Analysieren von Protokolldaten in Azure Monitor](../log-query/log-query-overview.md).
