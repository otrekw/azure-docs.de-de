...
Um einen anderen Arbeitsbereich in der Abfrage anzugeben, verwenden Sie die [*Arbeitsbereichs*](../logs/workspace-expression.md)-ID, und verwenden Sie für eine App in Application Insights die [*App*](./app-expression.md)-ID.  
