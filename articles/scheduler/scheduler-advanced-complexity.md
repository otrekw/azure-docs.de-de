---
title: Erstellen erweiterter Auftragszeitpläne und -serien
...
1. Registrieren Sie Ihr Azure-Abonnement mit dem [Registrierungsvorgang der Resource Manager-REST-API](/rest/api/resources/providers) bei einem Ressourcenanbieter. Der Anbietername für den Azure Scheduler-Dienst ist **Microsoft.Scheduler**. 

1. Erstellen Sie eine Auftragssammlung mit dem [Erstellungs- oder Aktualisierungsvorgang für Auftragssammlungen](/rest/api/scheduler/jobcollections) in der Scheduler-REST-API. 

1. Erstellen Sie einen Auftrag mit dem [Erstellungs- oder Aktualisierungsvorgang für Aufträge](/rest/api/scheduler/jobs/createorupdate). 
