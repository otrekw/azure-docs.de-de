...
| Unterstützte TLS-Versionen | TLS 1.2, TLS 1.0/1.1 ([konfigurierbar](https://docs.microsoft.com/rest/api/cdn/customdomains/enablecustomhttps#usermanagedhttpsparameters)) | TLS 1.2 | TLS 1.2 | TLS 1.2 |
||||
