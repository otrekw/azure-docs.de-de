...
- [Registrieren des Azure Cosmos DB-Ressourcenanbieters für Ihr Azure-Abonnement](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#register-resource-provider) 
- [Konfigurieren Ihrer Azure Key Vault-Instanz](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#configure-your-azure-key-vault-instance)
-  [Hinzufügen einer Zugriffsrichtlinie zu Ihrer Azure Key Vault-Instanz](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#add-an-access-policy-to-your-azure-key-vault-instance)
- [Generieren eines Schlüssels in Azure Key Vault](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#generate-a-key-in-azure-key-vault)
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-keypicker.png" alt-text="Erstellen einer Azure API for FHIR-Instanz":::
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-database.png" alt-text="Erstellen einer Azure API for FHIR-Instanz":::
