...
6. Wählen Sie **Speichern** aus. Eine Meldung bestätigt, dass Ihr neuer Zeitplan jetzt aktiv ist. 
   ...
   ![Meldung zur regionalen Verfügbarkeit](media/sql-data-warehouse-maintenance-scheduling/maintenance-not-active-toast.png)

## <a name="next-steps"></a>Nächste Schritte
- [Weitere Informationen](../monitoring-and-diagnostics/monitor-alerts-unified-usage.md) zum Erstellen, Anzeigen und Verwalten von Warnungen mit Azure Monitor
- [Weitere Informationen](../monitoring-and-diagnostics/monitor-alerts-unified-log-webhook.md) zu Webhookaktionen für Protokollwarnungsregeln
- [Weitere Informationen ](../monitoring-and-diagnostics/monitoring-action-groups.md) zum Erstellen und Verwalten von Aktionsgruppen.
