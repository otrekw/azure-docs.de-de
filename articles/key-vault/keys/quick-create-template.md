...
description: In dieser Schnellstartanleitung wird veranschaulicht, wie Sie Azure-Schlüsseltresore erstellen und den Tresoren Schlüssel hinzufügen, indem Sie die Azure Resource Manager-Vorlage verwenden.
services: key-vault
author: sebansal
