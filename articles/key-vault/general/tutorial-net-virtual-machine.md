...
Beachten Sie die im folgenden Code angezeigte Prinzipal-ID (PrincipalId). Die Ausgabe des obigen Befehls lautet etwa wie folgt: 
...
Weisen Sie Ihrem Schlüsseltresor mit dem Befehl [az keyvault set-policy](/cli/azure/keyvault#az_keyvault_set_policy) die zuvor erstellten Identitätsberechtigungen zu:
...
Wechseln Sie zur [.NET-Downloadseite](https://dotnet.microsoft.com/download), um .NET Core zu installieren.
