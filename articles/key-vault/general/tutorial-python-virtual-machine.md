...
Erstellen Sie für den virtuellen Computer mit dem Azure CLI-Befehl [az vm identity assign](/cli/azure/vm/identity#az_vm_identity_assign) eine systemseitig zugewiesene Identität:
