...
description: Hier erfahren Sie, wie Sie über die Azure CLI das Feature für vorläufiges Löschen von Azure Key Vault nutzen, das die Wiederherstellung von Schlüsseltresoren und Schlüsseltresorobjekten ermöglicht.
services: key-vault
