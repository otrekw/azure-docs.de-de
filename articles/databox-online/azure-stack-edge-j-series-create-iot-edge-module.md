---
title: C#-IoT Edge-Modul für Azure Stack Edge mit GPU | Microsoft-Dokumentation
description: Hier erfahren Sie, wie Sie ein C#-IoT Edge-Modul entwickeln, das auf einem Azure Stack Edge GPU-Gerät bereitgestellt werden kann.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
![Funktionsweise des Azure IoT Edge-Moduls in Azure Stack Edge](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Ein Azure Stack Edge-Gerät wird ausgeführt.
    ...
    Weitere Informationen zu Azure Stack Edge finden Sie unter [Konfigurieren von Compute](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute).
...
Informationen zum Bereitstellen und Ausführen dieses Moduls in Azure Stack Edge finden Sie in den Schritten unter [Hinzufügen eines Moduls](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).
