...
|    Maximale Blockblobgröße                              |    4,75 TB (100 MB X 50.000 Blöcke)                   |    4,75 TB (100 MB × 50.000 Blöcke) für Azure Stack Edge ab Version 2.1.1377.2170|
...
Für Azure Stack Edge-Blobspeicher sind bestimmte Clientbibliotheken vorhanden, und es gelten bestimmte Anforderungen an Endpunktsuffixe. Die Azure Stack Edge-Blobspeicher-Endpunkte sind der neuesten Version der REST-API für Azure Blob Storage nicht vollständig gleichgestellt, siehe [Unterstützte API-Versionen für Azure Stack Edge ab Version 2.1.1377.2170](#supported-api-versions). Bei den Speicherclientbibliotheken müssen Sie auf die Version achten, die mit der REST-API kompatibel ist.
