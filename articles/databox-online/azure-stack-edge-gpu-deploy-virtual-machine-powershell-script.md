---
title: Bereitstellen von VMs auf Ihrem Azure Stack Edge Pro-GPU-Gerät mithilfe eines Azure PowerShell-Skripts
description: Hier erfahren Sie, wie virtuelle Computer (VMs) auf einem Azure Stack Edge Pro-Gerät mit einem Azure PowerShell-Skript erstellt und verwaltet werden.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
1. Stellen Sie sicher, dass Sie Folgendes angepasst haben: 
...
1. Wechseln Sie zum Ordner, in den Sie das Skript auf Ihrem Client heruntergeladen haben.
1. Stellen Sie vor dem Ausführen des Skripts sicher, dass Sie noch mit der lokalen Azure Resource Manager-Instanz des Geräts verbunden sind und dass die Verbindung nicht abgelaufen ist.
...
1. Verwenden Sie den folgenden Befehl, um das Skript auszuführen:
    ...
    Wenn die IP-Adresse dynamisch der VM zugeordnet werden soll, lassen Sie den Parameter `-NicPrivateIp` weg.
...
1. Nachdem Sie die VMs erfolgreich erstellt haben, sollten sie in der Liste der VMs im Azure-Portal angezeigt werden. Navigieren Sie zum Anzeigen der VMs im Azure-Portal in der Azure Stack Edge-Ressource für Ihr Gerät zu **Edge-Dienste > Virtuelle Computer**. 

    ![Anzeigen der VM-Liste](media/azure-stack-edge-gpu-deploy-virtual-machine-powershell-script/list-virtual-machine-1.png)
    ...
    ![Anzeigen von VM-Details](media/azure-stack-edge-gpu-deploy-virtual-machine-powershell-script/view-virtual-machine-details-1.png)

1. Mit den folgenden Befehlen können Sie die vom Skript erstellten Ressourcen bereinigen:
...
[Bereitstellen von VMs mithilfe von Azure PowerShell-Cmdlets](azure-stack-edge-gpu-deploy-virtual-machine-powershell.md)