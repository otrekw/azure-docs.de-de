...
|Untergeordnete Ressourcen können nicht abgerufen werden.<br> Details: selbstsigniertes Zertifikat |Importieren Sie das SSL-Zertifikat für Ihr Gerät in Azure Storage-Explorer: <ol><li>Laden Sie das Zertifikat aus dem Azure-Portal herunter. Weitere Informationen finden Sie unter [Herunterladen des Zertifikats](https://docs.microsoft.com/azure/databox/data-box-deploy-copy-data-via-rest#download-certificate).</li><li>Wählen Sie im Menü **Bearbeiten** die Option SSL-Zertifikate und dann **Zertifikate importieren** aus.</li></ol>|
...
- Erfahren Sie mehr über die [bekannten Probleme in dieser Version](azure-stack-edge-gpu-2008-release-notes.md).
