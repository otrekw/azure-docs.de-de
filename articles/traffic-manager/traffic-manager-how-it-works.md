...
* [Welche IP-Adresse verwendet Traffic Manager?](./traffic-manager-faqs.md#what-ip-address-does-traffic-manager-use)

* [Welche Arten von Datenverkehr können mithilfe von Traffic Manager weitergeleitet werden?](./traffic-manager-faqs.md#what-types-of-traffic-can-be-routed-using-traffic-manager)

* [Unterstützt Traffic Manager persistente Sitzungen?](./traffic-manager-faqs.md#does-traffic-manager-support-sticky-sessions)

* [Warum tritt bei mir ein HTTP-Fehler auf, wenn ich Traffic Manager verwende?](./traffic-manager-faqs.md#why-am-i-seeing-an-http-error-when-using-traffic-manager)

* [Wie wirkt sich die Verwendung von Traffic Manager auf die Leistung aus?](./traffic-manager-faqs.md#what-is-the-performance-impact-of-using-traffic-manager)

* [Welche Anwendungsprotokolle kann ich mit Traffic Manager verwenden?](./traffic-manager-faqs.md#what-application-protocols-can-i-use-with-traffic-manager)

* [Kann ich Traffic Manager mit einem reinen Domänennamen verwenden?](./traffic-manager-faqs.md#can-i-use-traffic-manager-with-a-naked-domain-name)

* [Berücksichtigt Traffic Manager beim Verarbeiten von DNS-Abfragen die Clientsubnetzadresse?](./traffic-manager-faqs.md#does-traffic-manager-consider-the-client-subnet-address-when-handling-dns-queries)

* [Was ist DNS TTL, und wie wirkt DNS TTL sich auf meine Benutzer aus?](./traffic-manager-faqs.md#what-is-dns-ttl-and-how-does-it-impact-my-users)

* [Wie hoch oder niedrig kann ich die Gültigkeitsdauer (TTL) für Traffic Manager-Antworten festlegen?](./traffic-manager-faqs.md#how-high-or-low-can-i-set-the-ttl-for-traffic-manager-responses)

* [Wie kann ich das Volumen an mein Profil gerichteter Abfragen nachvollziehen?](./traffic-manager-faqs.md#how-can-i-understand-the-volume-of-queries-coming-to-my-profile)
