---
title: Bereitstellen und Konfigurieren von Azure Firewall-Richtlinien mithilfe von Azure PowerShell
description: In diesem Artikel erfahren Sie, wie Sie Azure Firewall-Richtlinien mithilfe von Azure PowerShell bereitstellen und konfigurieren.
services: firewall
author: vhorne
ms.service: firewall
ms.date: 05/03/2021
...
ms.locfileid: "108776712"
---
# <a name="deploy-and-configure-azure-firewall-policy-using-azure-powershell"></a>Bereitstellen und Konfigurieren von Azure Firewall-Richtlinien mithilfe von Azure PowerShell
...
Eine Möglichkeit zur Steuerung des ausgehenden Netzwerkzugriffs aus einem Azure-Subnetz ist Azure Firewall und eine Firewallrichtlinie. Mit Azure Firewall können Sie Folgendes konfigurieren:
...
Sie können dieses Verfahren auch im [Azure-Portal](tutorial-firewall-deploy-portal-policy.md) durchführen, wenn Sie das vorziehen.
...
```
## <a name="configure-a-firewall-policy-application-rule"></a>Konfigurieren einer Anwendungsregel für Firewallrichtlinien
...
## <a name="configure-a-firewall-policy-network-rule"></a>Konfigurieren einer Netzwerkregel für eine Firewallrichtlinie
...
Damit haben Sie sich vergewissert, dass die Regeln der Firewallrichtlinie funktionieren:
