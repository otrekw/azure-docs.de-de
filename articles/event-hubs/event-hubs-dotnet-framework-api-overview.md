...
description: Dieser Artikel enthält eine Zusammenfassung der wichtigsten .NET Framework-Client-APIs für Event Hubs (Verwaltung und Laufzeit).
services: event-hubs
