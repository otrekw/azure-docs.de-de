...
Verwenden Sie den CLI-Befehl [`az eventhubs eventhub update`](/cli/azure/eventhubs/eventhub#az-eventhubs-eventhub-update), um Partitionen in einem Event Hub zu aktualisieren. 
