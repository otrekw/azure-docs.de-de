...
Fügen Sie der `Sender`-Klasse eine Methode mit dem Namen `publishEvents` hinzu.
...
5. Erstellen Sie das Programm, und vergewissern Sie sich, dass keine Fehler vorhanden sind.
