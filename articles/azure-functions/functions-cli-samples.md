...
| [Erstellen einer serverlosen Python-Funktions-App](scripts/functions-cli-create-serverless-python.md) | Erstellen Sie eine Funktions-App in einem dedizierten App Service-Plan. |
| [Erstellen einer Funktions-App in einem Premium-Tarif mit Skalierungsmöglichkeit](scripts/functions-cli-create-premium-plan.md) | Erstellen Sie eine Funktions-App in einem dedizierten App Service-Plan. |
