...
| `Section` | Aufgaben |
| ------- | ----- |
| **Authentifizierung** | <ol><li>Herunterladen eines Veröffentlichungsprofils oder Definieren eines Dienstprinzipals.</li><li>Erstellen eines GitHub-Geheimnisses.</li></ol>|
...
## <a name="downloading-and-using-a-publish-profile-as-deployment-credential-recommended"></a>Herunterladen und Verwenden eines Veröffentlichungsprofils als Anmeldeinformationen für die Bereitstellung (empfohlen)
...
## <a name="create-a-service-principal-deprecated"></a>Erstellen eines Dienstprinzipals (veraltet)
=======
...
- Eine funktionierende Funktions-App, die in Azure mit einem GitHub-Repository gehostet wird.   
    - [Schnellstart: Erstellen einer Funktion in Azure mit Visual Studio Code](functions-create-first-function-vs-code.md)


## <a name="generate-deployment-credentials"></a>Generieren von Anmeldeinformationen für die Bereitstellung

Die empfohlene Vorgehensweise für die Authentifizierung mit Azure Functions für GitHub Actions ist ein Veröffentlichungsprofil. Sie können sich auch mit einem Dienstprinzipal authentifizieren, für diesen Vorgang sind jedoch weitere Schritte erforderlich. 
...
1. Navigieren Sie in [GitHub](https://github.com) zu Ihrem Repository, und wählen Sie **Einstellungen** > **Geheimnisse** > **Neues Geheimnis hinzufügen** aus.
   ...
   :::image type="content" source="media/functions-how-to-github-actions/add-secret.png" alt-text="Herunterladen des Veröffentlichungsprofils":::
...
1. Fügen Sie ein neues Geheimnis hinzu.
   ...
   * Wenn Sie ein Veröffentlichungsprofil verwenden, verwenden Sie `AZURE_FUNCTIONAPP_PUBLISH_PROFILE` für den **Namen**. Verwenden Sie dann den Dateiinhalt des Veröffentlichungsprofils für den **Wert**, und wählen Sie **Geheimnis hinzufügen** aus.
...
### <a name="publish-profile-deploy"></a>Bereitstellung des Veröffentlichungsprofils

In den folgenden Beispielen werden Version 1 von `functions-action` und ein `publish profile` für die Authentifizierung verwendet:
...
### <a name="service-principal-deploy"></a>Bereitstellung des Dienstprinzipals

Im folgenden Beispiel werden Version 1 von `functions-action` und ein `service principal` für die Authentifizierung verwendet. Der Workflow richtet eine Windows-.NET-Umgebung ein. 

# <a name="net"></a>[.NET](#tab/dotnet)

Richten Sie einen .NET-Linux-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen .NET-Windows-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen Java-Linux-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen Java-Windows-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen Node.JS-Linux-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen Node.JS-Windows-Workflow ein, der einen Dienstprinzipal verwendet.
...
Richten Sie einen Python-Linux-Workflow ein, der einen Dienstprinzipal verwendet.
...
> [Weitere Informationen zu Azure und zur GitHub-Integration](https://docs.microsoft.com/azure/developer/github/)
