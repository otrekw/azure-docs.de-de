...
> [!NOTE]
> Sie können auch die [IDocumentClient](/dotnet/api/microsoft.azure.documents.idocumentclient)-Schnittstelle verwenden, um das Testen zu vereinfachen.
