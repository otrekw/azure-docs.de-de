...
8. Stellen Sie unter **Subnetz** sicher, dass **myBackendSubnet** für das Subnetz ausgewählt ist, und wählen Sie anschließend **Weiter: Verwaltung** aus.
9. Wählen Sie **Deaktivieren** aus, um die Startdiagnose zu deaktivieren.
...
3. Installieren Sie IIS mithilfe der soeben abgeschlossenen Schritte auf den anderen virtuellen Computern. Verwenden Sie *myVM2* und *myVM3* für die VMName-Werte in Set-AzVMExtension.
...
3. Wählen Sie unter **Zieltyp** in der Dropdownliste die Option **Virtueller Computer** aus.
...
9. Geben Sie als **Zielnamen** *Images* ein.
