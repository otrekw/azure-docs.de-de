...
* `az` – Azure CLI: [Installationsanleitungen](/cli/azure/install-azure-cli?view=azure-cli-latest)
...
1. Erstellen des AD-Dienstprinzipals ([mehr über RBAC erfahren](../role-based-access-control/overview.md)):
    ```azurecli
