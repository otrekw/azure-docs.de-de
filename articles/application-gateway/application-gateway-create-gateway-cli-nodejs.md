...
Wie Sie die TLS-Auslagerung konfigurieren und die kostspielige TLS-Entschlüsselung außerhalb Ihrer Webserver durchführen, erfahren Sie unter [Konfigurieren der TLS-Auslagerung](application-gateway-ssl-arm.md).
