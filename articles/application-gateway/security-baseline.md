...
* [Application Gateway – Konfigurationsübersicht](https://docs.microsoft.com/azure/application-gateway/configuration-overview)
...
* [Häufig gestellte Fragen zu Application Gateway](https://docs.microsoft.com/azure/application-gateway/application-gateway-faq#diagnostics-and-logging)
...
* [Azure Application Gateway-Features](https://docs.microsoft.com/azure/application-gateway/features)

* [Azure Web Application Firewall für Azure Application Gateway](https://docs.microsoft.com/azure/web-application-firewall/ag/ag-overview)
...
* [Back-End-Integrität und Diagnoseprotokolle für Application Gateway](https://docs.microsoft.com/azure/application-gateway/application-gateway-diagnostics)

* [Was ist Application Insights?](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview)

* [Konfigurieren des fortlaufenden Exports](https://docs.microsoft.com/azure/azure-monitor/app/export-telemetry)
...
* [Azure Monitor für Netzwerke (Vorschau)](https://docs.microsoft.com/azure/azure-monitor/insights/network-insights-overview)
...
* [Verfügbarkeit von Features in Azure PaaS-Ressourcen](https://docs.microsoft.com/azure/security-center/features-paas)
...
* [Konfigurieren der TLS-Terminierung mit Key Vault-Zertifikaten mithilfe von Azure PowerShell](https://docs.microsoft.com/azure/application-gateway/configure-keyvault-ps)
...
* [WAF-Richtlinie](https://docs.microsoft.com/azure/web-application-firewall/ag/ag-overview#waf-policy)
...
* [Backup-AzureKeyVaultCertificate](https://docs.microsoft.com/powershell/module/azurerm.keyvault/backup-azurekeyvaultcertificate)
...
* [Restore-AzureKeyVaultCertificate](https://docs.microsoft.com/powershell/module/azurerm.keyvault/restore-azurekeyvaultcertificate)
