...
Vorhandene HTTPListener-Konfigurationselemente werden erweitert, um Elemente zu unterstützen, die den Hostnamen und den Servernamen angeben. Damit kann Application Gateway Datenverkehr an den richtigen Back-End-Pool weiterleiten. 

Das folgende Codebeispiel ist der Codeausschnitt des HttpListeners-Elements aus einer Vorlagendatei:
...
Fahren Sie nun mit dem Artikel [Erstellen eines Anwendungsgateways zum Hosten mehrerer Webanwendungen](tutorial-multiple-sites-powershell.md) fort, um ein Anwendungsgateway zu erstellen, das mehr als eine Webanwendung hosten kann.
