...
+ [API-Referenz für die Clientbibliothek](/dotnet/api/overview/azure/search.documents-readme?view=azure-dotnet)
...
+ [Azure.Search.Document-API-Referenz](/dotnet/api/overview/azure/search.documents-readme?view=azure-dotnet)