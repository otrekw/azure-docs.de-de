...
Dieser Codeausschnitt veranschaulicht das Hinzufügen einer synonymMap zu einem bereits vorhandenen Index. Dieser Code stammt aus [Synonyme – C#-Beispiel für die kognitive Azure-Suche](https://github.com/Azure-Samples/search-dotnet-getting-started/tree/v10/DotNetHowToSynonyms).
...
Versuchen Sie, andere Beispiele zu modifizieren, um ETags oder AccessCondition-Objekte zu verwenden.

+ [search-dotnet-getting-started in GitHub](https://github.com/Azure-Samples/search-dotnet-getting-started). Dieses Repository enthält das Projekt „DotNetEtagsExplainer“.

+ [azure-search-dotnet-samples in GitHub](https://github.com/Azure-Samples/azure-search-dotnet-samples) enthält zusätzliche C#-Beispiele.

## <a name="see-also"></a>Siehe auch

+ [Allgemeine HTTP-Anforderungs- und -Antwortheader](/rest/api/searchservice/common-http-request-and-response-headers-used-in-azure-search)
+ [HTTP-Statuscodes (Azure Cognitive Search)](/rest/api/searchservice/http-status-codes)
