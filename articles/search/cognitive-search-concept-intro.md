...
| Verarbeitung natürlicher Sprache | Textverarbeitung für Einblicke und Informationen zu Texteingaben. Sprachenerkennung, Standpunktanalyse und Schlüsselbegriffserkennung sind Fähigkeiten, die in den Bereich der Verarbeitung natürlicher Sprache fallen.  | Siehe [Schlüsselbegriffserkennung](cognitive-search-skill-keyphrases.md), [Sprachenerkennung](cognitive-search-skill-language-detection.md), [Textübersetzung](cognitive-search-skill-text-translation.md), [Standpunktanalyse](cognitive-search-skill-sentiment.md), [PII-Erkennung](cognitive-search-skill-pii-detection.md) |
