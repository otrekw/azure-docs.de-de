...
5. Wählen Sie **Aktivieren** aus, um die Aktivierung für Ihren Computer zu starten.
   ...
   ![Anzeigen von Onboardingoptionen](./media/manage-inventory-vms/inventory-onboarding-options.png)
   ...
   ![Anzeigen des Bestands](./media/manage-inventory-vms/inventory-onboarded.png)
...
![Anzeigen der Computergruppen auf der Seite „Inventar“](./media/manage-inventory-vms/inventory-machine-groups.png)
...
![Anzeigen der Seite „Computergruppe“](./media/manage-inventory-vms/machine-group-page.png)
...
![Erstellen der neuen Computergruppe](./media/manage-inventory-vms/create-new-group.png)
...
* Ausführliche Informationen zur Verwendung des Features finden Sie unter [Verwalten der Änderungsnachverfolgung und des Bestands](manage-change-tracking.md).
* Weitere Informationen zur Nachverfolgung von Softwareänderungen finden Sie unter [Übersicht über Änderungsnachverfolgung und Bestand](overview.md).
