...
1. Wählen Sie den *InputObject* -Parameter aus. Dies ist der Parameter, mit dem Sie den Text angeben, der an den Ausgabestream gesendet werden soll.
...
1. Ein Auftragsbereich für den soeben erstellten Runbookauftrag wird angezeigt. Vergewissern Sie sich, dass der **Auftragsstatus** den Wert „Abgeschlossen“ hat.
...
1. Den Eintrag „Write Hello World to output“ benötigen Sie nicht mehr. Klicken Sie einfach auf die Auslassungspunkte, und wählen Sie **Löschen** aus.
...
1. Nehmen Sie die folgenden Einstellungen in den vorgesehenen Feldern vor, und klicken Sie dann auf **OK**.
   ...
   * **Typ**: Behalten Sie die Einstellung „String“ bei.
...
1. Wählen Sie **Get-AzVM** und anschließend **Parametersatz** aus, um die Sätze für **Get-AzVM** anzuzeigen. 
