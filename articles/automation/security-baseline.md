...
- [Bereitstellen eines Automation-Kontos mithilfe einer Azure Resource Manager-Vorlage](/azure/automation/quickstart-create-account-template#deploy-the-template)
