...
> [!NOTE]
> Wenn Sie im Bereich **Eingabe- und Ausgabeeigenschaften** einen Wert ins Feld **Ausgabetyp** eingegeben haben, müssen Sie außerhalb des Steuerelements klicken, damit die Eingabe vom Steuerelement erkannt werden kann.
