...
![Auswählen der Skripts](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Ausgewählte Elemente](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Updateergebnisse](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![Ergebnisse der Bereitstellungsausführung](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
![Katalogliste](./media/update-mgmt-pre-post-scripts/runbook-gallery.png)
...
* Einzelheiten zur Updateverwaltung finden Sie unter [Verwalten von Updates und Patches für Ihre VMs](update-mgmt-manage-updates-for-vm.md).
