...
Wenn Sie die Verschlüsselung mit kundenseitig verwalteten Schlüsseln für ein Automation-Konto aktivieren, wird der Kontoverschlüsselungsschlüssel von Azure Automation mit dem kundenseitig verwalteten Schlüssel im zugeordneten Schlüsseltresor umschlossen. Das Aktivieren von kundenseitig verwalteten Schlüsseln wirkt sich nicht auf die Leistung aus. Das Konto wird ohne Zeitverzögerung sofort mit dem neuen Schlüssel verschlüsselt.
...
> [!NOTE] 
> Um kundenseitig verwaltete Schlüssel zu aktivieren, müssen Sie zurzeit Azure Automation REST-API-Aufrufe mithilfe der API-Version 2020-01-13-preview durchführen.
...
Vor dem Aktivieren kundenseitig verwalteter Schlüssel für ein Automation-Konto müssen Sie sicherstellen, dass die folgenden Voraussetzungen erfüllt sind.
 ...
 - Sie müssen die Eigenschaften **Vorläufiges Löschen** und **Do Not Purge** (Nicht bereinigen) im Schlüsseltresor aktivieren. Diese Funktionen sind erforderlich, um die Wiederherstellung von Schlüsseln im Falle einer versehentlichen Löschung zu ermöglichen.
...
Die systemseitig zugewiesene Identität für das Automation-Konto wird in der Antwort zurückgegeben.
...
Nachdem dem Automation-Konto eine verwaltete Identität zugewiesen wurde, konfigurieren Sie den Zugriff auf den Key Vault, in dem kundenseitig verwaltete Schlüssel gespeichert sind. Azure Automation erfordert **Get**, **recover**, **wrapKey**, **UnwrapKey** für die kundenseitig verwalteten Schlüssel.
...
Durch Rotieren des Schlüssels wird keine Neuverschlüsselung sicherer Ressourcen im Automation-Konto ausgelöst. Es ist keine weitere Aktion durch den Benutzer erforderlich.
