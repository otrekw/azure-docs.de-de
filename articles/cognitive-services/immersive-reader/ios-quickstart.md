...
description: In dieser Schnellstartanleitung erstellen Sie eine iOS-App von Grund auf neu und fügen die Funktion für den plastischen Reader hinzu.
author: metanMSFT
...
ms.locfileid: "75945466"
---
# <a name="quickstart-create-an-ios-app-that-launches-the-immersive-reader-swift"></a>Schnellstart: Erstellen einer iOS-App zum Starten des plastischen Readers (Swift)
...
In dieser Schnellstartanleitung erstellen Sie eine iOS-App von Grund auf neu und integrieren den plastischen Reader. Ein vollständiges Arbeitsbeispiel für diesen Schnellstart finden Sie [hier](https://github.com/microsoft/immersive-reader-sdk/tree/master/iOS/samples/quickstart-swift).
...
## <a name="create-the-view-controllers-and-add-sample-content"></a>Erstellen der Ansichtscontroller und Hinzufügen von Beispielinhalten
...
Fügen Sie dem Projektstammordner eine neue Datei mit dem Namen *ImmersiveReaderViewController.swift* hinzu, und fügen Sie den folgenden Code hinzu:
...
Fügen Sie dem Projektstammordner eine neue Datei mit dem Namen *LaunchImmersiveReader.swift* hinzu, und fügen Sie den folgenden Code hinzu:
