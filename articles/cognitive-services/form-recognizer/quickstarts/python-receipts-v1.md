...
> [!IMPORTANT]
> In dieser Schnellstartanleitung wird die Formularerkennungs-API v1.0 verwendet. Wenn sich Ihr Abonnement in der Region `West US 2` oder `West Europe` befindet, sollten Sie stattdessen die [Schnellstartanleitung für die API-Version 2.0](./python-train-extract.md) lesen.
