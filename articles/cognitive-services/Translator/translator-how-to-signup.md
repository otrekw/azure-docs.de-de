---
title: 'Erste Schritte: Translator'
titleSuffix: Azure Cognitive Services
description: In diesem Artikel erfahren Sie, wie Sie sich für Translator von Azure Cognitive Services registrieren und einen Abonnementschlüssel erhalten.
...
ms.locfileid: "98896713"
---
# <a name="how-to-sign-up-for-translator"></a>Registrieren für Translator

## <a name="sign-in-to-the-azure-portal"></a>Melden Sie sich auf dem Azure-Portal an.

- Sie haben kein Konto? Sie können ein [kostenloses Konto](https://azure.microsoft.com/free/cognitive-services) erstellen, um kostenlos zu experimentieren.
- Sie verfügen bereits über ein Konto? [Anmelden](https://ms.portal.azure.com/)

## <a name="create-a-subscription-for-translator"></a>Erstellen eines Abonnements für Translator

Nachdem Sie sich beim Portal angemeldet haben, können Sie wie folgt ein Abonnement für Translator erstellen:

1. Wählen Sie **+ Ressource erstellen**.
1. Geben Sie im Suchfeld **Marketplace durchsuchen** den Suchbegriff **Translator** ein, und wählen Sie Translator in den Ergebnissen aus.
