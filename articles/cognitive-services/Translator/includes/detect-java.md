...
Fügen Sie der Klasse `Detect` die folgenden Zeilen hinzu. Sie werden feststellen, dass der Abonnementschlüssel und der Endpunkt aus Umgebungsvariablen gelesen werden:
