...
Erstellen Sie mit Ihrer bevorzugten IDE/Ihrem bevorzugten Editor oder in einem neuen Ordner auf Ihrem Desktop ein neues Go-Projekt. Kopieren Sie anschließend den folgenden Codeausschnitt in Ihr Projekt/Ihren Ordner in eine Datei namens `dictionaryLookup.go`.
...
In diesem Schritt erstellen wir eine Funktion zum Abrufen alternativer Übersetzungen. Von dieser Funktion wird ein einzelnes Argument (Ihr Translator-Abonnementschlüssel) verwendet.
