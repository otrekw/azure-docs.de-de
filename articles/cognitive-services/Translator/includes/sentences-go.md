...
In diesem Schritt erstellen wir eine Funktion zum Ermitteln der Satzlänge. Von dieser Funktion wird ein einzelnes Argument (Ihr Translator-Abonnementschlüssel) verwendet.
