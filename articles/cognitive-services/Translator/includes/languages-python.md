...
Der globale Endpunkt von Translator wird als `endpoint` festgelegt. `path` legt die `languages`-Route fest und gibt die gewünschte Version der API (Version 3) an.
