...
description: Dieser Artikel enthält die Schritte, die Ihnen bei der Migration von V2 nach V3 der Textübersetzungs-API von Azure Cognitive Services helfen.
