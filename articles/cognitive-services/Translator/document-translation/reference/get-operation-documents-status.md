---
title: Dokument Übersetzung Status der Vorgangsdokumente abrufen
titleSuffix: Azure Cognitive Services
description: Die Methode „Get Operation Documents Status“ gibt den Status aller Dokumente in einer Batch Dokumentübersetzungsanforderung zurück.
...
ms.locfileid: "105613779"
---
# <a name="document-translation-get-operation-documents-status"></a>Dokumentübersetzung: Status der Vorgangsdokumente abrufen

Die Methode „Get Operation Documents Status“ gibt den Status aller Dokumente in einer Batch Dokumentübersetzungsanforderung zurück.
...
|$top|Falsch|Nimmt die $top-Einträge in die Auflistung auf. Wenn sowohl $top als auch $skip bereitgestellt werden, wird $skip zuerst angewendet.|
...
## <a name="get-operation-documents-status-response"></a>Abrufen der Antwort des Vorgangsdokumentstatus

### <a name="successful-get-operation-documents-status-response"></a>Erfolgreiches Abrufen der Antwort des Vorgangsdokumentstatus
