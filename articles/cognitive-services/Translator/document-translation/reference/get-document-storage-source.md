---
title: Dokumentübersetzung Get-Document-Storage-Source-Methode
titleSuffix: Azure Cognitive Services
description: Die Methode „Get Document Storage Source“ gibt eine Liste der unterstützten Speicherquellen zurück.
...
ms.locfileid: "105613789"
---
# <a name="document-translation-get-document-storage-source"></a>Dokumentübersetzung: Get-Document-Storage-Source-Methode

Die Methode „Get Document Storage Source“ gibt eine Liste der Speicherquellen/-optionen zurück, die vom Dokumentübersetzungsdienst unterstützt werden.
...
## <a name="get-document-storage-source-response"></a>Abrufen der Dokumentspeicherquelle

### <a name="successful-get-document-storage-source-response"></a>Erfolgreiche Antwort der Dokumentspeicherquelle
Der Basistyp für die Listenrückgabe in der „Get Document Storage Source“-API.
