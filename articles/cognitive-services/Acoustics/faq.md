...
## <a name="is-my-source-content-secure"></a>Ist mein Quellinhalt sicher?

Projekt Akustik lädt die Quellgeometrie der Szene nicht in die Cloud hoch. Stattdessen wird eine Voxelversion der Szene verwendet, die mit Testpositionsdaten kombiniert und in einem proprietären Format gespeichert wird.     
