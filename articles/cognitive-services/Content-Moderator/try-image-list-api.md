...
1. Geben Sie Ihren Abonnementschlüssel ein, und wählen Sie dann **Senden** aus.

1. Um sicherzustellen, dass das Bild gelöscht wurde, verwenden Sie die Konsole **Bild – Alle Bild-IDs abrufen**.
