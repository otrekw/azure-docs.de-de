---
title: 'Veraltete vordefinierte Entitäten: LUIS'
...
#### <a name="3-geography-subtypes"></a>3 untergeordnete geography-Typen

Vordefinierte Entität   |   Beispieläußerung   |   JSON
------|------|------|
...
## <a name="encyclopedia-culture"></a>Kultur „encyclopedia“
...
Vordefinierte Entität   |   Vordefinierte Entität (untergeordnete Typen)   |   Beispieläußerung
------|------|------|
