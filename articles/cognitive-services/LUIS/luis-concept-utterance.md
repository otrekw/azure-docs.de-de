...
Äußerungsnormalisierung ist der Prozess, bei dem der Einfluss von Interpunktion und diakritischen Zeichen während des Trainings und Vorhersagen außer Kraft gesetzt wird. Verwenden Sie [Anwendungseinstellungen](luis-reference-application-settings.md), um die Auswirkungen der Äußerungsnormalisierung auf Äußerungsvorhersagen zu steuern.
...
Normalisierung bedeutet nicht, dass in Ihren Beispieläußerungen oder Vorhersageantworten keine Interpunktion oder diakritischen Zeichen angezeigt werden, sondern nur, dass sie beim Trainieren und Vorhersagen ignoriert werden.
