...
* `COGNITIVESERVICE_AUTHORING_KEY`: Der Ressourcenschlüssel zum Authentifizieren Ihrer Anforderungen.
* `COGNITIVESERVICE_REGION`: Region, die Ihrem Schlüssel zugeordnet ist. Beispiel: `westus`.
