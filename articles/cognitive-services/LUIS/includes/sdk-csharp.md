...
Der LUIS-Erstellungsclient (Language Understanding) ist ein Objekt vom Typ [LUISAuthoringClient](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.luisauthoringclient), das sich bei Azure authentifiziert und Ihren Erstellungsschlüssel enthält.
...
* Apps: [Erstellen](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.appsextensions.addasync), [Löschen](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.appsextensions.deleteasync), [Veröffentlichen](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.appsextensions.publishasync)
* Beispieläußerungen: [Hinzufügen](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions), [Löschen anhand der ID](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions.deleteasync)
* Features: Verwalten von [Ausdruckslisten](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.featuresextensions.addphraselistasync)
* Modell: Verwalten von [Absichten](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.modelextensions) und Entitäten
* Muster: Verwalten von [Mustern](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.patternextensions)
* Trainieren: [Trainieren](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions.trainversionasync) der App und Abfragen des [Trainingsstatus](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions.getstatusasync)
* [Versionen:](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.versionsextensions) Verwalten mittels Klonen, Exportieren und Löschen

## <a name="prediction-object-model"></a>Vorhersageobjektmodell

Der LUIS-Vorhersagelaufzeit-Client (Language Understanding) ist ein Objekt vom Typ [LUISRuntimeClient](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.luisruntimeclient), das sich bei Azure authentifiziert und Ihren Ressourcenschlüssel enthält.

## <a name="code-examples-for-prediction-runtime"></a>Codebeispiele für die Vorhersagelaufzeit

Nach der Erstellung des Clients können Sie damit unter anderem auf folgende Funktionen zugreifen:

* Vorhersage nach [Staging- oder Produktionsslot](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.predictionoperationsextensions.getslotpredictionasync)
* Vorhersage durch [Version](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.predictionoperationsextensions.getversionpredictionasync)
...
Erstellen Sie ein Objekt vom Typ [ApplicationCreateObject](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.models.applicationcreateobject). Name und Sprachkultur sind erforderliche Eigenschaften. Rufen Sie die Methode [Apps.AddAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.appsextensions.addasync) auf. Die Antwort ist die App-ID.
...
Erstellen Sie ein Objekt vom Typ [ModelCreateObject](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.models.modelcreateobject) mit dem Namen der eindeutigen Absicht, und übergeben Sie dann die App-ID, die Versions-ID und das ModelCreateObject-Objekt an die Methode [Model.AddIntentAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.modelextensions.addintentasync). Die Antwort ist die Absichts-ID.
...
Erstellungsmethoden für Entitäten sind Teil der Klasse [Model](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.modelextensions). Jeder Entitätstyp verfügt über ein eigenes DTO-Modell (Data Transformation Object), das in der Regel das Wort `model` im Namespace [Models](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.models) enthält.
...
Rufen Sie [Examples.AddAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions) mit der App-ID, der Versions-ID und dem Beispiel auf.
...
Für die Methode [Train.TrainVersionAsync](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.trainextensions) müssen die App-ID und die Versions-ID angegeben werden.
...
Verwenden Sie ein Objekt vom Typ [ApiKeyServiceClientCredentials](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.apikeyserviceclientcredentials) mit Ihrem Schlüssel und mit Ihrem Endpunkt, um ein Objekt vom Typ [LUISRuntimeClient](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.luisruntimeclient) zu erstellen.
...
Die Benutzeräußerung ist Teil des [PredictionRequest](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime.models.predictionrequest)-Objekts.
