---
title: 'Schnellstart: LUIS-Erstellungsclientbibliothek (Language Understanding) 3.x für .NET'
titleSuffix: Azure Cognitive Services
description: Hier erhalten Sie Informationen zu den ersten Schritten mit der LUIS-Clientbibliothek 3.x für .NET. Führen Sie die nachfolgenden Schritte zum Installieren des Pakets aus, und testen Sie den Beispielcode für grundlegende Aufgaben.
...
ms.locfileid: "74808019"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Schnellstart: LUIS-Erstellungsclientbibliothek (Language Understanding) 3.x für .NET

Hier finden Sie Informationen zu den ersten Schritten mit der LUIS-Clientbibliothek (Language Understanding) 3.x für .NET. Führen Sie die nachfolgenden Schritte zum Installieren des Pakets aus, und testen Sie den Beispielcode für grundlegende Aufgaben.  Language Understanding (LUIS) ermöglicht das Anwenden benutzerdefinierter Machine Learning-Intelligenz auf Benutzertext mit natürlicher Sprache, um die allgemeine Bedeutung vorherzusagen sowie relevante, detaillierte Informationen zu extrahieren.

Verwenden Sie die LUIS-Erstellungsclientbibliothek (Language Understanding) 3.x für .NET für Folgendes:

* Abfragen eines veröffentlichten Endpunkts
