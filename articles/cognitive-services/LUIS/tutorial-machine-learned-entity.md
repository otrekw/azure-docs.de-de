...
1. Legen Sie den Entitätsnamen auf `SizeListentity` fest, sodass er im Vergleich mit der `SizePhraselist`, die im vorherigen Abschnitt erstellt wurde, leicht zu erkennen ist.
