...
:::row:::
    :::column span="3":::
        Xamarin.Android macht das vollständige Android SDK für .NET-Entwickler verfügbar. Erstellen Sie vollständig native Android-Apps mit C# oder F# in Visual Studio. Weitere Informationen finden Sie unter <a href="https://docs.microsoft.com/xamarin/android/" target="_blank">Xamarin.Android <span class="docon docon-navigate-external x-hidden-focus"></span></a>.
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">
