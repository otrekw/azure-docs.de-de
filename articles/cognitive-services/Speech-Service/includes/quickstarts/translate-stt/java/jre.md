---
title: 'Schnellstart: Übersetzen von Sprache in Text, Java (Windows, Linux) – Speech-Dienst'
...
1. Ersetzen Sie die Zeichenfolge `YourServiceRegion` durch die [Region](~/articles/cognitive-services/Speech-Service/regions.md).
