...
1. Ersetzen Sie außerdem die Zeichenfolge `YourServiceRegion` durch den **Regionsbezeichner** der [Region](https://aka.ms/speech/sdkregion), die mit Ihrem Abonnement verknüpft ist. Verwenden Sie beispielsweise `westus` für das kostenlose Testabonnement.
