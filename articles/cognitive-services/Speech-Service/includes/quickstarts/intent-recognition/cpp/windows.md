...
ms.locfileid: "75660495"
---
## <a name="prerequisites"></a>Voraussetzungen

Bevor Sie beginnen:

* Wenn dies Ihr erstes C++-Projekt ist, verwenden Sie diesen Leitfaden zum <a href="../quickstarts/create-project.md?tabs=windows" target="_blank">Erstellen eines leeren Beispielprojekts</a>.
* <a href="../quickstarts/setup-platform.md?tabs=windows" target="_blank">Installieren Sie das Speech SDK für Ihre Entwicklungsumgebung</a>.
