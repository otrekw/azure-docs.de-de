...
ms.locfileid: "75660491"
---
## <a name="prerequisites"></a>Voraussetzungen

Bevor Sie beginnen:

* Wenn dies Ihr erstes Python-Projekt ist, verwenden Sie diesen Leitfaden zum <a href="../quickstarts/create-project.md" target="_blank">Erstellen eines leeren Beispielprojekts</a>.
* <a href="../quickstarts/setup-platform.md" target="_blank">Installieren Sie das Speech SDK für Ihre Entwicklungsumgebung</a>.
