...
|--|--|--|
| C# | [In eine Audiodatei][1-file] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [In eine Audiodatei][2-file] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [In eine Audiodatei][3-file] | [Android][java-android], [JRE][java-jre] |
...
| Python | [In eine Audiodatei][4-file] | [Windows, Linux, macOS][python] |
