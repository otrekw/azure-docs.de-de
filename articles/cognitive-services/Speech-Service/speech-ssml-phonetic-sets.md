...
<a id="de-v-1"></a>
**1** *Nur in Wörtern mit fremdem Ursprung, z. B.: Fasci**ae**.*<br>
<a id="de-v-2"></a>
...
<a id="de-c-1"></a>
**1** *Nur in Wörtern mit fremdem Ursprung, z. B.: Pu**b**.*<br>
<a id="de-c-2"></a>
**2** *Weiches „ch“ nach „e“ und „i“*<br>
<a id="de-c-3"></a>
**3** *Nur in Wörtern mit fremdem Ursprung, z. B.: Len**d**l.*<br>
<a id="de-c-4"></a>
**4** *Nur in Wörtern mit fremdem Ursprung, z. B.: Clau**d**e.*<br>
<a id="de-c-5"></a>
**5** *Nur in Wörtern mit fremdem Ursprung, z. B.: Chan**g**e.*<br>
<a id="de-c-6"></a>
**6** *Am Wortende nur in Wörtern mit fremdem Ursprung, z. B. Gre**g**.*<br>
<a id="de-c-7"></a>
**7** *Nur in Wörtern mit fremdem Ursprung, z. B.: **Ng**uyen.*<br>
<a id="de-c-8"></a>
**8** *Nur in Wörtern mit fremdem Ursprung, z. B.: **S**taccato.*<br>
<a id="de-c-9"></a>
**9** *Nur in Wörtern mit fremdem Ursprung, z. B.: Gr**oo**ve.*<br>
<a id="de-c-10"></a>
...
<a id="de-c-12"></a>
**12** *Am Wortanfang nur in Wörtern mit fremdem Ursprung, z. B.: **J**uan. Am Silbenanfang auch in Wörtern wie: Ba**ch**erach.*<br>
...
Der für `zh-CN` festgelegte Phonemsatz des Speech-Diensts basiert auf dem nativen <a href="https://en.wikipedia.org/wiki/Pinyin" target="_blank">Pinyin<span class="docon docon-navigate-external x-hidden-focus"></span></a>-Phonemsatz.

### <a name="tone"></a>Aussprache
...
Der für `zh-TW` festgelegte Phonemsatz des Speech-Diensts basiert auf dem nativen <a href="https://en.wikipedia.org/wiki/Bopomofo" target="_blank">Bopomofo<span class="docon docon-navigate-external x-hidden-focus"></span></a>-Phonemsatz.
...
Der für `ja-JP` festgelegte Phonemsatz des Speech-Diensts basiert auf dem nativen <a href="https://en.wikipedia.org/wiki/Kana" target="_blank">Kana<span class="docon docon-navigate-external x-hidden-focus"></span></a>-Phonemsatz.

### <a name="stress"></a>Betonung
