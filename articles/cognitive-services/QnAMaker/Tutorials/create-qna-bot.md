...
* QnA Maker-Hilfebot, der im QnA Maker-Portal verwendet wird, ist als [Bot-Beispel](https://github.com/microsoft/BotBuilder-Samples/tree/master/experimental/qnamaker-support) verfügbar.
