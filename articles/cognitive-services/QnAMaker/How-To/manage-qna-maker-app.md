...
Sie können auch die Qualität Ihrer Wissensdatenbank verbessern, indem Sie durch [aktives Lernen](../Concepts/active-learning-suggestions.md) alternative Fragen vorschlagen. Benutzereingaben werden berücksichtigt und als Vorschläge in der Liste mit alternativen Fragen angezeigt. Sie können diese Vorschläge entweder als alternative Fragen hinzufügen oder ablehnen.
