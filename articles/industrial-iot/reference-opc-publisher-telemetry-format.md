---
title: 'Microsoft OPC Publisher: Telemetrieformat'
description: Dieser Artikel bietet eine Übersicht über die Konfigurationseinstellungendatei.
author: jehona-m
ms.author: jemorina
...
Außerdem unterstützen alle Versionen von OPC Publisher ein nicht standardisiertes, einfaches JSON-Telemetrieformat, das mit [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) kompatibel ist und wie folgt aussieht:
```
[
   {
