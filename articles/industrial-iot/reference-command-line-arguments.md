---
title: Microsoft OPC Publisher-Befehlszeilenargumente
description: Dieser Artikel enthält eine Übersicht über die OPC Publisher-Befehlszeilenargumente.
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787473"
---
# <a name="command-line-arguments"></a>Befehlszeilenargumente

Im Folgenden werden mehrere Befehlszeilenargumente aufgeführt, die verwendet werden können, um globale Einstellungen für OPC Publisher festzulegen.

## <a name="opc-publisher-command-line-arguments-for-version-25-and-below"></a>OPC Publisher-Befehlszeilenargumente bis Version 2.5

* Syntax: opcpublisher.exe \<applicationname> [\<iothubconnectionstring>] [\<options>]
    
* applicationname: Der Name der OPC UA-Anwendung, der verwendet werden soll. Der Anwendungsname wird auch verwendet, um den Herausgeber unter diesem Namen in der Registrierung des IoT Hub-Geräts zu registrieren.
    
* iothubconnectionstring: Die Verbindungszeichenfolge für den IoT Hub-Besitzer, optional. In der Regel geben Sie die Verbindungszeichenfolge des IoT Hub-Besitzers nur beim ersten Start der Anwendung an. Die Verbindungszeichenfolge ist verschlüsselt und wird im Plattformzertifikatspeicher gespeichert.
Bei nachfolgenden Aufrufen wird Sie von dort gelesen und wiederverwendet. Wenn Sie die Verbindungszeichenfolge bei jedem Start angeben, wird das Gerät, das für die Anwendung in der IoT Hub-Geräteregistrierung erstellt wird, jedes Mal entfernt und neu erstellt.
    
Es gibt eine Reihe von Umgebungsvariablen, die zum Steuern der Anwendung verwendet werden können:
```
...
## <a name="opc-publisher-command-line-arguments-for-version-26-and-above"></a>OPC Publisher-Befehlszeilenargumente ab Version 2.6
```
      --pf, --publishfile=VALUE
                                       the filename to configure the nodes  to publish.
...
Weitere Ressourcen finden Sie in den GitHub-Repositorys:
