---
title: Behandeln von häufigen Verbindungsproblemen mit SQL-Datenbank
...
3. Wenn sich eine Datenbank ihren Ressourcenbegrenzungen nähert, kann dies wie ein vorübergehendes Verbindungsproblem aussehen. Sie [Ressourceneinschränkungen](sql-database-resource-limits-database-server.md#what-happens-when-database-resource-limits-are-reached).
...
Weitere Informationen zur Behandlung vorübergehender Fehler in der Anwendungsüberprüfung finden Sie unter
* [Behandeln von Problemen bei vorübergehenden Verbindungsfehlern mit SQL-Datenbank](sql-database-connectivity-issues.md).
