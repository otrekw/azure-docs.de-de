...
Dieser Schnellstart zeigt, wie Sie mit [.NET-Framework](https://www.microsoft.com/net/) und C#-Code in Visual Studio eine Azure SQL-Datenbank mit Transact-SQL-Anweisungen abfragen können.
...
- Eine Azure SQL-Datenbank. In den folgenden Schnellstartanleitungen erfahren Sie jeweils, wie Sie eine Datenbank in Azure SQL-Datenbank erstellen und anschließend konfigurieren:
  ...
  |Laden der Daten|Laden von Adventure Works gemäß Schnellstartanleitung|[Wiederherstellen von Wide World Importers](sql-database-managed-instance-get-started-restore.md)
