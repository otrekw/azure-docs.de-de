...
In diesem Artikel werden die Authentifizierungsanforderungen zum Konfigurieren und Steuern der [aktiven Georeplikation](sql-database-active-geo-replication.md) und von [Gruppen für automatisches Failover](sql-database-auto-failover-group.md) beschrieben. Außerdem werden die erforderlichen Schritte zum Einrichten des Benutzerzugriffs auf die sekundäre Datenbank festgelegt. Schließlich wird auch wird beschrieben, wie nach der [Geowiederherstellung](sql-database-recovery-using-backups.md#geo-restore) der Zugriff auf die wiederhergestellte Datenbank aktiviert wird. Weitere Informationen zu Wiederherstellungsoptionen finden Sie unter [Übersicht über die Geschäftskontinuität](sql-database-business-continuity.md).
...
* Informationen zur aktiven Georeplikation finden Sie unter [Aktive Georeplikation](sql-database-active-geo-replication.md).
