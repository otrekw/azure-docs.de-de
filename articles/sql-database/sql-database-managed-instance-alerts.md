...
Sie können mit den folgenden Schnittstelle Warnungsregeln konfigurieren und zugehörige Informationen abrufen:
...
1. Suchen Sie im Azure-[Portal](https://portal.azure.com/) die verwaltete SQL-Instanz, die Sie überwachen möchten, und wählen Sie sie aus.

2. Wählen Sie das Menüelement **Metriken** im Abschnitt „Überwachung“ aus.

   ![Überwachung](media/sql-database-managed-instance-alerts/mi-alerting-menu-annotated.png)
...
6. Klicken Sie im Bereich „Warnungsregel erstellen“ auf **Bedingungsname** (im Beispiel wird der verwendete Speicherplatz gezeigt).
   ...
   ![Definieren der Bedingung](media/sql-database-managed-instance-alerts/mi-create-metrics-alert-smaller-annotated.png)
