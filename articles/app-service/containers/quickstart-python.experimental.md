...
description: Stellen Sie in wenigen Minuten Ihre erste Python-App „Hallo Welt“ in Azure App Service für Linux bereit.
...
## <a name="run-the-sample-app-locally"></a>Klonen Sie die Beispiel-App lokal:
