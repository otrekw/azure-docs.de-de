...
Kopieren Sie den folgenden Code in diese Datei ein. Achten Sie darauf, dass Sie die beiden Platzhalter *\<cosmosdb_name>* durch den Namen Ihrer Cosmos DB-Datenbank und den Platzhalter *\<primary_master_key>* durch den Schlüssel ersetzen, den Sie im vorherigen Schritt kopiert haben.
...
Die Option `ssl=true` ist erforderlich, um die [Anforderungen an die Verbindungszeichenfolge](../cosmos-db/connect-mongodb-account.md#connection-string-requirements) zu erfüllen. 
...
Umgebung:     Produktion Server:          http://0.0.0.0:8443 Datenbank:        mongodb://&lt; cosmosdb_name&gt;:&lt; primary_master_key&gt;@&lt; cosmosdb_name&gt;.documents.azure.com:10250/mean?ssl=true&sslverifycertificate=false App-Version:     0.5.0 MEAN.JS-Version: 0.5.0
</pre>
