...
Um die Domänenverifizierungs-ID für Ihre App abzurufen, befolgen Sie die Schritte unter [Abrufen der Verifizierungs-ID für eine Domäne](app-service-web-tutorial-custom-domain.md#3-get-a-domain-verification-id).
...
| - | - | - |
| \@ (Stamm) | _asuid_ | [Domänenverifizierungs-ID für Ihre App](app-service-web-tutorial-custom-domain.md#3-get-a-domain-verification-id) |
| www (Unterdomäne) | _asuid.www_ | [Domänenverifizierungs-ID für Ihre App](app-service-web-tutorial-custom-domain.md#3-get-a-domain-verification-id) |
| \* (Platzhalter) | _asuid_ | [Domänenverifizierungs-ID für Ihre App](app-service-web-tutorial-custom-domain.md#3-get-a-domain-verification-id) |
