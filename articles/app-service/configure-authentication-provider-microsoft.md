...
> [!IMPORTANT]
> Der Microsoft-Konto Anbieter wird zwar weiterhin unterstützt, es wird jedoch empfohlen, stattdessen den [Microsoft Identity Platform Provider (Azure AD)](./configure-authentication-provider-aad.md)zu verwenden. Die Microsoft Identity Platform bietet Unterstützung sowohl für Organisationskonten als auch für persönliche Microsoft-Konten.
