...
Erstellen Sie in Cloud Shell mit dem Befehl [`az mysql server create`](/cli/azure/mysql/server#az-mysql-server-create) einen Server in Azure Database for MySQL.
