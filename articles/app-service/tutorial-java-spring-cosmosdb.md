...
[Spring Boot](https://spring.io/projects/spring-boot), [Spring-Daten für Cosmos DB](/azure/developer/java/spring-framework/configure-spring-boot-starter-java-app-with-cosmos-db), [Azure Cosmos DB](../cosmos-db/introduction.md) und [App Service Linux](overview.md).
