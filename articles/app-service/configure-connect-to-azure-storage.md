...
Achten Sie darauf, dass die `mount-path-directory` in der Form `/path/to/dir` oder `\path\to\dir` ohne Laufwerksbezeichnung sein sollte, da sie immer auf dem Laufwerk `C:\` montiert wird.
