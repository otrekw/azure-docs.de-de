---
title: '(VERALTET) Tutorial für Azure Container Service: Überwachen von Kubernetes'
...
ms.locfileid: "78273323"
---
# <a name="deprecated-monitor-a-kubernetes-cluster-with-log-analytics"></a>(VERALTET) Überwachen eines Kubernetes-Clusters mit Log Analytics

> [!TIP]
> Die aktualisierte Version dieses Tutorials zu Azure Kubernetes Service finden Sie unter [Azure Monitor für Container (Vorschau) – Übersicht](../../azure-monitor/insights/container-insights-overview.md).
...
![Containerdashboard im Azure-Portal](./media/container-service-tutorial-kubernetes-monitor/oms-containers-dashboard.png)
