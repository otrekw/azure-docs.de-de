---
title: 'Schnellstart: Interagieren mit einem IoT Plug & Play-Gerät, das mit Ihrer Azure IoT-Lösung verbunden ist | Microsoft-Dokumentation'
description: In dieser Schnellstartanleitung erfahren Sie, wie Sie C#, JavaScript, Java oder Python verwenden, um eine Verbindung mit einem IoT Plug & Play-Gerät herzustellen, das mit Ihrer Azure IoT-Lösung verbunden ist, und mit diesem Gerät interagieren.
author: ericmitt
ms.author: ericmitt
ms.date: 09/21/2020
ms.topic: quickstart
...
ms.locfileid: "99831898"
---
# <a name="quickstart-interact-with-an-iot-plug-and-play-device-thats-connected-to-your-solution"></a>Schnellstart: Interagieren mit einem IoT Plug & Play-Gerät, das mit Ihrer Lösung verbunden ist
