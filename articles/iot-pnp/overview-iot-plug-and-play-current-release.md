...
- C-Geräte-SDK [VcPkg 19.07.2020](https://github.com/microsoft/vcpkg/tree/master/ports/azure-iot-sdk-c)
- .NET-Geräte-SDK [NuGet Microsoft.Azure.Devices.Client 1.30.0](https://www.nuget.org/packages/Microsoft.Azure.Devices.Client/)
- Java-Geräte-SDK [Maven iot-device-client 1.25.0](https://search.maven.org/artifact/com.microsoft.azure.sdk.iot/iot-device-client)
- Python-Geräte-SDK [Pip azure-iot-device v2.2.0](https://pypi.org/project/azure-iot-device/)
- Node.js-Geräte-SDK [npm azure-iot-device 1.17.1](https://www.npmjs.com/package/azure-iot-device)
- .NET – IoT Hub-Dienst [NuGet Microsoft.Azure.Devices 1.22.0](https://www.nuget.org/packages/Microsoft.Azure.Devices/)
- Java – IoT Hub-Dienst [Maven iot-service-client 1.25.0](https://search.maven.org/artifact/com.microsoft.azure.sdk.iot/iot-service-client)
- Node.js – IoT Hub-Dienst [npm azure-iothub 1.12.5](https://www.npmjs.com/package/azure-iothub)
- Python – IoT Hub/Digital Twins-Dienst [Pip azure-iot-hub 2.2.2](https://pypi.org/project/azure-iot-hub/)
- DTDL-Modellparser [NuGet](https://www.nuget.org/packages/Microsoft.Azure.DigitalTwins.Parser).

### <a name="preview"></a>Vorschau

- Azure SDK für Embedded [1.0.0-Preview.5](https://github.com/Azure/azure-sdk-for-c/releases/tag/1.0.0-preview.5)
