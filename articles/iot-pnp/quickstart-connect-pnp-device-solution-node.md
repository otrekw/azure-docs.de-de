---
title: 'Interagieren mit einem IoT Plug & Play Preview-Gerät, das mit Ihrer Lösung verbunden ist: Node.js | Microsoft-Dokumentation'
...
1. Dieses Terminalfenster wird jetzt als _Geräteterminal_ verwendet. Wechseln Sie zum Ordner Ihres geklonten Repositorys, und navigieren Sie zum Ordner **/azure-iot-samples-node/digital-twins/Quickstarts/Device**. Installieren Sie alle Abhängigkeiten, indem Sie den folgenden Befehl ausführen:
