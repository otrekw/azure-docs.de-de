---
title: 'Tutorial: Verbinden von IoT Plug & Play-Node.js-Beispielgerätecode für Komponenten mit Azure IoT Hub | Microsoft-Dokumentation'
description: 'Tutorial: Erstellen und Ausführen von IoT Plug & Play-Node.js-Beispielgerätecode, der mehrere Komponenten verwendet und eine Verbindung mit einem IoT-Hub herstellt Verwenden Sie das Tool Azure IoT-Explorer, um die vom Gerät an den Hub gesendeten Informationen anzuzeigen.'
author: olivakar
ms.author: olkar
ms.date: 07/10/2020
ms.topic: tutorial
