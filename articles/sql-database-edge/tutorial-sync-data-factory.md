...
* Verwenden Sie [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms/) oder [Azure Data Studio](/sql/azure-data-studio/download/) zum Herstellen einer Verbindung mit SQL Database Edge. Führen Sie ein SQL-Skript zum Erstellen der Datenbank und der Tabelle aus.
