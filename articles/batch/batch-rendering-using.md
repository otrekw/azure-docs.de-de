...
* Befehlszeilentools:
  * Die [Azure-Befehlszeile](/cli/azure/) oder [PowerShell](/powershell/azure/overview) können verwendet werden, um Skripts für die Batch-Nutzung zu erstellen.
