...
![Screenshot der Seite „Kostenlose Dienste“](./media/billing-create-free-services-included-free-account/billing-freeservices-grid.png)
...
- Erhalten Sie weitere Informationen zum [Überprüfen der Nutzung kostenloser Dienste, die in Ihrem kostenlosen Azure-Konto enthalten sind](billing-check-free-service-usage.md).
- Lesen Sie den Artikel [Vermeiden Sie, dass Ihnen für Ihr kostenloses Azure-Konto Gebühren angezeigt werden](billing-avoid-charges-free-account.md).
