...
Dieser Artikel bezieht sich auf ein Azure-Abrechnungskonto für eine Microsoft-Partnervereinbarung. [Überprüfen Sie, ob Sie Zugriff auf eine Microsoft-Partnervereinbarung haben.](#check-access-to-a-microsoft-partner-agreement)
...
## <a name="billing-details-by-product"></a>Abrechnungsdetails nach Produkt

Im Abschnitt **Abrechnungsdetails nach Produkt** werden die Gesamtkosten für die einzelnen Produkte aufgeführt, die diesem Abrechnungsprofil zugeordnet sind. In der CSV-Datei zu Azure-Nutzung und -Gebühren finden Sie eine tägliche Aufschlüsselung der Gebühren für die einzelnen Produkte. Weitere Informationen zum Abstimmen der Rechnung mit der CSV-Datei zu Azure-Nutzung und -Gebühren finden Sie unter [Grundlegendes zur Rechnung für Ihre Microsoft-Partnervereinbarung](billing-mpa-understand-your-bill.md).

## <a name="how-to-pay"></a>Zahlung

Anweisungen zur Bezahlung Ihrer Rechnung finden Sie unten auf der Rechnung. Sie können innerhalb von 60 Tagen nach dem Rechnungsdatum per Scheck oder per Überweisung bezahlen.
