...
Hier werden die verschiedenen Möglichkeiten zur Erstellung eines Containers für die Azure Cosmos DB-Tabellen-API erläutert. Wenn Sie eine andere API verwenden, finden Sie weitere Informationen zum Erstellen des Containers in den Artikeln zur [API für MongoDB](../mongodb/how-to-create-container-mongodb.md), [Cassandra-API](../cassandra/how-to-create-container-cassandra.md), [Gremlin-API](../how-to-create-container-gremlin.md) und [SQL-API](../how-to-create-container.md).
