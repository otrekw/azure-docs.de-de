...
* Ein binäres [Maven](https://maven.apache.org/download.cgi)-Archiv ([Download](https://maven.apache.org/install.html)/[Installationsanleitung](https://maven.apache.org/))  
