...
ms.locfileid: "87082884"
---
# <a name="regional-presence-with-azure-cosmos-db"></a>Regionale Präsenz von Azure Cosmos DB

Azure Cosmos DB ist ein grundlegender Dienst in Azure und standardmäßig in [allen Regionen verfügbar, in denen auch Azure verfügbar ist](https://azure.microsoft.com/global-infrastructure/services/?products=cosmos-db&regions=all).

:::image type="content" source="./media/regional-presence/regional-presence.png" alt-text="Regionen, in denen Azure Cosmos DB verfügbar ist" lightbox="./media/regional-presence/regional-presence.png" border="false":::
...
Die globale Replikationsunterstützung ist auf eine Azure-Cloudumgebung beschränkt. Ein Beispiel: Azure Cosmos DB-Konten in der *öffentlichen Azure-Cloud* können in jede Azure-Region innerhalb der *öffentlichen Azure-Cloud* repliziert werden. Eine Replikation in Azure-Regionen innerhalb von *Azure China 21Vianet* ist dagegen nicht möglich.
