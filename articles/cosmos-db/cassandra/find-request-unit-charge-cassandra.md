...
Weitere Informationen finden Sie unter [Quickstart: Erstellen einer Cassandra-App mithilfe des .NET-SDK und Azure Cosmos DB](manage-data-dotnet.md).
...
Weitere Informationen finden Sie unter [Quickstart: Erstellen einer Cassandra-App mithilfe des Java SDK und Azure Cosmos DB](manage-data-java.md).
