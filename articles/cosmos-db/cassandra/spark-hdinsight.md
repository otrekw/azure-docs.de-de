...
* [Die Azure Cosmos DB-Cassandra-API muss bereitgestellt sein.](manage-data-dotnet.md#create-a-database-account)
...
* [Vollständige Liste der Codebeispiele für die Arbeit mit der Cassandra-API](connect-spark-configuration.md)
