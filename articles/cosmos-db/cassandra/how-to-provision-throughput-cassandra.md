...
Wenn Sie eine andere API verwenden, finden Sie weitere Informationen zum Bereitstellen des Durchsatzes in den Artikeln zur [SQL-API](../how-to-provision-container-throughput.md), [API für MongoDB](../mongodb/how-to-provision-throughput-mongodb.md) und [Gremlin-API](../how-to-provision-throughput-gremlin.md).
