...
| [Get-AzCosmosDBTable](/powershell/module/az.cosmosdb/get-azcosmosdbtable) | Listet Tabellen-API-Tabellen in einem Konto auf oder ruft eine bestimmte Tabellen-API-Tabelle in einem Konto ab. |
