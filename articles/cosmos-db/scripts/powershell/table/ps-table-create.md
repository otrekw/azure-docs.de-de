...
| [Set-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/set-azcosmosdbtable) | Erstellt oder aktualisiert eine Tabellen-API-Tabelle. |
