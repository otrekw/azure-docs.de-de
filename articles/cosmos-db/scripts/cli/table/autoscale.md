---
title: Erstellen einer Tabellen-API-Tabelle mit Autoskalierung für Azure Cosmos DB
description: Erstellen einer Tabellen-API-Tabelle mit Autoskalierung für Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "93089473"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-with-autoscale-using-azure-cli"></a>Erstellen eines Azure Cosmos-Tabellen-API-Kontos sowie einer Tabelle mit Autoskalierung mithilfe der Azure CLI
