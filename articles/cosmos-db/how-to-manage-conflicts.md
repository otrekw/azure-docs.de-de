...
# <a name="java-async-sdk"></a>[Asynchrones Java SDK](#tab/async)
...
# <a name="java-sync-sdk"></a>[Synchrones Java SDK](#tab/sync)
...
```
# <a name="java-async-sdk"></a>[Asynchrones Java SDK](#tab/sync)
