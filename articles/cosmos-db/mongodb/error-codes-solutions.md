...
>[!Note]
> Azure Cosmos DB hostet nicht die MongoDB-Engine. Der Dienst bietet eine Implementierung der [Wire Protocol-Versionen 4.0](feature-support-40.md) und [3.6](feature-support-36.md) von MongoDB sowie Legacy-Unterstützung für die [Wire Protocol-Version 3.2](feature-support-32.md). Daher finden sich einige dieser Fehler nur in der Azure Cosmos DB-API für MongoDB.
