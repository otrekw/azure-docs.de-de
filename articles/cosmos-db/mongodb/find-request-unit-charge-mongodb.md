...
1. Um Anforderungsgebühren für Datenmanipulationsbefehle zu erhalten, führen Sie den `getLastRequestStatistics`Befehl von einer Shell-basierten UI, wie Mongo Shell,[Robo 3T](connect-using-robomongo.md),[MongoDB Compass](connect-using-compass.md), oder einer VS Code-Erweiterung mit Shell-Skripting aus.
