...
## <a name="export-the-tlsssl-certificate"></a>Exportieren des TLS-/SSL-Zertifikats
...
Beim Herstellen einer Verbindung mit dem Emulator in Python- und Node.js-SDKs ist die TLS-Überprüfung deaktiviert.
