...
Darüber hinaus können partitionsübergreifende `GROUP BY`-Abfragen maximal 21 [Aggregatsystemfunktionen](sql-query-aggregate-functions.md) umfassen. 
