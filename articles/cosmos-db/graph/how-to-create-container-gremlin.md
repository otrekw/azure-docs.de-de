...
In diesem Artikel werden die verschiedenen Möglichkeiten zur Erstellung eines Containers in der Azure Cosmos DB-Gremlin-API erläutert. Wenn Sie eine andere API verwenden, finden Sie weitere Informationen zum Erstellen des Containers unter [Erstellen eines Containers in der Azure Cosmos DB-API für MongoDB](../mongodb/how-to-create-container-mongodb.md), [Erstellen eines Containers in der Azure Cosmos DB-Cassandra-API](../cassandra/how-to-create-container-cassandra.md), [Erstellen eines Containers in der Azure Cosmos DB-Tabellen-API](../table/how-to-create-container.md) und [Erstellen eines Azure Cosmos-Containers](../how-to-create-container.md).
