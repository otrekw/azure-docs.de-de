...
10. Fügen Sie in der Projektdatei **AppDelegate.h** die folgende `import`-Anweisung hinzu:
...
2. Fügen Sie in  **ViewController.h** außerdem die folgende Eigenschaftendeklaration nach der `@interface`-Deklaration hinzu:
