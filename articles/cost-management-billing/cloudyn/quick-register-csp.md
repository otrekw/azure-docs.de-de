...
description: Hier wird der Registrierungsvorgang ausführlich erläutert, der zum Erstellen eines Cloudyn-Testabonnements und zum Anmelden beim Cloudyn-Portal erforderlich ist.
author: bandersmsft
ms.author: banders
ms.date: 03/12/2020
ms.topic: quickstart
...
> Weitere Informationen finden Sie unter [Herstellen einer Verbindung mit der Partner Center-API](/partner-center/develop/set-up-api-access-in-partner-center).
>
...
>
>Cloudyn ist mit dem sicheren Anwendungsmodell von Microsoft kompatibel. Weitere Informationen finden Sie unter [Aktivieren des Frameworks für das sichere Anwendungsmodell](/partner-center/develop/enable-secure-app-model).
