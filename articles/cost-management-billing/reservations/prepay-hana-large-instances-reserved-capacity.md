...
Sie können reservierte Kapazität im Azure-Portal oder mithilfe der [REST-API](https://docs.microsoft.com/rest/api/reserved-vm-instances/reservationorder/purchase) erwerben.
