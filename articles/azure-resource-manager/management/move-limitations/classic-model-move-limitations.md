...
Um klassische Ressourcen in eine neue Ressourcengruppe innerhalb des gleichen Abonnements zu verschieben, verwenden Sie die [standardmäßigen Verschiebevorgänge](../move-resource-group-and-subscription.md) im Portal, in Azure PowerShell, in der Azure-Befehlszeilenschnittstelle (CLI) oder in der REST-API. Sie verwenden hierbei die gleichen Vorgänge wie beim Verschieben von Resource Manager-Ressourcen.
