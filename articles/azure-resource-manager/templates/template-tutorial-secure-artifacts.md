...
1. Ersetzen Sie die Parameterdefinition „storageAccountKey“ durch die folgende Parameterdefinition: 
    ...
    ![Resource Manager-Tutorial: Schützen von Artefaktparametern](./media/template-tutorial-secure-artifacts/resource-manager-tutorial-secure-artifacts-parameters.png)

1. Aktualisieren Sie den Wert der folgenden drei Elemente der SQL-Erweiterungsressource:
...
Informationen zum Bereitstellungsverfahren finden Sie im Abschnitt [Bereitstellen der Vorlage](./template-tutorial-create-multiple-instances.md#deploy-the-template). Verwenden Sie stattdessen das folgende PowerShell-Bereitstellungsskript:
