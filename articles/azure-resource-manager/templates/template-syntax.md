...
Für Inlinekommentare können Sie entweder `//` oder `/* ... */` verwenden.
...
> [!NOTE]
>
> Verwenden Sie zum Bereitstellen von Vorlagen mit mehrzeiligen Zeichenfolgen Azure PowerShell oder Azure CLI. Verwenden Sie für die CLI die Version 2.3.0 oder höher, und geben Sie die Option `--handle-extended-json-format` an.
>
> Mehrzeilige Zeichenfolgen werden nicht unterstützt, wenn Sie die Vorlage über das Azure-Portal, eine DevOps-Pipeline oder die REST-API bereitstellen.
