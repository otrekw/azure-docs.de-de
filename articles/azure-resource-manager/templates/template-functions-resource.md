...
> [!NOTE]
> „Loops“ (Schleifen) und „copyIndex()“ sind noch nicht implementiert.  Siehe unter [Loops](https://github.com/Azure/bicep/blob/main/docs/spec/loops.md) (Schleifen).
