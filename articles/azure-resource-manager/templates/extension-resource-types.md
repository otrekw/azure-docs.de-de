...
- Verwenden Sie [extensionResourceId](template-functions-resource.md#extensionresourceid), um die Ressourcen-ID für eine Erweiterungsressource in einer Azure Resource Manager-Vorlage abzurufen.
