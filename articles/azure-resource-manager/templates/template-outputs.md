...
Fügen Sie in Bicep einen `for`-Ausdruck hinzu, der die Bedingungen für die dynamische Ausgabe definiert. Im folgenden Beispiel wird ein Bereich von ganzen Zahlen durchlaufen. Sie können auch ein Array durchlaufen.
