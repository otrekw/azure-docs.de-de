...
ms.locfileid: "83652436"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-custom-resource-providers"></a>Integrierte Azure Policy-Richtliniendefinitionen für benutzerdefinierte Azure-Ressourcenanbieter

Diese Seite enthält einen Index der integrierten [Azure Policy](../../governance/policy/overview.md)-Richtliniendefinitionen für benutzerdefinierte Azure-Ressourcenanbieter. Weitere Azure Policy-Integrationen für andere Dienste finden Sie unter [Integrierte Azure Policy-Richtliniendefinitionen](../../governance/policy/samples/built-in-policies.md).
...
## <a name="azure-custom-resource-providers"></a>Benutzerdefinierte Azure-Ressourcenanbieter
