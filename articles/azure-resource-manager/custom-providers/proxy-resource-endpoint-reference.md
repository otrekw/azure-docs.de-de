...
ms.locfileid: "75649198"
---
# <a name="custom-resource-proxy-reference"></a>Referenz zu benutzerdefinierten Ressourcenproxys

In diesem Artikel werden die Anforderungen an Endgeräte zur Implementierung benutzerdefinierter Proxyressourcen erläutert. Wenn Sie mit benutzerdefinierten Azure-Ressourcenanbietern nicht vertraut sind, siehe die [Übersicht über benutzerdefinierte Ressourcenanbieter](overview.md).
