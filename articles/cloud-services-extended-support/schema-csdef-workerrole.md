---
title: 'Azure Cloud Services (erweiterter Support): Definition WorkerRole-Schema | Microsoft-Dokumentation'
description: Informationen zum Workerrollenschema für Cloud Services (erweiterter Support)
ms.topic: article
...
ms.locfileid: "98743991"
---
# <a name="azure-cloud-services-extended-support-definition-workerrole-schema"></a>Azure Cloud Services (erweiterter Support) – WorkerRole-Definitionsschema
...
|vmsize|Zeichenfolge|Optional. Legen Sie diesen Wert fest, um die Größe des virtuellen Computers zu ändern, der dieser Rolle zugeordnet ist. Standardwert: `Small`. Eine Liste mit den möglichen VM-Größen und den dazugehörigen Attributen finden Sie unter [Größen für Clouddienste](available-sizes.md).|
