...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Erstellen einer neuen Cloud Services-Instanz mit einer einzelnen Rolle und einem Zertifikat aus dem Schlüsseltresor
