...
* [Grundlegendes zu Sicherheitskontrollen für Azure ExpressRoute](https://docs.microsoft.com/azure/expressroute/expressroute-security-controls)
...
* [Aktivieren des Auditings in Azure Sentinel](https://docs.microsoft.com/azure/sentinel/resources)
...
* [Grundlegendes zu Überwachung und Warnungen in ExpressRoute](https://docs.microsoft.com/azure/expressroute/expressroute-monitoring-metrics-alerts)
...
* [Einsatz von RBAC in der Resource Manager-API für ExpressRoute-Partner](https://docs.microsoft.com/azure/expressroute/cross-connections-api-developmentment)
...
**Leitfaden**: Nicht zutreffend, da die Kunden-Lockbox für Azure ExpressRoute nicht unterstützt wird.
...
* [Konfigurieren von Site-to-Site-IPSec über ExpressRoute](https://docs.microsoft.com/azure/expressroute/site-to-site-vpn-over-microsoft-peering)
...
* [Grundlegendes zur Point-to-Point-Verschlüsselung in Azure ExpressRoute](https://docs.microsoft.com/azure/expressroute/expressroute-about-encryption)

* [Konfigurieren von MACsec für ExpressRoute Direct-Ports](https://docs.microsoft.com/azure/expressroute/expressroute-howto-macsec)

* [Azure-Sicherheitsbaseline für Key Vault](https://docs.microsoft.com/azure/key-vault/general/security-baseline)
...
* [Erstellen einer Key Vault-Instanz zum Speichern von MACsec-Geheimnissen in einer neuen Ressourcengruppe](https://docs.microsoft.com/azure/expressroute/expressroute-howto-macsec)
...
* [Testen der Konnektivität von Azure ExpressRoute-Verbindungen nach der MACsec-Konfiguration](https://docs.microsoft.com/azure/expressroute/expressroute-howto-macsec)
