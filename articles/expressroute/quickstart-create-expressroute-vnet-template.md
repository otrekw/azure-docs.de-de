---
title: Erstellen einer ExpressRoute-Leitung mithilfe einer ARM-Vorlage (Azure Resource Manager)
description: Hier erfahren Sie, wie Sie eine ExpressRoute-Leitung mithilfe einer ARM-Vorlage (Azure Resource Manager) erstellen.
