---
title: Arbeiten mit der verwalteten Clientbibliothek
...
### <a name="how-to-work-with-debug-symbols-in-visual-studio"></a><a name="symbolsource"></a>Vorgehensweise: Arbeiten mit Debugsymbolen in Visual Studio
...
## <a name="create-the-mobile-apps-client"></a><a name="create-client"></a>Erstellen des Mobile Apps-Clients
...
Der folgende Abschnitt enthält Informationen zum Suchen und Abrufen von Datensätzen sowie Ändern der Daten in der Tabelle.  Die folgenden Themen werden erörtert:
...
### <a name="how-to-create-a-table-reference"></a><a name="instantiating"></a>Vorgehensweise: Erstellen eines Tabellenverweises
...
### <a name="how-to-query-data-from-your-mobile-app"></a><a name="querying"></a>Vorgehensweise: Abfragen von Daten aus Ihrer mobilen App
...
### <a name="how-to-filter-returned-data"></a><a name="filtering"></a>Vorgehensweise: Filtern zurückgegebener Daten
...
### <a name="how-to-sort-returned-data"></a><a name="sorting"></a>Vorgehensweise: Sortieren zurückgegebener Daten
...
### <a name="how-to-return-data-in-pages"></a><a name="paging"></a>Vorgehensweise: Seitenweises Zurückgeben von Daten
...
### <a name="how-to-select-specific-columns"></a><a name="selecting"></a>Vorgehensweise: Auswählen bestimmter Spalten
Sie können angeben, welche Eigenschaften im Ergebnis enthalten sein sollen, indem Sie eine [Auswählen] -Klausel zu Ihrer Abfrage hinzufügen. Der folgende Code zeigt, wie Sie nur ein Feld auswählen oder auch mehrere Felder auswählen und formatieren können:
...
### <a name="how-to-look-up-data-by-id"></a><a name="lookingup"></a>Vorgehensweise: Abrufen von Daten nach ID
...
### <a name="how-to-execute-untyped-queries"></a><a name="untypedqueries"></a>Vorgehensweise: Ausführen nicht typisierter Abfragen
...
### <a name="how-to-insert-data-into-a-mobile-app-backend"></a><a name="inserting"></a>Vorgehensweise: Einfügen von Daten in ein Mobile App-Back-End
...
### <a name="how-to-modify-data-in-a-mobile-app-backend"></a><a name="modifying"></a>Vorgehensweise: Ändern von Daten in einem Mobile App-Back-End
...
### <a name="how-to-delete-data-in-a-mobile-app-backend"></a><a name="deleting"></a>Vorgehensweise: Löschen von Daten in einem Mobile App-Back-End
...
### <a name="how-to-use-optimistic-concurrency-for-conflict-resolution"></a><a name="optimisticconcurrency"></a>Vorgehensweise: Verwenden der optimistischen Parallelität zur Lösung von Konflikten
...
### <a name="how-to-bind-mobile-apps-data-to-a-windows-user-interface"></a><a name="binding"></a>Vorgehensweise: Binden von Mobile Apps-Daten an eine Windows-Benutzeroberfläche
...
### <a name="change-the-page-size"></a><a name="pagesize"></a>Ändern der Seitengröße
...
## <a name="work-with-offline-tables"></a><a name="#offlinesync"></a>Mit Offlinetabellen arbeiten
...
### <a name="syncing-an-offline-table"></a><a name="syncoffline"></a>Synchronisieren einer Offlinetabelle
...
## <a name="work-with-a-custom-api"></a><a name="#customapi"></a>Arbeiten mit einer benutzerdefinierten API
...
## <a name="authenticate-users"></a><a name="authentication"></a>Authentifizieren von Benutzern
...
### <a name="client-managed-authentication"></a><a name="clientflow"></a>Vom Client verwaltete Authentifizierung
...
#### <a name="authenticate-users-with-the-active-directory-authentication-library"></a><a name="adal"></a>Authentifizieren von Benutzern mit der Active Directory Authentication Library
...
#### <a name="single-sign-on-using-a-token-from-facebook-or-google"></a><a name="client-facebook"></a>Einmaliges Anmelden mit einem Token von Facebook oder Google
...
### <a name="server-managed-authentication"></a><a name="serverflow"></a>Vom Server verwaltete Authentifizierung
...
### <a name="caching-the-authentication-token"></a><a name="caching"></a>Zwischenspeichern von Authentifizierungstoken
...
## <a name="push-notifications"></a><a name="pushnotifications"></a>Pushbenachrichtigungen
...
### <a name="how-to-register-for-push-notifications"></a><a name="register-for-push"></a>Vorgehensweise: Registrieren für Pushbenachrichtigungen
...
### <a name="how-to-obtain-a-microsoft-store-package-sid"></a><a name="package-sid"></a>Vorgehensweise: Abrufen einer Microsoft Store-Paket-SID
...
### <a name="how-to-register-push-templates-to-send-cross-platform-notifications"></a><a name="register-xplat"></a>Vorgehensweise: Registrieren von Pushvorlagen zum Senden plattformübergreifender Benachrichtigungen
...
## <a name="miscellaneous-topics"></a><a name="misc"></a>Verschiedene Themen
...
### <a name="how-to-customize-request-headers"></a><a name="headers"></a>Vorgehensweise: Anpassen von Anforderungsheadern
...
[Auswählen]: https://msdn.microsoft.com/library/azure/dn250569(v=azure.10).aspx
