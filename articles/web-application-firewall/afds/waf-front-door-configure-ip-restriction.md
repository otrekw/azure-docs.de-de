---
title: Konfigurieren einer IP-Einschränkungs-WAF-Regel für Azure Front Door Service
...
Gehen Sie zum Erstellen eines Azure Front Door Service-Profils gemäß den Anweisungen unter [Schnellstart: Erstellen Sie eine „Front Door“ für eine hoch verfügbare globale Webanwendung](../../frontdoor/quickstart-create-front-door.md).
...
Erstellen Sie zunächst eine IP-Zulassungsregel für die Richtlinie, die Sie im vorherigen Schritt erstellt haben. Beachten Sie, dass **--defer** erforderlich ist, da eine Regel eine Übereinstimmungsbedingung aufweisen muss, die im nächsten Schritt hinzugefügt wird.
...
- Erfahren Sie, wie Sie [ein Azure Front Door Service-Profil erstellen](../../frontdoor/quickstart-create-front-door.md).
