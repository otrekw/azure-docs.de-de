...
Erstellen Sie mit [az network route-table create](/cli/azure/network/route-table#az_network_route_table_create) eine Routingtabelle. Im folgenden Beispiel wird eine Routingtabelle mit dem Namen *myRouteTablePublic* erstellt. 
