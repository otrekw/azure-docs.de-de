...
Verwenden Sie [az network public-ip show](/cli/azure/network/public-ip#az_network_public_ip_show), um die öffentliche IP-Adresse **myVM2** abzurufen.
