...
Unterstützung für Routingpräferenzen für das Speicherkonto ist in den folgenden Azure-Regionen verfügbar: Frankreich (Süden), USA (Norden-Mitte) und USA (Westen-Mitte).
