...
> | Aktion | Microsoft.ApiManagement/service/portalsettings/listSecrets/action | Ruft den Validierungsschlüssel von Portaldelegierungseinstellungen ab. |
> | Aktion | Microsoft.ApiManagement/service/portalsettings/read | Listet eine Sammlung von Portaleinstellungen auf. Oder ruft die Registrierungs-, Anmelde- oder Delegierungseinstellungen für das Portal ab. |
...
> | Aktion | Microsoft.ApiManagement/service/write | Erstellen oder Aktualisieren einer API Management-Dienstinstanz |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.AppConfiguration/checkNameAvailability/read | Überprüft, ob der Ressourcenname zur Verwendung verfügbar ist. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/delete | Löscht einen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/eventGridFilters/delete | Löscht einen Konfigurationsspeicher-Ereignisrasterfilter. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/eventGridFilters/read | Ruft die Eigenschaften des angegebenen Konfigurationsspeicher-Ereignisrasterfilters ab oder listet alle Konfigurationsspeicher-Ereignisrasterfilter unter dem angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/eventGridFilters/write | Erstellt oder aktualisiert einen Konfigurationsspeicher-Ereignisrasterfilter mit den angegebenen Parametern. |
> | DataAction | Microsoft.AppConfiguration/configurationStores/keyValues/delete | Löscht einen vorhandenen Schlüsselwert aus dem Konfigurationsspeicher. |
> | DataAction | Microsoft.AppConfiguration/configurationStores/keyValues/read | Liest einen Schlüsselwert aus dem Konfigurationsspeicher. |
> | DataAction | Microsoft.AppConfiguration/configurationStores/keyValues/write | Erstellt oder aktualisiert einen Schlüsselwert im Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/ListKeys/action | Listet die API-Schlüssel für den angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/ListKeyValue/action | Listet einen Schlüsselwert für den angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnectionProxies/delete | Löscht einen privaten Endpunktverbindungsproxy unter dem angegebenen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnectionProxies/read | Ruft einen privaten Endpunktverbindungsproxy unter dem angegebenen Konfigurationsspeicher ab. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnectionProxies/validate/action | Überprüft einen privaten Endpunktverbindungsproxy unter dem angegebenen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnectionProxies/write | Erstellt oder aktualisiert einen privaten Endpunktverbindungsproxy unter dem angegebenen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnections/delete | Löscht eine Verbindung mit einem privaten Endpunkt unter dem angegebenen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnections/read | Ruft eine Verbindung mit einem privaten Endpunkt ab oder listet Verbindungen mit privaten Endpunkten unter dem angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateEndpointConnections/write | Genehmigt eine Verbindung mit einem privaten Endpunkt unter dem angegebenen Konfigurationsspeicher oder lehnt diese ab. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/PrivateEndpointConnectionsApproval/action | Führt eine automatische Genehmigung einer Verbindung mit einem privaten Endpunkt unter dem angegebenen Konfigurationsspeicher aus. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/privateLinkResources/read | Listet alle Private Link-Ressourcen im angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/providers/Microsoft.Insights/diagnosticSettings/read | Liest alle Werte der Diagnoseeinstellungen für einen Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/providers/Microsoft.Insights/diagnosticSettings/write | Schreibt/überschreibt Diagnoseeinstellungen für Microsoft App Configuration. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/providers/Microsoft.Insights/metricDefinitions/read | Ruft alle Metrikdefinitionen für Microsoft App Configuration ab. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/read | Ruft die Eigenschaften des angegebenen Konfigurationsspeichers ab oder listet alle Konfigurationsspeicher unter der angegebenen Ressourcengruppe bzw. dem angegebenen Abonnement auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/RegenerateKey/action | Generiert die API-Schlüssel für den angegebenen Konfigurationsspeicher neu. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/syncTasks/delete | Löscht eine Synchronisierungsaufgabe für den Konfigurationsspeicher. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/syncTasks/read | Ruft die Eigenschaften der angegebenen Synchronisierungsaufgabe für den Konfigurationsspeicher ab oder listet alle Synchronisierungsaufgaben für den Konfigurationsspeicher unter dem angegebenen Konfigurationsspeicher auf. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/syncTasks/write | Erstellt oder aktualisiert eine Synchronisierungsaufgabe für den Konfigurationsspeicher mit den angegebenen Parametern. |
> | Aktion | Microsoft.AppConfiguration/configurationStores/write | Erstellt oder aktualisiert einen Konfigurationsspeicher mit den angegebenen Parametern. |
> | Aktion | Microsoft.AppConfiguration/locations/operationsStatus/read | Ruft den Status eines Vorgangs ab. |
> | Aktion | Microsoft.AppConfiguration/operations/read | Listet alle von Microsoft App Configuration unterstützten Vorgänge auf. |
> | Aktion | Microsoft.AppConfiguration/register/action | Registriert ein Abonnement für die Verwendung von Microsoft App Configuration. |
...
> | Aktion | Microsoft.Billing/validateAddress/action |  |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.BingMaps/listCommunicationPreference/action | Ruft die Kommunikationseinstellungen für den Besitzer von Microsoft.BingMaps ab |
> | Aktion | Microsoft.BingMaps/mapApis/Delete | Löscht die Ressource für Microsoft.BingMaps/mapApis |
> | Aktion | Microsoft.BingMaps/mapApis/listSecrets/action | Listet die Geheimnisse für Microsoft.BingMaps/mapApis auf |
> | Aktion | Microsoft.BingMaps/mapApis/listUsageMetrics/action | Listet die Metriken für Microsoft.BingMaps/mapApis auf |
> | Aktion | Microsoft.BingMaps/mapApis/Read | Ruft die Ressource für Microsoft.BingMaps/mapApis ab |
> | Aktion | Microsoft.BingMaps/mapApis/regenerateKey/action | Generiert die Schlüssel für Microsoft.BingMaps/mapApis erneut |
> | Aktion | Microsoft.BingMaps/mapApis/Write | Aktualisiert die Ressource für Microsoft.BingMaps/mapApis |
> | Aktion | Microsoft.BingMaps/Operations/read | Listet die Vorgänge für Microsoft.BingMaps auf |
> | Aktion | Microsoft.BingMaps/updateCommunicationPreference/action | Aktualisiert die Kommunikationseinstellungen für den Besitzer von Microsoft.BingMaps |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.BotService/botServices/channels/delete | Löscht einen Botdienstkanal |
> | Aktion | Microsoft.BotService/botServices/channels/listchannelwithkeys/action | Listet die Botdienstkanäle mit Geheimnissen auf |
> | Aktion | Microsoft.BotService/botServices/channels/read | Liest einen Botdienstkanal |
> | Aktion | Microsoft.BotService/botServices/channels/write | Schreibt einen Botdienstkanal |
> | Aktion | Microsoft.BotService/botServices/connections/delete | Löscht eine Botdienstverbindung |
> | Aktion | Microsoft.BotService/botServices/connections/listwithsecrets/write | Schreibt eine Botdienst-Verbindungsliste  |
> | Aktion | Microsoft.BotService/botServices/connections/read | Liest eine Botdienstverbindung |
> | Aktion | Microsoft.BotService/botServices/connections/write | Schreibt eine Botdienstverbindung |
...
> | Aktion | Microsoft.BotService/checknameavailability/action | Überprüft die Verfügbarkeit des Namens eines Bots |
> | Aktion | Microsoft.BotService/listauthserviceproviders/action | Listet die Authentifizierungsdienstanbieter auf |
...
> | Aktion | Microsoft.Capacity/reservationorders/mergeoperationresults/read | Rust einen Zusammenführungsvorgang ab. |
...
> | Aktion | Microsoft.Capacity/reservationorders/reservations/availablescopes/action | Sucht nach verfügbaren Bereichen. |
...
> | Aktion | Microsoft.Capacity/reservationorders/splitoperationresults/read | Rust einen Teilungsvorgang ab. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallmanagedrulesets/delete |  |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallmanagedrulesets/read |  |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallmanagedrulesets/write |  |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallpolicies/delete |  |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallpolicies/read |  |
> | Aktion | Microsoft.Cdn/cdnwebapplicationfirewallpolicies/write |  |
...
> | Aktion | Microsoft.Cdn/operationresults/cdnwebapplicationfirewallpolicyresults/delete |  |
> | Aktion | Microsoft.Cdn/operationresults/cdnwebapplicationfirewallpolicyresults/read |  |
> | Aktion | Microsoft.Cdn/operationresults/cdnwebapplicationfirewallpolicyresults/write |  |
...
> | Aktion | Microsoft.ClassicStorage/storageAccounts/blobServices/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/blobServices/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Hinzufügen oder Ändern der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/blobServices/providers/Microsoft.Insights/metricDefinitions/read | Ruft die Metrikdefinitionen ab. |
...
> | Aktion | Microsoft.ClassicStorage/storageAccounts/fileServices/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/fileServices/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Hinzufügen oder Ändern der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/fileServices/providers/Microsoft.Insights/metricDefinitions/read | Ruft die Metrikdefinitionen ab. |
...
> | Aktion | Microsoft.ClassicStorage/storageAccounts/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Hinzufügen oder Ändern der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/providers/Microsoft.Insights/metricDefinitions/read | Ruft die Metrikdefinitionen ab. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/queueServices/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/queueServices/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Hinzufügen oder Ändern der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/queueServices/providers/Microsoft.Insights/metricDefinitions/read | Ruft die Metrikdefinitionen ab. |
...
> | Aktion | Microsoft.ClassicStorage/storageAccounts/tableServices/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/tableServices/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Hinzufügen oder Ändern der Diagnoseeinstellungen. |
> | Aktion | Microsoft.ClassicStorage/storageAccounts/tableServices/providers/Microsoft.Insights/metricDefinitions/read | Ruft die Metrikdefinitionen ab. |
...
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/projects/images/suggested/count/action | Bei dieser API werden Tag-IDs verwendet, um die Anzahl der nicht markierten Bilder über vorgeschlagene Tags für einen bestimmten Schwellenwert abzurufen. |
...
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshot/apply/action | Wendet eine Momentaufnahme an und stellt eine benutzerdefinierte Objekt-ID bereit. |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshot/delete | Löscht eine Momentaufnahme. |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshot/read | Ruft den Status eines Momentaufnahmevorgangs ab. |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshot/take/action | Erstellt eine Momentaufnahme für ein Objekt. |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshot/write | Aktualisiert Eigenschaften einer Momentaufnahme. |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/snapshots/read | Listet alle Momentaufnahmen mit Informationen auf, auf die der Benutzer zugreifen kann.* |
...
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/alterations/read | Lädt Änderungen aus der Runtime herunter. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/alterations/write | Ersetzt Änderungsdaten. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/endpointkeys/read | Ruft Endpunktschlüssel für einen Endpunkt ab. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/endpointkeys/refreshkeys/action | Generiert einen Endpunktschlüssel neu. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/endpointsettings/read | Ruft Endpunkteinstellungen für einen Endpunkt ab. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/endpointsettings/write | Aktualisiert Endpunkteinstellungen für einen Endpunkt. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/create/write | Asynchroner Vorgang zum Erstellen einer neuen Wissensdatenbank. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/delete | Löscht die Wissensdatenbank und alle ihre Daten. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/download/read | Lädt die Wissensdatenbank herunter. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/generateanswer/action | GenerateAnswer-Befehl zum Abfragen der Wissensdatenbank. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/publish/action | Veröffentlicht alle Änderungen im Testindex einer Wissensdatenbank in ihren Produktionsindex. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/read | Ruft die Liste der Wissensdatenbanken oder Details einer bestimmten Wissensdatenbank ab. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/train/action | Trainingsaufruf zum Hinzuzufügen von Vorschläge zur Wissensdatenbank. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/knowledgebases/write | Asynchroner Vorgang zum Ändern einer Wissensdatenbank oder zum Ersetzen des Inhalts der Wissensdatenbank. |
> | DataAction | Microsoft.CognitiveServices/accounts/QnAMaker/operations/read | Ruft Details zu einem bestimmten zeitintensiven Vorgang ab. |
...
> | Aktion | Microsoft.CognitiveServices/locations/operationresults/read | Liest den Status eines asynchronen Vorgangs. |
...
> | Aktion | Microsoft.Commerce/register/action | Registriert das Abonnement für Microsoft Commerce UsageAggregate. |
> | Aktion | Microsoft.Commerce/unregister/action | Hebt die Registrierung des Abonnements für Microsoft Commerce UsageAggregate auf. |
...
> | Aktion | Microsoft.Compute/diskEncryptionSets/delete | Löschen eines Datenträgerverschlüsselungssatzes |
> | Aktion | Microsoft.Compute/diskEncryptionSets/read | Abrufen der Eigenschaften eines Datenträgerverschlüsselungssatzes |
> | Aktion | Microsoft.Compute/diskEncryptionSets/write | Erstellen einer neuen Datenträgerverschlüsselungssatzes oder Aktualisieren einer bereits vorhandenen |
...
> | Aktion | Microsoft.Compute/galleries/applications/delete | Löscht die Kataloganwendung. |
> | Aktion | Microsoft.Compute/galleries/applications/read | Ruft die Eigenschaften der Kataloganwendung ab. |
> | Aktion | Microsoft.Compute/galleries/applications/versions/delete | Löscht die Version der Kataloganwendung. |
> | Aktion | Microsoft.Compute/galleries/applications/versions/read | Ruft die Eigenschaften der Kataloganwendungsversion ab. |
> | Aktion | Microsoft.Compute/galleries/applications/versions/write | Erstellt eine neue Kataloganwendungsversion oder aktualisiert eine vorhandene Version. |
> | Aktion | Microsoft.Compute/galleries/applications/write | Erstellt eine neue Kataloganwendung oder aktualisiert eine vorhandene. |
...
> | Aktion | Microsoft.Compute/hostGroups/hosts/delete | Löscht den Host |
> | Aktion | Microsoft.Compute/hostGroups/hosts/read | Ruft die Eigenschaften eines Hosts ab |
> | Aktion | Microsoft.Compute/hostGroups/hosts/write | Erstellt einen neuen Host oder aktualisiert einen bereits vorhandenen Host |
...
> | Aktion | Microsoft.Compute/locations/vsmOperations/read | Ruft den Status eines asynchronen Vorgangs für eine VM-Skalierungsgruppe mit der Virtual Machine Runtime Service-Erweiterung ab. |
...
> | Aktion | Microsoft.Compute/virtualMachines/assessPatches/action | Bewertet den virtuellen Computer und ermittelt eine Liste verfügbarer Patches für das Betriebssystemupdate. |
> | Aktion | Microsoft.Compute/virtualMachines/cancelPatchInstallation/action | Bricht den laufenden Installationsvorgang für Betriebssystemupdate-Patches auf dem virtuellen Computer ab. |
...
> | Aktion | Microsoft.Compute/virtualMachineScaleSets/extensions/roles/read | Ruft die Eigenschaften einer Rolle in einer VM-Skalierungsgruppe mit der VM-Laufzeitdiensterweiterung ab |
> | Aktion | Microsoft.Compute/virtualMachineScaleSets/extensions/roles/write | Aktualisiert die Eigenschaften einer vorhandenen Rolle in einer VM-Skalierungsgruppe mit der VM-Laufzeitdiensterweiterung |
...
> | Aktion | Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades/action | Bricht das parallele Upgrade einer VM-Skalierungsgruppe ab. |
...
> | Aktion | Microsoft.Compute/virtualMachineScaleSets/vmSizes/read | Listet die Größen auf, die zum Erstellen oder Aktualisieren eines virtuellen Computers in der VM-Skalierungsgruppe zur Verfügung stehen |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Consumption/aggregatedcost/read | Listet AggregatedCost für eine Verwaltungsgruppe auf. |
...
> | Aktion | Microsoft.Consumption/externalBillingAccounts/tags/read | Listet Tags für EA und Abonnements auf. |
> | Aktion | Microsoft.Consumption/externalSubscriptions/tags/read | Listet Tags für EA und Abonnements auf. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.ContainerInstance/containerGroups/containers/buildlogs/read | Ruft die Buildprotokolle für einen bestimmten Container ab. |
...
> | Aktion | Microsoft.ContainerInstance/containerGroups/operationResults/read | Abrufen des Ergebnisses eines asynchronen Vorgangs |
...
> | Aktion | Microsoft.ContainerInstance/locations/operations/read | Auflisten der Vorgänge für den Azure Container Instances-Dienst |
> | Aktion | Microsoft.ContainerInstance/locations/usages/read | Ruft die Nutzung für eine bestimmte Region ab. |
> | Aktion | Microsoft.ContainerInstance/operations/read | Auflisten der Vorgänge für den Azure Container Instances-Dienst |
...
> | Aktion | Microsoft.ContainerInstance/serviceassociationlinks/delete | Löschen des vom Azure Container Instances-Ressourcenanbieter erstellten Dienstzuordnungslinks in einem Subnetz |
...
> | Aktion | Microsoft.ContainerRegistry/registries/generateCredentials/action | Generiert Schlüssel für ein Token mit einer angegebenen Containerregistrierung. |
...
> | Aktion | Microsoft.ContainerRegistry/registries/privateEndpointConnectionProxies/delete | Löscht den Verbindungsproxy für einen privaten Endpunkt (nur NRP) |
> | Aktion | Microsoft.ContainerRegistry/registries/privateEndpointConnectionProxies/operationStatuses/read | Ruft den Status des asynchronen Vorgangs des Verbindungsproxys eines privaten Endpunkts ab |
> | Aktion | Microsoft.ContainerRegistry/registries/privateEndpointConnectionProxies/read | Ruft den Verbindungsproxy für einen privaten Endpunkt ab (nur NRP) |
> | Aktion | Microsoft.ContainerRegistry/registries/privateEndpointConnectionProxies/validate/action | Überprüft den Verbindungsproxy für einen privaten Endpunkt (nur NRP) |
> | Aktion | Microsoft.ContainerRegistry/registries/privateEndpointConnectionProxies/write | Erstellt den Verbindungsproxy für einen privaten Endpunkt (nur NRP) |
...
> | Aktion | Microsoft.ContainerRegistry/registries/quarantine/read | Pullen oder Abrufen von Images in Quarantäne aus einer Containerregistrierung |
> | Aktion | Microsoft.ContainerRegistry/registries/quarantine/write | Schreiben/Ändern des Quarantänezustands von unter Quarantäne gestellten Images |
...
> | Aktion | Microsoft.ContainerRegistry/registries/scopeMaps/delete | Löscht eine Bereichszuordnung aus einer Containerregistrierung. |
> | Aktion | Microsoft.ContainerRegistry/registries/scopeMaps/operationStatuses/read | Ruft den Status eines asynchronen Vorgangs der Bereichszuordnung ab. |
> | Aktion | Microsoft.ContainerRegistry/registries/scopeMaps/read | Ruft die Eigenschaften der angegebenen Bereichszuordnung ab oder listet alle Bereichszuordnungen für die angegebene Containerregistrierung auf. |
> | Aktion | Microsoft.ContainerRegistry/registries/scopeMaps/write | Erstellt oder aktualisiert eine Bereichszuordnung für eine Containerregistrierung mit den angegebenen Parametern. |
...
> | Aktion | Microsoft.ContainerRegistry/registries/tokens/delete | Löscht ein Token aus einer Containerregistrierung. |
> | Aktion | Microsoft.ContainerRegistry/registries/tokens/operationStatuses/read | Ruft den Status des asynchronen Vorgangs eines Tokens ab. |
> | Aktion | Microsoft.ContainerRegistry/registries/tokens/read | Ruft die Eigenschaften des angegebenen Tokens ab oder listet alle Token für die angegebene Containerregistrierung auf. |
> | Aktion | Microsoft.ContainerRegistry/registries/tokens/write | Erstellt oder aktualisiert ein Token für eine Containerregistrierung mit den angegebenen Parametern. |
...
> | Aktion | Microsoft.ContainerService/managedClusters/agentPools/upgradeProfiles/read | Ruft das Upgradeprofil des Agentpools ab |
...
> | Aktion | Microsoft.ContainerService/managedClusters/availableAgentPoolVersions/read | Ruft die verfügbaren Agentpool-Versionen des Clusters ab. |
> | Aktion | Microsoft.ContainerService/managedClusters/delete | Löscht einen verwalteten Cluster. |
> | Aktion | Microsoft.ContainerService/managedClusters/detectors/read | Ruft die Erkennung verwalteter Cluster ab |
> | Aktion | Microsoft.ContainerService/managedClusters/diagnosticsState/read | Abrufen des Diagnosezustands des Clusters |
...
> | Aktion | Microsoft.ContainerService/managedClusters/listClusterMonitoringUserCredential/action | Listet die clusterMonitoringUser-Anmeldeinformationen eines verwalteten Clusters auf. |
...
> | Aktion | Microsoft.ContainerService/managedClusters/privateEndpointConnectionsApproval/action | Bestimmt, ob der Benutzer eine private Endpunktverbindung genehmigen darf. |
...
> | Aktion | Microsoft.ContainerService/managedClusters/rotateClusterCertificates/action | Führt die Rotation von Zertifikaten eines verwalteten Clusters durch. |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.CostManagement/alerts/write | Aktualisieren von Warnungen. |
...
> | Aktion | Microsoft.CostManagement/externalBillingAccounts/dimensions/read | Listet alle unterstützten Dimensionen für externe BillingAccounts auf. |
...
> | Aktion | Microsoft.CostManagement/externalBillingAccounts/forecast/action | Prognostiziert die Nutzungsdaten für externe BillingAccounts. |
> | Aktion | Microsoft.CostManagement/externalBillingAccounts/forecast/read | Prognostiziert die Nutzungsdaten für externe BillingAccounts. |
> | Aktion | Microsoft.CostManagement/externalBillingAccounts/query/action | Fragt die Nutzungsdaten für externe BillingAccounts ab. |
> | Aktion | Microsoft.CostManagement/externalBillingAccounts/query/read | Fragt die Nutzungsdaten für externe BillingAccounts ab. |
...
> | Aktion | Microsoft.CostManagement/externalSubscriptions/dimensions/read | Listet alle unterstützten Dimensionen für externe Abonnements auf. |
> | Aktion | Microsoft.CostManagement/externalSubscriptions/forecast/action | Prognostiziert die Nutzungsdaten für externe BillingAccounts. |
> | Aktion | Microsoft.CostManagement/externalSubscriptions/forecast/read | Prognostiziert die Nutzungsdaten für externe BillingAccounts. |
> | Aktion | Microsoft.CostManagement/externalSubscriptions/query/action | Fragt die Nutzungsdaten für das externe Abonnement ab. |
> | Aktion | Microsoft.CostManagement/externalSubscriptions/query/read | Fragt die Nutzungsdaten für das externe Abonnement ab. |
...
> | Aktion | Microsoft.CostManagement/forecast/action | Prognostiziert Nutzungsdaten nach Bereich. |
> | Aktion | Microsoft.CostManagement/forecast/read | Prognostiziert Nutzungsdaten nach Bereich. |
> | Aktion | Microsoft.CostManagement/operations/read | Listet alle vom Microsoft.CostManagement-Ressourcenanbieter unterstützten Vorgänge auf. |
...
> | Aktion | Microsoft.CostManagement/views/action | Erstellt eine Ansicht. |
> | Aktion | Microsoft.CostManagement/views/delete | Löscht gespeicherte Ansichten. |
> | Aktion | Microsoft.CostManagement/views/read | Listet alle gespeicherten Ansichten auf. |
> | Aktion | Microsoft.CostManagement/views/write | Aktualisiert die Ansicht. |
...
> | Aktion | Microsoft.DataBox/locations/availableSkus/read | Liste die verfügbaren SKUs auf oder ruft sie ab |
> | Aktion | Microsoft.DataBox/locations/operationResults/read | Listet die Vorgangsergebnisse auf bzw. ruft sie ab. |
> | Aktion | Microsoft.DataBox/locations/regionConfiguration/action | Diese Methode gibt die Konfigurationen für die Region zurück. |
...
> | Aktion | Microsoft.DataBox/locations/validateInputs/action | Diese Methode führt alle Arten von Prüfungen aus. |
> | Aktion | Microsoft.DataBox/operations/read | Listet die Vorgänge auf bzw. ruft sie ab |
> | Aktion | Microsoft.DataBox/register/action | Registriert den Anbieter „Microsoft.Databox“. |
> | Aktion | Microsoft.DataBox/subscriptions/resourceGroups/moveResources/action | Diese Methode führt die Verschiebung der Ressource durch. |
> | Aktion | Microsoft.DataBox/subscriptions/resourceGroups/validateMoveResources/action | Diese Methode überprüft, ob die Verschiebung der Ressource zulässig ist oder nicht. |
> | Aktion | Microsoft.DataBox/unregister/action | Hebt die Registrierung des Anbieters „Microsoft.Databox“ auf |
...
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/nodes/read | Listet die Knoten auf oder ruft sie ab. |
...
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers/delete | Löscht die Container. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers/operationResults/read | Listet die Vorgangsergebnisse auf oder ruft sie ab |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers/read | Listet die Container auf oder ruft sie ab. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers/refresh/action | Aktualisiert die Containermetadaten mit Daten aus der Cloud. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/containers/write | Erstellt oder aktualisiert die Container. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/delete | Löscht die Speicherkonten. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/operationResults/read | Listet die Vorgangsergebnisse auf oder ruft sie ab |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/read | Listet die Speicherkonten auf oder ruft sie ab. |
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts/write | Erstellt oder aktualisiert die Speicherkonten. |
...
> | Aktion | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Erstellt oder aktualisiert die Data Box Edge-Geräte. |
> | Aktion | Microsoft.DataBoxEdge/skus/read | Listet die SKUs auf oder ruft sie ab |
...
> | Aktion | Microsoft.Databricks/locations/operationstatuses/read | Liest den Vorgangsstatus für die Ressource. |
> | Aktion | Microsoft.Databricks/operations/read | Ruft die Liste der Vorgänge ab. |
...
> | Aktion | Microsoft.Databricks/workspaces/refreshPermissions/action | Aktualisiert Berechtigungen für einen Arbeitsbereich. |
> | Aktion | Microsoft.Databricks/workspaces/storageEncryption/delete | Deaktiviert die Verschlüsselung kundenseitig verwalteter Schlüssel für das verwaltete Speicherkonto des Databricks-Arbeitsbereichs. |
> | Aktion | Microsoft.Databricks/workspaces/storageEncryption/write | Aktiviert die Verschlüsselung kundenseitig verwalteter Schlüssel für das verwaltete Speicherkonto des Databricks-Arbeitsbereichs. |
> | Aktion | Microsoft.Databricks/workspaces/updateDenyAssignment/action | Aktualisiert die nicht zulässigen Aktionen für Ablehnungszuweisungen für eine verwaltete Ressourcengruppe eines Arbeitsbereichs. |
> | Aktion | Microsoft.Databricks/workspaces/virtualNetworkPeerings/delete | Löscht ein Peering virtueller Netzwerke. |
> | Aktion | Microsoft.Databricks/workspaces/virtualNetworkPeerings/read | Ruft das Peering virtueller Netzwerke ab. |
> | Aktion | Microsoft.Databricks/workspaces/virtualNetworkPeerings/write | Dient zum Hinzufügen oder Ändern des Peerings virtueller Netzwerke. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.DataCatalog/catalogs/delete | Löscht die catalogs-Ressource für den Data Catalog-Ressourcenanbieter |
> | Aktion | Microsoft.DataCatalog/catalogs/read | Liest die catalogs-Ressource für den Data Catalog-Ressourcenanbieter |
> | Aktion | Microsoft.DataCatalog/catalogs/write | Schreibt die catalogs-Ressource für den Data Catalog-Ressourcenanbieter |
> | Aktion | Microsoft.DataCatalog/checkNameAvailability/read | Überprüft die Verfügbarkeit des Katalognamens für den Data Catalog-Ressourcenanbieter |
...
> | Aktion | Microsoft.DataFactory/factories/addDataFlowToDebugSession/action | Fügt der Debugsitzung den Datenfluss zu Vorschauzwecken hinzu. |
...
> | Aktion | Microsoft.DataFactory/factories/cancelSandboxPipelineRun/action | Bricht einen Debuglauf für die Pipeline ab. |
> | Aktion | Microsoft.DataFactory/factories/createdataflowdebugsession/action | Erstellt eine Debugsitzung für einen Datenfluss. |
> | Aktion | Microsoft.DataFactory/factories/dataflows/delete | Löscht den Datenfluss. |
> | Aktion | Microsoft.DataFactory/factories/dataflows/read | Liest den Datenfluss. |
> | Aktion | Microsoft.DataFactory/factories/dataflows/write | Erstellen oder Aktualisieren des Datenflusses |
...
> | Aktion | Microsoft.DataFactory/factories/debugpipelineruns/cancel/action | Bricht einen Debuglauf für die Pipeline ab. |
...
> | Aktion | Microsoft.DataFactory/factories/executeDataFlowDebugCommand/action | Führt den Debugbefehl für den Datenfluss aus. |
...
> | Aktion | Microsoft.DataFactory/factories/operationResults/read | Ruft die Ergebnisse eines Vorgangs ab. |
...
> | Aktion | Microsoft.DataFactory/factories/pipelines/sandbox/action | Erstellt eine Debuglaufumgebung für die Pipeline. |
> | Aktion | Microsoft.DataFactory/factories/pipelines/sandbox/create/action | Erstellt eine Debuglaufumgebung für die Pipeline. |
> | Aktion | Microsoft.DataFactory/factories/pipelines/sandbox/run/action | Erstellt einen Debuglauf für die Pipeline. |
> | Aktion | Microsoft.DataFactory/factories/pipelines/write | Dient zum Erstellen oder Aktualisieren von Pipelines. |
> | Aktion | Microsoft.DataFactory/factories/querydataflowdebugsessions/action | Fragt eine Debugsitzung für einen Datenfluss ab. |
...
> | Aktion | Microsoft.DataFactory/factories/querytriggers/action | Fragt die Trigger ab. |
> | Aktion | Microsoft.DataFactory/factories/read | Liest Data Factorys. |
> | Aktion | Microsoft.DataFactory/factories/sandboxpipelineruns/action | Fragt die Debugpipelineausführungen ab. |
> | Aktion | Microsoft.DataFactory/factories/sandboxpipelineruns/read | Ruft die Debuglaufinformationen für die Pipeline ab. |
> | Aktion | Microsoft.DataFactory/factories/sandboxpipelineruns/sandboxActivityRuns/read | Ruft die Debuglaufinformationen für die Aktivität ab. |
...
> | Aktion | Microsoft.DataFactory/factories/triggers/geteventsubscriptionstatus/action | Status des Ereignisabonnements |
...
> | Aktion | Microsoft.DataFactory/factories/triggers/subscribetoevents/action | Abonniert Ereignisse. |
> | Aktion | Microsoft.DataFactory/factories/triggers/triggerruns/read | Liest die Triggerausführungen. |
> | Aktion | Microsoft.DataFactory/factories/triggers/unsubscribefromevents/action | Dient zum Kündigen des Abonnements von Ereignissen. |
...
> | Aktion | Microsoft.DataLakeStore/accounts/shares/delete | Löschen einer Freigabe. |
> | Aktion | Microsoft.DataLakeStore/accounts/shares/read | Abrufen von Informationen zu einer Freigabe. |
> | Aktion | Microsoft.DataLakeStore/accounts/shares/write | Erstellen oder Aktualisieren einer Freigabe. |
...
> | Aktion | Microsoft.DataMigration/services/getHybridDownloadLink/action | Ruft einen Downloadlink für das DMS-Workerpaket aus dem RP-Blobspeicher ab. |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.DBforMariaDB/checkNameAvailability/action | Überprüfen Sie, ob der angegebene Servername für die weltweite Bereitstellung bei einem bestimmten Abonnement verfügbar ist. |
...
> | Aktion | Microsoft.DBforMariaDB/locations/privateEndpointConnectionAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMariaDB/locations/privateEndpointConnectionOperationResults/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMariaDB/locations/privateEndpointConnectionProxyAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMariaDB/locations/privateEndpointConnectionProxyOperationResults/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
...
> | Aktion | Microsoft.DBforMariaDB/locations/serverKeyAzureAsyncOperation/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
> | Aktion | Microsoft.DBforMariaDB/locations/serverKeyOperationResults/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
...
> | Aktion | Microsoft.DBforMariaDB/servers/administrators/delete | Löscht einen vorhandenen Administrator eines MariaDB-Servers |
> | Aktion | Microsoft.DBforMariaDB/servers/administrators/read | Ruft eine Liste der MariaDB-Serveradministratoren ab |
> | Aktion | Microsoft.DBforMariaDB/servers/administrators/write | Erstellt oder aktualisiert den MariaDB-Serveradministrator mit den angegebenen Parametern |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/createRecommendedActionSession/action | Erstellt eine neue Empfehlungsmaßnahmensitzung |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/read | Gibt die Liste mit den Ratgebern zurück. |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/read | Gibt einen Advisor zurück |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/recommendedActions/read | Gibt die Liste der empfohlenen Aktionen zurück. |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/recommendedActions/read | Gibt die Liste der empfohlenen Aktionen zurück. |
> | Aktion | Microsoft.DBforMariaDB/servers/advisors/recommendedActions/read | Gibt eine empfohlene Maßnahme zurück |
...
> | Aktion | Microsoft.DBforMariaDB/servers/keys/delete | Löscht einen vorhandenen Serverschlüssel. |
> | Aktion | Microsoft.DBforMariaDB/servers/keys/read | Gibt die Liste der Serverschlüssel zurück oder ruft die Eigenschaften für den angegebenen Serverschlüssel ab. |
> | Aktion | Microsoft.DBforMariaDB/servers/keys/write | Erstellt einen Schlüssel mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Markierungen für den angegebenen Serverschlüssel. |
> | Aktion | Microsoft.DBforMariaDB/servers/logFiles/read | Gibt die Liste der MariaDB-Protokolldateien zurück |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnectionProxies/delete | Löscht einen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnectionProxies/read | Gibt eine Liste der Verbindungsproxys eines privaten Endpunkts zurück oder ruft die Eigenschaften für den angegebenen Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnectionProxies/validate/action | Überprüft den Aufruf zum Erstellen einer Verbindung mit einem privaten Endpunkt auf NRP-Seite |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnectionProxies/write | Erstellt einen Verbindungsproxy eines privaten Endpunkts mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Tags für den angegebenen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnections/delete | Löscht eine Verbindung mit einem privaten Endpunkt |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnections/read | Gibt eine Liste der Verbindungen mit einem privaten Endpunkt zurück oder ruft die Eigenschaften für die angegebene Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMariaDB/servers/privateEndpointConnections/write | Genehmigt eine vorhandene Verbindung mit einem privaten Endpunkt, oder lehnt diese ab |
> | Aktion | Microsoft.DBforMariaDB/servers/privateLinkResources/read | Ruft die Ressourcen der privaten Verbindung für den entsprechenden MariaDB-Server ab. |
...
> | Aktion | Microsoft.DBforMariaDB/servers/queryTexts/action | Zurückgeben des Texts einer Abfrage |
...
> | Aktion | Microsoft.DBforMariaDB/servers/replicas/read | Ruft Lesereplikate eines MariaDB-Servers ab |
> | Aktion | Microsoft.DBforMariaDB/servers/restart/action | Startet einen bestimmten Server neu |
...
> | Aktion | Microsoft.DBforMariaDB/servers/topQueryStatistics/read | Gibt eine Abfragestatistik zurück |
...
> | Aktion | Microsoft.DBforMariaDB/servers/waitStatistics/read | Gibt eine Wartezeitstatistik zurück |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.DBforMySQL/checkNameAvailability/action | Überprüfen Sie, ob der angegebene Servername für die weltweite Bereitstellung bei einem bestimmten Abonnement verfügbar ist. |
...
> | Aktion | Microsoft.DBforMySQL/locations/privateEndpointConnectionAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMySQL/locations/privateEndpointConnectionOperationResults/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMySQL/locations/privateEndpointConnectionProxyAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMySQL/locations/privateEndpointConnectionProxyOperationResults/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
...
> | Aktion | Microsoft.DBforMySQL/locations/serverKeyAzureAsyncOperation/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
> | Aktion | Microsoft.DBforMySQL/locations/serverKeyOperationResults/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
...
> | Aktion | Microsoft.DBforMySQL/servers/administrators/delete | Löscht einen vorhandenen Administrator eines MySQL-Servers |
> | Aktion | Microsoft.DBforMySQL/servers/administrators/read | Ruft eine Liste der MySQL-Serveradministratoren ab |
> | Aktion | Microsoft.DBforMySQL/servers/administrators/write | Erstellt oder aktualisiert den MySQL-Serveradministrator mit den angegebenen Parametern |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/createRecommendedActionSession/action | Erstellt eine neue Empfehlungsmaßnahmensitzung |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/read | Gibt die Liste mit den Ratgebern zurück. |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/read | Gibt einen Advisor zurück |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/recommendedActions/read | Gibt die Liste der empfohlenen Aktionen zurück. |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/recommendedActions/read | Gibt die Liste der empfohlenen Aktionen zurück. |
> | Aktion | Microsoft.DBforMySQL/servers/advisors/recommendedActions/read | Gibt eine empfohlene Maßnahme zurück |
...
> | Aktion | Microsoft.DBforMySQL/servers/keys/delete | Löscht einen vorhandenen Serverschlüssel. |
> | Aktion | Microsoft.DBforMySQL/servers/keys/read | Gibt die Liste der Serverschlüssel zurück oder ruft die Eigenschaften für den angegebenen Serverschlüssel ab. |
> | Aktion | Microsoft.DBforMySQL/servers/keys/write | Erstellt einen Schlüssel mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Markierungen für den angegebenen Serverschlüssel. |
> | Aktion | Microsoft.DBforMySQL/servers/logFiles/read | Gibt die Liste mit MySQL LogFiles zurück. |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnectionProxies/delete | Löscht einen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnectionProxies/read | Gibt eine Liste der Verbindungsproxys eines privaten Endpunkts zurück oder ruft die Eigenschaften für den angegebenen Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnectionProxies/validate/action | Überprüft den Aufruf zum Erstellen einer Verbindung mit einem privaten Endpunkt auf NRP-Seite |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnectionProxies/write | Erstellt einen Verbindungsproxy eines privaten Endpunkts mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Tags für den angegebenen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnections/delete | Löscht eine Verbindung mit einem privaten Endpunkt |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnections/read | Gibt eine Liste der Verbindungen mit einem privaten Endpunkt zurück oder ruft die Eigenschaften für die angegebene Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforMySQL/servers/privateEndpointConnections/write | Genehmigt eine vorhandene Verbindung mit einem privaten Endpunkt, oder lehnt diese ab |
> | Aktion | Microsoft.DBforMySQL/servers/privateLinkResources/read | Ruft die Ressourcen der privaten Verbindung für den entsprechenden MySQL-Server ab. |
...
> | Aktion | Microsoft.DBforMySQL/servers/queryTexts/action | Zurückgeben des Texts einer Abfrage |
...
> | Aktion | Microsoft.DBforMySQL/servers/replicas/read | Ruft Lesereplikate eines MySQL-Servers ab |
> | Aktion | Microsoft.DBforMySQL/servers/restart/action | Startet einen bestimmten Server neu |
...
> | Aktion | Microsoft.DBforMySQL/servers/topQueryStatistics/read | Gibt eine Abfragestatistik zurück |
...
> | Aktion | Microsoft.DBforMySQL/servers/waitStatistics/read | Gibt eine Wartezeitstatistik zurück |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.DBforPostgreSQL/checkNameAvailability/action | Überprüfen Sie, ob der angegebene Servername für die weltweite Bereitstellung bei einem bestimmten Abonnement verfügbar ist. |
...
> | Aktion | Microsoft.DBforPostgreSQL/locations/privateEndpointConnectionAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforPostgreSQL/locations/privateEndpointConnectionOperationResults/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforPostgreSQL/locations/privateEndpointConnectionProxyAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforPostgreSQL/locations/privateEndpointConnectionProxyOperationResults/read | Ruft das Ergebnis für einen Vorgang auf dem Verbindungsproxy eines privaten Endpunkts ab |
...
> | Aktion | Microsoft.DBforPostgreSQL/locations/serverKeyAzureAsyncOperation/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
> | Aktion | Microsoft.DBforPostgreSQL/locations/serverKeyOperationResults/read | Ruft gegenwärtig ausgeführte Vorgänge für Serverschlüssel von Transparent Data Encryption ab. |
...
> | Aktion | Microsoft.DBforPostgreSQL/servers/administrators/delete | Löscht einen vorhandenen Administrator eines PostgreSQL-Servers |
> | Aktion | Microsoft.DBforPostgreSQL/servers/administrators/read | Ruft eine Liste der PostgreSQL-Serveradministratoren ab |
> | Aktion | Microsoft.DBforPostgreSQL/servers/administrators/write | Erstellt oder aktualisiert den PostgreSQL-Serveradministrator mit den angegebenen Parametern |
...
> | Aktion | Microsoft.DBforPostgreSQL/servers/keys/delete | Löscht einen vorhandenen Serverschlüssel. |
> | Aktion | Microsoft.DBforPostgreSQL/servers/keys/read | Gibt die Liste der Serverschlüssel zurück oder ruft die Eigenschaften für den angegebenen Serverschlüssel ab. |
> | Aktion | Microsoft.DBforPostgreSQL/servers/keys/write | Erstellt einen Schlüssel mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Markierungen für den angegebenen Serverschlüssel. |
> | Aktion | Microsoft.DBforPostgreSQL/servers/logFiles/read | Gibt die Liste der PostgreSQL-Protokolldateien zurück |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnectionProxies/delete | Löscht einen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnectionProxies/read | Gibt eine Liste der Verbindungsproxys eines privaten Endpunkts zurück oder ruft die Eigenschaften für den angegebenen Verbindungsproxy eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnectionProxies/validate/action | Überprüft den Aufruf zum Erstellen einer Verbindung mit einem privaten Endpunkt auf NRP-Seite |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnectionProxies/write | Erstellt einen Verbindungsproxy eines privaten Endpunkts mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Tags für den angegebenen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnections/delete | Löscht eine Verbindung mit einem privaten Endpunkt |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnections/read | Gibt eine Liste der Verbindungen mit einem privaten Endpunkt zurück oder ruft die Eigenschaften für die angegebene Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateEndpointConnections/write | Genehmigt eine vorhandene Verbindung mit einem privaten Endpunkt, oder lehnt diese ab |
> | Aktion | Microsoft.DBforPostgreSQL/servers/privateLinkResources/read | Ruft die Ressourcen der privaten Verknüpfung für die entsprechende PostgreSQL Server-Instanz ab |
...
> | Aktion | Microsoft.DBforPostgreSQL/servers/replicas/read | Ruft Lesereplikate eines PostgreSQL-Servers ab |
> | Aktion | Microsoft.DBforPostgreSQL/servers/restart/action | Startet einen bestimmten Server neu |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Devices/Account/diagnosticSettings/read | Ruft die Diagnoseeinstellung für die Ressource ab. |
> | Aktion | Microsoft.Devices/Account/diagnosticSettings/write | Erstellt oder aktualisiert die Diagnoseeinstellung für die Ressource. |
> | Aktion | Microsoft.Devices/Account/logDefinitions/read | Ruft die verfügbaren Protokolldefinitionen für den IotHub-Dienst ab. |
> | Aktion | Microsoft.Devices/Account/metricDefinitions/read | Ruft die verfügbaren Metriken für den IotHub-Dienst ab. |
...
> | Aktion | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | Überprüft, ob der Name des Provisioning-Diensts verfügbar ist. |
> | Aktion | Microsoft.Devices/digitalTwins/Delete | Löschen eines vorhandenen Digital Twins-Kontos und aller untergeordneten Elemente |
> | Aktion | Microsoft.Devices/digitalTwins/operationresults/Read | Abrufen des Status eines Vorgangs für ein Digital Twins-Konto |
> | Aktion | Microsoft.Devices/digitalTwins/Read | Ruft eine Liste der Digital Twins-Konten ab, die einem Abonnement zugeordnet sind |
> | Aktion | Microsoft.Devices/digitalTwins/skus/Read | Abrufen einer Liste gültiger SKUs für Digital Twins-Konten |
> | Aktion | Microsoft.Devices/digitalTwins/Write | Erstellen eines neuen Digitial Twins-Kontos |
...
> | Aktion | Microsoft.Devices/elasticPools/eventGridFilters/Delete | Löscht den Event Grid-Filter eines Pools für elastische Datenbanken. |
> | Aktion | Microsoft.Devices/elasticPools/eventGridFilters/Read | Ruft den Event Grid-Filter eines Pools für elastische Datenbanken ab. |
> | Aktion | Microsoft.Devices/elasticPools/eventGridFilters/Write | Erstellt einen neuen Event Grid-Filter eines Pools für elastische Datenbanken oder aktualisiert ihn. |
...
> | Aktion | Microsoft.Devices/elasticPools/iotHubTenants/securitySettings/operationResults/Read | Ruft das Ergebnis des asynchronen PUT-Vorgangs für SecuritySettings des IoT-Mandantenhubs ab. |
> | Aktion | Microsoft.Devices/elasticPools/iotHubTenants/securitySettings/Read | Ruft die Azure Security Center-Einstellungen auf dem IoT-Mandantenhub ab. |
> | Aktion | Microsoft.Devices/elasticPools/iotHubTenants/securitySettings/Write | Aktualisiert die Azure Security Center-Einstellungen auf dem IoT-Mandantenhub. |
...
> | Aktion | Microsoft.Devices/iotHubs/securitySettings/operationResults/Read | Ruft das Ergebnis des asynchronen PUT-Vorgangs für SecuritySettings des IoT-Hubs ab. |
> | Aktion | Microsoft.Devices/iotHubs/securitySettings/Read | Ruft die Azure Security Center-Einstellungen auf dem IoT-Hub ab. |
> | Aktion | Microsoft.Devices/iotHubs/securitySettings/Write | Aktualisiert die Azure Security Center-Einstellungen auf dem IoT-Hub. |
...
> | Aktion | Microsoft.DevSpaces/locations/checkContainerHostMapping/read | Überprüft die bestehende Controllerzuordnung für einen Containerhost |
...
> | Aktion | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | Generiert eine Azure Resource Manager-Vorlage für das angegebene Artefakt, lädt die erforderlichen Dateien in ein Speicherkonto hoch und überprüft das generierte Artefakt. |
...
> | Aktion | Microsoft.DevTestLab/labs/notificationChannels/delete | Löscht Benachrichtigungskanäle. |
...
> | Aktion | Microsoft.DevTestLab/labs/notificationChannels/read | Liest Benachrichtigungskanäle. |
...
> | Aktion | Microsoft.DevTestLab/labs/virtualMachines/ClearArtifactResults/action | Löscht die Artefaktergebnisse des virtuellen Computers. |
...
> | Aktion | Microsoft.DevTestLab/labs/virtualNetworks/bastionHosts/delete | Löschen von bastionhosts. |
> | Aktion | Microsoft.DevTestLab/labs/virtualNetworks/bastionHosts/read | Lesen von bastionhosts. |
> | Aktion | Microsoft.DevTestLab/labs/virtualNetworks/bastionHosts/write | Hinzufügen oder Ändern von bastionhosts. |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/delete | Löscht einen Cassandra-Keyspace. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/read | Liest einen Cassandra-Keyspace oder listet alle Cassandra-Keyspaces auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/delete | Löscht eine Cassandra-Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/read | Liest eine Cassandra-Tabelle oder listet alle Cassandra-Tabellen auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/read | Liest den Durchsatz einer Cassandra-Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/write | Aktualisiert den Durchsatz einer Cassandra-Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/write | Erstellt oder aktualisiert eine Cassandra-Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/read | Liest den Durchsatz eines Cassandra-Keyspace. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/write | Aktualisiert den Durchsatz eines Cassandra-Keyspace. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/write | Erstellt einen Cassandra-Keyspace. |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/getBackupPolicy/action | Ruft die Sicherungsrichtlinie des Datenbankkontos ab. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/delete | Löscht eine Gremlin-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/delete | Löscht ein Gremlin-Diagramm. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/read | Liest ein Gremlin-Diagramm oder listet alle Gremlin-Diagramme auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings/read | Liest den Durchsatz eines Gremlin-Diagramms. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings/write | Aktualisiert den Durchsatz eines Gremlin-Diagramms. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/write | Erstellt oder aktualisiert ein Gremlin-Diagramm. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/read | Liest eine Gremlin-Datenbank oder listet alle Gremlin-Datenbanken auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/read | Liest den Durchsatz einer Gremlin-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/write | Aktualisiert den Durchsatz einer Gremlin-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/write | Erstellt eine Gremlin-Datenbank. |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/delete | Löscht eine MongoDB-Sammlung. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/read | Liest eine MongoDB-Sammlung oder listet alle MongoDB-Sammlungen auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/read | Liest den Durchsatz einer MongoDB-Sammlung. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/write | Aktualisiert den Durchsatz einer MongoDB-Sammlung. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections/write | Erstellt oder aktualisiert eine MongoDB-Sammlung: |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/delete | Löscht eine MongoDB-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/read | Liest eine MongoDB-Datenbank oder listet alle MongoDB-Datenbanken auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/read | Liest den Durchsatz einer MongoDB-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/write | Aktualisiert den Durchsatz einer MongoDB-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/write | Erstellt eine MongoDB-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/delete | Löscht einen Notebook-Arbeitsbereich |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/listConnectionInfo/action | Listet die Verbindungsinformationen für einen Notebook-Arbeitsbereich auf |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/operationResults/read | Liest den Status eines asynchronen Vorgangs in Notebook-Arbeitsbereichen |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/read | Liest einen Notebook-Arbeitsbereich |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/write | Erstellt oder aktualisiert einen Notebook-Arbeitsbereich |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/operationResults/read | Liest den Status des asynchronen Vorgangs des Verbindungsproxys eines privaten Endpunkts. |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections/delete | Löscht für ein Datenbankkonto die Verbindung eines privaten Endpunkts. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections/operationResults/read | Liest den Status eines asynchronen Vorgangs von privateEndpointConnections. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections/read | Liest die Verbindung eines privaten Endpunkts oder listet für ein Datenbankkonto alle Verbindungen mit privaten Endpunkten auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections/write | Erstellt oder aktualisiert für ein Datenbankkonto die Verbindung mit einem privaten Endpunkt. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/privateLinkResources/read | Liest eine Ressource einer privaten Verbindung oder listet für ein Datenbankkonto alle Ressourcen einer privaten Verbindung auf. |
...
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/delete | Löscht einen SQL-Container. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/read | Liest einen SQL-Container oder listet alle SQL-Container auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures/delete | Löscht eine gespeicherte SQL-Prozedur. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures/read | Liest eine gespeicherte SQL-Prozedur oder listet alle gespeicherten SQL-Prozeduren auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures/write | Erstellt oder aktualisiert eine gespeicherte SQL-Prozedur. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings/read | Liest den Durchsatz eines SQL-Containers. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings/write | Aktualisiert den Durchsatz eines SQL-Containers. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers/delete | Löscht einen SQL-Trigger. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers/read | List einen SQL-Trigger oder listet alle SQL-Trigger auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers/write | Erstellt oder aktualisiert einen SQL-Trigger. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions/delete | Löscht eine benutzerdefinierte Funktion. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions/read | Liest eine benutzerdefinierte SQL-Funktion oder listet alle benutzerdefinierten SQL-Funktionen auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/userDefinedFunctions/write | Erstellt oder aktualisiert eine benutzerdefinierte SQL-Funktion. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/write | Erstellt oder aktualisiert einen SQL-Container. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/delete | Löscht eine SQL-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/read | Liest eine SQL-Datenbank oder listet alle SQL-Datenbanken auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/read | Liest den Durchsatz einer SQL-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/write | Aktualisiert den Durchsatz einer SQL-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/write | Erstellt eine SQL-Datenbank. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/delete | Löscht eine Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/read | Liest eine Tabelle oder listet alle Tabellen auf. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings/operationResults/read | Liest den Status des asynchronen Vorgangs. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings/read | Liest den Durchsatz einer Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings/write | Aktualisiert den Durchsatz einer Tabelle. |
> | Aktion | Microsoft.DocumentDB/databaseAccounts/tables/write | Erstellt oder aktualisiert eine Tabelle. |
...
> | Aktion | Microsoft.DocumentDB/locations/operationsStatus/read | Liest den Status asynchroner Vorgänge |
...
> | Aktion | Microsoft.EventGrid/domains/providers/Microsoft.Insights/logDefinitions/read | Ermöglicht den Zugriff auf Diagnoseprotokolle. |
...
> | Aktion | Microsoft.EventGrid/domains/topics/delete | Löscht ein Domänenthema |
> | Aktion | Microsoft.EventGrid/domains/topics/read | Liest ein Domänenthema. |
> | Aktion | Microsoft.EventGrid/domains/topics/write | Erstellt oder aktualisiert ein Domänenthema |
...
> | Aktion | Microsoft.EventGrid/topics/providers/Microsoft.Insights/logDefinitions/read | Ermöglicht den Zugriff auf Diagnoseprotokolle. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.EventHub/availableClusterRegions/read | Liest den Vorgang zum Auflisten verfügbarer vorab bereitgestellter Cluster nach Azure-Region |
...
> | Aktion | Microsoft.EventHub/clusters/delete | Löscht eine vorhandene Clusterressource |
> | Aktion | Microsoft.EventHub/clusters/namespaces/read | Listet Azure Resource Manager-Namespace-IDs für die Namespaces eines Clusters auf. |
> | Aktion | Microsoft.EventHub/clusters/operationresults/read | Ruft den Status eines asynchronen Clustervorgangs ab |
...
> | Aktion | Microsoft.EventHub/clusters/write | Erstellt oder bearbeitet eine vorhandene Clusterressource |
...
> | Aktion | Microsoft.EventHub/namespaces/networkruleset/delete | Löscht eine VNET-Regelressource. |
> | Aktion | Microsoft.EventHub/namespaces/networkruleset/read | Ruft die NetworkRuleSet-Ressource ab |
> | Aktion | Microsoft.EventHub/namespaces/networkruleset/write | Erstellt eine VNET-Regelressource. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.GuestConfiguration/guestConfigurationAssignments/delete | Löscht die Zuweisung der Gastkonfiguration |
...
> | Aktion | Microsoft.GuestConfiguration/operations/read | Ruft die Vorgänge für den Ressourcenanbieter „Microsoft.GuestConfiguration“ ab. |
> | Aktion | Microsoft.GuestConfiguration/register/action | Registriert das Abonnement für den Ressourcenanbieter „Microsoft.GuestConfiguration“ |
...
> | Aktion | Microsoft.HDInsight/clusters/extensions/delete | Löscht die Clustererweiterung für HDInsight-Cluster |
> | Aktion | Microsoft.HDInsight/clusters/extensions/read | Ruft die Clustererweiterung für HDInsight-Cluster ab |
> | Aktion | Microsoft.HDInsight/clusters/extensions/write | Erstellt die Clustererweiterung für HDInsight-Cluster |
...
> | Aktion | Microsoft.HDInsight/register/action | Dient zum Registrieren des HDInsight-Ressourcenanbieters für das Abonnement |
> | Aktion | Microsoft.HDInsight/unregister/action | Dient zum Aufheben der Registrierung des HDInsight-Ressourcenanbieters für das Abonnement |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.HybridCompute/locations/operationresults/read | Liest den Status eines Vorgangs im Microsoft.HybridCompute-Ressourcenanbieter |
> | Aktion | Microsoft.HybridCompute/machines/delete | Löscht einen Azure Arc-Computer |
> | Aktion | Microsoft.HybridCompute/machines/extensions/delete | Löscht eine Azure Arc-Erweiterung |
> | Aktion | Microsoft.HybridCompute/machines/extensions/read | Liest alle Azure Arc-Erweiterungen |
> | Aktion | Microsoft.HybridCompute/machines/extensions/write | Installiert oder aktualisiert eine Azure Arc-Erweiterung |
> | Aktion | Microsoft.HybridCompute/machines/read | Liest einen beliebigen Azure Arc-Computer. |
> | Aktion | Microsoft.HybridCompute/machines/reconnect/action | Verbindet einen Azure Arc-Computer erneut |
> | Aktion | Microsoft.HybridCompute/machines/write | Schreibt auf einem Azure Arc-Computer |
> | Aktion | Microsoft.HybridCompute/operations/read | Liest alle Vorgänge für Azure Arc für Server |
> | Aktion | Microsoft.HybridCompute/register/action | Registriert das Abonnement für den Microsoft.HybridCompute-Ressourcenanbieter |
> | Aktion | Microsoft.HybridCompute/unregister/action | Hebt die Registrierung des Abonnements für den Microsoft.HybridCompute-Ressourcenanbieter auf |
...
> | Aktion | Microsoft.ImportExport/operations/read | Ruft die vom Ressourcenanbieter unterstützten Vorgänge ab. |
...
> | Aktion | Microsoft.Insights/Components/DailyCapReached/Action | Das Tageslimit für die Application Insights-Komponente wurde erreicht. |
> | Aktion | Microsoft.Insights/Components/DailyCapWarningThresholdReached/Action | Der Warnungsschwellenwert für das Tageslimit der Application Insights-Komponente wurde erreicht. |
...
> | Aktion | Microsoft.Insights/Components/providers/Microsoft.Insights/diagnosticSettings/Read | Liest eine Diagnoseeinstellung für eine Ressource. |
> | Aktion | Microsoft.Insights/Components/providers/Microsoft.Insights/diagnosticSettings/Write | Erstellt oder aktualisiert eine Diagnoseeinstellung für eine Ressource. |
> | Aktion | Microsoft.Insights/Components/providers/Microsoft.Insights/logDefinitions/Read | Dient zum Lesen von Protokolldefinitionen. |
...
> | Aktion | Microsoft.Insights/DataCollectionRuleAssociations/Delete | Löscht die Zuordnung einer Ressource zu einer Datensammlungsregel. |
> | Aktion | Microsoft.Insights/DataCollectionRuleAssociations/Read | Liest die Zuordnung einer Ressource zu einer Datensammlungsregel. |
> | Aktion | Microsoft.Insights/DataCollectionRuleAssociations/Write | Erstellt oder aktualisiert die Zuordnung einer Ressource zu einer Datensammlungsregel. |
> | DataAction | Microsoft.Insights/DataCollectionRules/Data/Write | Sendet Daten an eine Datensammlungsregel. |
> | Aktion | Microsoft.Insights/DataCollectionRules/Delete | Löscht eine Datensammlungsregel. |
> | Aktion | Microsoft.Insights/DataCollectionRules/Read | Liest eine Datensammlungsregel. |
> | Aktion | Microsoft.Insights/DataCollectionRules/Write | Erstellt oder aktualisiert eine Datensammlungsregel. |
...
> | Aktion | Microsoft.Insights/Logs/Tables.Custom/Read | Hiermit lesen Sie Daten aus einem beliebigen benutzerdefinierten Protokoll. |
...
> | Aktion | Microsoft.Insights/MetricBaselines/Read | Liest Metrikbaselines |
...
> | Aktion | Microsoft.Insights/myWorkbooks/Read | Liest eine private Arbeitsmappe |
> | Aktion | Microsoft.Insights/myWorkbooks/Write | Erstellt oder aktualisiert eine private Arbeitsmappe |
> | Aktion | Microsoft.Insights/Operations/Read | Dient zum Lesen von Vorgängen. |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/Delete | Löscht einen Private Link-Bereich |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Delete | Löscht den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Read | Liest den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Validate/Action | Überprüft den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Write | Erstellt oder aktualisiert den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnections/Delete | Löscht die Verbindung mit einem privatem Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnections/Read | Liest die Verbindung eines privaten Endpunkts |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateEndpointConnections/Write | Erstellt oder aktualisiert die Verbindung mit einem privaten Endpunkt |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/PrivateLinkResources/Read | Liest eine Private Link-Ressource |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/Read | Liest einen Private Link-Bereich |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/ScopedResources/Delete | Löscht eine Ressource mit Private Link-Bereich |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/ScopedResources/Read | Liest eine Ressource mit Private Link-Bereich |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/ScopedResources/Write | Erstellt oder aktualisiert eine Ressource mit Private Link-Bereich |
> | Aktion | Microsoft.Insights/PrivateLinkScopes/Write | Erstellt oder aktualisiert einen Private Link-Bereich |
...
> | Aktion | Microsoft.Insights/Workbooks/Delete | Löschen einer Arbeitsmappe |
> | Aktion | Microsoft.Insights/Workbooks/Read | Lesen einer Arbeitsmappe |
> | Aktion | Microsoft.Insights/Workbooks/Write | Erstellen oder Aktualisieren einer Arbeitsmappe |
...
> | DataAction | Microsoft.KeyVault/vaults/certificatecas/delete | Löscht einen Zertifikataussteller. |
> | DataAction | Microsoft.KeyVault/vaults/certificatecas/read | Liest einen Zertifikataussteller. |
> | DataAction | Microsoft.KeyVault/vaults/certificatecas/write | Schreibt einen Zertifikataussteller. |
> | DataAction | Microsoft.KeyVault/vaults/certificatecontacts/write | Verwaltet einen Zertifikatkontakt. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/backup/action | Erstellt die Sicherungsdatei eines Zertifikats. Die Datei kann verwendet werden, um das Zertifikat in einem Key Vault desselben Abonnements wiederherzustellen. Es können Einschränkungen gelten. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/create/action | Erstellt ein neues Zertifikat. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/delete | Löscht ein Zertifikat. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/import/action | Importiert ein vorhandenes gültiges Zertifikat mit einem privaten Schlüssel in Azure Key Vault. Das zu importierende Zertifikat kann im PFX- oder PEM-Format vorliegen. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/purge/action | Bereinigt ein Zertifikat. Es kann anschließend nicht mehr wiederhergestellt werden. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/read | Listet Zertifikate in einem angegebenen Schlüsseltresor auf oder ruft Informationen zu einem Zertifikat ab. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/recover/action | Stellt das gelöschte Zertifikat wieder her. Der Vorgang führt die Umkehrung des Löschvorgangs aus. Der Vorgang gilt in Tresoren, die für vorläufiges Löschen aktiviert sind, und muss während des Aufbewahrungsintervalls ausgegeben werden. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/restore/action | Stellt ein gesichertes Zertifikat und alle zugehörigen Versionen in einem Tresor wieder her. |
> | DataAction | Microsoft.KeyVault/vaults/certificates/update/action | Aktualisiert die angegebenen Attribute, die dem jeweiligen Zertifikat zugeordnet sind. |
...
> | DataAction | Microsoft.KeyVault/vaults/keys/backup/action | Erstellt die Sicherungsdatei eines Schlüssels. Die Datei kann verwendet werden, um den Schlüssel in einem Key Vault desselben Abonnements wiederherzustellen. Es können Einschränkungen gelten. |
> | DataAction | Microsoft.KeyVault/vaults/keys/create/action | Erstellt einen neuen Schlüssel. |
> | DataAction | Microsoft.KeyVault/vaults/keys/decrypt/action | Entschlüsselt Chiffretext mit einem Schlüssel. |
> | DataAction | Microsoft.KeyVault/vaults/keys/delete | Löscht einen Schlüssel. |
> | DataAction | Microsoft.KeyVault/vaults/keys/encrypt/action | Verschlüsselt Klartext mit einem Schlüssel. Hinweis: Wenn es sich um einen asymmetrischen Schlüssel handelt, kann dieser Vorgang mit einem Prinzipal mit Lesezugriff durchgeführt werden. |
> | DataAction | Microsoft.KeyVault/vaults/keys/import/action | Importiert einen extern erstellten Schlüssel, speichert ihn und gibt Schlüsselparameter und Attribute an den Client zurück. |
> | DataAction | Microsoft.KeyVault/vaults/keys/purge/action | Bereinigt einen Schlüssel. Er kann anschließend nicht mehr wiederhergestellt werden. |
> | DataAction | Microsoft.KeyVault/vaults/keys/read | Listet Schlüssel im angegebenen Tresor auf oder liest Eigenschaften und öffentliche Informationen eines Schlüssels.<br>Bei asymmetrischen Schlüsseln legt dieser Vorgang den öffentlichen Schlüssel offen und beinhaltet die Fähigkeit, Algorithmen für öffentliche Schlüssel durchzuführen, z. B. Verschlüsselung und Überprüfung der Signatur.<br>Private Schlüssel und symmetrische Schlüssel werden nie offengelegt. |
> | DataAction | Microsoft.KeyVault/vaults/keys/recover/action | Stellt den gelöschten Schlüssel wieder her. Der Vorgang führt die Umkehrung des Löschvorgangs aus. Der Vorgang gilt in Tresoren, die für vorläufiges Löschen aktiviert sind, und muss während des Aufbewahrungsintervalls ausgegeben werden. |
> | DataAction | Microsoft.KeyVault/vaults/keys/restore/action | Stellt einen gesicherten Schlüssel und alle zugehörigen Versionen in einem Tresor wieder her. |
> | DataAction | Microsoft.KeyVault/vaults/keys/sign/action | Signiert einen Hash mit einem Schlüssel. |
> | DataAction | Microsoft.KeyVault/vaults/keys/unwrap/action | Hebt die Umschließung eines symmetrischen Schlüssels mit einem Key Vault-Schlüssel auf. |
> | DataAction | Microsoft.KeyVault/vaults/keys/update/action | Aktualisiert die angegebenen Attribute, die dem jeweiligen Schlüssel zugeordnet sind. |
> | DataAction | Microsoft.KeyVault/vaults/keys/verify/action | Überprüft einen Hash. Hinweis: Wenn es sich um einen asymmetrischen Schlüssel handelt, kann dieser Vorgang mit einem Prinzipal mit Lesezugriff durchgeführt werden. |
> | DataAction | Microsoft.KeyVault/vaults/keys/wrap/action | Umschließt einen symmetrischen Schlüssel mit einem Key Vault-Schlüssel. Hinweis: Wenn es sich um einen asymmetrischen Key Vault-Schlüssel handelt, kann dieser Vorgang mit Lesezugriff durchgeführt werden. |
> | Aktion | Microsoft.KeyVault/vaults/read | Dient zum Anzeigen der Eigenschaften eines Schlüsseltresors. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/backup/action | Erstellt die Sicherungsdatei eines Geheimnisses. Die Datei kann verwendet werden, um das Geheimnis in einem Key Vault desselben Abonnements wiederherzustellen. Es können Einschränkungen gelten. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/delete | Löscht ein Geheimnis. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/getSecret/action | Ruft den Wert eines Geheimnisses ab. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/purge/action | Bereinigt ein Geheimnis. Es kann anschließend nicht mehr wiederhergestellt werden. |
> | Aktion | Microsoft.KeyVault/vaults/secrets/read | Zeigt die Eigenschaften (aber nicht den Wert) eines Geheimnisses an |
> | DataAction | Microsoft.KeyVault/vaults/secrets/readMetadata/action | Listet die Eigenschaften eines Geheimnisses auf oder zeigt sie an, nicht aber dessen Wert. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/recover/action | Stellt das gelöschte Geheimnis wieder her. Der Vorgang führt die Umkehrung des Löschvorgangs aus. Der Vorgang gilt in Tresoren, die für vorläufiges Löschen aktiviert sind, und muss während des Aufbewahrungsintervalls ausgegeben werden. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/restore/action | Stellt ein gesichertes Geheimnis und alle zugehörigen Versionen in einem Tresor wieder her. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/setSecret/action | Erstellt ein neues Geheimnis. |
> | DataAction | Microsoft.KeyVault/vaults/secrets/update/action | Aktualisiert die angegebenen Attribute, die dem jeweiligen Geheimnis zugeordnet sind. |
> | Aktion | Microsoft.KeyVault/vaults/secrets/write | Erstellt ein neues Geheimnis oder aktualisiert den Wert eines vorhandenen Geheimnisses |
...
> | Aktion | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/delete | Löscht eine angefügte Datenbankkonfigurationsressource |
> | Aktion | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/read | Liest eine angefügte Datenbankkonfigurationsressource |
> | Aktion | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/write | Schreibt eine angefügte Datenbankkonfigurationsressource |
...
> | Aktion | Microsoft.Kusto/Clusters/Databases/PrincipalAssignments/delete | Löscht eine Datenbankprinzipal-Zuweisungsressource. |
> | Aktion | Microsoft.Kusto/Clusters/Databases/PrincipalAssignments/read | Liest die Datenbankprinzipal-Zuweisungsressource. |
> | Aktion | Microsoft.Kusto/Clusters/Databases/PrincipalAssignments/write | Schreibt eine Datenbankprinzipal-Zuweisungsressource. |
...
> | Aktion | Microsoft.Kusto/Clusters/DataConnections/delete | Löscht eine Datenverbindungsressource eines Clusters. |
> | Aktion | Microsoft.Kusto/Clusters/DataConnections/read | Liest eine Datenverbindungsressource eines Clusters. |
> | Aktion | Microsoft.Kusto/Clusters/DataConnections/write | Schreibt eine Datenverbindungsressource eines Clusters. |
...
> | Aktion | Microsoft.Kusto/Clusters/DetachFollowerDatabases/action | Trennt die Datenbanken des Followers. |
> | Aktion | Microsoft.Kusto/Clusters/DiagnoseVirtualNetwork/action | Diagnostiziert den Status der Netzwerkkonnektivität für externe Ressourcen, von denen der Dienst abhängig ist. |
> | Aktion | Microsoft.Kusto/Clusters/ListFollowerDatabases/action | Listet die Datenbanken des Followers auf. |
> | Aktion | Microsoft.Kusto/Clusters/PrincipalAssignments/delete | Schreibt eine Clusterprinzipal-Zuweisungsressource. |
> | Aktion | Microsoft.Kusto/Clusters/PrincipalAssignments/read | Liest eine Clusterprinzipal-Zuweisungsressource. |
> | Aktion | Microsoft.Kusto/Clusters/PrincipalAssignments/write | Schreibt eine Clusterprinzipal-Zuweisungsressource. |
...
> | Aktion | Microsoft.Kusto/Locations/GetNetworkPolicies/action | Ruft Netzwerkzielrichtlinien ab. |
...
> | Aktion | Microsoft.Kusto/register/action | Abonnementregistrierungsaktion |
...
> | Aktion | Microsoft.LabServices/labAccounts/GetPricingAndAvailability/action | Ruft die Preise und die Verfügbarkeit von Kombinationen aus Größen, Regionen und Betriebssystemen für das Labkonto ab. |
...
> | Aktion | Microsoft.LabServices/labAccounts/GetRestrictionsAndUsage/action | Ruft Kerneinschränkungen und Nutzungsdaten für dieses Abonnement ab |
...
> | Aktion | Microsoft.LabServices/labAccounts/labs/environmentSettings/ResetPassword/action | Setzt das Kennwort der Vorlagen-VM zurück |
...
> | Aktion | Microsoft.LabServices/labAccounts/labs/GetLabPricingAndAvailability/action | Ruft die Preise pro Lab-Einheit für dieses Lab und die Verfügbarkeit ab. Diese gibt an, ob das Lab zentral hochskaliert werden kann. |
...
> | Aktion | Microsoft.LabServices/users/UserSettings/action | Aktualisiert die persönlichen Benutzereinstellungen und gibt sie zurück. |
...
> | Aktion | Microsoft.Logic/integrationAccounts/groups/delete | Löscht die Gruppe im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/groups/read | Liest die Gruppe im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/groups/write | Erstellt oder aktualisiert die Gruppe im Integrationskonto. |
...
> | Aktion | Microsoft.Logic/integrationAccounts/rosettaNetProcessConfigurations/delete | Löscht die RosettaNet-Prozesskonfiguration im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/rosettaNetProcessConfigurations/read | Liest die RosettaNet-Prozesskonfiguration im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/rosettaNetProcessConfigurations/write | Erstellt oder aktualisiert die RosettaNet-Prozesskonfiguration im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/schedules/delete | Löscht den Zeitplan im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/schedules/read | Liest den Zeitplan im Integrationskonto. |
> | Aktion | Microsoft.Logic/integrationAccounts/schedules/write | Erstellt oder aktualisiert den Zeitplan im Integrationskonto. |
...
> | Aktion | Microsoft.Logic/integrationAccounts/sessions/read | Liest die Sitzung im Integrationskonto. |
...
> | Aktion | Microsoft.Logic/integrationServiceEnvironments/availableManagedApis/read | Liest die in der Integrationsdienstumgebung verfügbaren verwalteten APIs. |
...
> | Aktion | Microsoft.Logic/integrationServiceEnvironments/managedApis/join/action | Bindet die verwaltete API der Integrationsdienstumgebung ein. |
> | Aktion | Microsoft.Logic/integrationServiceEnvironments/managedApis/operationStatuses/read | Liest die Vorgangsstatus der in der Integrationsdienstumgebung verwalteten API. |
...
> | Aktion | Microsoft.Logic/integrationServiceEnvironments/managedApis/write | Erstellt oder aktualisiert eine in der Integrationsdienstumgebung verwaltete API. |
...
> | Aktion | Microsoft.Logic/workflows/detectors/read | Liest die Workflowerkennung. |
...
> | Aktion | Microsoft.MachineLearningServices/locations/quotas/read | Ruft die derzeit zugewiesenen Arbeitsbereichskontingente basierend auf VMFamily ab. |
> | Aktion | Microsoft.MachineLearningServices/locations/updateQuotas/action | Aktualisieren Sie das Kontingent für jede VM-Familie des Arbeitsbereichs. |
...
> | Aktion | Microsoft.MachineLearningServices/workspaces/computes/restart/action | Startet die Computeressource im Machine Learning Services-Arbeitsbereich neu |
> | Aktion | Microsoft.MachineLearningServices/workspaces/computes/start/action | Startet die Computeressource im Machine Learning Services-Arbeitsbereich |
> | Aktion | Microsoft.MachineLearningServices/workspaces/computes/stop/action | Beendet die Computeressource im Machine Learning Services-Arbeitsbereich |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/datasets/registered/profile/write | Erstellt oder aktualisiert die Datasetprofile für registrierte Datasets in Machine Learning Services-Arbeitsbereichen. |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/datasets/registered/schema/read | Ruft das Datasetschema für registrierte Datasets in Machine Learning Services-Arbeitsbereichen ab. |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/datasets/unregistered/profile/write | Erstellt oder aktualisiert die Datasetprofile für unregistrierte Datasets in Machine Learning Services-Arbeitsbereichen. |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/datasets/unregistered/schema/read | Ruft das Datasetschema für unregistrierte Datasets in Machine Learning Services-Arbeitsbereichen ab. |
...
> | Aktion | Microsoft.MachineLearningServices/workspaces/eventGridFilters/read | Ruft einen Event Grid-Filter für einen bestimmten Arbeitsbereich ab. |
...
> | Aktion | Microsoft.MachineLearningServices/workspaces/features/read | Ruft alle aktivierten Features für einen Machine Learning Services-Arbeitsbereich ab |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/export/action | Exportiert Bezeichnungen von Bezeichnungsprojekten in Machine Learning Services-Arbeitsbereichen |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/labels/read | Ruft Bezeichnungen von Bezeichnungsprojekten in Machine Learning Services-Arbeitsbereichen ab |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/labels/reject/action | Lehnt Bezeichnungen von Bezeichnungsprojekten in Machine Learning Services-Arbeitsbereichen ab |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/labels/write | Erstellt Bezeichnungen von Bezeichnungsprojekten in Machine Learning Services-Arbeitsbereichen |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/projects/delete | Löscht Bezeichnungsprojekte in Machine Learning Services-Arbeitsbereichen |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/projects/read | Ruft Bezeichnungsprojekte in Machine Learning Services-Arbeitsbereichen ab |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/projects/summary/read | Ruft die Zusammenfassung von Bezeichnungsprojekten in Machine Learning Services-Arbeitsbereichen ab |
> | DataAction | Microsoft.MachineLearningServices/workspaces/labeling/projects/write | Erstellt oder aktualisiert Bezeichnungsprojekte in Machine Learning Services-Arbeitsbereichen |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/metadata/secrets/delete | Löscht Geheimnisse in Machine Learning Services-Arbeitsbereichen. |
> | DataAction | Microsoft.MachineLearningServices/workspaces/metadata/secrets/read | Ruft Geheimnisse in Machine Learning Services-Arbeitsbereichen ab. |
> | DataAction | Microsoft.MachineLearningServices/workspaces/metadata/secrets/write | Erstellt oder aktualisiert Geheimnisse in Machine Learning Services-Arbeitsbereichen. |
...
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnectionProxies/delete | Löscht einen Verbindungsproxy für eine Ressource des privaten Endpunkts des Microsoft.Network-Anbieters. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnectionProxies/read | Zeigt den Status eines Verbindungsproxys für eine Ressource des privaten Endpunkts des Microsoft.Network-Anbieters an. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnectionProxies/validate/action | Überprüft einen Verbindungsproxy für eine Ressource des privaten Endpunkts des Microsoft.Network-Anbieters. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnectionProxies/write | Ändert den Status eines Verbindungsproxys für eine Ressource des privaten Endpunkts des Microsoft.Network-Anbieters. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnections/delete | Löscht eine Verbindung mit einer Ressource des privaten Endpunkts des Microsoft.Network-Anbieters. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnections/read | Zeigt den Status einer Verbindung mit einer Ressource des privaten Endpunkts des Microsoft.Network-Anbieters an. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateEndpointConnections/write | Ändert den Status einer Verbindung mit einer Ressource des privaten Endpunkts des Microsoft.Network-Anbieters. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/PrivateEndpointConnectionsApproval/action | Genehmigt eine Verbindung mit einer Ressource des privaten Endpunkts des Microsoft.Network-Anbieters oder lehnt diese Verbindung ab. |
> | Aktion | Microsoft.MachineLearningServices/workspaces/privateLinkResources/read | Ruft die verfügbaren privaten Verknüpfungsressourcen für die angegebene Instanz der Machine Learning Services-Arbeitsbereiche ab. |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.ManagedIdentity/identities/read | Ruft eine vorhandene systemseitig zugewiesene Identität ab. |
> | Aktion | Microsoft.ManagedIdentity/operations/read | Listet verfügbare Vorgänge für den Microsoft.ManagedIdentity-Ressourcenanbieter auf. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.ManagedServices/marketplaceRegistrationDefinitions/read | Ruft eine Liste der Registrierungsdefinitionen für verwaltete Dienste ab. |
> | Aktion | Microsoft.ManagedServices/operations/read | Ruft eine Liste von Vorgängen verwalteter Dienste ab. |
> | Aktion | Microsoft.ManagedServices/operationStatuses/read | Liest den Vorgangsstatus für die Ressource. |
> | Aktion | Microsoft.ManagedServices/register/action | Führt eine Registrierung bei verwalteten Diensten durch. |
> | Aktion | Microsoft.ManagedServices/registrationAssignments/delete | Entfernt die Registrierungszuweisung für verwaltete Dienste. |
> | Aktion | Microsoft.ManagedServices/registrationAssignments/read | Ruft eine Liste der Registrierungszuweisungen für verwaltete Dienste ab. |
> | Aktion | Microsoft.ManagedServices/registrationAssignments/write | Fügt eine Registrierungszuweisung für verwaltete Dienste hinzu oder ändert sie. |
> | Aktion | Microsoft.ManagedServices/registrationDefinitions/delete | Entfernt die Registrierungsdefinition für verwaltete Dienste. |
> | Aktion | Microsoft.ManagedServices/registrationDefinitions/read | Ruft eine Liste der Registrierungsdefinitionen für verwaltete Dienste ab. |
> | Aktion | Microsoft.ManagedServices/registrationDefinitions/write | Fügt eine Registrierungsdefinition für verwaltete Dienste hinzu oder ändert sie. |
> | Aktion | Microsoft.ManagedServices/unregister/action | Hebt die Registrierung bei verwalteten Diensten auf. |
...
> | Aktion | Microsoft.Management/managementGroups/descendants/read | Ruft alle Nachfolger (Verwaltungsgruppen, Abonnements) einer Verwaltungsgruppe ab. |
> | Aktion | Microsoft.Management/managementGroups/read | Listet die Verwaltungsgruppen für den authentifizierten Benutzer auf. |
> | Aktion | Microsoft.Management/managementGroups/settings/delete | Löscht Hierarchieeinstellungen einer Verwaltungsgruppe. |
> | Aktion | Microsoft.Management/managementGroups/settings/read | Listet vorhandene Hierarchieeinstellungen einer Verwaltungsgruppe auf. |
> | Aktion | Microsoft.Management/managementGroups/settings/write | Erstellt oder aktualisiert Hierarchieeinstellungen einer Verwaltungsgruppe. |
...
> | Aktion | Microsoft.MarketplaceOrdering/operations/read | Listet alle möglichen Vorgänge in der API auf |
...
> | Aktionstyp | Vorgang | Beschreibung |
> | --- | --- | --- |
> | Aktion | Microsoft.Migrate/assessmentprojects/assessmentOptions/read | Ruft die Bewertungsoptionen ab, die am angegebenen Standort verfügbar sind. |
> | Aktion | Microsoft.Migrate/assessmentprojects/assessments/read | Listet die Bewertungen innerhalb eines Projekts auf. |
> | Aktion | Microsoft.Migrate/assessmentprojects/delete | Löscht das Bewertungsprojekt |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/assessments/assessedmachines/read | Ruft die Eigenschaften eines bewerteten Computers ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/assessments/delete | Löscht eine Bewertung. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/assessments/downloadurl/action | Lädt die URL für einen Bewertungsbericht herunter. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/assessments/read | Ruft die Eigenschaften einer Bewertung ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/assessments/write | Erstellt eine neue Bewertung oder aktualisiert eine vorhandene Bewertung. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/delete | Löscht eine Gruppe. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/read | Ruft die Eigenschaften einer Gruppe ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/updateMachines/action | Aktualisiert eine Gruppe durch Hinzufügen oder Entfernen von Computern |
> | Aktion | Microsoft.Migrate/assessmentprojects/groups/write | Erstellt eine neue Gruppe oder aktualisiert eine vorhandene Gruppe. |
> | Aktion | Microsoft.Migrate/assessmentprojects/hypervcollectors/delete | Löscht den Hyper-V-Collector |
> | Aktion | Microsoft.Migrate/assessmentprojects/hypervcollectors/read | Ruft die Eigenschaften eines Hyper-V-Collectors ab |
> | Aktion | Microsoft.Migrate/assessmentprojects/hypervcollectors/write | Erstellt einen neuen Hyper-V-Collector oder aktualisiert einen vorhandenen Hyper-V-Collector |
> | Aktion | Microsoft.Migrate/assessmentprojects/importcollectors/delete | Löscht den Importsammler. |
> | Aktion | Microsoft.Migrate/assessmentprojects/importcollectors/read | Ruft die Eigenschaften des Importsammlers ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/importcollectors/write | Erstellt einen neuen Importsammler oder aktualisiert einen vorhandenen Importsammler. |
> | Aktion | Microsoft.Migrate/assessmentprojects/machines/read | Ruft die Eigenschaften eines Computers ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/read | Ruft die Eigenschaften eines Bewertungsprojekts ab |
> | Aktion | Microsoft.Migrate/assessmentprojects/servercollectors/read | Ruft die Eigenschaften eines Serversammlers ab. |
> | Aktion | Microsoft.Migrate/assessmentprojects/servercollectors/write | Erstellt einen neuen Serversammler oder aktualisiert einen vorhandenen Serversammler. |
> | Aktion | Microsoft.Migrate/assessmentprojects/vmwarecollectors/delete | Löscht den VMware-Collector |
> | Aktion | Microsoft.Migrate/assessmentprojects/vmwarecollectors/read | Ruft die Eigenschaften eines VMware-Collectors ab |
> | Aktion | Microsoft.Migrate/assessmentprojects/vmwarecollectors/write | Erstellt einen neuen VMware-Collector oder aktualisiert einen vorhandenen VMware-Collector |
> | Aktion | Microsoft.Migrate/assessmentprojects/write | Erstellt ein neues Bewertungsprojekt oder aktualisiert ein vorhandenes Bewertungsprojekt |
...
> | Aktion | Microsoft.Migrate/migrateprojects/DatabaseInstances/read | Ruft die Eigenschaften einer Datenbankinstanz ab |
> | Aktion | Microsoft.Migrate/migrateprojects/Databases/read | Ruft die Eigenschaften einer Datenbank ab |
> | Aktion | Microsoft.Migrate/migrateprojects/delete | Löscht ein Migrate-Projekt |
> | Aktion | Microsoft.Migrate/migrateprojects/machines/read | Ruft die Eigenschaften eines Computers ab. |
> | Aktion | Microsoft.Migrate/migrateprojects/MigrateEvents/Delete | Löscht ein Migrate-Ereignis |
> | Aktion | Microsoft.Migrate/migrateprojects/MigrateEvents/read | Ruft die Eigenschaften eines Migrate-Ereignisses ab |
> | Aktion | Microsoft.Migrate/migrateprojects/read | Ruft die Eigenschaften eines Migrate-Projekts ab |
> | Aktion | Microsoft.Migrate/migrateprojects/RefreshSummary/action | Aktualisiert die Zusammenfassung des Migrationsprojekts |
> | Aktion | Microsoft.Migrate/migrateprojects/registerTool/action | Registriert ein Tool für ein Migrate-Projekt |
> | Aktion | Microsoft.Migrate/migrateprojects/solutions/cleanupData/action | Bereinigt die Lösungsdaten des Migrate-Projekts |
> | Aktion | Microsoft.Migrate/migrateprojects/solutions/Delete | Löscht eine Migrate-Projektlösung |
...
> | Aktion | Microsoft.Migrate/migrateprojects/solutions/read | Ruft die Eigenschaften einer Migrate-Projektlösung ab |
> | Aktion | Microsoft.Migrate/migrateprojects/solutions/write | Erstellt eine neue Migrate-Projektlösung oder aktualisiert eine vorhandene Migrate-Projektlösung |
> | Aktion | Microsoft.Migrate/migrateprojects/write | Erstellt ein neues Migrate-Projekt oder aktualisiert ein vorhandenes Migrate-Projekt |
...
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/convert/action | Startet die Objektkonvertierung. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/convert/delete | Beendet die Objektkonvertierung. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/convert/read | Ruft die Objektkonvertierungseigenschaften ab. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/diagnostic/read | Stellt eine Verbindung mit der Remote Rendering-Prüfung her. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/managesessions/action | Startet Sitzungen. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/managesessions/delete | Beendet Sitzungen. |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/managesessions/read | Ruft Sitzungseigenschaften ab. |
> | Aktion | Microsoft.MixedReality/remoteRenderingAccounts/providers/Microsoft.Insights/metricDefinitions/read | Ruft die verfügbaren Metriken für Microsoft.MixedReality/remoteRenderingAccounts ab |
> | DataAction | Microsoft.MixedReality/RemoteRenderingAccounts/render/read | Stellt eine Verbindung mit einer Sitzung her. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.NetApp/locations/checkfilepathavailability/action | Dient zum Prüfen, ob ein Dateipfad verfügbar ist |
> | Aktion | Microsoft.NetApp/locations/checknameavailability/action | Prüft, ob ein Ressourcenname verfügbar ist |
...
> | Aktion | Microsoft.NetApp/netAppAccounts/accountBackups/delete | Löscht eine Kontosicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/accountBackups/read | Liest eine Kontosicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/accountBackups/write | Schreibt eine Kontosicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/backupPolicies/delete | Löscht die Ressource einer Sicherungsrichtlinie. |
> | Aktion | Microsoft.NetApp/netAppAccounts/backupPolicies/read | Liest die Ressource einer Sicherungsrichtlinie. |
> | Aktion | Microsoft.NetApp/netAppAccounts/backupPolicies/write | Schreibt die Ressource einer Sicherungsrichtlinie. |
...
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/AuthorizeReplication/action | Autorisiert die Quellvolumereplikation |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups/delete | Löscht eine Sicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups/read | Liest eine Sicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups/write | Schreibt eine Sicherungsressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/break/action | Unterbricht die Beziehungen in Bezug auf die Volumereplikation. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | Löscht eine Volumeressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/DeleteReplication/action | Löscht die Replikation auf dem Zielvolume |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/read | Liest eine Volumeressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/ReplicationStatus/action | Liest die Status der Volumereplikation. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/ResyncReplication/action | Synchronisiert die Replikation auf dem Zielvolume erneut. |
> | Aktion | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/revert/action | Setzt das Volume auf eine bestimmte Momentaufnahme zurück. |
...
> | Aktion | Microsoft.NetApp/netAppAccounts/snapshotPolicies/delete | Löscht eine Momentaufnahme-Richtlinienressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/snapshotPolicies/ListVolumes/action | Listet die mit der Momentaufnahmenrichtlinie verbundenen Volumes auf |
> | Aktion | Microsoft.NetApp/netAppAccounts/snapshotPolicies/read | Liest eine Momentaufnahme-Richtlinienressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/snapshotPolicies/write | Schreibt eine Momentaufnahme-Richtlinienressource. |
> | Aktion | Microsoft.NetApp/netAppAccounts/vaults/read | Liest eine Tresorressource. |
...
> | Aktion | Microsoft.NetApp/register/action | Abonnementregistrierungsaktion |
> | Aktion | Microsoft.NetApp/unregister/action | Hebt die Registrierung eines Abonnements bei einem Microsoft.NetApp-Ressourcenanbieter auf |
...
> | Aktion | Microsoft.Network/applicationGateways/getBackendHealthOnDemand/action | Ruft die Integrität des Back-Ends eines Anwendungsgateways für eine angegebene HTTP-Einstellung und den Back-End-Pool bedarfsgesteuert ab |
...
> | Aktion | Microsoft.Network/bastionHosts/createShareableLinks/action | Erstellt freigabefähige URLs für die VMs unter einem Bastionhost und gibt die URLs zurück. |
> | Aktion | Microsoft.Network/bastionHosts/delete | Löscht einen Bastionhost. |
> | Aktion | Microsoft.Network/bastionHosts/deleteShareableLinks/action | Löscht freigabefähige URLs für die bereitgestellten VMs unter einem Bastionhost. |
> | Aktion | Microsoft.Network/bastionHosts/disconnectactivesessions/action | Trennt angegebene aktive Sitzungen auf dem Bastionhost. |
> | Aktion | Microsoft.Network/bastionHosts/getactivesessions/action | Ruft aktive Sitzungen auf dem Bastionhost ab. |
> | Aktion | Microsoft.Network/bastionHosts/getShareableLinks/action | Gibt die freigabefähigen URLs für die angegebenen VMs in einem Bastionhostsubnetz zurück, sofern die zugehörigen URLs erstellt wurden. |
...
> | Aktion | Microsoft.Network/connections/startpacketcapture/action | Startet die Erfassung der Verbindungspakete eines Gateways für virtuelle Netzwerke. |
> | Aktion | Microsoft.Network/connections/stoppacketcapture/action | Beendet die Erfassung der Verbindungspakete eines Gateways für virtuelle Netzwerke. |
...
> | Aktion | Microsoft.Network/expressRouteCircuits/peerings/arpTables/read | Ruft ein ArpTable-Element für ein ExpressRouteCircuit-Peering ab. |
...
> | Aktion | Microsoft.Network/expressRouteCircuits/peerings/routeTables/read | Ruft ein RouteTable-Element für ein ExpressRouteCircuit-Peering ab. |
> | Aktion | Microsoft.Network/expressRouteCircuits/peerings/routeTablesSummary/read | Ruft eine RouteTable-Zusammenfassung für ein ExpressRouteCircuit-Peering ab. |
...
> | Aktion | Microsoft.Network/expressRouteCrossConnections/peerings/arpTables/read | Ruft eine ARP-Tabelle zum Peering einer ExpressRoute-Querverbindung ab. |
...
> | Aktion | Microsoft.Network/expressRouteCrossConnections/peerings/routeTables/read | Ruft eine Routentabelle zum Peering einer ExpressRoute-Querverbindung ab. |
> | Aktion | Microsoft.Network/expressRouteCrossConnections/peerings/routeTableSummary/read | Ruft eine Routentabellenzusammenfassung zum Peering einer ExpressRoute-Querverbindung ab. |
...
> | Aktion | Microsoft.Network/firewallPolicies/delete | Löscht eine Firewallregel. |
> | Aktion | Microsoft.Network/firewallPolicies/join/action | Verknüpft eine Firewallregel. Nicht warnbar. |
> | Aktion | Microsoft.Network/firewallPolicies/read | Ruft eine Firewallregel ab. |
> | Aktion | Microsoft.Network/firewallPolicies/ruleGroups/delete | Löscht eine Gruppe von Firewallrichtlinienregeln. |
> | Aktion | Microsoft.Network/firewallPolicies/ruleGroups/read | Ruft eine Gruppe von Firewallrichtlinienregeln ab. |
> | Aktion | Microsoft.Network/firewallPolicies/ruleGroups/write | Erstellt eine Gruppe von Firewallrichtlinienregeln oder aktualisiert eine vorhandene Gruppe von Firewallrichtlinienregeln. |
> | Aktion | Microsoft.Network/firewallPolicies/write | Erstellt eine Firewallrichtlinie oder aktualisiert eine vorhandene Gruppe von Firewallrichtlinien. |
...
> | Aktion | Microsoft.Network/frontDoorWebApplicationFirewallManagedRuleSets/read | Ruft verwaltete Web Application Firewall-Regelsätze ab |
> | Aktion | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/delete | Löscht eine Web Application Firewall-Richtlinie. |
> | Aktion | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/join/action | Bindet eine Web Application Firewall-Richtlinie ein. Nicht warnbar. |
...
> | Aktion | Microsoft.Network/ipAllocations/delete | Löscht eine IP-Zuordnung |
> | Aktion | Microsoft.Network/ipAllocations/read | Ruft die IP-Zuordnung ab |
> | Aktion | Microsoft.Network/ipAllocations/write | Erstellt oder aktualisiert eine IP-Zuordnung |
> | Aktion | Microsoft.Network/ipGroups/delete | Löscht eine IpGroup. |
> | Aktion | Microsoft.Network/ipGroups/join/action | Bindet eine IpGroup ein. Nicht warnbar. |
> | Aktion | Microsoft.Network/ipGroups/read | Ruft eine IpGroup ab. |
> | Aktion | Microsoft.Network/ipGroups/updateReferences/action | Aktualisiert Verweise in einer IpGroup. |
> | Aktion | Microsoft.Network/ipGroups/validate/action | Überprüft eine IpGroup. |
> | Aktion | Microsoft.Network/ipGroups/write | Erstellt eine IpGroup oder aktualisiert eine vorhandene IpGroup. |
...
> | Aktion | Microsoft.Network/locations/autoApprovedPrivateLinkServices/read | Ruft automatisch genehmigte Private Link-Dienste ab |
> | Aktion | Microsoft.Network/locations/availableDelegations/read | Ruft verfügbare Delegierungen ab. |
> | Aktion | Microsoft.Network/locations/availablePrivateEndpointTypes/read | Ruft die verfügbaren privaten Endpunktressourcen ab. |
> | Aktion | Microsoft.Network/locations/availableServiceAliases/read | Ruft verfügbare Dienstaliase ab. |
...
> | Aktion | Microsoft.Network/locations/batchNotifyPrivateEndpointsForResourceMove/action | Benachrichtigt den privaten Endpunkt in Batches über Ressourcenverschiebungen |
...
> | Aktion | Microsoft.Network/locations/checkPrivateLinkServiceVisibility/action | Überprüft die Sichtbarkeit des Private Link-Diensts |
...
> | Aktion | Microsoft.Network/networkInterfaces/UpdateParentNicAttachmentOnElasticNic/action | Aktualisiert die übergeordnete NIC, die der elastischen NIC zugeordnet ist |
...
> | Aktion | Microsoft.Network/networkWatchers/flowLogs/delete | Löscht ein Datenflussprotokoll. |
> | Aktion | Microsoft.Network/networkWatchers/flowLogs/read | Ruft Details zu Datenflussprotokollen ab. |
> | Aktion | Microsoft.Network/networkWatchers/flowLogs/write | Erstellt ein Datenflussprotokoll. |
...
> | Aktion | Microsoft.Network/p2sVpnGateways/disconnectp2svpnconnections/action | Trennt P2S-VPN-Verbindungen |
...
> | Aktion | Microsoft.Network/p2sVpnGateways/getp2svpnconnectionhealthdetailed/action | Ruft die P2S-VPN-Verbindungsintegrität für P2SVpnGateway ab |
...
> | Aktion | Microsoft.Network/privateDnsOperationResults/read | Ruft Ergebnisse eines Vorgangs mit Privatem DNS ab |
> | Aktion | Microsoft.Network/privateDnsOperationStatuses/read | Ruft den Status eines Vorgangs mit Privatem DNS ab |
> | Aktion | Microsoft.Network/privateDnsZones/A/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „A“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/A/read | Ruft den Ressourceneintragssatz vom Typ „A“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/A/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „A“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/AAAA/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „AAAA“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/AAAA/read | Ruft den Ressourceneintragssatz vom Typ „AAAA“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/AAAA/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „AAAA“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/ALL/read | Ruft Ressourceneintragssätze mit Privatem DNS typenübergreifend ab |
> | Aktion | Microsoft.Network/privateDnsZones/CNAME/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „CNAME“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/CNAME/read | Ruft den Ressourceneintragssatz vom Typ „CNAME“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab |
> | Aktion | Microsoft.Network/privateDnsZones/CNAME/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „CNAME“ innerhalb einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/delete | Löscht eine Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/join/action | Verknüpft eine private DNS-Zone |
> | Aktion | Microsoft.Network/privateDnsZones/MX/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „MX“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/MX/read | Ruft den Ressourceneintragssatz vom Typ „MX“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/MX/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „MX“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/PTR/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „PTR“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/PTR/read | Ruft den Ressourceneintragssatz vom Typ „PTR“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/PTR/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „PTR“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/read | Ruft die Eigenschaften der Zone mit Privatem DNS im JSON-Format ab. Beachten Sie, dass dieser Befehl weder die virtuellen Netzwerke abruft, mit denen die Zone mit Privatem DNS verknüpft ist, noch die in der Zone enthaltenen Ressourceneintragssätze. |
> | Aktion | Microsoft.Network/privateDnsZones/recordsets/read | Ruft Ressourceneintragssätze mit Privatem DNS typenübergreifend ab |
> | Aktion | Microsoft.Network/privateDnsZones/SOA/read | Ruft den Ressourceneintragssatz vom Typ „SOA“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab |
> | Aktion | Microsoft.Network/privateDnsZones/SOA/write | Aktualisiert einen Ressourceneintragssatz vom Typ „SOA“ innerhalb einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/SRV/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „SRV“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/SRV/read | Ruft den Ressourceneintragssatz vom Typ „SRV“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/SRV/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „SRV“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/TXT/delete | Entfernt den Ressourceneintragssatz mit einem bestimmten Namen und dem Typ „TXT“ aus einer Zone mit Privatem DNS |
> | Aktion | Microsoft.Network/privateDnsZones/TXT/read | Ruft den Ressourceneintragssatz vom Typ „TXT“ innerhalb einer Zone mit Privatem DNS im JSON-Format ab. Der Ressourceneintragssatz enthält eine Liste mit Einträgen sowie Gültigkeitsdauer, Tags und ETag. |
> | Aktion | Microsoft.Network/privateDnsZones/TXT/write | Erstellt oder aktualisiert einen Ressourceneintragssatz vom Typ „TXT“ innerhalb einer Zone mit Privatem DNS. Die aktuellen Ressourceneinträge des Ressourceneintragssatzes werden durch die angegebenen Einträge ersetzt. |
> | Aktion | Microsoft.Network/privateDnsZones/virtualNetworkLinks/delete | Löscht die Verknüpfung einer Zone mit Privatem DNS mit dem virtuellen Netzwerk |
> | Aktion | Microsoft.Network/privateDnsZones/virtualNetworkLinks/read | Ruft die Verknüpfung der Zone mit Privatem DNS mit den Eigenschaften des virtuellen Netzwerks im JSON-Format ab |
> | Aktion | Microsoft.Network/privateDnsZones/virtualNetworkLinks/write | Erstellt oder aktualisiert die Verknüpfung einer Zone mit Privatem DNS mit dem virtuellen Netzwerk |
> | Aktion | Microsoft.Network/privateDnsZones/write | Erstellt oder aktualisiert eine Zone mit Privatem DNS innerhalb einer Ressourcengruppe. Beachten Sie, dass dieser Befehl nicht zum Erstellen oder Aktualisieren von Verknüpfungen mit dem virtuellen Netzwerk oder von Ressourceneintragssätzen innerhalb der Zone verwendet werden kann. |
> | Aktion | Microsoft.Network/privateEndpointRedirectMaps/read | Ruft eine RedirectMap für einen privaten Endpunkt ab |
> | Aktion | Microsoft.Network/privateEndpointRedirectMaps/write | Erstellt eine RedirectMap für einen privaten Endpunkt oder aktualisiert eine vorhandene RedirectMap für einen privaten Endpunkt |
> | Aktion | Microsoft.Network/privateEndpoints/delete | Löscht eine private Endpunktressource. |
> | Aktion | Microsoft.Network/privateEndpoints/privateDnsZoneConfigs/write | Übermittelt die Konfiguration einer privaten DNS-Zone |
...
> | Aktion | Microsoft.Network/virtualHubs/effectiveRoutes/action | Ruft die effektive Route ab, die für den virtuellen Hub konfiguriert wurde. |
...
> | Aktion | Microsoft.Network/virtualHubs/routeTables/delete | Löschen einer VirtualHubRouteTableV2 |
> | Aktion | Microsoft.Network/virtualHubs/routeTables/read | Abrufen einer VirtualHubRouteTableV2 |
> | Aktion | Microsoft.Network/virtualHubs/routeTables/write | Erstellen oder Aktualisieren einer VirtualHubRouteTableV2 |
...
> | Aktion | microsoft.network/virtualnetworkgateways/disconnectvirtualnetworkgatewayvpnconnections/action | Trennt VPN-Verbindungen des Gateways für virtuelle Netzwerke. |
...
> | Aktion | microsoft.network/virtualnetworkgateways/startpacketcapture/action | Startet die Erfassung der Pakete eines Gateways für virtuelle Netzwerke. |
> | Aktion | microsoft.network/virtualnetworkgateways/stoppacketcapture/action | Beendet die Erfassung der Pakete eines Gateways für virtuelle Netzwerke. |
...
> | Aktion | Microsoft.Network/virtualNetworks/join/action | Verknüpft ein virtuelles Netzwerk. Nicht warnbar. |
...
> | Aktion | Microsoft.Network/virtualNetworks/subnets/contextualServiceEndpointPolicies/delete | Löscht eine kontextbezogene Dienstendpunktrichtlinie. |
> | Aktion | Microsoft.Network/virtualNetworks/subnets/contextualServiceEndpointPolicies/read | Ruft kontextbezogene Dienstendpunktrichtlinien ab. |
> | Aktion | Microsoft.Network/virtualNetworks/subnets/contextualServiceEndpointPolicies/write | Erstellt eine kontextbezogene Dienstendpunktrichtlinie oder aktualisiert eine vorhandene kontextbezogene Dienstendpunktrichtlinie. |
...
> | Aktion | Microsoft.Network/virtualNetworks/subnets/unprepareNetworkPolicies/action | Aufheben der Vorbereitung eines Subnetzes durch Entfernen der angewandten Netzwerkrichtlinien |
...
> | Aktion | Microsoft.Network/virtualRouters/delete | Löscht einen VirtualRouter |
> | Aktion | Microsoft.Network/virtualRouters/join/action | Verknüpft einen VirtualRouter Nicht warnbar. |
> | Aktion | Microsoft.Network/virtualRouters/peerings/delete | Löscht ein VirtualRouterPeering |
> | Aktion | Microsoft.Network/virtualRouters/peerings/read | Ruft ein VirtualRouterPeering ab |
> | Aktion | Microsoft.Network/virtualRouters/peerings/write | Erstellt ein VirtualRouterPeering oder aktualisiert ein vorhandenes |
> | Aktion | Microsoft.Network/virtualRouters/read | Ruft einen VirtualRouter ab |
> | Aktion | Microsoft.Network/virtualRouters/write | Erstellt einen VirtualRouter oder aktualisiert einen vorhandenen |
> | Aktion | Microsoft.Network/virtualWans/delete | Löscht ein virtuelles WAN. |
> | Aktion | Microsoft.Network/virtualwans/generateVpnProfile/action | Generieren eines VpnProfile für die VirtualWanVpnServerConfiguration |
...
> | Aktion | Microsoft.Network/virtualwans/vpnServerConfigurations/action | Abrufen von VirtualWanVpnServerConfigurations |
...
> | Aktion | microsoft.network/vpnGateways/vpnConnections/vpnLinkConnections/read | Ruft eine VPN-Linkverbindung ab |
...
> | Aktion | Microsoft.Network/vpnServerConfigurations/delete | Löschen einer VpnServerConfiguration |
> | Aktion | Microsoft.Network/vpnServerConfigurations/read | Abrufen einer VpnServerConfiguration |
> | Aktion | Microsoft.Network/vpnServerConfigurations/write | Erstellen oder Aktualisieren einer VpnServerConfiguration |
...
> | Aktion | microsoft.network/vpnSites/vpnSiteLinks/read | Ruft einen VPN-Standortlink ab |
...
> | Aktion | Microsoft.OffAzure/HyperVSites/healthsummary/read | Ruft die Integritätszusammenfassung für eine Hyper-V-Ressource ab |
...
> | Aktion | Microsoft.OffAzure/HyperVSites/summary/read | Ruft die Zusammenfassung einer Hyper-V-Site ab |
...
> | Aktion | Microsoft.OffAzure/ImportSites/delete | Löscht die Importsite. |
> | Aktion | Microsoft.OffAzure/ImportSites/exporturi/action | Ruft den SAS-URI zum Exportieren der CSV-Computerdatei ab. |
> | Aktion | Microsoft.OffAzure/ImportSites/importuri/action | Ruft den SAS-URI zum Importieren der CSV-Computerdatei ab. |
> | Aktion | Microsoft.OffAzure/ImportSites/jobs/read | Ruft die Eigenschaften eines Importauftrags ab. |
> | Aktion | Microsoft.OffAzure/ImportSites/machines/delete | Löscht den Importcomputer. |
> | Aktion | Microsoft.OffAzure/ImportSites/machines/read | Ruft die Eigenschaften eines Importcomputers ab. |
> | Aktion | Microsoft.OffAzure/ImportSites/read | Ruft die Eigenschaften einer Importsite ab. |
> | Aktion | Microsoft.OffAzure/ImportSites/write | Erstellt oder aktualisiert die Importsite. |
...
> | Aktion | Microsoft.OffAzure/ServerSites/delete | Löscht den Serverstandort. |
> | Aktion | Microsoft.OffAzure/ServerSites/jobs/read | Ruft die Eigenschaften eines Serverauftrags ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/machines/read | Ruft die Eigenschaften eines Servercomputers ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/machines/write | Schreibt die Eigenschaften eines Servercomputers. |
> | Aktion | Microsoft.OffAzure/ServerSites/operationsstatus/read | Ruft die Eigenschaften eines Servervorgangsstatus ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/read | Ruft die Eigenschaften einer Serversite ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/refresh/action | Aktualisiert die Objekte in einer Serversite. |
> | Aktion | Microsoft.OffAzure/ServerSites/runasaccounts/read | Ruft die Eigenschaften eines ausführenden Serverkontos ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/summary/read | Ruft die Zusammenfassung einer Serversite ab |
> | Aktion | Microsoft.OffAzure/ServerSites/usage/read | Ruft die Verwendungen einer Serversite ab. |
> | Aktion | Microsoft.OffAzure/ServerSites/write | Erstellt oder aktualisiert die Serversite. |
> | Aktion | Microsoft.OffAzure/VMwareSites/clientGroupMembers/action | Listet die Mitglieder der Clientgruppe für die ausgewählte Clientgruppe auf. |
> | Aktion | Microsoft.OffAzure/VMwareSites/delete | Löscht die VMware-Site. |
> | Aktion | Microsoft.OffAzure/VMwareSites/exportapplications/action | Exportiert die VMware-Anwendungen und -Rollen Daten in XLS-Dateien. |
> | Aktion | Microsoft.OffAzure/VMwareSites/generateCoarseMap/action | Generiert die grobe Zuordnung für die Liste der Computer. |
> | Aktion | Microsoft.OffAzure/VMwareSites/generateDetailedMap/action | Generiert die ausführliche grobe VMware-Zuordnung. |
> | Aktion | Microsoft.OffAzure/VMwareSites/getApplications/action | Ruft die Liste der Anwendungsinformationen für die ausgewählten Computer ab. |
> | Aktion | Microsoft.OffAzure/VMwareSites/healthsummary/read | Ruft die Integritätszusammenfassung für eine VMware-Ressource ab |
> | Aktion | Microsoft.OffAzure/VMwareSites/jobs/read | Ruft die Eigenschaften eines VMware-Auftrags ab. |
> | Aktion | Microsoft.OffAzure/VMwareSites/machines/applications/read | Ruft die Eigenschaften von VMware-Computeranwendungen ab. |
...
> | Aktion | Microsoft.OffAzure/VMwareSites/serverGroupMembers/action | Listet die Mitglieder der Servergruppe für die ausgewählte Servergruppe auf. |
> | Aktion | Microsoft.OffAzure/VMwareSites/summary/read | Ruft die Zusammenfassung einer VMware-Site ab |
> | Aktion | Microsoft.OffAzure/VMwareSites/updateProperties/action | Aktualisiert die Eigenschaften für Computer an einem Standort. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | microsoft.operationalinsights/availableservicetiers/read | Ruft die verfügbaren Dienstebenen ab |
...
> | Aktion | microsoft.operationalinsights/locations/operationStatuses/read | Ruft den Status des asynchronen Azure-Vorgangs für Log Analytics ab |
...
> | Aktion | microsoft.operationalinsights/workspaces/dataexport/delete | Löscht einen spezifischen Datenexport |
> | Aktion | microsoft.operationalinsights/workspaces/dataexport/read | Ruft einen spezifischen Datenexport ab |
> | Aktion | microsoft.operationalinsights/workspaces/dataexport/write | Erstellt oder aktualisiert einen Datenexport |
...
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnectionProxies/delete | Löscht den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnectionProxies/read | Ruft den Verbindungsproxy für einen privaten Endpunkt ab |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnectionProxies/validate/action | Überprüft den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnectionProxies/write | Übermittelt den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnections/delete | Löscht den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnections/read | Ruft den Verbindungsproxy für einen privaten Endpunkt ab |
> | Aktion | microsoft.operationalinsights/workspaces/privateEndpointConnections/write | Übermittelt den Verbindungsproxy für einen privaten Endpunkt |
> | Aktion | microsoft.operationalinsights/workspaces/privateLinkResources/read | Ruft Private Link-Ressourcen für Log Analytics ab |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesAccountManagement/read | Liest Daten aus der Tabelle „AADDomainServicesAccountManagement“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesDirectoryServiceAccess/read | Liest Daten aus der Tabelle „AADDomainServicesDirectoryServiceAccess“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesPolicyChange/read | Liest Daten aus der Tabelle „AADDomainServicesPolicyChange“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesPrivilegeUse/read | Liest Daten aus der Tabelle „AADDomainServicesPrivilegeUse“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesSystemSecurity/read | Liest Daten aus der Tabelle „AADDomainServicesSystemSecurity“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AddonAzureBackupAlerts/read | Liest Daten aus der Tabelle AddonAzureBackupAlerts |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AddonAzureBackupJobs/read | Liest Daten aus der Tabelle AddonAzureBackupJobs |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AddonAzureBackupPolicy/read | Liest Daten aus der Tabelle AddonAzureBackupPolicy |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AddonAzureBackupProtectedInstance/read | Liest Daten aus der Tabelle AddonAzureBackupProtectedInstance |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AddonAzureBackupStorage/read | Liest Daten aus der Tabelle AddonAzureBackupStorage |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ADFActivityRun/read | Liest Daten aus der Tabelle „ADFActivityRun“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ADFPipelineRun/read | Liest Daten aus der Tabelle „ADFPipelineRun“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ADFTriggerRun/read | Liest Daten aus der Tabelle „ADFTriggerRun“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AegDeliveryFailureLogs/read | Liest Daten aus der Tabelle „AegDeliveryFailureLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AegPublishFailureLogs/read | Liest Daten aus der Tabelle „AegPublishFailureLogs“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AmlComputeClusterEvent/read | Lesen von Daten aus der Tabelle „AmlComputeClusterEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AmlComputeClusterNodeEvent/read | Lesen von Daten aus der Tabelle „AmlComputeClusterNodeEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AmlComputeJobEvent/read | Lesen von Daten aus der Tabelle „AmlComputeJobEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ApiManagementGatewayLogs/read | Liest Daten aus der Tabelle ApiManagementGatewayLogs |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppPlatformLogsforSpring/read | Lesen von Daten aus der Tabelle „AppPlatformLogsforSpring“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppPlatformSystemLogs/read | Liest Daten aus der Tabelle „AppPlatformSystemLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceAppLogs/read | Liest Daten aus der Tabelle „AppServiceAppLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceAuditLogs/read | Liest Daten aus der Tabelle „AppServiceAuditLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceConsoleLogs/read | Liest Daten aus der Tabelle „AppServiceConsoleLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceEnvironmentPlatformLogs/read | Lesen von Daten aus der Tabelle „AppServiceEnvironmentPlatformLogs“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceFileAuditLogs/read | Liest Daten aus der AppServiceFileAuditLogs-Tabelle. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AppServiceHTTPLogs/read | Liest Daten aus der Tabelle „AppServiceHTTPLogs“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/availabilityResults/read | Liest Daten aus der Tabelle „availabilityResults“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/AzureAssessmentRecommendation/read | Liest Daten aus der Tabelle „AzureAssessmentRecommendation“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BaiClusterEvent/read | Lesen von Daten aus der Tabelle „BaiClusterEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BaiClusterNodeEvent/read | Lesen von Daten aus der Tabelle „BaiClusterNodeEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BaiJobEvent/read | Lesen von Daten aus der Tabelle „BaiJobEvent“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BlockchainApplicationLog/read | Liest Daten aus der Tabelle „BlockchainApplicationLog“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BlockchainProxyLog/read | Liest Daten aus der Tabelle „BlockchainProxyLog“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/BoundPort/read | Hiermit lesen Sie Daten aus der BoundPort-Tabelle. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/browserTimings/read | Liest Daten aus der Tabelle „browserTimings“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ContainerRegistryLoginEvents/read | Liest Daten aus der Tabelle ContainerRegistryLoginEvents |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/ContainerRegistryRepositoryEvents/read | Liest Daten aus der Tabelle ContainerRegistryRepositoryEvents |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/CoreAzureBackup/read | Liest Daten aus der Tabelle CoreAzureBackup |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/customEvents/read | Liest Daten aus der Tabelle „customEvents“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/customMetrics/read | Liest Daten aus der Tabelle „customMetrics“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/DatabricksInstancePools/read | Lesen von Daten aus der Tabelle „DatabricksInstancePools“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/dependencies/read | Lesen von Daten aus der Tabelle mit den Abhängigkeiten. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/DHCPActivity/read | Liest Daten aus der Tabelle „DHCPActivity“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/FailedIngestion/read | Lesen von Daten aus der Tabelle „FailedIngestion“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/FunctionAppLogs/read | Liest Daten aus der Tabelle „FunctionAppLogs“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/IntuneDeviceComplianceOrg/read | Liest Daten aus der Tabelle „IntuneDeviceComplianceOrg“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/IoTHubDistributedTracing/read | Liest Daten aus der IoTHubDistributedTracing-Tabelle. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/KubeEvents/read | Liest Daten aus der Tabelle „KubeEvents“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/KubeHealth/read | Lesen von Daten aus der Tabelle „KubeHealth“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/KubeMonAgentEvents/read | Liest Daten aus der Tabelle „KubeMonAgentEvents“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/McasShadowItReporting/read | Liest Daten aus der Tabelle McasShadowItReporting |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftAzureBastionAuditLogs/read | Liest Daten aus der Tabelle „MicrosoftAzureBastionAuditLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftDataShareReceivedSnapshotLog/read | Liest Daten aus der Tabelle „MicrosoftDataShareReceivedSnapshotLog“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftDataShareSentSnapshotLog/read | Liest Daten aus der Tabelle „MicrosoftDataShareSentSnapshotLog“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftDataShareShareLog/read | Lesen von Daten aus der Tabelle „MicrosoftDataShareShareLog“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftDynamicsTelemetryPerformanceLogs/read | Liest Daten aus der Tabelle „MicrosoftDynamicsTelemetryPerformanceLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftDynamicsTelemetrySystemMetricsLogs/read | Liest Daten aus der Tabelle „MicrosoftDynamicsTelemetrySystemMetricsLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/MicrosoftHealthcareApisAuditLogs/read | Lesen von Daten aus der Tabelle „MicrosoftHealthcareApisAuditLogs“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/pageViews/read | Liest Daten aus der Tabelle „pageViews“ |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/Perf/read | Hiermit lesen Sie Daten aus der Perf-Tabelle. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/performanceCounters/read | Liest Daten aus der Tabelle „performanceCounters“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/requests/read | Liest Daten aus der Anforderungstabelle. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/SignalRServiceDiagnosticLogs/read | Liest Daten aus der Tabelle „SignalRServiceDiagnosticLogs“. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/StorageBlobLogs/read | Liest Daten aus der Tabelle „StorageBlobLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/StorageFileLogs/read | Liest Daten aus der Tabelle „StorageFileLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/StorageQueueLogs/read | Liest Daten aus der Tabelle „StorageQueueLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/StorageTableLogs/read | Liest Daten aus der Tabelle „StorageTableLogs“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/SucceededIngestion/read | Lesen von Daten aus der Tabelle „SucceededIngestion“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/systemEvents/read | Liest Daten aus der Tabelle „systemEvents“ |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/traces/read | Liest Daten aus der Ablaufverfolgungstabelle. |
...
> | Aktion | Microsoft.OperationalInsights/workspaces/query/VMComputer/read | Liest Daten aus der Tabelle „VMComputer“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/VMConnection/read | Liest Daten aus der Tabelle „VMConnection“. |
> | Aktion | Microsoft.OperationalInsights/workspaces/query/VMProcess/read | Liest Daten aus der Tabelle „VMProcess“. |
...
> | Aktion | microsoft.operationalinsights/workspaces/savedsearches/results/read | Ruft die Ergebnisse gespeicherter Suchvorgänge ab. Als veraltet markiert |
...
> | Aktion | microsoft.operationalinsights/workspaces/scopedPrivateLinkProxies/delete | Löscht einen Proxy für einen Private Link-Bereich |
> | Aktion | microsoft.operationalinsights/workspaces/scopedPrivateLinkProxies/read | Ruft einen Proxy für einen Private Link-Bereich ab |
> | Aktion | microsoft.operationalinsights/workspaces/scopedPrivateLinkProxies/write | Übermittelt den Proxy für einen Private Link-Bereich |
...
> | Aktion | Microsoft.PolicyInsights/policyMetadata/read | Ruft Ressourcen für Richtlinienmetadaten ab. |
...
> | Aktion | microsoft.recoveryservices/Vaults/backupEncryptionConfigs/read | Ruft die Verschlüsselungskonfiguration für Sicherungsressourcen ab. |
> | Aktion | microsoft.recoveryservices/Vaults/backupEncryptionConfigs/write | Aktualisiert die Verschlüsselungskonfiguration für Sicherungsressourcen. |
...
> | Aktion | microsoft.recoveryservices/Vaults/backupFabrics/operationsStatus/read | Gibt den Status des Vorgangs zurück. |
...
> | Aktion | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/operationsStatus/read | Ruft den Status eines Vorgangs ab, der für den Schutzcontainer ausgeführt wurde. |
...
> | Aktion | microsoft.recoveryservices/Vaults/backupJobs/operationsStatus/read | Gibt den Status des Auftragsvorgangs zurück. |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Fabrics von Ressourcen nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Schutzcontainer der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Migrationselemente der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/resync/action | Erneutes Synchronisieren. |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für geschützte Elemente der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Schutzcontainerzuordnungen der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationRecoveryServicesProviders/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Recovery Services-Anbieter der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Speicherklassifizierungszuordnungen der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für vCenters der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationJobs/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Aufträge der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationOperationStatus/read | Liest alle Status des Tresorreplikationsvorgangs |
> | Aktion | Microsoft.RecoveryServices/vaults/replicationPolicies/delete | Löscht Richtlinien. |
> | Aktion | Microsoft.RecoveryServices/vaults/replicationPolicies/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Richtlinien der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationRecoveryPlans/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für Wiederherstellungspläne der Ressource nach |
...
> | Aktion | Microsoft.RecoveryServices/vaults/replicationVaultHealth/operationresults/read | Verfolgt die Ergebnisse eines asynchronen Vorgangs für die Integrität der Tresorreplikation der Ressource nach |
...
> | Aktion | Microsoft.Relay/namespaces/networkrulesets/delete | Löscht eine VNET-Regelressource. |
> | Aktion | Microsoft.Relay/namespaces/networkrulesets/read | Ruft die NetworkRuleSet-Ressource ab |
> | Aktion | Microsoft.Relay/namespaces/networkrulesets/write | Erstellt eine VNET-Regelressource. |
> | Aktion | Microsoft.Relay/namespaces/operationresults/read | Hiermit wird der Status des Namespacevorgangs abgerufen. |
> | Aktion | Microsoft.Relay/namespaces/providers/Microsoft.Insights/diagnosticSettings/read | Dient zum Abrufen der Liste mit Ressourcenbeschreibungen für Namespacediagnoseeinstellungen. |
> | Aktion | Microsoft.Relay/namespaces/providers/Microsoft.Insights/diagnosticSettings/write | Dient zum Abrufen der Liste mit Ressourcenbeschreibungen für Namespacediagnoseeinstellungen. |
> | Aktion | Microsoft.Relay/namespaces/providers/Microsoft.Insights/logDefinitions/read | Dient zum Abrufen der Liste mit Ressourcenbeschreibungen für Namespaceprotokolle. |
...
> | Aktion | Microsoft.ResourceHealth/metadata/read | Ruft Metadaten ab |
> | Aktion | Microsoft.ResourceHealth/Notifications/read | Empfängt Azure Resource Manager-Benachrichtigungen. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Resources/calculateTemplateHash/action | Berechnen des Hashs der bereitgestellten Vorlage |
> | Aktion | Microsoft.Resources/checkPolicyCompliance/read | Überprüft den Konformitätsstatus einer angegebenen Ressource anhand von Ressourcenrichtlinien. |
...
> | Aktion | Microsoft.Resources/deployments/exportTemplate/action | Exportieren der Vorlage für eine Bereitstellung |
> | Aktion | Microsoft.Resources/deployments/operations/read | Ruft Bereitstellungsvorgänge ab oder listet sie auf. |
> | Aktion | Microsoft.Resources/deployments/operationstatuses/read | Ruft den Status von Bereitstellungsvorgängen ab oder listet ihn auf. |
...
> | Aktion | Microsoft.Resources/deploymentScripts/delete | Löscht ein Bereitstellungsskript. |
> | Aktion | Microsoft.Resources/deploymentScripts/logs/read | Ruft Bereitstellungsskriptprotokolle ab oder listet diese auf. |
> | Aktion | Microsoft.Resources/deploymentScripts/read | Ruft Bereitstellungsskripts ab oder listet diese auf. |
> | Aktion | Microsoft.Resources/deploymentScripts/write | Erstellt oder aktualisiert ein Bereitstellungsskript. |
...
> | Aktion | Microsoft.Search/searchServices/listQueryKeys/action | Gibt die Liste der API-Abfrageschlüssel für den angegebenen Azure Search-Dienst zurück. |
> | Aktion | Microsoft.Search/searchServices/privateEndpointConnectionProxies/delete | Löscht einen Verbindungsproxy eines privaten Endpunkts |
> | Aktion | Microsoft.Search/searchServices/privateEndpointConnectionProxies/read | Gibt eine Liste der Verbindungsproxys eines privaten Endpunkts zurück oder ruft die Eigenschaften für den angegebenen Verbindungsproxy eines privaten Endpunkts ab. |
> | Aktion | Microsoft.Search/searchServices/privateEndpointConnectionProxies/validate/action | Überprüft den Aufruf zum Erstellen einer Verbindung mit einem privaten Endpunkt auf NRP-Seite |
> | Aktion | Microsoft.Search/searchServices/privateEndpointConnectionProxies/write | Erstellt einen Verbindungsproxy eines privaten Endpunkts mit den angegebenen Parametern oder aktualisiert die Eigenschaften oder Tags für den angegebenen Verbindungsproxy eines privaten Endpunkts. |
...
> | Aktion | Microsoft.Security/assessmentMetadata/read | Abrufen der verfügbaren Sicherheitsbewertungs-Metadaten für Ihr Abonnement |
> | Aktion | Microsoft.Security/assessmentMetadata/write | Erstellen oder Aktualisieren von Sicherheitsbewertungs-Metadaten |
> | Aktion | Microsoft.Security/assessments/read | Abrufen von Sicherheitsbewertungen für Ihr Abonnement |
> | Aktion | Microsoft.Security/assessments/write | Erstellen oder Aktualisieren von Sicherheitsbewertungen für Ihr Abonnement |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.SecurityInsights/Aggregations/read | Ruft aggregierte Informationen ab. |
> | Aktion | Microsoft.SecurityInsights/alertRules/actions/delete | Löscht die Antwortaktionen einer Warnungsregel. |
> | Aktion | Microsoft.SecurityInsights/alertRules/actions/read | Ruft die Antwortaktionen einer Warnungsregel ab. |
> | Aktion | Microsoft.SecurityInsights/alertRules/actions/write | Aktualisiert die Antwortaktionen einer Warnungsregel. |
> | Aktion | Microsoft.SecurityInsights/alertRules/delete | Löscht Warnungsregeln. |
> | Aktion | Microsoft.SecurityInsights/alertRules/read | Ruft die Warnungsregeln ab. |
> | Aktion | Microsoft.SecurityInsights/alertRules/write | Aktualisiert Warnungsregeln. |
> | Aktion | Microsoft.SecurityInsights/Bookmarks/delete | Löscht Lesezeichen. |
> | Aktion | Microsoft.SecurityInsights/Bookmarks/expand/action | Ruft verwandte Entitäten einer Entität über eine bestimmte Erweiterung ab. |
> | Aktion | Microsoft.SecurityInsights/Bookmarks/read | Ruft Lesezeichen ab. |
> | Aktion | Microsoft.SecurityInsights/Bookmarks/write | Aktualisiert Lesezeichen. |
> | Aktion | Microsoft.SecurityInsights/cases/comments/read | Ruft die Kommentare zu Fällen ab. |
> | Aktion | Microsoft.SecurityInsights/cases/comments/write | Erstellt die Kommentare zu Fällen. |
> | Aktion | Microsoft.SecurityInsights/cases/delete | Löscht einen Fall. |
> | Aktion | Microsoft.SecurityInsights/cases/investigations/read | Ruft die Falluntersuchungen ab. |
> | Aktion | Microsoft.SecurityInsights/cases/investigations/write | Aktualisiert die Metadaten eines Falls. |
> | Aktion | Microsoft.SecurityInsights/cases/read | Ruft einen Fall ab. |
> | Aktion | Microsoft.SecurityInsights/cases/write | Aktualisiert einen Fall. |
> | Aktion | Microsoft.SecurityInsights/dataConnectors/delete | Löscht einen Datenconnector. |
> | Aktion | Microsoft.SecurityInsights/dataConnectors/read | Ruft die Datenconnectors ab. |
> | Aktion | Microsoft.SecurityInsights/dataConnectors/write | Aktualisiert einen Datenconnector. |
> | Aktion | Microsoft.SecurityInsights/incidents/comments/read | Ruft die Kommentare zum Incident ab |
> | Aktion | Microsoft.SecurityInsights/incidents/comments/write | Erstellt einen Kommentar zum Incident |
> | Aktion | Microsoft.SecurityInsights/incidents/delete | Löscht einen Incident |
> | Aktion | Microsoft.SecurityInsights/incidents/read | Ruft einen Incident ab |
> | Aktion | Microsoft.SecurityInsights/incidents/relations/delete | Löscht eine Beziehung zwischen dem Incident und den zugehörigen Ressourcen |
> | Aktion | Microsoft.SecurityInsights/incidents/relations/read | Ruft eine Beziehung zwischen dem Incident und den zugehörigen Ressourcen ab |
> | Aktion | Microsoft.SecurityInsights/incidents/relations/write | Aktualisiert eine Beziehung zwischen dem Incident und den zugehörigen Ressourcen |
> | Aktion | Microsoft.SecurityInsights/incidents/write | Aktualisiert einen Incident |
> | Aktion | Microsoft.SecurityInsights/register/action | Registriert das Abonnement für Azure Sentinel. |
> | Aktion | Microsoft.SecurityInsights/settings/read | Ruft Einstellungen ab. |
> | Aktion | Microsoft.SecurityInsights/settings/write | Aktualisiert Einstellungen. |
> | Aktion | Microsoft.SecurityInsights/unregister/action | Hebt die Registrierung des Abonnements für Azure Sentinel auf. |
...
> | Aktion | Microsoft.ServiceBus/namespaces/networkruleset/delete | Löscht eine VNET-Regelressource. |
> | Aktion | Microsoft.ServiceBus/namespaces/networkruleset/read | Ruft die NetworkRuleSet-Ressource ab |
> | Aktion | Microsoft.ServiceBus/namespaces/networkruleset/write | Erstellt eine VNET-Regelressource. |
...
> | Aktion | Microsoft.SignalRService/locations/operationresults/signalr/read | Fragt die Ergebnisse eines standortbasierten asynchronen Vorgangs ab |
> | Aktion | Microsoft.SignalRService/locations/operationStatuses/operationId/read | Fragt den Status eines standortbasierten asynchronen Vorgangs ab |
> | Aktion | Microsoft.SignalRService/locations/usages/read | Ruft den Kontingentbedarf für den Azure SignalR Service ab. |
> | Aktion | Microsoft.SignalRService/operationresults/read | Fragt die Ergebnisse eines asynchronen Vorgangs auf Anbieterebene ab |
> | Aktion | Microsoft.SignalRService/operations/read | Auflisten der Vorgänge für Azure SignalR Service. |
> | Aktion | Microsoft.SignalRService/operationstatus/read | Fragt den Status eines asynchronen Vorgangs auf Anbieterebene ab |
...
> | Aktion | Microsoft.SignalRService/SignalR/eventGridFilters/delete | Löscht einen Event Grid-Filter aus einer SignalR-Instanz |
> | Aktion | Microsoft.SignalRService/SignalR/eventGridFilters/read | Ruft die Eigenschaften des angegebenen Event Grid-Filters ab oder listet alle Event Grid-Filter für die angegebene SignalR-Instanz auf |
> | Aktion | Microsoft.SignalRService/SignalR/eventGridFilters/write | Erstellt oder aktualisiert einen Event Grid-Filter für eine SignalR-Instanz mit den angegebenen Parametern |
...
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/delete | Löscht den Verbindungsproxy für einen privaten Endpunkt. |
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/read | Liest den Verbindungsproxy für einen privaten Endpunkt. |
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/validate/action | Überprüft den Verbindungsproxy für einen privaten Endpunkt. |
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/write | Erstellt einen Verbindungsproxy für einen privaten Endpunkt. |
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnections/read | Liest die Verbindung eines privaten Endpunkts. |
> | Aktion | Microsoft.SignalRService/SignalR/privateEndpointConnections/write | Genehmigt die Verbindung eines privaten Endpunkts oder lehnt sie ab. |
> | Aktion | Microsoft.SignalRService/SignalR/privateLinkResources/read | Listet alle Ressourcen einer privaten SignalR-Verbindung auf. |
...
> | Aktion | Microsoft.Solutions/operations/read | Ruft die Liste der Vorgänge ab. |
...
> | Aktion | Microsoft.Sql/locations/longTermRetentionManagedInstanceBackups/read | Gibt eine Liste von LTR-Sicherungen der verwalteten Instanz für einen bestimmten Standort zurück  |
> | Aktion | Microsoft.Sql/locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/delete | Löscht eine LTR-Sicherung für eine verwaltete Instanzdatenbank |
> | Aktion | Microsoft.Sql/locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/read | Gibt eine Liste der LTR-Sicherungen für eine verwaltete Instanzdatenbank zurück |
> | Aktion | Microsoft.Sql/locations/longTermRetentionManagedInstances/longTermRetentionManagedInstanceBackups/read | Gibt eine Liste von LTR-Sicherungen der verwalteten Instanz für eine bestimmte verwaltete Instanz zurück |
...
> | Aktion | Microsoft.Sql/locations/managedInstanceLongTermRetentionPolicyAzureAsyncOperation/read | Ruft den Status des Vorgangs für eine Richtlinie zur langfristigen Aufbewahrung für eine verwaltete Datenbank ab. |
> | Aktion | Microsoft.Sql/locations/managedInstanceLongTermRetentionPolicyOperationResults/read | Ruft den Status des Vorgangs für eine Richtlinie zur langfristigen Aufbewahrung für eine verwaltete Datenbank ab. |
> | Aktion | Microsoft.Sql/locations/managedShortTermRetentionPolicyOperationResults/read | Ruft den Status des Vorgangs für eine Richtlinie zur kurzfristigen Aufbewahrung ab. |
...
> | Aktion | Microsoft.Sql/locations/privateEndpointConnectionAzureAsyncOperation/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
> | Aktion | Microsoft.Sql/locations/privateEndpointConnectionOperationResults/read | Ruft das Ergebnis für einen Vorgang auf der Verbindung eines privaten Endpunkts ab |
...
> | Aktion | Microsoft.Sql/locations/serverAdministratorAzureAsyncOperation/read | Ergebnisse des asynchronen Vorgangs für den Azure Active Directory-Serveradministrator. |
> | Aktion | Microsoft.Sql/locations/serverAdministratorOperationResults/read | Ergebnisse des Vorgangs für den Azure Active Directory-Serveradministrator. |
...
> | Aktion | Microsoft.Sql/locations/shortTermRetentionPolicyOperationResults/read | Ruft den Status des Vorgangs für eine Richtlinie zur kurzfristigen Aufbewahrung ab. |
...
> | Aktion | Microsoft.Sql/locations/transparentDataEncryptionAzureAsyncOperation/read | Ruft gegenwärtig ausgeführte Vorgänge für Transparent Data Encryption einer logischen Datenbank ab |
> | Aktion | Microsoft.Sql/locations/transparentDataEncryptionOperationResults/read | Ruft gegenwärtig ausgeführte Vorgänge für Transparent Data Encryption einer logischen Datenbank ab |
...
> | Aktion | Microsoft.Sql/managedInstances/databases/backupLongTermRetentionPolicies/read | Ruft eine Richtlinie zur langfristigen Aufbewahrung für eine verwaltete Datenbank ab. |
> | Aktion | Microsoft.Sql/managedInstances/databases/backupLongTermRetentionPolicies/write | Aktualisiert eine Richtlinie zur langfristigen Aufbewahrung für eine verwaltete Datenbank. |
...
> | Aktion | Microsoft.Sql/managedInstances/databases/columns/read | Zurückgeben einer Liste von Spalten für eine verwaltete Datenbank |
> | Aktion | Microsoft.Sql/managedInstances/databases/completeRestore/action | Führt den Vorgang zur Wiederherstellung einer verwalteten Datenbank durch. |
...
> | Aktion | Microsoft.Sql/managedInstances/databases/currentSensitivityLabels/write | Batchupdate von Vertraulichkeitsbezeichnungen |
...
> | Aktion | Microsoft.Sql/managedInstances/databases/recommendedSensitivityLabels/write | Batchupdate von empfohlenen Vertraulichkeitsbezeichnungen |
> | Aktion | Microsoft.Sql/managedInstances/databases/restoreDetails/read | Gibt Details zur Wiederherstellung einer verwalteten Datenbank während der Wiederherstellung zurück. |
> | Aktion | Microsoft.Sql/managedInstances/databases/schemas/read | Ruft ein verwaltetes Datenbankschema ab. (Nur Schema) |
> | Aktion | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/read | Ruft eine verwaltete Datenbankspalte ab (nur Schema). |
...
> | Aktion | Microsoft.Sql/managedInstances/databases/schemas/tables/read | Ruft eine verwaltete Datenbanktabelle ab (nur Schema). |
...
> | Aktion | Microsoft.Sql/managedInstances/encryptionProtector/revalidate/action | Aktualisiert die Eigenschaften für die angegebene Schutzvorrichtung zur Serververschlüsselung. |
...
> | Aktion | Microsoft.Sql/managedInstances/inaccessibleManagedDatabases/read | Ruft eine Liste mit den unzugänglichen verwalteten Datenbank einer verwalteten Instanz ab. |
...
> | Aktion | Microsoft.Sql/managedInstances/operations/cancel/action | Bricht einen ausstehenden asynchronen Vorgang einer verwaltete Azure SQL-Datenbank-Instanz ab, der noch nicht abgeschlossen ist. |
> | Aktion | Microsoft.Sql/managedInstances/operations/read | Ruft Vorgänge einer verwalteten Instanz ab. |
...
> | Aktion | Microsoft.Sql/privateEndpointConnectionsApproval/action | Bestimmt, ob der Benutzer eine private Endpunktverbindung genehmigen darf. |
...
> | Aktion | Microsoft.Sql/servers/administrators/delete | Löscht ein bestimmtes Azure Active Directory-Administratorobjekt. |
> | Aktion | Microsoft.Sql/servers/administrators/read | Ruft ein bestimmtes Azure Active Directory-Administratorobjekt ab. |
> | Aktion | Microsoft.Sql/servers/administrators/write | Fügt ein bestimmtes Azure Active Directory-Administratorobjekt hinzu, oder aktualisiert es. |
...
> | Aktion | Microsoft.Sql/servers/databases/backupShortTermRetentionPolicies/read | Ruft eine kurzfristige Aufbewahrungsrichtlinie für eine Datenbank ab |
> | Aktion | Microsoft.Sql/servers/databases/backupShortTermRetentionPolicies/write | Aktualisiert eine kurzfristige Aufbewahrungsrichtlinie für eine Datenbank |
> | Aktion | Microsoft.Sql/servers/databases/columns/read | Zurückgeben einer Liste von Spalten für eine Datenbank |
...
> | Aktion | Microsoft.Sql/servers/databases/currentSensitivityLabels/write | Batchupdate von Vertraulichkeitsbezeichnungen |
...
> | Aktion | Microsoft.Sql/servers/databases/extensions/importExtensionOperationResults/read | Ruft aktuell ausgeführte Importvorgänge ab. |
...
> | Aktion | Microsoft.Sql/servers/databases/failover/action | Vom Kunden initiiertes Datenbankfailover |
...
> | Aktion | Microsoft.Sql/servers/databases/recommendedSensitivityLabels/write | Batchupdate von empfohlenen Vertraulichkeitsbezeichnungen |
...
> | Aktion | Microsoft.Sql/servers/databases/schemas/read | Ruft ein Datenbankschema ab (nur Schema). |
> | Aktion | Microsoft.Sql/servers/databases/schemas/tables/columns/read | Ruft eine Datenbankspalte ab (nur Schema). |
...
> | Aktion | Microsoft.Sql/servers/databases/schemas/tables/read | Ruft eine Datenbanktabelle ab (nur Schema). |
...
> | Aktion | Microsoft.Sql/servers/databases/transparentDataEncryption/read | Ruft Details zur Transparent Data Encryption für logische Datenbanken für eine bestimmte verwaltete Datenbank ab |
> | Aktion | Microsoft.Sql/servers/databases/transparentDataEncryption/write | Ändert Transparent Data Encryption für Datenbanken für eine bestimmte logische Datenbank |
...
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/delete | Löscht eine bestimmte Arbeitsauslastungsgruppe. |
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/read | Listet die Arbeitsauslastungsgruppen für eine ausgewählte Datenbank auf. |
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/workloadClassifiers/delete | Löscht einen bestimmten Arbeitsauslastungsklassifizierer. |
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/workloadClassifiers/read | Listet die Arbeitsauslastungsklassifizierer für eine ausgewählte Datenbank auf. |
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/workloadClassifiers/write | Legt die Eigenschaften für einen bestimmten Arbeitsauslastungsklassifizierer fest. |
> | Aktion | Microsoft.Sql/servers/databases/workloadGroups/write | Legt die Eigenschaften für eine bestimmte Arbeitsauslastungsgruppe fest. |
...
> | Aktion | Microsoft.Sql/servers/disableAzureADOnlyAuthentication/action | Deaktiviert die ausschließliche Azure Active Directory-Authentifizierung auf dem logischen Server |
...
> | Aktion | Microsoft.Sql/servers/elasticPools/failover/action | Vom Kunden initiiertes Failover eines Pools für elastische Datenbanken |
...
> | Aktion | Microsoft.Sql/servers/encryptionProtector/revalidate/action | Aktualisiert die Eigenschaften für die angegebene Schutzvorrichtung zur Serververschlüsselung. |
...
> | Aktion | Microsoft.Sql/servers/inaccessibleDatabases/read | Gibt eine Liste mit den nicht zugänglichen Datenbanken auf einem logischen Server zurück. |
...
> | Aktion | Microsoft.Sql/servers/operations/read | Gibt die Liste mit den Vorgängen zurück, die auf dem Server ausgeführt werden. |
...
> | Aktion | Microsoft.Sql/servers/privateEndpointConnections/write | Genehmigt eine vorhandene Verbindung mit einem privaten Endpunkt, oder lehnt diese ab |
> | Aktion | Microsoft.Sql/servers/privateEndpointConnectionsApproval/action | Bestimmt, ob der Benutzer eine private Endpunktverbindung genehmigen darf. |
> | Aktion | Microsoft.Sql/servers/privateLinkResources/read | Ruft die Ressourcen der privaten Verknüpfung für die entsprechende SQL Server-Instanz ab |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.SqlVirtualMachine/locations/availabilityGroupListenerOperationResults/read | Ruft das Ergebnis des Vorgangs eines Verfügbarkeitsgruppenlisteners ab. |
> | Aktion | Microsoft.SqlVirtualMachine/locations/sqlVirtualMachineGroupOperationResults/read | Ruft das Ergebnis des Vorgangs einer Gruppe mit virtuellen SQL-Computern ab. |
> | Aktion | Microsoft.SqlVirtualMachine/locations/sqlVirtualMachineOperationResults/read | Ruft das Ergebnis des Vorgangs eines virtuellen SQL-Computers ab. |
> | Aktion | Microsoft.SqlVirtualMachine/operations/read |  |
> | Aktion | Microsoft.SqlVirtualMachine/register/action | Registriert das Abonnement beim Microsoft.SqlVirtualMachine-Ressourcenanbieter. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/delete | Löscht einen vorhandenen Verfügbarkeitsgruppenlistener. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/read | Ruft die Details eines SQL-Verfügbarkeitsgruppenlisteners für eine bestimmte Gruppe mit virtuellen SQL-Computern ab. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/write | Erstellt einen neuen SQL-Verfügbarkeitsgruppenlistener oder ändert dessen Eigenschaften. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/delete | Löscht eine vorhandene Gruppe mit virtuellen SQL-Computern. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/read | Ruft die Details einer Gruppe mit virtuellen SQL-Computern ab. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/sqlVirtualMachines/read | Listet die virtuellen SQL-Computer einer bestimmten Gruppe mit virtuellen SQL-Computern auf. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/write | Erstellt eine neue Gruppe mit virtuellen SQL-Computern oder ändert deren Eigenschaften. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachines/delete | Löscht einen vorhandenen virtuellen SQL-Computer. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachines/read | Ruft die Details eines virtuellen SQL-Computers ab. |
> | Aktion | Microsoft.SqlVirtualMachine/sqlVirtualMachines/write | Erstellt einen neuen virtuellen SQL-Computer oder ändert dessen Eigenschaften. |
> | Aktion | Microsoft.SqlVirtualMachine/unregister/action | Hebt die Registrierung des Abonnements beim Microsoft.SqlVirtualMachine-Ressourcenanbieter auf. |
...
> | Aktion | Microsoft.Storage/locations/checknameavailability/read | Prüft, ob der Kontoname gültig ist und noch nicht verwendet wird. |
...
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/manageOwnership/action | Ändert den Besitz des Blobs. |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/modifyPermissions/action | Ändert die Berechtigungen des Blobs. |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/move/action | Verschiebt das Blob aus einem Pfad in einen anderen. |
...
> | Aktion | Microsoft.Storage/storageAccounts/blobServices/containers/read | Hiermit wird eine Liste von Containern zurückgegeben. |
...
> | Aktion | Microsoft.Storage/storageAccounts/blobServices/read |  |
...
> | Aktion | Microsoft.Storage/storageAccounts/dataSharePolicies/delete |  |
> | Aktion | Microsoft.Storage/storageAccounts/dataSharePolicies/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/dataSharePolicies/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/dataSharePolicies/delete |  |
> | Aktion | Microsoft.Storage/storageAccounts/delete | Löscht ein vorhandenes Speicherkonto. |
> | Aktion | Microsoft.Storage/storageAccounts/encryptionScopes/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/encryptionScopes/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/encryptionScopes/write |  |
> | Aktion | Microsoft.Storage/storageAccounts/encryptionScopes/write |  |
...
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/read | Ruft Dateidiensteigenschaften ab. |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/shares/action |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/shares/delete |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/shares/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/shares/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/shares/write |  |
> | Aktion | Microsoft.Storage/storageAccounts/fileServices/write |  |
...
> | Aktion | Microsoft.Storage/storageAccounts/objectReplicationPolicies/delete |  |
> | Aktion | Microsoft.Storage/storageAccounts/objectReplicationPolicies/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/objectReplicationPolicies/read |  |
> | Aktion | Microsoft.Storage/storageAccounts/objectReplicationPolicies/write |  |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/delete | Löscht die Proxys der Verbindung mit privatem Endpunkt |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/read | Abrufen des Verbindungsproxys des privaten Endpunkts |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/write | Gibt die Proxys der Verbindung mit privatem Endpunkt an |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnections/delete | Löscht eine Verbindung mit privatem Endpunkt |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnections/read | Ruft eine Verbindung mit privatem Endpunkt ab |
> | Aktion | Microsoft.Storage/storageAccounts/privateEndpointConnections/write | Platziert eine Verbindung mit privatem Endpunkt |
> | Aktion | Microsoft.Storage/storageAccounts/PrivateEndpointConnectionsApproval/action | Bestätigt Verbindungen mit privaten Endpunkten |
> | Aktion | Microsoft.Storage/storageAccounts/privateLinkResources/read | Ruft die StorageAccount-Gruppen-IDs ab |
...
> | Aktion | Microsoft.Storage/storageAccounts/restoreBlobRanges/action | Stellt Blobbereiche auf den Status der angegebenen Zeit wieder her |
...
> | Aktion | microsoft.storagesync/operations/read | Ruft eine Liste der unterstützten Vorgänge ab. |
> | Aktion | microsoft.storagesync/register/action | Registriert das Abonnement für den Speichersynchronisierungsanbieter. |
...
> | Aktion | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/triggerChangeDetection/action | Rufen Sie diese Aktion auf, um die Erkennung von Änderungen auf der Dateifreigabe eines Cloudendpunkts auszulösen. |
...
> | Aktion | microsoft.storagesync/unregister/action | Hebt die Registrierung des Abonnements für den Speichersynchronisierungsanbieter auf. |
...
> | Aktion | Microsoft.StorSimple/managers/migrateClassicToResourceManager/action | Migrieren von klassischen Bereitstellungen zu Resource Manager-Bereitstellungen |
...
> | Aktion | Microsoft.StreamAnalytics/streamingjobs/PublishEdgePackage/action | Veröffentlicht ein Edgepaket für einen Stream Analytics-Auftrag. |
> | Aktion | Microsoft.StreamAnalytics/streamingjobs/Read | Dient zum Lesen von Stream Analytics-Aufträgen. |
> | Aktion | Microsoft.StreamAnalytics/streamingjobs/Scale/action | Skaliert einen Stream Analytics-Auftrag. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Subscription/cancel/action | Kündigt das Abonnement. |
...
> | Aktion | Microsoft.Subscription/rename/action | Benennt das Abonnement um. |
...
> | Aktionstyp | Vorgang | BESCHREIBUNG |
> | --- | --- | --- |
> | Aktion | Microsoft.Support/checkNameAvailability/action | Überprüft, ob der Name gültig ist und nicht für den Ressourcentyp verwendet wird. |
> | Aktion | Microsoft.Support/operationresults/read | Hiermit rufen Sie das Vorgangsergebnis ab. |
> | Aktion | Microsoft.Support/operations/read | Listet die verfügbaren Vorgänge für den Microsoft.Support-Ressourcenanbieter auf. |
> | Aktion | Microsoft.Support/operationsstatus/read | Vorgangsstatus abrufen |
> | Aktion | Microsoft.Support/register/action | Registriert den Supportressourcenanbieter. |
> | Aktion | Microsoft.Support/services/problemClassifications/read | Ruft die Liste der für einen Azure-Dienst verfügbaren Problemklassifizierung ab. |
> | Aktion | Microsoft.Support/services/read | Ruft die Liste der für Support verfügbaren Azure-Dienste ab. |
> | Aktion | Microsoft.Support/supportTickets/communications/read | Ruft die Liste der Supportticketmitteilungen ab. |
> | Aktion | Microsoft.Support/supportTickets/communications/write | Erstellt Supportticketmitteilungen. |
> | Aktion | Microsoft.Support/supportTickets/read | Ruft die Liste der Supporttickets ab. |
> | Aktion | Microsoft.Support/supportTickets/write | Erstellt ein Supportticket asynchron oder aktualisiert es. Sie können ein Supportticket zu technischen Problemen bzw. zu Problemen im Zusammenhang mit Abrechnung, Kontingenten oder Abonnementverwaltung erstellen. Sie können den Schweregrad und die Kontaktinformationen für vorhandene Supporttickets aktualisieren. |
...
> | Aktion | Microsoft.Web/hostingEnvironments/eventGridFilters/delete | Löscht einen Event Grid-Filter für die Hostingumgebung. |
> | Aktion | Microsoft.Web/hostingEnvironments/eventGridFilters/read | Ruft einen Event Grid-Filter für die Hostingumgebung ab. |
> | Aktion | Microsoft.Web/hostingEnvironments/eventGridFilters/write | Legt einen Event Grid-Filter für die Hostingumgebung fest. |
...
> | Aktion | microsoft.web/locations/operationResults/read | Dient zum Abrufen von Vorgängen. |
> | Aktion | microsoft.web/locations/operations/read | Dient zum Abrufen von Vorgängen. |
...
> | Aktion | Microsoft.Web/serverfarms/eventGridFilters/delete | Löschen des Event Grid-Filters für eine Serverfarm. |
> | Aktion | Microsoft.Web/serverfarms/eventGridFilters/read | Abrufen des Event Grid-Filters für eine Serverfarm. |
> | Aktion | Microsoft.Web/serverfarms/eventGridFilters/write | Festlegen des Event Grid-Filters für eine Serverfarm. |
...
> | Aktion | Microsoft.Web/sites/eventGridFilters/delete | Löschen des Event Grid-Filters für eine Web-App. |
> | Aktion | Microsoft.Web/sites/eventGridFilters/read | Abrufen des Event Grid-Filters für eine Web-App. |
> | Aktion | Microsoft.Web/sites/eventGridFilters/write | Festlegen des Event Grid-Filters für eine Web-App. |
...
> | Aktion | microsoft.web/sites/functions/keys/delete | Löschen von Funktionsschlüsseln. |
> | Aktion | microsoft.web/sites/functions/keys/write | Aktualisieren von Funktionsschlüsseln. |
> | Aktion | microsoft.web/sites/functions/listkeys/action | Auflisten von Funktionsschlüsseln. |
> | Aktion | microsoft.web/sites/functions/listsecrets/action | Auflisten von Funktionsgeheimnissen. |
> | Aktion | microsoft.web/sites/functions/masterkey/read | Dient zum Abrufen des Hauptschlüssels von Web-Apps-Funktionen. |
> | Aktion | microsoft.web/sites/functions/properties/read | Lesen von Web-Apps-Funktionseigenschaften. |
> | Aktion | microsoft.web/sites/functions/properties/write | Aktualisieren von Web-Apps-Funktionseigenschaften. |
...
> | Aktion | microsoft.web/sites/host/functionkeys/delete | Löschen von Functions-Hostfunktionsschlüsseln. |
> | Aktion | microsoft.web/sites/host/functionkeys/write | Aktualisieren von Functions-Hostfunktionsschlüsseln. |
> | Aktion | microsoft.web/sites/host/listkeys/action | Auflisten von Functions-Hostschlüsseln. |
> | Aktion | microsoft.web/sites/host/listsyncstatus/action | Auflisten des Status von Synchronisierungsfunktionstriggern. |
> | Aktion | microsoft.web/sites/host/properties/read | Lesen von Web-Apps-Functions-Hosteigenschaften. |
> | Aktion | microsoft.web/sites/host/sync/action | Synchronisieren von Funktionstriggern. |
> | Aktion | microsoft.web/sites/host/systemkeys/delete | Löschen von Functions-Hostsystemschlüsseln. |
> | Aktion | microsoft.web/sites/host/systemkeys/write | Aktualisieren von Functions-Hostsystemschlüsseln. |
...
> | Aktion | microsoft.web/sites/listsyncfunctiontriggerstatus/action | Auflisten des Status von Synchronisierungsfunktionstriggern. |
...
> | Aktion | microsoft.web/sites/restorefromdeletedapp/action | Hiermit stellen Sie Web-Apps aus einer gelöschten App wieder her. |
...
> | Aktion | microsoft.web/sites/slots/extensions/read | Ruft Erweiterungen von Web-Apps-Slots ab |
> | Aktion | microsoft.web/sites/slots/extensions/write | Aktualisiert Erweiterungen von Web-Apps-Slots |
...
> | Aktion | microsoft.web/sites/slots/restorefromdeletedapp/action | Hiermit stellen Sie Web-App-Slots aus einer gelöschten App wieder her. |
...
> | Aktion | microsoft.web/sites/syncfunctiontriggers/action | Synchronisieren von Funktionstriggern. |
