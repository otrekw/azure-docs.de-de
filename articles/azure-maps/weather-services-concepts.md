...
| 25           | :::image type="icon" source="./media/weather-services-concepts/sleet-i.png"::: | Ja |  Ja   | Schneeregen|
...
Über die [Get Map Tile v2-API](/rest/api/maps/render-v2/get-map-tile) können Benutzer die neuesten Radar- und Infrarotsatellitenbilder anfordern. Weitere Informationen zur Interpretation von Farben für Radar- und Satellitenkacheln finden Sie im nachfolgenden Leitfaden.
...
| #b71691        | ![Farbe für sehr starken Eisregen.](./media/weather-services-concepts/color-b71691.png) | Ice-Severe |
