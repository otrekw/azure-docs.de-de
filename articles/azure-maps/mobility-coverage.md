---
title: Mobilitätsabdeckung (Verkehr) in Mobilitätsdiensten von Microsoft Azure Maps (Vorschau)
description: Erfahren Sie, welchen Grad der Abdeckung die Azure Maps-Mobilitätsdienste (Vorschau) in welchen Regionen für Funktionen des öffentlichen Nahverkehrs wie Streckenplanung und Dienstwarnungen bietet.
author: anastasia-ms
ms.author: v-stharr
ms.date: 12/07/2020
ms.topic: conceptual
...
Die folgende Tabelle enthält Informationen dazu, welche Abdeckung die Mobilitätsdienste von Azure Maps bieten.
...
| Mexiko | Acapulco, Aguascalientes, Cancun, Durango, Mexico City, Guadalajara, Lion, Merida, Monterrey, Puebla, Puerto Vallarta, Querétaro, San Luis Potosi, Tijuana, Torreon|
| Nicaragua | Managua |
| Panama | Panama*|
| Peru | Cusco, Lima |
...
| Griechenland | <p>Agrinio, Aigio, Athen, Arta, Amorgos, Chania, Corfu, Chios Kos, Heraklion, Ioannina, Kavala, Kalamata, Khios, Komotini, Kos, Larissa, Meganisi, Milos, Mykonos, Patra, Rethimno, Rhodes, Santorini, Serres, Syros, Tinos, Thessaloniki, Veria, Volos, Xanthi </P> |
...
| Russland  | Kaliningrad, Rostow am Don, Wolgograd, Jekaterinburg, Kasan, Kirow, Krasnodar, Moskau, Naltschik, Nischni Nowgorod, Nowosibirsk, Nojabrsk, Omsk, Oryol, Perm, Pyatigorsk, Sankt Petersburg, Twer, Tomsk |
...
| Türkei | Adana-Mersin, Ankara, Antalya, Balıkesir, Bilecik, Bolu, Bursa, Çorum, Denizli, Duzce, Edirne, Elazig, Eskisehir, Istanbul, Izmir-Aydin, Kahramanmaras, Kayseri, Konya, Malatya, Muğla, Samsun, Şanlıurfa, Trabzon |
...
| Marokko | Casablanca, Essaouira, Khouribga, Tétouan|
| Katar| Doha|
