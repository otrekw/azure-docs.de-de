...
ms.locfileid: "122355841"
---
# <a name="choose-the-right-pricing-tier-in-azure-maps"></a>Auswählen des richtigen Tarifs in Azure Maps

Azure Maps bietet jetzt zwei Preisstufen an:  Gen 1 und Gen 2. Die neue Preisstufe Gen 2 enthält alle Azure Maps-Funktionen ohne QPS-Beschränkung (Abfragen pro Sekunde) und ermöglicht Ihnen Kosteneinsparungen bei steigenden Azure Maps-Transaktionen. Dieser Artikel soll Ihnen bei der Auswahl des richtigen Tarifs für Ihre Ansprüche helfen.
...
| **Gen2** | Karten/Standort-Erkenntnisse | Die Preisstufe Gen 2 ist für neue und aktuelle Azure Maps Kunden. Gen 2 wird mit einer kostenlosen monatlichen Transaktionsstufe geliefert, die zum Testen und Erstellen von Azure-Karten verwendet wird. Karten und SKU-Standort-Erkenntnisse enthalten alle Azure Maps Funktionen. Außerdem bestehen keine QPS-Einschränkungen (Abfragen pro Sekunde), was bei den meisten Diensten zu Kosteneinsparungen führt, während gleichzeitig die Azure Maps-Transaktionen zunehmen.  
|     |  |
