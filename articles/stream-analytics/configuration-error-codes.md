...
* **Ursache:** Der Stream Analytics-Auftrag verfügt nicht über die erforderliche Berechtigung zum Ausführen bestimmter Aktionen.

## <a name="kafkainvalidconfiguration"></a>KafkaInvalidConfiguration

* **Ursache:** Bestimmte Konfigurationen für den Kafka-Adapter sind ungültig.

## <a name="kafkainvalidtimestamptype"></a>KafkaInvalidTimestampType

* **Ursache:** Der von Kafka verwendete Zeitstempeltyp ist ungültig.
