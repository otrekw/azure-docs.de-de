...
Im Folgenden finden Sie die Lösungsarchitektur, die Sie implementieren werden.
   ...
   ![Ein Diagramm, das die verschiedenen Dienste und Anwendungen zeigt, die zum Erstellen der Lösung verwendet werden.](./media/stream-analytics-twitter-sentiment-analysis-trends/solution-diagram.png "Lösungsdiagramm")
