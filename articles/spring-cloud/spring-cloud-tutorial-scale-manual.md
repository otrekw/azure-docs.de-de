...
* **Anzahl von App-Instanzen**: Im Standard-Tarif können Sie maximal 20 Instanzen horizontal hochskalieren. Dieser Wert ändert die Anzahl separat ausgeführter Instanzen der Microserviceanwendung.
