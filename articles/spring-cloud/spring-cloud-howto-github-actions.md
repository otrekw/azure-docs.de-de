...
Für dieses Beispiel wird die [Azure-Befehlszeilenschnittstelle](/cli/azure/install-azure-cli) benötigt.
...
* [Azure Active Directory-Dienstprinzipale](/cli/azure/ad/sp#az-ad-sp-create-for-rbac)
