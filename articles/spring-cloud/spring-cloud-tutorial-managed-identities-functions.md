...
* [Konfigurieren einer Daemon-Clientanwendung für Aufrufe zwischen Diensten](../app-service/configure-authentication-provider-aad.md#configure-a-daemon-client-application-for-service-to-service-calls)