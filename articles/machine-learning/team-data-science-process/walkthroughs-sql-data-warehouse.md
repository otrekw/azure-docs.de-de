...
Die exemplarische Vorgehensweise [Verwenden von SQL Data Warehouse](sqldw-walkthrough.md) zeigt, wie Sie mit SQL Data Warehouse (SQL DW) Modelle für die Machine Learning-Klassifizierung und -Regression erstellen und bereitstellen.  Bei den Daten handelt es sich um ein öffentlich zugängliches Dataset mit Taxifahrten und Fahrpreisen für New York.
