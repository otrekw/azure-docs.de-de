...
- Schreiben der transformierten Daten in die `PipelineData`-Ausgabepfade
...
>[!Important]
> Wenn `AutoMLStep` `PipelineOutputTabularDataset`-Objekte als Eingabe verwendet, müssen Sie `passthru_automl_config` auf `False` festlegen.
