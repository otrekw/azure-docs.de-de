...
> [!NOTE]
> Diese Liste wurde im Dezember 2020 aktualisiert. Mit dem Python SDK können Sie die aktuellste Liste der Umgebungen mit ihren Abhängigkeiten abrufen. Weitere Informationen finden Sie im [Artikel zu Umgebungen](./how-to-use-environments.md#use-a-curated-environment).
