...
[![Graph der Pipeline](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png)](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png#lightbox)
...
![Datenverarbeitung](./media/how-to-designer-sample-classification-flight-delay/data-process.png)
...
Die Flugdatensätze werden mit den Wetterdaten am Ausgangspunkt des Fluges (**OriginAirportID**) über das Modul **Join Data** verknüpft.
 ...
 ![Verknüpfen von Flug- und Wetterdaten nach Ursprung](./media/how-to-designer-sample-classification-flight-delay/join-origin.png)


Flugdatensätze werden mit Wetterdaten anhand des Flugziels verknüpft (**DestAirportID**).

 ![Verknüpfen von Flug- und Wetterdaten nach Ziel](./media/how-to-designer-sample-classification-flight-delay/join-destination.png)
...
Das Modul **Split Data** trennt die Daten in die Datensätze von April bis September für das Training und von Oktober für den Test.
 ...
 ![Trennen von Trainings- und Testdaten](./media/how-to-designer-sample-classification-flight-delay/split.png)
...
Das logistische Regressionsmodell verwendet für den Testsatz einen AUC-Wert von 0.631.
 ...
 ![Evaluieren](media/how-to-designer-sample-classification-flight-delay/sample6-evaluate-1225.png)
