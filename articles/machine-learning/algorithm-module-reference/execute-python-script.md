...
Nachdem die Pipeline erfolgreich übermittelt wurde, können Sie eine Vorschau des Images im rechten Bereich des Moduls ![Uploaded-image](media/module/upload-image-in-python-script.png) anzeigen.
