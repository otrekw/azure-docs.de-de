...
ms.locfileid: "90905173"
---
# <a name="score-wide-and-deep-recommender"></a>Score Wide and Deep Recommender

In diesem Artikel wird beschrieben, wie Sie das Modul **Score Wide & Deep Recommender** im Azure Machine Learning-Designer verwenden, um ausgehend von einem trainierten Empfehlungsmodell, das auf Wide & Deep Learning von Google basiert, Vorhersagen zu treffen.
