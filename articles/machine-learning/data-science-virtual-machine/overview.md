...
description: 'Übersicht über Azure Data Science Virtual Machine: ein einfach zu erstellender und verwendender virtueller Computer auf der Azure-Cloudplattform mit vorinstallierten und konfigurierten Tools und Bibliotheken für Data Science-Vorgänge und die Entwicklung intelligenter Anwendungen.'
...
Die Windows-Editionen von DSVM enthalten vorinstallierte GPU-Treiber und -Frameworks sowie GPU-Versionen der Deep Learning-Frameworks. Unter der Linux-Edition ist GPU-basiertes Deep Learning in der DSVM-Instanz mit Ubuntu aktiviert. 
