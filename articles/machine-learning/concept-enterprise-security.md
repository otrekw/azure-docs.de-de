...
Ausführliche Beispiele und Anweisungen zum Einrichten der Authentifizierung, einschließlich der Dienstprinzipalauthentifizierung für automatisierte Workflows, finden Sie in der Anleitung [Einrichten der Authentifizierung](how-to-setup-authentication.md).
...
Im [Abschnitt „Webdienstauthentifizierung“](how-to-setup-authentication.md#web-service-authentication) finden Sie Codebeispiele zum Authentifizieren bei Webdiensten in Azure Machine Learning.
