...
* Hinzufügen von Eigenschaften und Tags
    ...
    :::image type="content" source="media/how-to-manage-runs/run-tags.gif" alt-text="Screenshot: Ausführungstags hinzufügen, bearbeiten oder löschen":::
...
Sie können über das Feld `Run.parent` auf die Ausführung zugreifen, die die aktuelle untergeordnete Ausführung gestartet hat. Ein häufiger Anwendungsfall für `Run.parent`ist die Zusammenfassung von Protokollergebnissen an einer einzigen Stelle. Beachten Sie, dass Child-Ausführungen asynchron ausgeführt werden und es keine Garantie für die Reihenfolge oder Synchronisation gibt, abgesehen von der Fähigkeit der Parent-Ausführung, auf die Fertigstellung seiner Child-Ausführungen abzuwarten.
