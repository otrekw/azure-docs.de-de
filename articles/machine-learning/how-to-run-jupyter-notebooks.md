...
### <a name="a-nameterminal-use-files-from-git-and-version-my-files"></a><a name="terminal"> Verwenden von Dateien aus Git und Versionsverwaltung für meine Dateien
