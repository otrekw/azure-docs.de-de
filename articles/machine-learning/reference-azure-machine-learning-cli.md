...
+ Registrieren eines Datasets:
    ...
    Informationen zum Format der JSON-Datei, mit der das Dataset definiert wird, finden Sie unter `az ml dataset --show-template`.
