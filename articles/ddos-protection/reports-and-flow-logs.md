...
Diese [Vorlage](https://github.com/Azure/Azure-Network-Security/tree/master/Azure%20DDoS%20Protection/Enable%20Diagnostic%20Logging/Azure%20Policy) erstellt eine Azure Policy-Definition, um die diagnostische Protokollierung zu aktivieren.

### <a name="azure-sentinel-data-connector"></a>Azure Sentinel-Datenconnector

Sie können Protokolle des Angriffsrisikominderungsflusses mit Azure Sentinel verbinden, Ihre Daten in Arbeitsmappen anzeigen und analysieren, benutzerdefinierte Warnungen erstellen und diese in Untersuchungsprozesse integrieren. Informationen zum Herstellen einer Verbindung mit Azure Sentinel finden Sie unter [Herstellen einer Verbindung mit Azure Sentinel](../sentinel/connect-azure-ddos-protection.md). 
...
## <a name="sample-log-outputs"></a>Beispielprotokollausgaben

Die folgenden Screenshots sind Beispielprotokollausgaben:
