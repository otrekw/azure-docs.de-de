...
* Machen Sie sich mit der Arbeit mit dem aktuellen Release in folgendem Schnellstart vertraut: [Schnellstart: Erste Schritte mit dem Azure Digital Twins-Explorer](quickstart-azure-digital-twins-explorer.md).
