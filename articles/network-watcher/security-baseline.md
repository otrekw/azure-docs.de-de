...
description: Die Sicherheitsbaseline für Network Watcher enthält Schritt-für-Schritt-Anleitungen und Ressourcen für die Implementierung der Sicherheitsempfehlungen aus dem Vergleichstest für die Azure-Sicherheit.
author: msmbaldwin
...
ms.locfileid: "105969035"
---
# <a name="azure-security-baseline-for-network-watcher"></a>Azure-Sicherheitsbaseline für Network Watcher

Diese Sicherheitsbaseline wendet Empfehlungen aus [Version 1.0 des Azure-Sicherheitsvergleichstests](../security/benchmarks/overview-v1.md) auf Network Watcher an. Der Azure-Sicherheitsvergleichstest enthält Empfehlungen zum Schutz Ihrer Cloudlösungen in Azure. Der Inhalt ist nach den **Sicherheitskontrollen** gruppiert, die durch den Azure-Sicherheitsvergleichstest und die entsprechenden, für Network Watcher geltenden Empfehlungen definiert werden. Nicht auf Network Watcher anwendbare **Steuerungen** oder Steuerungen, für die Microsoft die Verantwortung trägt, wurden ausgeschlossen.

Die gesamte Zuordnung zwischen Network Watcher und dem Azure-Sicherheitsvergleichstest finden Sie in der [vollständigen Zuordnungsdatei der Network Watcher-Sicherheitsbaseline](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
Bewahren Sie den Überblick über dedizierte administrative Konten, und verwenden Sie Empfehlungen von Security Center oder integrierte Azure-Richtlinien, zum Beispiel:
