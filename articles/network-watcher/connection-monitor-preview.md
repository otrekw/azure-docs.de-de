---
title: Verbindungsmonitor (Vorschau) | Microsoft-Dokumentation
...
| Testnummer | Quelle | Ziel | Testkonfiguration |
| --- | --- | --- | --- |
| 1 | A | D | Config 1 |
| 2 | A | D | Config 2 |
| 3 | A | E | Config 1 |
...
| Metrik | Anzeigename | Einheit | Aggregationstyp | BESCHREIBUNG | Dimensionen |
| --- | --- | --- | --- | --- | --- |
