...
2. Erstellen Sie mit dem Cmdlet **New-AzStorageAccount** das Speicherkonto [mystorageaccount](https://docs.microsoft.com/powershell/module/az.storage/new-azstorageaccount) in dieser Ressourcengruppe:
