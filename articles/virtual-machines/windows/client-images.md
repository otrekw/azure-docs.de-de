...
> [!NOTE]
> Imageangebote unter **Windows Client** im Azure Marketplace. Verwenden Sie den **Windows-Client** beim Suchen nach Clientimages für Visual Studio-Abonnenten. 
