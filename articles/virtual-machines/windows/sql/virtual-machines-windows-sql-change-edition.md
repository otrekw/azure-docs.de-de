...
Nachdem Sie die Edition von SQL Server mithilfe der Installationsmedien geändert und Ihre SQL Server-VM beim [SQL-VM-Ressourcenanbieter](virtual-machines-windows-sql-register-with-resource-provider.md) registriert haben, können Sie die Eigenschaft „Edition“ der SQL Server-VM im Azure-Portal zu Abrechnungszwecken ändern. Gehen Sie dazu folgendermaßen vor: 
