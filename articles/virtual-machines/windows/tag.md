...
Das erste Cmdlet legt alle Tags, die auf *MyTestVM* platziert sind, mithilfe der Eigenschaften *und* auf die `Get-AzResource`$tags`Tags`-Variable fest.
