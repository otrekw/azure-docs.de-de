...
Die Unterstützung für SAP Hybris Commerce Platform 5.x und 6.x in Azure ist im [Hybris-Wiki](https://wiki.hybris.com/display/SUP/Using+the+hybris+Platform+with+the+Cloud) beschrieben.
