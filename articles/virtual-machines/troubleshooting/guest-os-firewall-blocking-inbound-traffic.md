...
description: Erfahren Sie, wie Sie das Verbindungsproblem beim Remote Desktop Portal (RDP) beheben, bei dem die Firewall des Gastbetriebssystems eingehenden Datenverkehr blockiert.
