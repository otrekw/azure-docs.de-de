...
Weitere Informationen zum Verwenden von Azure Monitor zur Verwaltung von Azure-VMs finden Sie unter [Überwachen von virtuellen Azure-Computern mit Azure Monitor](../../azure-monitor/vm/monitor-vm-azure.md).
