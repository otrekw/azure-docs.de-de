---
title: Azure CLI-Skriptbeispiel – Installieren von IIS
...
ms.locfileid: "87499210"
---
# <a name="create-a-virtual-machine-with-the-azure-cli-with-a-custom-script-to-install-iis"></a>Erstellen eines virtuellen Computers mit der Azure CLI mit einem benutzerdefinierten Skript zum Installieren von IIS
...
| [azure vm extension set](/cli/azure/vm/extension) | Fügt eine VM-Erweiterung zu einem virtuellen Computer hinzu und führt diese aus. In diesem Beispiel wird die benutzerdefinierte Skripterweiterung zum Installieren von IIS verwendet.|
