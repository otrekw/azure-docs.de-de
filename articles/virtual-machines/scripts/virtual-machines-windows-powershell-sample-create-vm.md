---
title: 'Azure PowerShell-Skriptbeispiel: Erstellen einer vollständig konfigurierten Windows-VM'
description: 'Azure PowerShell-Skriptbeispiel: Erstellen einer vollständig konfigurierten Windows-VM'
