...
| [New-AzStorageAccount](https://docs.microsoft.com/powershell/module/az.storage/new-azstorageaccount)                         | Erstellt ein Speicherkonto.                                                                                                                                                           |
| [Add-AzVhd](https://docs.microsoft.com/powershell/module/az.compute/add-azvhd)                                               | Lädt eine virtuelle Festplatte von einem lokalen virtuellen Computer zu einem Blob in einem Cloudspeicherkonto in Azure hoch                                                                       |
| [New-AzImageConfig](https://docs.microsoft.com/powershell/module/az.compute/new-azimageconfig)                               | Erstellt ein konfigurierbares Imageobjekt                                                                                                                                                 |
| [Set-AzImageOsDisk](https://docs.microsoft.com/powershell/module/az.compute/set-azimageosdisk)                               | Legt die Eigenschaften des Betriebssystemdatenträgers für ein Imageobjekt fest                                                                                                                        |
| [New-AzImage](https://docs.microsoft.com/powershell/module/az.compute/new-azimage)                                           | Erstellt ein neues Image                                                                                                                                                                 |
...
| [Get-AzVirtualNetwork](https://docs.microsoft.com/powershell/module/az.network/get-azvirtualnetwork)                         | Ruft ein virtuelles Netzwerk in einer Ressourcengruppe ab                                                                                                                                          |
...
| [Set-AzVMSourceImage](https://docs.microsoft.com/powershell/module/az.compute/set-azvmsourceimage)                           | Gibt ein Image für einen virtuellen Computer an                                                                                                                                            |
| [Set-AzVMOSDisk](https://docs.microsoft.com/powershell/module/az.compute/set-azvmosdisk)                                     | Legt die Eigenschaften des Betriebssystemdatenträgers eines virtuellen Computers fest                                                                                                                      |
| [Set-AzVMOperatingSystem](https://docs.microsoft.com/powershell/module/az.compute/set-azvmoperatingsystem)                   | Legt die Eigenschaften des Betriebssystemdatenträgers eines virtuellen Computers fest                                                                                                                      |
