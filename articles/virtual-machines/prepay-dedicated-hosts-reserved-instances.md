...
Beginnen Sie, indem Sie die unterstützten Größen für [virtuellen Windows-Computer](./sizes.md) oder [Linux](./sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) ermitteln, um die VM-Serie zu identifizieren.
