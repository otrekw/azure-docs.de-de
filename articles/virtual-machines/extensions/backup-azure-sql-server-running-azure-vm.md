...
Wir empfehlen, die Erweiterung AzureBackupWindowsWorkload zu einem virtuellen Computer hinzuzufügen, indem Sie die SQL Server-Sicherung auf dem virtuellen Computer aktivieren. Dafür verwenden Sie die [Resource Manager-Vorlage](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.recoveryservices/recovery-services-vm-workload-backup),die für die Automatisierung der Sicherung auf einer SQL Server-VM entwickelt wurde.
