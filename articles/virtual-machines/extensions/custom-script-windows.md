...
* Die Erweiterung für benutzerdefinierte Skripts verfügt über keine native Proxyserverunterstützung. Sie können innerhalb Ihres Skripts jedoch ein Dateiübertragungstool mit Proxyserverunterstützung verwenden (beispielsweise *Invoke-WebRequest*).
...
* `fileUris` (optional, Zeichenfolgenarray): die URLs für die herunterzuladenden Dateien. Wenn URLs vertraulich sind (z. B. URLs mit Schlüsseln), sollte dieses Feld in protectedSettings angegeben werden.
...
Informationen zum Bereitstellen der benutzerdefinierten Skripterweiterung für eine Skalierungsgruppe finden Sie unter [Add-AzVmssExtension](/powershell/module/az.compute/add-azvmssextension).
