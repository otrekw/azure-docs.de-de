...
Verwenden Sie den **parted**-Befehl, um zu Bestimmen, ob die Datenträgerpartition mit einer Master Boot Record-Partition (MBR) oder einer GPT-Partition erstellt wurde.
...
Wenn der Neustart der VM erfolgt ist, führen Sie die folgenden Schritte aus:
   ...
   1. Verwenden Sie den folgenden Befehl, um das **gptfdisk**-Paket zu installieren, das erforderlich ist, um die Größe des Betriebssystem-Datenträgers heraufzusetzen:
   ...
   1. Führen Sie den Befehl **#lsblk** aus, um zu prüfen, ob die Partition vergrößert wurde.

      Die folgende Ausgabe zeigt, dass die Partition **/dev/sda4** auf 98,5 GB vergrößert wurde.
   ...
   1. Bestimmen Sie den Typ des Dateisystems auf dem Betriebssystem-Datenträger mithilfe des folgenden Befehls:
