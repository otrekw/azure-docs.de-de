...
In diesem Abschnitt erfahren Sie, wie Sie mit dem Hyper-V-Manager eine [RHEL 6](#rhel-6-using-hyper-v-manager)- oder [RHEL 7](#rhel-7-using-hyper-v-manager)-VM vorbereiten.
