...
3. Stellen Sie die Verbindung mit dem virtuellen Computer wieder her, und setzen Sie die Installation mit den folgenden Befehlen fort:
   ...
   Die Installation kann einige Minuten dauern. 
    ...
    > [!NOTE]
   >  Besuchen Sie das [Fedora-](https://dl.fedoraproject.org/pub/epel/) und [Nvidia-CUDA-Repository](https://developer.download.nvidia.com/compute/cuda/repos/), um das richtige Paket für die gewünschte CentOS- oder RHEL-Version zu wählen.
   >  
...
* Wenn Sie ein Linux-VM-Image mit den installierten NVIDIA-Treibern erfassen möchten, lesen Sie [Generalisieren und Erfassen eines virtuellen Linux-Computers](capture-image.md).
