...
- Wenn Sie Fragen zum Thema Verschlüsselung haben, sehen Sie sich die [häufig gestellten Fragen zu Azure Backup](/azure/backup/backup-azure-backup-faq.yml#encryption) an.