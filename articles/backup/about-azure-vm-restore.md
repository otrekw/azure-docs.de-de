...
ms.locfileid: "84325675"
---
# <a name="about-azure-vm-restore"></a>Informationen zur Wiederherstellung von Azure-VMs

In diesem Artikel wird beschrieben, wie virtuelle Azure-Computer (VMs) mit dem Dienst [Azure Backup](https://docs.microsoft.com/azure/backup/backup-overview) wiederhergestellt werden. Es gibt eine Reihe von Wiederherstellungsoptionen. Wir besprechen die verschiedenen Szenarien, in denen Sie unterstützt werden.
...
- **Regionsübergreifende Wiederherstellung**: Als eine der [Wiederherstellungsoptionen](https://docs.microsoft.com/azure/backup/backup-azure-arm-restore-vms#restore-options) ermöglicht die regionsübergreifende Wiederherstellung die Wiederherstellung von Azure-VMs in einer sekundären Region, bei der es sich um eine [gekoppelte Azure-Region](https://docs.microsoft.com/azure/best-practices-availability-paired-regions#what-are-paired-regions) handelt.
...
- [Unterstützte Wiederherstellungsmethoden](https://docs.microsoft.com/azure/backup/backup-support-matrix-iaas#supported-restore-methods)
- [Problembehandlung bei der Wiederherstellung](https://docs.microsoft.com/azure/backup/backup-azure-vms-troubleshoot#restore)
