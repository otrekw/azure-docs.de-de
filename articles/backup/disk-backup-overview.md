...
Azure Disk Backup ist eine absturzsichere Lösung ohne Agent, die [inkrementelle Momentaufnahmen](https://docs.microsoft.com/azure/virtual-machines/windows/disks-incremental-snapshots) verwendet und die folgenden Vorteile bietet:
