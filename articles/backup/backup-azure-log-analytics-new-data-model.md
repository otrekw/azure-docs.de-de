...
| OperationName                     | Text          | Dieses Feld repräsentiert den Namen des aktuellen Vorgangs: BackupItem, BackupItemAssociation oder ProtectedContainer |
...
| OperationName                  | Text          | Name des aktuellen Vorgangs. Beispiel: Warnung            |
...
| OperationName                  | Text          | Name des Vorgangs (z. B. ProtectedInstance)         |
...
| ------------------------------- | -------------- | ------------------------------------------------------------ |
| resourceId                      | Text           | eindeutiger Bezeichner der Ressource, zu der Daten gesammelt werden. Beispiel: eine Ressourcen-ID des Recovery Services-Tresors |
| OperationName                   | Text           | Name des Vorgangs (z. B. Richtlinie oder PolicyAssociation) |
...
| DiffBackupRetentionDuration     | Dezimalzahl | Aufbewahrungsdauer für differenzielle Sicherungen für SQL im Azure Backup-Dienst für VMs |
| DiffBackupTime                  | Time           | Zeit für differenzielle Sicherungen für SQL im Azure Backup-Dienst für VMs     |
| LogBackupFrequency              | Dezimalzahl | Häufigkeit von Protokollsicherungen für SQL                            |
| LogBackupRetentionDuration      | Dezimalzahl | Aufbewahrungsdauer für Protokollsicherungen für SQL im Azure Backup-Dienst für VMs |
...
| WeeklyRetentionDuration         | Dezimalzahl | Gesamte wöchentliche Aufbewahrungsdauer in Wochen für konfigurierte Sicherungen |
...
| ------------------------------ | ------------- | ------------------------------------------------------------ |
| resourceId                     | Text          | Ressourcenbezeichner der Daten, die erfasst werden. Beispiel: Ressourcen-ID des Recovery Services-Tresors |
| OperationName                  | Text          | Dieses Feld repräsentiert den Namen des aktuellen Vorgangs (z. B. Speicher oder StorageAssociation). |
...
- [Informationen zum Senden von Diagnosedaten an Log Analytics](https://aka.ms/AA6il6r)