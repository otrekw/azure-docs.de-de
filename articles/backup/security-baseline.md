...
- [Verschlüsselung von Sicherungsdaten mit vom Kunden verwalteten Schlüsseln](./backup-encryption.md#encryption-of-backup-data-using-customer-managed-keys)
