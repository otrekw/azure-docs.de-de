...
Überprüfen Sie vor dem Wiederherstellen von SQL-Datenbanken die [hier](restore-sql-database-azure-vm.md#restore-prerequisites) genannten Voraussetzungen.
