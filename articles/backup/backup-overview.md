...
- **Azure Files-Freigaben** - [Sichern Sie Azure Files-Freigaben in einem Speicherkonto, und stellen Sie sie daraus wieder her.](backup-azure-files.md)
