---
title: 'Verwalten von JAR-Abhängigkeiten: Azure HDInsight'
...
ms.locfileid: "77135700"
---
# <a name="jar-dependency-management-best-practices"></a>Bewährte Methoden für die Verwaltung von JAR-Abhängigkeiten
...
* [Verwenden von IntelliJ-Tools für HDInsight](https://docs.microsoft.com/azure/hdinsight/hadoop/hdinsight-tools-for-intellij-with-hortonworks-sandbox)

* [Erstellen einer Scala-Maven-Anwendung für Spark in IntelliJ](https://docs.microsoft.com/azure/hdinsight/spark/apache-spark-create-standalone-application)
