...
1. Installieren Sie Java, wenn dies noch nicht geschehen ist. Das können Sie mit dem Befehl `which java` überprüfen.
    ...
    1. Öffnen Sie die BASHRC-Datei (normalerweise in „~/.bashrc“): `nano ~/.bashrc`.
