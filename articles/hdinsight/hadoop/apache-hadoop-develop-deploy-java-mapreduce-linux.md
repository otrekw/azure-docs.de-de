...
1. Geben Sie den folgenden Befehl ein, um ein Maven-Projekt mit dem Namen **wordcountjava** zu erstellen:
   ...
   ```
    ...
    Mit diesem Befehl wird ein Verzeichnis mit dem durch den `artifactID`Parameter angegebenen Namen erstellt (in diesem Beispiel **wordcountjava**.) Dieses Verzeichnis enthält die folgenden Elemente:
    ...
    * src\main\java\org\apache\hadoop\examples: Enthält den Code Ihrer Anwendung.
