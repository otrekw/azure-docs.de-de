...
:::image type="content" source="./media/hive-llap-sizing-guide/LLAP_architecture_sizing_guide.png " alt-text="`LLAP-Architektur/Komponenten`" border="true":::
...
:::image type="content" source="./media/hive-llap-sizing-guide/LLAP_sizing_guide_max_concurrent_queries.png " alt-text="`LLAP: Maximale Anzahl gleichzeitiger Abfragen`" border="true":::
...
Für D14 v2-Workerknoten wird **85** als Wert für die LLAP-Warteschlange empfohlen.     
...
Konfiguration: ***hive.llap.daemon.num.executors** _, _ *_hive.llap.io.threadpool.size_**
...
Bei D14 v2 lautet der empfohlene Wert für die Anzahl von Executors (16 virtuelle Kerne × 120 %) ~= **19** auf jedem Workerknoten, wenn von 3 GB pro Executor ausgegangen wird.
...
:::image type="content" source="./media/hive-llap-sizing-guide/LLAP_sizing_guide_llap_heap_size.png " alt-text="`LLAP-Heapgröße`" border="true":::
...
:::image type="content" source="./media/hive-llap-sizing-guide/LLAP_sizing_guide_num_llap_nodes.png " alt-text="`Anzahl der Knoten für den LLAP-Dienst`" border="true":::  
...
:::image type="content" source="./media/hive-llap-sizing-guide/LLAP_sizing_guide_num_llap_nodes_for_llap_daemons.png " alt-text="`Anzahl der Knoten für LLAP-Daemons`" border="true":::
