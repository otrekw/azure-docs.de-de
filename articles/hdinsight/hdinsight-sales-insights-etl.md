...
* Wenn Sie PowerShell zum Auslösen der Data Factory-Pipeline verwenden, benötigen Sie das [Az-Modul](https://docs.microsoft.com/powershell/azure/overview).
