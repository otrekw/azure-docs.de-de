...
| --- | --- |
| Azure HDInsight SDK für .NET|Weitere Informationen finden Sie unter [Azure HDInsight SDK für .NET](/dotnet/api/overview/azure/hdinsight). |
