...
| --- | --- |
| Azure HDInsight SDK für .NET|Weitere Informationen finden Sie unter [Azure HDInsight SDK für .NET](https://docs.microsoft.com/dotnet/api/overview/azure/hdinsight?view=azure-dotnet). |
