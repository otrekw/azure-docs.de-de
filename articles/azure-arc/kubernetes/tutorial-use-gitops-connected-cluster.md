...
> * Wenden Sie die Konfiguration aus einem privaten Git-Repository an.
...
Fahren Sie mit dem nächsten Artikel fort, um zu erfahren, wie Sie Helm mit Konfigurationen verwenden können.
> [!div class="nextstepaction"]
> [Verwenden von Helm mit Konfigurationen](./use-gitops-with-helm.md)
