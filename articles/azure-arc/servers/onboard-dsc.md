...
description: In diesem Artikel erfahren Sie, wie Sie Computer mithilfe von Azure Arc-fähigen Servern (Vorschauversion) und Windows PowerShell DSC mit Azure verbinden.
ms.date: 03/12/2020
ms.topic: conceptual
