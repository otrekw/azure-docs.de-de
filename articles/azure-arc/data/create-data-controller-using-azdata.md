...
Zum Erstellen des Azure Arc-Datencontrollers mithilfe der Azure Data CLI muss die Azure Data CLI installiert sein.

   [Installieren der Azure Data CLI](install-client-tools.md)
