---
title: Bereitstellen des nativen C++-OpenXR-Tutorials für HoloLens
description: In diesem Schnellstart erfahren Sie, wie Sie das native C++-OpenXR-Tutorial auf einem HoloLens-Gerät ausführen.
...
ms.locfileid: "113667564"
---
# <a name="quickstart-deploy-native-c-openxr-sample-to-hololens"></a>Schnellstart: Bereitstellen des nativen C++-OpenXR-Beispiels für HoloLens

In diesem Schnellstart erfahren Sie, wie Sie die auf OpenXR basierende native C++-Tutorialanwendung auf einem HoloLens 2-Gerät bereitstellen und ausführen.
...
Das C++-HoloLens-Tutorial befindet sich im Unterverzeichnis *NativeCpp/HoloLens-OpenXr*.

## <a name="build-the-project"></a>Erstellen des Projekts

Öffnen Sie die Projektmappendatei *BasicXrApp.sln* im Unterverzeichnis *NativeCpp/HoloLens-OpenXr* mit Visual Studio 2019.
...
Da die Kontoanmeldeinformationen im Quellcode des Tutorials hartcodiert sind, müssen sie in gültige Anmeldeinformationen geändert werden. Öffnen Sie dazu in Visual Studio die Datei `OpenXrProgram.cpp`, und ändern Sie den Teil, in dem der Client erstellt wird (innerhalb der `InitARR()`-Funktion):
...
Nachdem Sie nun erfolgreich ein natives OpenXR-Beispiel mit ARR-Funktionen kompiliert und bereitgestellt haben, können Sie mit dem Erweitern des Beispiels beginnen, indem Sie Interaktionscode für Remoteobjekte hinzufügen:

> [!div class="nextstepaction"]
> [Konzepte: Entitäten](../../../concepts/entities.md)

Außerdem können Sie ein eigenes konvertiertes Modell einfügen:

> [!div class="nextstepaction"]
> [Schnellstart: Konvertieren eines Modells](../../../quickstarts/convert-model.md)
