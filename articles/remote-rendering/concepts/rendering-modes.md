...
* [C# ConnectToRuntimeParams-Struktur](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.connecttoruntimeparams)
* [C++ AzureSession::ConnectToRuntime()](https://docs.microsoft.com/cpp/api/remote-rendering/azuresession#connecttoruntime)
* [C++ ConnectToRuntimeParams-Struktur](https://docs.microsoft.com/cpp/api/remote-rendering/connecttoruntimeparams)
