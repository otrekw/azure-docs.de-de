---
title: Erstellen eines Beratungsdienstangebots im Partner Center – Azure Marketplace
description: Erfahren Sie, wie Sie mit dem Partner Center ein Beratungsdienstangebot im Azure Marketplace oder in AppSource veröffentlichen.
author: anbene
ms.author: mingshen
...
ms.locfileid: "80873819"
---
# <a name="create-a-consulting-service-offer"></a>Erstellen eines Beratungsdienstangebots

> [!IMPORTANT]
> Wir verlagern die Verwaltung Ihrer Angebote für Beratungsdienste vom Cloud-Partnerportal in das Partner Center. Bis Ihre Angebote migriert werden, können Sie diese verwalten, wie in den Anweisungen unter [Azure- und Dynamics 365-Beratungsdienstangebot](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/consulting-services/cloud-partner-portal-consulting-services-publishing-offer) für das Cloud-Partnerportal beschrieben.

In diesem Artikel wird beschrieben, wie Sie ein Beratungsdienstangebot im [Azure Marketplace](https://azuremarketplace.microsoft.com/) oder in [AppSource](https://appsource.microsoft.com/) veröffentlichen. Beratungsdienstangebote auf Basis von Microsoft [Dynamics 365](https://dynamics.microsoft.com/) und Power Platform sollten in AppSource aufgelistet werden. Beratungsdienstangebote auf Basis von Microsoft Azure sollten im Azure Marketplace aufgelistet werden.

Um in den Azure Marketplace- oder AppSource-Beratungsdiensten ein Beratungsdienstangebot zu erstellen, benötigen Sie zunächst [ein Herausgeberkonto im Partner Center](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account). Außerdem muss das Konto im Programm „Kommerzieller Marketplace“ registriert sein. Bevor Sie Ihr Angebot erstellen, sollten Sie sich unter [Voraussetzungen für Beratungsdienst](https://docs.microsoft.com/azure/marketplace/partner-center-portal/consulting-service-prerequisites) über die Voraussetzungen informieren.
...
- In AppSource können Sie mehr als 100 Millionen Office 365- und Dynamics 365-Benutzer erreichen und über den Azure Marketplace über 200.000 Organisationen.
...
Wenn die oben beschriebenen Anforderungen erfüllt sind, erstellen Sie anhand der folgenden Schritte ein Beratungsdienstangebot.

1. Melden Sie sich beim [Partner Center](https://partner.microsoft.com) an, und wählen Sie dann im oberen Menü **Dashboard** aus.
2. Wählen Sie in der linken Navigationsleiste **Kommerzieller Marketplace** aus, und wählen Sie dann **Übersicht** aus.

    :::image type="content" source="media/cs-menu-overview.png" alt-text="Veranschaulicht das Menü für den kommerziellen Marketplace":::

3. Wählen Sie **+ Neues Angebot** und dann **Beratungsdienst** aus.

    :::image type="content" source="media/cs-menu-newoffer.png" alt-text="Veranschaulicht die Schaltfläche zum Erstellen eines neuen Angebots":::

4. Geben Sie eine **Angebots-ID** ein. Dies ist ein eindeutiger Bezeichner für jedes Angebot in Ihrem Konto.

    - Diese ID ist für Kunden in der Webadresse des Marketplace-Angebots sichtbar.
    - Verwenden Sie nur Kleinbuchstaben, Ziffern, Bindestriche und Unterstriche, aber keine Leerzeichen. Die Länge ist auf 50 Zeichen beschränkt. Wenn Sie z. B. **test-offer-1** eingeben, lautet die Angebots-URL `https://azuremarketplace.microsoft.com/marketplace/../test-offer-1`.
    - Nachdem Sie **Erstellen** ausgewählt haben, kann die Angebots-ID nicht mehr geändert werden.

5. Geben Sie einen **Angebotsalias** ein. Dies ist der Name, der zum Verweisen auf das Angebot im Partner Center verwendet wird.

    - Dieser Name wird nicht im Marketplace verwendet. Er unterscheidet sich vom Angebotsnamen und anderen Werten, die Kunden präsentiert werden. Sie können dieses Feld verwenden, um dem Angebot einen Namen zuzuweisen, mit dem es sich zu internen Zwecken besser identifizieren lässt. Er ist für Kunden nicht sichtbar.
    - Nachdem Sie **Erstellen** ausgewählt haben, kann der Angebotsalias nicht mehr geändert werden.

Nachdem Sie diese beiden Werte eingegeben haben, wählen Sie **Erstellen** aus, um mit der Seite **Angebotseinrichtung** fortzufahren.

## <a name="offer-setup"></a>Angebotseinrichtung

Nachdem Sie eine Angebots-ID und einen Angebotsalias eingegeben haben, werden im Partner Center ein Entwurfsangebot erstellt und die Seite **Angebotseinrichtung** angezeigt. Führen Sie die unten angegebenen Schritte aus, um Ihr Angebot einzurichten.

### <a name="connect-lead-management"></a>Einbinden der Leadverwaltung

Wenn Sie Ihr Angebot mithilfe des Partner Centers im Marketplace veröffentlichen, _müssen_ Sie es mit einem CRM (Customer Relationship Management)- oder Marketingautomatisierungssystem verbinden. Dadurch erhalten Sie Kontaktinformationen zum Kunden, sobald jemand sein Interesse an Ihrem Produkt bekundet oder es verwendet.
...
3. Vergewissern Sie sich, dass die Verbindung mit dem Leadziel ordnungsgemäß konfiguriert ist. Nach ihrer Veröffentlichung im Partner Center überprüfen wir die Verbindung und senden Ihnen einen Testlead. Während Sie das Angebot vor der Liveschaltung als Vorschau anzeigen, können Sie Ihre Leadverbindung ebenfalls testen, indem Sie selbst versuchen, das Angebot in der Vorschauumgebung zu kaufen.
...
1. Wenn Sie ein **Azure-Produkt** als primäres Produkt ausgewählt haben, wählen Sie bis zu drei **Lösungsbereiche** aus. Diese erleichtern es Kunden, Ihr Angebot in Azure Marketplace zu finden. Wenn Sie sich nicht für Azure entschieden haben, überspringen Sie diesen Schritt.
2. Wenn Sie ein _anderes_ als ein Azure-Produkt als primäres Produkt ausgewählt haben, wählen Sie bis zu drei **Anwendbare Produkte** aus. Diese erleichtern es Kunden, Ihr Angebot in AppSource zu finden. Ausführliche Informationen finden Sie unter [Richtlinien zum Listing von Microsoft AppSource-Beratungsdiensten](https://go.microsoft.com/fwlink/?LinkId=828734&amp;clcid=0x409) (PDF).
3. Wählen Sie bis zu sechs **Branchen** aus, für die das Angebot gilt. Diese erleichtern es Kunden, Ihr Angebot zu finden.
4. Fügen Sie bis zu drei **Kompetenzen** hinzu, die Ihr Unternehmen erworben hat und die in der Angebotsliste Ihres Beratungsdiensts angezeigt werden sollen. Es ist mindestens eine Kompetenz erforderlich, außer für Azure Expert MSPs und Azure Networking MSPs.
...
Hier definieren Sie die Angebotsdetails, die im Marketplace angezeigt werden. Dazu gehörten der Name des Angebots, eine Beschreibung, Bilder usw. Achten Sie darauf, bei der Konfiguration dieses Angebots die Richtlinien auf der [Richtlinienseite von Microsoft](https://docs.microsoft.com/legal/marketplace/certification-policies#800-consulting-services) zu befolgen.

> [!NOTE]
> Eine Angabe der Angebotsdetails in englischer Sprache ist nicht erforderlich, sofern die Angebotsbeschreibung mit dem Satz &quot;Diese Anwendung ist nur auf [nicht englische Sprache] erhältlich&quot; beginnt. Es ist auch in Ordnung, einen nützlichen Link mit Inhalten in einer anderen Sprache bereitzustellen als der Sprache, die für die Details der Angebotsliste verwendet wurde.
...
- Setzen Sie nicht nur auf die Merkmale und Funktionen, um Ihr Produkt zu verkaufen. Konzentrieren Sie sich stattdessen auf den Nutzen, den Ihr Angebot bietet.
- Verwenden Sie möglichst branchenspezifisches Vokabular oder nutzenorientierte Formulierungen.

Um Ihre Beschreibung ansprechender zu gestalten, formatieren Sie diese mithilfe des Rich-Text-Editors. Mit dem Rich-Text-Editor können Sie Zahlen, Aufzählungspunkte, fette und kursive Formatierungen und Einzüge hinzufügen, um die Lesbarkeit Ihrer Beschreibung zu verbessern.

:::image type="content" source="media/cs-rich-text-editor.png" alt-text="Veranschaulicht den Rich-Text-Editor zum Schreiben der Angebotsbeschreibung" border="false":::
...
Stellen Sie PNG-Dateien des Logos zu Ihrem Angebot in jeder der folgenden Pixelgrößen bereit:
...
Wählen Sie **Entwurf speichern** aus, bevor Sie mit dem nächsten Abschnitt fortfahren: Preise und Verfügbarkeit.
...
5. Wähen Sie **Entwurf speichern** aus.
