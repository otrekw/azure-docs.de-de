...
Wenn Sie Angebote über den Azure Marketplace verkaufen, werden Informationen zu erfolgreichen Auszahlungen auch in der Auszahlungszusammenfassung angezeigt. Weitere Informationen zu Azure Marketplace-Zahlungen finden Sie unter [Zahlungserhalt im kommerziellen Marketplace](./get-paid.md) und in der [Microsoft-Herausgebervereinbarung](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4xqkx).

> [!NOTE]
> Qualifiziert für eine Auszahlung sind Beträge, die den Zahlungsschwellenwert von 50 US-Dollar erreichen. Weitere Informationen finden Sie in der [Microsoft-Herausgebervereinbarung](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4xqkx).
...
Dies sind die Rollen und Berechtigungen für den Zugriff auf den Auszahlungsbericht:
...
Informationen zu Zahlungsplänen finden Sie im Abschnitt [Zahlungspläne](./payout-policy-details.md#payment-schedules) des Artikels zu **Auszahlungsdetails**. Dort wird unter anderem auf Einbehaltungszeiträume, auf die Sichtbarkeit für Partner und auf die Kreditkarten-/Rechnungsverwendung des Kunden eingegangen.
