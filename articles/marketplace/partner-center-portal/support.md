...
3. Der Bereich **Hilfe und Support** wird auf der rechten Seite der Seite angezeigt. 
   ...
   ![Hilfe und Support über die Startseite](./media/homepage-help-support.png)
...
![Hilfe und Support](./media/help-and-support.png)
...
![Nächster Schritt](./media/next-step.png)
...
![Empfohlene Lösungen](./media/recommended-solutions.png)
