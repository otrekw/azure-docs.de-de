...
| [Seite „Preise und Verfügbarkeit des Plans“](#plan-pricing-and-availability-page)  | Nur verfügbar, wenn Sie sich für den Vertrieb des Angebots über Microsoft entscheiden.  Erfasst die Geschäftsmerkmale (Preismodell), Zielgruppe und Marktverfügbarkeit für jeden Plan (Version) Ihres Angebots.  |
...
| Store-Logos (klein, mittel, groß)  | Das große Logo (zwischen 216 x 216 und 350 x 350 Pixel) ist erforderlich. Dies wird in Partner Center verwendet, um ein kleines Logo (48 × 48 Pixel) und ein mittleres Logo (90 x 90 Pixel) zu erstellen. Sie können diese Logos später optional durch andere Bilder ersetzen. Logos müssen im PNG-Format vorliegen. |
...
## <a name="plan-pricing-and-availability-page"></a>Seite „Preise und Verfügbarkeit des Plans“
