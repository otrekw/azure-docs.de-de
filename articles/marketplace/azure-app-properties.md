...
description: Hier erfahren Sie, wie Sie die Angebotseigenschaften für Ihre Azure-Anwendung in Partner Center (Azure Marketplace) konfigurieren.
author: aarathin
ms.author: aarathin
...
ms.locfileid: "111542486"
---
# <a name="configure-azure-application-offer-properties"></a>Konfigurieren der Eigenschaften von Azure-Anwendungsangeboten
...
- [Konfigurieren von Azure-Anwendungsauflistungsdetails](azure-app-offer-listing.md)
