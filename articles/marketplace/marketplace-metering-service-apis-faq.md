...
Ja, durch Aufruf der [API zum Abrufen der Abonnementliste](partner-center-portal/pc-saas-fulfillment-api-v2.md#subscription-apis), da sie eine Liste aller SaaS-Abonnements enthält. Im Statusfeld in der Antwort für das jeweilige SaaS-Abonnement wird angegeben, ob das Abonnement aktiv oder gekündigt ist.
