...
- **Beschreibung**: Stellen Sie sich eine Übersicht über Ihre Testversion bereit. Dieser Text wird dem Benutzer während der Bereitstellung der Testversion angezeigt. Dieses Feld unterstützt HTML, wenn Sie formatierte Inhalte bereitstellen möchten.
...
- **Demovideo zur Testversion**: Optional können Sie ein Video hochladen, das Ihre App präsentiert.
...
- **Azure AD-App-Schlüssel**: Geheimer Schlüssel für die in Schritt 7 erstellte Azure AD-App. Beispielwert :IJUgaIOfq9b9LbUjeQmzNBW4VGn6grr1l/n3aMrnfdk=
- **Azure AD-Mandantenname**: Geben Sie den Namen des Azure-Mandanten für Ihre Dynamics 365-Instanz an. Verwenden Sie das Format der \<Mandantenname.\>onmicrosoft.com. Beispielwert: testdrive.onmicrosoft.com
- **URL der Web-API-Instanz**: Geben Sie die Web-API-URL für Ihre Dynamics 365-Instanz an. Sie können diesen Wert abrufen, indem Sie sich bei Ihrer Microsoft Dynamics 365-Instanz anmelden und zu „Einstellung -\> Anpassung -\> Entwicklerressourcen -\> Web-API der Instanz“ navigieren (diese URL kopieren). Beispielwert: https:\//testdrive.crm.dynamics.com/api/data/v9.0
