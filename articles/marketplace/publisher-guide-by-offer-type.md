...
| [**Verwalteter Dienst**](partner-center-portal/create-new-managed-service-offer.md) | Über [Azure Lighthouse](/azure/lighthouse/overview) können Sie verwaltete Dienstangebote erstellen und vom Kunden delegierte Abonnements oder Ressourcengruppen verwalten.|
...
| [**Software-as-a-Service**](plan-saas-offer.md) | Verwenden Sie den SaaS-Angebotstyp (Software-as-a-Service), um Ihren Kunden die Möglichkeit zu geben, Ihre SaaS-basierte, technische Lösung als Abonnement zu kaufen. |
