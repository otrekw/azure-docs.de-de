---
title: Konfigurieren Sie Dynamics 365 für Customer Engagement & PowerApps Angebotsdetails auf Microsoft AppSource (Azure Marketplace)
description: Konfigurieren Sie Dynamics 365 für Customer Engagement & PowerApps Angebotsdetails auf Microsoft AppSource (Azure Marketplace).
...
ms.locfileid: "110612659"
---
# <a name="configure-dynamics-365-for-customer-engagement--power-apps-offer-listing-details"></a>Konfigurieren Sie Dynamics 365 für Customer Engagement & Power Apps Angebotsdetails

Über diese Seite können Sie die Angebotsdetails wie Angebotsname, Beschreibung, Links, Kontakte, Logo und Screenshots festlegen.
...
:::image type="content" source="media/dynamics-365/example-dynamics-365-customer-engagement.png" alt-text="Veranschaulicht, wie dieses Angebot in Microsoft AppSource angezeigt wird.":::
...
Geben Sie mindestens ein (und höchstens drei) zugehörige PDF-Marketingdokumente an, z. B. Whitepaper, Broschüren, Checklisten oder Präsentationen.
...
Wählen Sie **Entwurf speichern** aus, bevor Sie mit der nächsten Registerkarte im linken Navigationsmenü, **Verfügbarkeit**, fortfahren.

## <a name="next-steps"></a>Nächste Schritte

- [Angebotsverfügbarkeit einstellen](dynamics-365-customer-engage-availability.md)
