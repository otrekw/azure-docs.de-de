---
title: Häufig gestellte Fragen zur Migration zu Partner Center | Azure Marketplace
description: In diesem Artikel werden häufig gestellte Fragen zur Migration von Angeboten aus dem Cloud-Partnerportal zu Partner Center behandelt.
author: anbene
...
ms.locfileid: "81275819"
---
# <a name="frequently-asked-questions-for-migrating-from-the-cloud-partner-portal-to-partner-center"></a>Häufig gestellte Fragen zur Migration vom Cloud-Partnerportal zu Partner Center
...
Angebote werden ab dem 13. April bis Ende Mai zu Partner Center migriert. Während dieses Zeitraums können Sie wie gewohnt auf das Cloud-Partnerportal zugreifen, außer zum Zeitpunkt der für Ihr Angebot geplanten Migration.
Während Ihre Angebote migriert werden, weisen sie den Status „Gesperrt. Wird in Partner Center verschoben“ auf, wie im folgenden Screenshot dargestellt. Dieser Migrationszeitraum sollte weniger als 24 Stunden betragen. In dieser Zeit können Sie keine Aktualisierungen an Ihren Angeboten vornehmen. Sie erhalten eine E-Mail-Benachrichtigung, wenn wir die Migration Ihrer Angebote abgeschlossen haben.

:::image type="content" source="media/migration-faq/all-offers-1.png" alt-text="Zeigt den Status von migrierten Angeboten.":::

Nachdem Ihre Angebote migriert wurden, befinden sie sich im Cloud-Partnerportal **für einen begrenzten Zeitraum** im schreibgeschützten Modus. Ihr Status lautet „In Partner Center verschoben“ und enthält einen Link zu Ihrem Angebot in Partner Center, wie in den folgenden Screenshots dargestellt. Ab diesem Zeitpunkt verwalten Sie Aktualisierungen all Ihrer Angebote oder erstellen neue Angebote ausschließlich über Partner Center.
