---
title: Kategorien und Unterkategorien im kommerziellen Marketplace | Azure Marketplace und Microsoft AppSource
description: In diesem Artikel werden die Kategorien und Unterkategorien für Angebote aufgelistet, die in den Microsoft AppSource- und Azure Marketplace-Onlineshops veröffentlicht sind.
...
Kategorien und Unterkategorien werden je nach Lösungstyp einem oder beiden [kommerziellen Marketplace-Onlineshops](overview.md#commercial-marketplace-online-stores) zugeordnet. Wenn Sie ein kommerzielles Marketplace-Angebot im Partner Center erstellen, kann es je nach Angebotsart, Kategorien und anderen von Ihnen ausgewählten Optionen in einem oder beiden Onlineshops aufgeführt werden. In den seltenen Fällen, in denen das Angebot für die Benutzer beider Onlineshops relevant ist, kann es in beiden angezeigt werden.

Wählen Sie die Kategorien und Unterkategorien aus, die am besten zu Ihrer Lösung passen. Indem Sie die richtigen Kategorien und Unterkategorien für Angebot zuweisen, helfen Sie Kunden, Ihr Angebot im kommerziellen Marketplace zu finden. 
...
- Bis zu zwei Unterkategorien für jede primäre Kategorie. Auch wenn Sie keine Unterkategorien auswählen, ist das Angebot unter der ausgewählten Kategorie auffindbar.

## <a name="azure-marketplace-categories-and-subcategories"></a>Azure Marketplace-Kategorien und -Unterkategorien

In dieser Tabelle sind die primären Kategorien und Unterkategorien aufgeführt, die Azure Marketplace zugeordnet sind.

| Primäre Kategorie | Unterkategorie |
| ------------ | ------------- |
| KI + Machine Learning | Automatisiertes maschinelles Lernen<br>Botdienste<br>Geschäftsprozessautomatisierung/robotergesteuerte Prozessautomatisierung<br>Cognitive Services<br>Datenbeschriftung<br>Vorbereitung der Daten<br>Knowledge Mining<br>ML-Vorgänge<br>ML-Dienst |
| Analytics | Big Data<br>Datenanalyse<br>Datenerkenntnisse<br>Predictive Analytics<br>Echtzeit-/Streaminganalyse |
| Blockchain | App-Beschleuniger<br>Ledger mit mehreren Knoten<br>Ledger mit einem Knoten<br>Tools |
| Compute | Anwendungsinfrastruktur<br>cache<br>Betriebssysteme |
| Container | Container-Apps<br>Containerimages<br>Erste Schritte mit Containern |
...
## <a name="microsoft-appsource-categories-and-subcategories"></a>Microsoft AppSource-Kategorien und -Unterkategorien

In dieser Tabelle sind die primären Kategorien und Unterkategorien aufgeführt, die Microsoft AppSource zugeordnet sind.
