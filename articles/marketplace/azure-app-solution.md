...
description: Konfigurieren Sie einen Plan für eine Lösungsvorlage für Ihr Azure-Anwendungsangebot in Partner Center (Azure Marketplace).
author: aarathin
ms.author: aarathin
...
ms.locfileid: "111542471"
---
# <a name="configure-a-solution-template-plan"></a>Konfigurieren eines Plans für eine Lösungsvorlage

Dieser Artikel bezieht sich nur auf Pläne für Lösungsvorlagen in Azure-Anwendungsangeboten. Wenn Sie einen Plan für eine verwaltete Anwendung konfigurieren, lesen Sie [Konfigurieren eines Plans für verwaltete Anwendungen](azure-app-managed.md).
...
- [Testen und Veröffentlichen dieses Angebots](azure-app-test-publish.md)
- So nutzen Sie die Programme **Co-Selling mit Microsoft** und/oder **Verkaufen über CSPs** zum [Verkaufen dieses Angebots](azure-app-marketing.md)
