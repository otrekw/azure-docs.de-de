---
title: Problembehandlung bei der Zertifizierung von VMs für Azure Marketplace
...
> [!NOTE]
> Wenden Sie sich an den [Partner Center-Support](https://go.microsoft.com/fwlink/?linkid=2165533), falls Sie Fragen zu diesem Artikel oder Verbesserungsvorschläge haben.
...
> - [Generalisieren der Windows-VM mithilfe von Sysprep](../virtual-machines/generalize.md#windows)
...
## <a name="vm-images-must-have-1mb-free-space"></a>VM-Images müssen über 1 MB freien Speicherplatz verfügen.
...
### <a name="how-to-keep-1-mb-free-space-at-the-start-on-an-empty-vhd-2048-sectors-each-sector-of-512-bytes"></a>So halten Sie 1 MB Speicherplatz am Anfang einer leeren VHD frei (2.048 Sektoren mit jeweils 512 Byte)
...
### <a name="how-to-keep-1-mb-free-space-by-moving-existing-data-on-vhd-2048-sectors-each-sector-of-512-bytes"></a>So erhalten Sie 1 MB freien Speicherplatz durch Verschieben existierender Daten auf einer VHD (2048 Sektoren mit jeweils 512 Byte)
...
- Wenn Sie kein neues VM-Image als Ersatz für das einzige VM-Image in einem Plan besitzen und den Plan beenden möchten, können Sie [den Verkauf des Plans einstellen](update-existing-offer.md#stop-selling-an-offer-or-plan).
- Wenn das einzige VM-Image im Angebot nicht ersetzt werden soll, empfiehlt es sich, [den Verkauf des Angebots einzustellen](update-existing-offer.md#stop-selling-an-offer-or-plan).
...
Weitere Informationen finden Sie unter [VM-Erweiterung](../virtual-machines/extensions/diagnostics-linux.md).
...
- Wenden Sie sich an den [Partner Center-Support](https://go.microsoft.com/fwlink/?linkid=2165533), wenn Sie Fragen oder Verbesserungsvorschläge haben.
