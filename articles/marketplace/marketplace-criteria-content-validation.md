...
| 7 | Marketingartefakte | Logos werden korrekt angezeigt. | <ul><li>Logos: Klein (48 × 48 Pixel) und groß (216 × 216 Pixel) sind erforderlich.</li><li>Screenshots (max. 5): Erfordert ein PNG-Bild mit einer Auflösung von 1.280 × 720 Pixel. |
...
| 3 | Marketplace-Artefakte | Logos werden korrekt angezeigt. |<ul><li>Logos: Klein (48 × 48 Pixel) und groß (216 × 216 Pixel) sind erforderlich.</li><li>Screenshots (max. 5): Erfordert ein PNG-Bild mit einer Auflösung von 1280 x 720 Pixel.|
