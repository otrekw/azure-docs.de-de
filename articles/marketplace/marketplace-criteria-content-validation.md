...
| Number | Auflistungselement | Grundlegende Anforderung | Optimale Anforderung |
|:--- |:--- |:--- |:--- |
...
| 3 | Logo | Das Logo wird korrekt angezeigt. | Das Logo wird korrekt angezeigt und enthält ein „Herobild“ (das großformatige Bild im Azure-Portal). |
...
| 5 | Kategorien und Branchen | <ul><li>Kategorien und Unterkategorien müssen den Angebotsfunktionen entsprechen. </li><li>Wählen Sie keine Kategorien/Unterkategorien aus, die nicht Ihren Angebotsfunktionen entsprechen. </li></ul> | <ul><li>Wählen Sie bis zu zwei (2) Kategorien aus, einschließlich einer primären und einer sekundären Kategorie (optional).</li><li>Wählen Sie bis zu zwei (2) Unterkategorien für jede primäre und/oder sekundäre Kategorie aus. Wenn keine Unterkategorie ausgewählt wird, ist das Angebot weiterhin unter der ausgewählten Kategorie auffindbar.</li></ul> |
| 6 | Bilder | <ul><li>Es ist kein Bild erforderlich. Wird ein Bild bereitgestellt, muss es hochauflösend sein.</li><li>Die Anforderungen für Bilder sind im Cloudpartnerportal (CPP) und hier aufgeführt.</li><li>Text im Screenshot ist lesbar, und das Bild ist scharf. | Das Lösungsangebot ist auf einen Blick leicht verständlich. |
...
| Number | Auflistungselement | Grundlegende Anforderung | Optimale Anforderung | 
|:--- |:--- |:--- |:--- |
| 1 | Listenstatus (Handlungsaufforderung) | Der Link muss zu einer kundengeführten Testbenutzeroberfläche führen *.* | Andere Handlungsaufforderungen (z. B. *Jetzt kaufen*) sind ebenfalls verfügbar. | 
...
| 7 | Marketingartefakte | Logos werden korrekt angezeigt. | <ul><li>Das Logo enthält ein „Herobild“ (das großformatige Bild im Azure-Portal).</li><li>Logos: Kleine (48 &#215; 48 Pixel) und große (216 &#215; 216 Pixel) sind erforderlich.</li><li>[Anforderungen an das Herobild](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-new-azure-apps-offer).</li><li>Screenshots (max. 5): Das Cloudpartnerportal (CPP) erfordert ein PNG-Bild mit einer Auflösung von 1280 &#215; 720 Pixel. |
| 8 | Kategorien und Branchen | <ul><li>Kategorien und Unterkategorien entsprechen den Angebotsfunktionen.</li><li>Wählen Sie keine Kategorien/Unterkategorien aus, die nicht Ihren Angebotsfunktionen entsprechen. </li><li>Richten Sie es auf Branche und Sektoren aus, wenn das Angebot branchenspezifisch ist. Ist es nicht branchenspezifisch, wählen Sie keine Branche aus.</li></ul> | <ul><li>Wählen Sie bis zu zwei (2) Kategorien aus, einschließlich einer primären und einer sekundären Kategorie (optional).</li> <li>Wählen Sie bis zu zwei (2) Unterkategorien für jede primäre und/oder sekundäre Kategorie aus. Wenn keine Unterkategorie ausgewählt wird, ist das Angebot weiterhin unter der ausgewählten Kategorie auffindbar.</li> <li>Sie können bis zu zwei (2) Branchen und zwei Sektoren pro ausgewählter Branche auswählen.</li></ul> |
...
| 11 | Rechtliche Hinweise |<ul><li>URL der Datenschutzrichtlinie: Die URL für die Datenschutzrichtlinie Ihrer App im Feld für die Datenschutzrichtlinien-URL im Cloudpartnerportal (CPP).</li><li>Nutzungsbedingungen: Die Nutzungsbedingungen Ihrer App. Kunden müssen diese Bedingungen akzeptieren, bevor sie Ihre App testen können. |    Richtlinien oder Bestimmungen sind auf einer Website über eine öffentliche URL verfügbar. |
...
| 2 | SKUs | Der Partner wählt neue SKUs aus.| Der Titel entspricht dem Stil des Titels in der Beschreibung. Vermeiden Sie lange Titel.  |
| 3 | Marketplace-Artefakte | Logos werden korrekt angezeigt. |<ul><li>Das Logo enthält ein „Herobild“ (das großformatige Bild im Azure-Portal).</li><li>Logos: Kleine (48 &#215; 48 Pixel) und große (216 &#215; 216 Pixel) sind erforderlich.</li><li>[Anforderungen an das Herobild](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-new-azure-apps-offer).</li><li>Screenshots (max. 5): Das Cloudpartnerportal (CPP) erfordert ein PNG-Bild mit einer Auflösung von 1280 &#215; 720 Pixel.|
...
| Number | Auflistungselement | Grundlegende Anforderung | Optimale Anforderung |
|:--- |:--- |:--- |:--- |
| 1 | Titel des Angebots  |  Der Typ und die Dauer des Diensts müssen eindeutig im folgenden Format angegeben sein: *Name: Dauer Typ* (z. B. „Angebotserstellung: 1-wöchiger Proof-of-Concept“).  | <ul><li>Der Name des Herausgebers wird nicht wiederholt.</li><li>Der Titel entspricht dem Stil des Titels in der Beschreibung. Vermeiden Sie lange Titel. | 
...
| 9 | Kompetenzen | Sie müssen Kompetenz in mindestens einem der folgenden Bereiche aufweisen:<ul><li>Anwendungsentwicklung</li><li>Anwendungsintegration</li><li>Anwendungslebenszyklusverwaltung</li><li>Cloudplattform<li>Datenanalyse</li><li>Rechenzentrum</li><li>Datenplattform</li><li>DevOps |
| 10 | Produkte | Müssen Azure-Produkte sein. | |
| 11 | Land/Region | Stellen Sie sicher, dass das Land bzw. die Region der ausgewählten Währung entspricht. | |
| 12 | Weitere Informationen  | <ul><li>Links am unteren Rand (unter der Beschreibung, nicht unter den Azure Marketplace-Links auf der linken Seite) führen zu weiteren Informationen zur Lösung, sind öffentlich verfügbar und werden richtig angezeigt.</li><li>Links müssen über einen Anzeigenamen verfügen und werden nicht als Dateinamen von Downloads angezeigt. | |
