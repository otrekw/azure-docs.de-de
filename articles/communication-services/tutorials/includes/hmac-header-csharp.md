...
In diesem Beispiel wird eine Anforderung zum Erstellen einer neuen Identität mithilfe der Authentifizierungs-API (Version `2020-07-20-preview2`) von Communication Services signiert.
