---
title: Übersicht über die Referenzdokumentation zu Azure Communication Services
titleSuffix: An Azure Communication Services concept document
description: Hier finden Sie Informationen zur Referenzdokumentation zu Communication Services.
author: mikben
manager: jken
...
ms.locfileid: "102487592"
---
# <a name="reference-documentation-overview"></a>Übersicht über die Referenzdokumentation

[!INCLUDE [Public Preview Notice](../includes/public-preview-include.md)]


In der folgenden Tabelle werden die verfügbaren Communication Services-Pakete zusammen mit der entsprechenden Referenzdokumentation erläutert:
...
| Aufrufen        | [npm](https://www.npmjs.com/package/@azure/communication-calling)         | -      | -      | -     | [GitHub](https://github.com/Azure/Communication/releases) ([Dokumentation](/objectivec/communication-services/calling/))     | [Maven](https://search.maven.org/artifact/com.azure.android/azure-communication-calling/)            | -                              |
