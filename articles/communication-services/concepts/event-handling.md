...
description: Lösen Sie mit Azure Event Grid Prozesse auf der Grundlage von Aktionen aus, die in einer Communication Services-Instanz auftreten.
author: mikben
manager: jken
...
| Microsoft.Communication.ChatParticipantAddedToThreadWithUser|  Wird für einen Benutzer veröffentlicht, wenn zu einem Chatthread, dem der Benutzer angehört, ein neuer Teilnehmer hinzugefügt wird.|
| Microsoft.Communication.ChatParticipantRemovedFromThreadWithUser |  Wird für einen Benutzer veröffentlicht, wenn aus einem Chatthread, dem der Benutzer angehört, ein Teilnehmer entfernt wird. |
| Microsoft.Communication.ChatThreadCreated  | Wird beim Erstellen eines Chatthreads veröffentlicht.  |
| Microsoft.Communication.ChatThreadDeleted| Wird beim Löschen eines Chatthreads veröffentlicht.  |
| Microsoft.Communication.ChatThreadParticipantAdded | Wird veröffentlicht, wenn einem Chatthread ein neuer Teilnehmer hinzugefügt wird.  |
| Microsoft.Communication.ChatThreadParticipantRemoved | Wird veröffentlicht, wenn einem Chatthread ein neuer Teilnehmer hinzugefügt wird.  |  
| Microsoft.Communication.ChatMessageReceivedInThread | Wird veröffentlicht, wenn in einem Chatthread eine Nachricht empfangen wird.  |    
| Microsoft.Communication.ChatThreadPropertiesUpdated| Wird veröffentlicht, wenn die Eigenschaften eines Chatthreads (etwa das Thema) aktualisiert werden.|    
...
Das Feld `subject` gibt bei allen Communication Services-Ereignissen Aufschluss über den Benutzer, die Telefonnummer oder die Entität, an den bzw. an die sich das Ereignis richtet. Zur Ermöglichung einer einfachen [Event Grid-Filterung](../../event-grid/event-filtering.md) werden gängige Präfixe verwendet.
...
### <a name="microsoftcommunicationchatmessageedited-event"></a>Ereignis „Microsoft.Communication.ChatMessageEdited“
...
### <a name="microsoftcommunicationchatparticipantaddedtothreadwithuser--event"></a>Ereignis „Microsoft.Communication.ChatParticipantAddedToThreadWithUser“ 
```json
[{
...
### <a name="microsoftcommunicationchatparticipantremovedfromthreadwithuser-event"></a>Ereignis „Microsoft.Communication.ChatParticipantRemovedFromThreadWithUser“ 
```json
[{
...
### <a name="microsoftcommunicationchatthreadcreated-event"></a>Ereignis „Microsoft.Communication.ChatThreadCreated“
...
```
### <a name="microsoftcommunicationchatthreadpropertiesupdated-event"></a>Ereignis „Microsoft.Communication.ChatThreadPropertiesUpdated“
...
```
### <a name="microsoftcommunicationchatthreaddeleted-event"></a>Ereignis „Microsoft.Communication.ChatThreadDeleted“
...
```
### <a name="microsoftcommunicationchatthreadparticipantadded-event"></a>Ereignis „Microsoft.Communication.ChatThreadParticipantAdded“
...
```
### <a name="microsoftcommunicationchatthreadparticipantremoved-event"></a>Ereignis „Microsoft.Communication.ChatThreadParticipantRemoved“
...
```
### <a name="microsoftcommunicationchatmessagereceivedinthread-event"></a>Ereignis „Microsoft.Communication.ChatMessageReceivedInThread“
...
```
### <a name="microsoftcommunicationchatmessageeditedinthread-event"></a>Ereignis „Microsoft.Communication.ChatMessageEditedInThread“
...
### <a name="microsoftcommunicationchatmessagedeletedinthread-event"></a>Ereignis „Microsoft.Communication.ChatMessageDeletedInThread“
...
## <a name="quickstarts-and-how-tos"></a>Schnellstarts und Anleitungen

| Titel | Beschreibung |
| --- | --- |
| [Behandeln von SMS-Ereignissen in Communication Services](../quickstarts/telephony-sms/handle-sms-events.md) | Hier finden Sie Informationen zur Behandlung aller von Ihrer Communication Services-Instanz empfangenen SMS-Ereignisse unter Verwendung eines Webhooks. |


## <a name="next-steps"></a>Nächste Schritte

* Eine Einführung zu Azure Event Grid finden Sie unter [Einführung in Azure Event Grid](../../event-grid/overview.md).
* Eine Einführung in Azure Event Grid-Konzepte finden Sie [hier](../../event-grid/concepts.md).
* Eine Einführung in Azure Event Grid-Systemthemen finden Sie [hier](../../event-grid/system-topics.md).
