---
title: Referenzliste von Azure-Domänen
description: Referenzliste von Azure-Domänen (nicht vollständig)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
ms.locfileid: "87433214"
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Referenzliste von Azure-Domänen (nicht vollständig)

Diese Seite ist eine unvollständige Liste der verwendeten Azure-Domänen. Einige davon sind REST-API-Endpunkte.


|Dienst  |Unterdomäne  |
|---------|---------|
|[Azure Access Control Service](https://azure.microsoft.com/blog/one-month-retirement-notice-access-control-service/) (veraltet)|*.accesscontrol.windows.net|
...
|[Azure BizTalk Services](https://azure.microsoft.com/pricing/details/biztalk-services/) (veraltet)|*.biztalk.windows.net|
|[Azure Blob Storage](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) und [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)|*.cloudapp.net|
...
|Azure Container Service (ACS) (veraltet)|*.azurecontainer.io|
...
|Azure-Verwaltungsdienste|*.management.core.windows.net|
...
|[Azure SQL-Datenbank](https://azure.microsoft.com/services/sql-database/)|*.database.windows.net|
|[Azure Stack Edge](https://azure.microsoft.com/products/azure-stack/edge/) und [Azure IoT Edge](https://azure.microsoft.com/services/iot-edge/)|*.azureedge.net|
