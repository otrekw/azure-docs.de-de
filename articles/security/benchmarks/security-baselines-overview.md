...
ms.locfileid: "77616445"
---
# <a name="overview-of-azure-security-baselines"></a>Übersicht über Azure-Sicherheitsbaselines

Azure-Sicherheitsbaselines helfen Ihnen, die Sicherheit unserer Produkte durch verbesserte Tools, Nachverfolgung und Sicherheitsfeatures zu erhöhen, und stellen Ihnen eine konsistente Umgebung zum Sichern Ihrer Umgebung bereit.

Azure Services-Sicherheitsbaselines konzentrieren sich auf cloudzentrierte Steuerungsbereiche. Diese Steuerungen sind mit bekannten Sicherheitsbenchmarks konsistent – beispielsweise denen von Center for Internet Security (CIS). Unsere Baselines bieten einen Leitfaden für die im [Vergleichstest für die Azure-Sicherheit](overview.md) aufgeführten Steuerungsbereiche.
