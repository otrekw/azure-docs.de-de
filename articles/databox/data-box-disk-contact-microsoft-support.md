...
2. Die Tabelle **Kürzlich gesendete Supportanfragen** wird unter **Hilfe + Support** angezeigt.
    ...
    ![Verwalten von Supportanfragen 2](./media/data-box-disk-contact-microsoft-support/data-box-disk-manage-support-ticket2.png)
...
Erhalten Sie Informationen über das [Überprüfen von Kopierfehlern bei einem Upload aus einer Data Box oder einem Data Box Disk-Gerät](data-box-troubleshoot-data-upload.md).
