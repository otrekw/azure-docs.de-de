...
Warteschlangen in JMS sind semantisch vergleichbar mit den herkömmlichen Service Bus-Warteschlangen, die oben erläutert wurden.
...
Themen in JMS sind semantisch vergleichbar mit den herkömmlichen Service Bus-Themen, die oben erläutert wurden.
...
Um ein nicht freigegebenes nicht dauerhaftes Abonnement zu erstellen, erstellen Sie ein `JMSConsumer`-Element, wie in den unten genannten Methoden aus der `JMSContext-Klasse gezeigt: 
