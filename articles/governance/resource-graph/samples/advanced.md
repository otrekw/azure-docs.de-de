...
In der folgenden Abfrage wird **inner** `join` zum Verbinden von Speicherkonten mit Ressourcengruppen verwendet, die einen festgelegten Tagnamen und einen Tagwert aufweisen.
