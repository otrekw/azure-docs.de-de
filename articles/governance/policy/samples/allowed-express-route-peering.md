---
title: 'Beispiel: Zulässige ExpressRoute-Peeringstandorte'
description: Diese Beispielrichtliniendefinition erfordert, dass ExpressRoute angegebene Peeringstandorte verwendet, die in einem Parameter definiert sind.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463458"
---
# <a name="sample---allowed-peering-location-for-expressroute"></a>Beispiel: Zulässiger Peeringstandort für ExpressRoute

Diese Richtlinie erfordert, dass ExpressRoute angegebene Peeringstandorte verwendet. Sie geben ein Array von zulässigen Peeringstandorten an.
