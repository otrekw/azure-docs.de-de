...
description: Mit dieser Beispielrichtliniendefinition wird die Verwendung von bestimmten Erweiterungen, die per Parameter definiert werden, auf virtuellen Computern untersagt.
ms.date: 01/23/2019
ms.topic: sample
