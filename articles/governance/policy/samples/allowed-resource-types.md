...
description: Mit dieser Beispielrichtliniendefinition wird sichergestellt, dass nur genehmigte Ressourcentypen, die per Parameter definiert sind, bereitgestellt werden.
ms.date: 01/23/2019
ms.topic: sample
