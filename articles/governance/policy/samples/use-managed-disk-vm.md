...
description: Für diese Beispielrichtliniendefinition ist es erforderlich, dass für virtuelle Computer und VM-Skalierungsgruppen verwaltete Datenträger verwendet werden.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463031"
---
# <a name="sample---create-vm-using-managed-disk"></a>Beispiel: Erstellen einer VM mithilfe eines verwalteten Datenträgers
