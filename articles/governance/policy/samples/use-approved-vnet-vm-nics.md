...
description: Diese Beispielrichtliniendefinition erfordert, dass Netzwerkschnittstellen ein genehmigtes virtuelles Netzwerk verwenden, das per Parameter definiert ist.
ms.date: 01/23/2019
ms.topic: sample
