...
description: Bei dieser Beispielrichtliniendefinition muss für alle Azure-Speicherkonten festgelegt sein, dass nur sicherer HTTPS-Datenverkehr zulässig ist.
ms.date: 01/23/2019
ms.topic: sample
