...
description: Diese Beispielrichtliniendefinition überwacht die in einem Parameter definierten Überwachungseinstellungen von SQL Server mit „auditIfNotExists“.
ms.date: 01/23/2019
ms.topic: sample
