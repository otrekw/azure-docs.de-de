...
description: Diese Beispielrichtliniendefinition überwacht, ob Network Watcher für eine bestimmte Region, die per Parameter definiert ist, nicht aktiviert ist.
ms.date: 01/23/2019
ms.topic: sample
