...
Der Abschnitt zur Empfehlungszuordnung enthält Details zu den in dieser Blaupause enthaltenen Richtlinien. Außerdem wird erläutert, wie diese Richtlinien verschiedene Empfehlungen in CIS Microsoft Azure Foundations Benchmark v1.1.0 umsetzen. Bei der Zuweisung zu einer Architektur werden Ressourcen von Azure Policy auf Nichtkonformität mit den zugewiesenen Richtlinien überprüft. Weitere Informationen finden Sie unter [Was ist Azure Policy?](../../../policy/overview.md).

## <a name="next-steps"></a>Nächste Schritte

Sie haben sich die Übersicht über das Blaupausenbeispiel „CIS Microsoft Azure Foundations Benchmark“ angesehen.
Lesen Sie als Nächstes die folgenden Artikel, um mehr über die Empfehlungszuordnung zu erfahren:

> [!div class="nextstepaction"]
> [Empfehlungszuordnung des Blaupausenbeispiels „CIS Microsoft Azure Foundations Benchmark“](./control-mapping.md)
> [Blaupausenbeispiel „CIS Microsoft Azure Foundations Benchmark“: Bereitstellungsschritte](./deploy.md)
