---
title: Bereitstellen des Blaupausenbeispiels für den Azure-Sicherheitsvergleichstest
description: Bereitstellungsschritte für das Blaupausenbeispiel für den Azure-Sicherheitsvergleichstest, einschließlich Details zum Blaupausenartefaktparameter
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702671"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Bereitstellen des Blaupausenbeispiels für den Azure-Sicherheitsvergleichstest
...
1. Suchen Sie unter _Weitere Beispiele_ nach dem Blaupausenbeispiel **Azure-Sicherheitsvergleichstest**, und klicken Sie auf den Namen, um dieses Beispiel auszuwählen.
...
|-|-|-|-|
|Azure Security Benchmark-Empfehlungen überwachen und spezifische unterstützende VM-Erweiterungen bereitstellen|Richtlinienzuweisung|
Liste der aus der Windows-VM-Administratorengruppe ausgeschlossenen Benutzer|Eine durch Semikolon getrennte Liste von Mitgliedern, die aus der Gruppe der lokalen Administratoren ausgeschlossen werden sollen. Beispiel: Administrator; myUser1; myUser2|
...
Nachdem Sie sich nun die Schritte zur Bereitstellung des Blaupausenbeispiels für den Azure-Sicherheitsvergleichstest angesehen haben, empfiehlt sich die Lektüre der folgenden Artikel, um mehr über die Blaupause und die Steuerungszuordnung zu erfahren:

> [!div class="nextstepaction"]
> [Blaupausenbeispiel für den Azure-Sicherheitsvergleichstest – Übersicht](./index.md)
> [Blaupause des Azure-Sicherheitsvergleichstests – Steuerungszuordnung](./control-mapping.md)
