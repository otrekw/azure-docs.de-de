---
title: Bereitstellen des Medien-Blaupausenbeispiels
...
ms.locfileid: "106386387"
---
# <a name="deploy-the-media-blueprint-sample"></a>Bereitstellen des Medien-Blaupausenbeispiels

Führen Sie zum Bereitstellen des Medien-Blaupausenbeispiels die folgenden Schritte aus:
...
1. Suchen Sie unter _Weitere Beispiele_ nach dem Blaupausenbeispiel **Medien**, und klicken Sie auf **Dieses Beispiel verwenden**.
...
Nachdem Sie sich nun die Schritte zur Bereitstellung des Beispiels „Medien“ angesehen haben, lesen Sie die folgenden Artikel, um sich einen Überblick zu verschaffen und mehr über die Steuerungszuordnung zu erfahren:

> [!div class="nextstepaction"]
> [Übersicht über das Medien-Blaupausenbeispiel](./index.md)
> [Steuerungszuordnung des Medien-Blaupausenbeispiels](./control-mapping.md)
