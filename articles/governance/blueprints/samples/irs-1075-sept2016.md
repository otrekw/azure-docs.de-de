---
title: Blaupausenbeispiel „IRS 1075, September 2016“
description: Übersicht über das Blaupausenbeispiel „IRS 1075, September 2016“ Dieses Blaupausenbeispiel unterstützt Kunden bei der Bewertung spezifischer Kontrollen.
ms.date: 05/04/2021
ms.topic: sample
...
ms.locfileid: "108776143"
---
# <a name="irs-1075-september-2016-blueprint-sample"></a>Blaupausenbeispiel „IRS 1075, September 2016“

Das Blaupausenbeispiel „IRS 1075, September 2016“ bietet mithilfe von [Azure Policy](../../policy/overview.md) Schutzmaßnahmen für Governance, die Ihnen beim Bewerten bestimmter Steuerungen für [IRS 1075, September 2016](https://www.irs.gov/pub/irs-pdf/p1075.pdf) helfen. Diese Blaupause hilft Kunden bei der Bereitstellung eines Kernsatzes von Richtlinien für jede in Azure bereitgestellte Architektur, die Kontrollen für „IRS 1075, September 2016“ implementieren muss.

## <a name="control-mapping"></a>Steuerungszuordnung

In der [Azure Policy-Steuerungszuordnung](../../policy/samples/irs-1075-sept2016.md) finden Sie Details zu den in dieser Blaupause enthaltenen Richtliniendefinitionen. Darüber hinaus erfahren Sie, wie diese Richtliniendefinitionen den **Steuerungen** im Framework von „IRS 1075, September 2016“ entsprechen. Bei der Zuweisung zu einer Architektur werden Ressourcen von Azure Policy auf Nichtkonformität mit den zugewiesenen Richtliniendefinitionen überprüft. Weitere Informationen finden Sie unter [Was ist Azure Policy?](../../policy/overview.md).

## <a name="deploy"></a>Bereitstellen

Führen Sie zum Bereitstellen des Blaupausenbeispiels „IRS 1075, September 2016“ von Azure Blueprints die folgenden Schritte aus:
...
1. Suchen Sie unter _Weitere Beispiele_ nach dem Blaupausenbeispiel **IRS 1075, September 2016**, und wählen Sie **Dieses Beispiel verwenden** aus.

1. Geben Sie die _Grundlagen_ des Blaupausenbeispiels ein:

   - **Name der Blaupause**: Geben Sie einen Namen für Ihre Kopie des Blaupausenbeispiels „IRS 1075, September 2016“ ein.
...
1. Wählen Sie oben auf der Seite die Option **Blaupause veröffentlichen** aus. Geben Sie auf der neuen Seite rechts für Ihre Kopie des Blaupausenbeispiels eine **Version** an. Diese Eigenschaft ist hilfreich, wenn Sie später Änderungen vornehmen. Geben Sie **Änderungshinweise** ein, z. B. „Erste mit dem Blaupausenbeispiel ‚IRS 1075, September 2016‘ veröffentlichte Version“. Wählen Sie dann unten auf der Seite **Veröffentlichen** aus.
