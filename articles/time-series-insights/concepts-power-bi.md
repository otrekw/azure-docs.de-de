---
title: Power BI-Integration – Azure Time Series Insights | Microsoft-Dokumentation
...
* Ändern Sie Time Series Insights-Daten in Power BI mithilfe des leistungsstarken erweiterten Editors.

## <a name="native-connector"></a>Nativer Connector

Das Verbinden Ihrer Daten dauert weniger als eine Minute. Durch schnelles Exportieren Ihrer Ansicht aus Time Series Insight-Explorer nach Power BI kann jeder in Ihrer Organisation intuitiv auf Daten zugreifen und diese visuell darstellen.
...
Lesen Sie [Verbinden von Time Series Insights mit Power BI](./how-to-connect-power-bi.md), um schrittweise Anleitungen zu erhalten.

## <a name="flexible-workflow"></a>Flexibler Workflow
 
Verwenden Sie den Connector an beliebiger Stelle in Ihrem Workflow:

* Wenn Sie sich im Time Series Insights-Explorer befinden, können Sie Ihre Ansicht schnell nach Power BI exportieren. 
* Wenn Sie bereits in Power BI sind, erweitern Sie Ihre vorhandenen Visualisierungsszenarien mithilfe von Time Series Insights-Abfragedaten.
