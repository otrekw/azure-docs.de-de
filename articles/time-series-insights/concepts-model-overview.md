...
Ein Zeitreihenmodell kann über die Schnittstelle [Azure Time Series Insights-Explorer](https://docs.microsoft.com/azure/time-series-insights/concepts-ux-panels) erstellt und verwaltet werden. Die Einstellungen eines Zeitreihenmodells können über die [Modelleinstellungs-API](/rest/api/time-series-insights/reference-model-apis) verwaltet werden.
