...
Ein Zeitreihenmodell kann über die Schnittstelle [Azure Time Series Insights-Explorer](./concepts-ux-panels.md) erstellt und verwaltet werden. Die Einstellungen eines Zeitreihenmodells können über die [Modelleinstellungs-API](/rest/api/time-series-insights/reference-model-apis) verwaltet werden.
