...
Informationen zu den bewährten Methoden für die Event Hubs-Partitionierung finden Sie unter [Wie viele Partitionen benötige ich?](../event-hubs/event-hubs-faq.yml#how-many-partitions-do-i-need-).
