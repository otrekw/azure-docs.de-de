...
- Erfahren Sie mehr über die [Datenerfassung](./concepts-ingestion-overview.md).
- Lesen Sie den Artikel zur [Datenspeicherung](./concepts-storage.md).
- Weitere Informationen zu [Datenmodellierung](./concepts-model-overview.md) finden Sie in der Time Series Insights-Vorschauversion.
