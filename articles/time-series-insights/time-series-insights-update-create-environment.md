...
Weitere Informationen zur Azure Time Series Insights-Erfassung finden Sie hier:

> [!div class="nextstepaction"]
> [Übersicht über die Azure Time Series Insights-Datenerfassung](./concepts-ingestion-overview.md)

Erfahren Sie mehr über Zeitreihenmodelle:

> [!div class="nextstepaction"]
> [Datenmodellierung in Azure Time Series Insights](./concepts-model-overview.md)
