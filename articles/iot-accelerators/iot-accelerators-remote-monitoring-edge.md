...
Weitere Informationen zum Installieren der IoT Edge-Runtime finden Sie unter [Installieren der Azure IoT Edge-Runtime unter Linux (x64)](../iot-edge/how-to-install-iot-edge.md).
