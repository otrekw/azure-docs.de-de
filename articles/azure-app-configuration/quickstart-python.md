...
- Python 2.7, 3.6 oder höher: Informationen zum Einrichten von Python unter Windows finden Sie in [dieser Dokumentation]( https://docs.microsoft.com/windows/python/).
