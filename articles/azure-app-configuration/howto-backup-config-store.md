...
Gewähren Sie mit dem folgenden Befehl oder über das [Azure-Portal](../storage/blobs/assign-azure-role-data-access.md#assign-an-azure-role) der verwalteten Identität Ihrer Funktions-App Zugriff auf Ihre Warteschlange. Weisen Sie die `Storage Queue Data Contributor`-Rolle in der Warteschlange zu.
