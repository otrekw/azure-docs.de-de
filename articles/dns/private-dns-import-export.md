---
title: 'Importieren und Exportieren einer Domänenzonendatei für privates Azure-DNS: Azure CLI'
titleSuffix: Azure DNS
description: Informationen zum Importieren und Exportieren einer DNS-Zonendatei in privatem Azure-DNS mit der Azure CLI
services: dns
author: duongau
ms.service: dns
ms.date: 03/16/2021
...
ms.locfileid: "106450693"
---
# <a name="import-and-export-a-private-dns-zone-file-for-azure-private-dns"></a>Importieren und Exportieren einer privaten DNS-Zonendatei für privates Azure-DNS
...
Für privates Azure-DNS wird das Importieren und Exportieren von Zonendateien mit der Azure-Befehlszeilenschnittstelle (CLI) unterstützt. Das Importieren von Zonendateien mithilfe von Azure PowerShell oder dem Azure-Portal wird derzeit **nicht** unterstützt.
...
## <a name="import-a-dns-zone-file-into-azure-private-dns"></a>Importieren einer DNS-Zonendatei in privates Azure-DNS
...
* Erfahren Sie, wie Sie [Ressourceneintragssätze und Einträge in Ihrer DNS-Zone verwalten](./private-dns-getstarted-cli.md).
