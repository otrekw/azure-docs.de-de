...
![RBAC auf Ressourcengruppenebene über das Azure-Portal](./media/dns-protect-private-zones-recordsets/rbac1.png)
...
### <a name="private-zone-level-rbac"></a>RBAC auf der Ebene der privaten Zone
...
![RBAC auf DNS-Zonenebene über das Azure-Portal](./media/dns-protect-private-zones-recordsets/rbac2.png)
