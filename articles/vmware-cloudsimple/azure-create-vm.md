---
title: 'Azure VMware Solutions (AVS): Erstellen eines virtuellen Computers in Azure mit VM-Vorlagen'
description: Beschreibt, wie virtuelle Computer in Azure mithilfe von VM-Vorlagen in der VMware-Infrastruktur für Ihre private AVS-Cloud erstellt werden
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/16/2019
ms.topic: article
...
Sie können einen virtuellen Computer im Azure-Portal mithilfe von VM-Vorlagen für die VMware-Infrastruktur erstellen, die Ihr AVS-Administrator für Ihr Abonnement aktiviert hat.

## <a name="sign-in-to-azure"></a>Anmelden bei Azure

Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an.

## <a name="create-avs-virtual-machine"></a>Erstellen eines virtuellen AVS-Computers
...
4. Geben Sie grundlegende Informationen ein, und klicken Sie auf **Weiter:Größe**.
    ...
    | Private Cloud | Die private AVS-Cloud, in der Sie den virtuellen Computer erstellen möchten. |
...
## <a name="view-list-of-avs-virtual-machines"></a>Anzeigen der Liste von virtuellen AVS-Computern
...
3. Wählen Sie den virtuellen Computer aus, der in der privaten Cloud erstellt wurde.
    ...
    ![Liste der virtuellen AVS-Computer](media/list-cloudsimple-virtual-machines.png)

Die Liste der virtuellen AVS-Computer enthält virtuelle Computer, die über das Azure-Portal erstellt wurden.  Virtuelle Computer, die in vCenter in der privaten Cloud im zugeordneten vCenter-Ressourcenpool erstellt wurden, werden in der Liste angezeigt.  
