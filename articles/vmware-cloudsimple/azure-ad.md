---
title: 'Azure VMware Solutions (AVS): Verwenden von Azure AD als Identitätsquelle für die private AVS-Cloud'
description: Beschreibt, wie Sie Azure AD als Identitätsanbieter in Ihrer privaten AVS-Cloud hinzufügen, um Benutzer zu authentifizieren, die aus Azure auf AVS zugreifen
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
ms.locfileid: "77015922"
---
# <a name="use-azure-ad-as-an-identity-provider-for-vcenter-on-avs-private-cloud"></a>Sie können Azure AD als Identitätsanbieter für vCenter in der privaten AVS-Cloud verwenden.

Sie können Ihre vCenter-Instanz in der privaten AVS-Cloud für die Authentifizierung mit Azure Active Directory (Azure AD) einrichten, damit Ihre VMware-Administratoren auf vCenter zugreifen können. Nachdem die Identitätsquelle für einmaliges Anmelden eingerichtet wurde, kann der **cloudowner**-Benutzer vCenter Benutzer aus der Identitätsquelle hinzufügen.  
...
2. [Einrichten einer Identitätsquelle für vCenter in Ihrer privaten AVS-Cloud](#set-up-an-identity-source-on-your-avs-private-cloud-vcenter)
...
## <a name="set-up-an-identity-source-on-your-avs-private-cloud-vcenter"></a>Einrichten einer Identitätsquelle für vCenter in Ihrer privaten AVS-Cloud

1. [Eskalieren Sie die Berechtigungen](escalate-private-cloud-privileges.md) für vCenter in Ihrer privaten AVS-Cloud.
2. Erfassen Sie die Konfigurationsparameter, die zum Einrichten der Identitätsquelle erforderlich sind.
    ...
    | **Zertifikat auswählen** | Wenn Sie LDAPS mit der Active Directory-LDAP-Server- oder der OpenLDAP-Server-Identitätsquelle verwenden möchten, wird eine Schaltfläche  **Zertifikat auswählen** nach dem Eingeben von  `ldaps://` im URL-Textfeld angezeigt. Eine sekundäre URL ist nicht erforderlich. |
...
3. Melden Sie sich bei vCenter in Ihrer privaten AVS-Cloud an, nachdem die Berechtigungen eskaliert wurden.
