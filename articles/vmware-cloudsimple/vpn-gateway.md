---
title: 'Azure VMware Solutions (AVS): Einrichten eines VPN-Gateways'
description: Beschreibt, wie Sie ein Point-to-Site-VPN-Gateway und ein Site-to-Site-VPN-Gateway einrichten und Verbindungen zwischen Ihrem lokalen Netzwerk und Ihrer privaten AVS-Cloud herstellen
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/14/2019
ms.topic: article
...
ms.locfileid: "77016764"
---
# <a name="set-up-vpn-gateways-on-avs-network"></a>Einrichten von VPN-Gateways im AVS-Netzwerk

VPN-Gateways ermöglichen Ihnen, eine Remoteverbindung mit einem AVS-Netzwerk aus Ihrem lokalen Netzwerk und über einen Clientcomputer herzustellen. Eine VPN-Verbindung zwischen Ihrem lokalen Netzwerk und Ihrem AVS-Netzwerk ermöglicht den Zugriff auf vCenter und Workloads in Ihrer privaten AVS-Cloud. AVS unterstützt Site-to-Site- und Point-to-Site-VPN-Gateways.
...
* Eine **Point-to-Site-VPN**-Verbindung ist die einfachste Möglichkeit, auf Ihrem Computer eine Verbindung mit Ihrer privaten AVS-Cloud herzustellen. Verwenden Sie eine Point-to-Site-VPN-Verbindung, wenn Sie eine Remoteverbindung mit der privaten AVS-Cloud herstellen möchten. Informationen zum Installieren eines Clients für eine Point-to-Site-VPN-Verbindung finden Sie unter [Konfigurieren einer VPN-Verbindung mit Ihrer privaten AVS-Cloud](set-up-vpn.md).
...
AVS-VPN-Gateways bieten Richtlinien zum Hinzufügen von VLANs/Subnetzen zu VPN-Gateways. Mit Richtlinien können Sie verschiedene Regeln für Verwaltungs-VLANs/-Subnetze und benutzerdefinierte VLANs/Subnetze angeben. Die Regeln für Verwaltungs-VLANs/-Subnetze gelten für alle neuen privaten AVS-Clouds, die Sie erstellen. Regeln für benutzerdefinierte VLANs/Subnetze ermöglichen das automatische Hinzufügen neuer VLANs/Subnetze zu vorhandenen oder neuen privaten AVS-Clouds für ein Site-to-Site-VPN-Gateway. Die Richtlinie wird für jede Verbindung definiert.
...
5. Erstellen Sie die erste Verbindung aus Ihrem lokalen Netzwerk, und klicken Sie auf **Weiter**.
    ...
    * Geben Sie für **On-Premises Prefixes** (Lokale Präfixe) die lokalen CIDR-Präfixe ein, die auf das AVS-Netzwerk zugreifen. Beim Erstellen der Verbindung können Sie mehrere CIDR-Präfixe hinzufügen.

    ![Erstellen einer Site-to-Site-VPN-Gatewayverbindung](media/create-vpn-gateway-s2s-connection.png)

6. Aktivieren Sie die VLANs/Subnetze für Ihr privates AVS-Cloudnetzwerk, auf das über das lokale Netzwerk zugegriffen werden soll, und klicken Sie dann auf **Next** (Weiter).

    * Aktivieren Sie **Add management VLANs/Subnets of AVS Private Clouds** (Verwaltungs-VLANs/-Subnetze privater AVS-Clouds hinzufügen), um ein Verwaltungs-VLAN/-Subnetz hinzuzufügen. Das Verwaltungssubnetz ist für vMotion- und vSAN-Subnetze erforderlich.
    * Um vMotion-Subnetze hinzuzufügen, aktivieren Sie **Add vMotion network of AVS Private Clouds** (vMotion-Netzwerk privater AVS-Clouds hinzufügen).
...
Informationen zum Herstellen einer Verbindung mit einem Point-to-Site-VPN finden Sie unter [Herstellen einer Verbindung mit AVS mit einem Point-to-Site-VPN](set-up-vpn.md#connect-to-avs-using-point-to-site-vpn).
