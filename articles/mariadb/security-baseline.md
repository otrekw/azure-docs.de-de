...
description: Die Azure Database for MariaDB-Sicherheitsbaseline enthält Schrittanleitungen und Ressourcen für die Implementierung der Sicherheitsempfehlungen, die im Vergleichstest für die Azure-Sicherheit angegeben sind.
author: msmbaldwin
ms.service: mariadb
ms.topic: conceptual
ms.date: 03/29/2021
...
ms.locfileid: "105967694"
---
# <a name="azure-security-baseline-for-azure-database-for-mariadb"></a>Azure-Sicherheitsbaseline für Azure Database for MariaDB

Diese Sicherheitsbaseline wendet Empfehlungen des [Azure-Sicherheitsvergleichstests Version 1.0](../security/benchmarks/overview-v1.md) auf Azure Datenbank für MariaDB an. Der Azure-Sicherheitsvergleichstest enthält Empfehlungen zum Schutz Ihrer Cloudlösungen in Azure. Der Inhalt wird nach den **Sicherheitskontrollen** gruppiert, die durch den Azure-Sicherheitsvergleichstest und die entsprechenden für Azure Datenbank für MariaDB geltenden Empfehlungen definiert sind. Nicht auf Azure Datenbank für MariaDB anwendbare **Steuerungen** oder Steuerungen, für die Microsoft die Verantwortung trägt, wurden ausgeschlossen.

Die vollständige Zuordnung von Azure Datenbank für MariaDB zum Azure-Sicherheitsvergleichstest finden Sie in der [vollständigen Zuordnungsdatei der Azure Datenbank für MariaDB-Sicherheitsbaseline](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
- [Konfigurieren von Private Link für Azure Database for MariaDB](howto-configure-privatelink-portal.md)

- [Erstellen und Verwalten von VNET-Dienstendpunkten und VNET-Regeln im Azure Database for MariaDB-Server](howto-manage-vnet-portal.md)

- [Konfigurieren von Azure Database for MariaDB-Firewallregeln](concepts-firewall-rules.md)
...
**Integrierte Azure-Richtlinien-Definitionen - Microsoft.DBforMariaDB**:
...
- [Konfigurieren von Advanced Threat Protection für Azure Database for MariaDB](howto-database-threat-protection-portal.md)
...
Azure Database for MariaDB verwendet das Diensttag „Microsoft.Sql“.

- [Weitere Informationen zur Verwendung von Diensttags](../virtual-network/service-tags-overview.md)

- [ Grundlegendes zur Verwendung von Diensttags für Azure Database for MariaDB](https://docs.microsoft.com/azure/mariadb/concepts-data-access-security-vnet#terminology-and-description)
...
- [Azure Policy-Beispiele für Netzwerke](../governance/policy/samples/built-in-policies.md)
...
- [ Konfigurieren von Serverprotokollen für Azure Database for MariaDB](concepts-server-logs.md)und Zugreifen auf diese

- [So konfigurieren Sie Audit-Protokolle für Azure Database for MariaDB und greifen darauf zu](howto-configure-audit-logs-portal.md)
...
- [Azure-Ressourcenprotokolle](/azure/azure-monitor/platform/resource-logs#send-to-azure-storage)
...
- [Weitere Informationen zum Log Analytics-Arbeitsbereich](/azure/azure-monitor/log-query/get-started-portal)
...
- [Aktivieren von Advanced Threat Protection für MariaDB](howto-database-threat-protection-portal.md)

- [Konfigurieren von Serverprotokollen für MariaDB und Zugreifen auf diese](concepts-server-logs.md)

- [Konfigurieren von Überwachungsprotokollen für MariaDB und Zugreifen auf diese](howto-configure-audit-logs-portal.md)
...
- [Grundlegendes zu integrierten Azure-Rollen für Azure-Abonnements](../role-based-access-control/built-in-roles.md)
...
**Leitfaden**: Azure Active Directory (Azure AD) verfolgt nicht das Konzept der Standardkennwörter.
...
- [Erstellen zusätzlicher Konten für MariaDB](howto-create-users.md)
...
- [Grundlegendes zur REST-API für Azure Database for MariaDB](/rest/api/mariadb/)
...
**Leitfaden**: Aktivieren Sie die Diagnoseeinstellungen für MariaDB und Azure Active Directory (Azure AD), und senden Sie alle Protokolle an einen Log Analytics-Arbeitsbereich. Konfigurieren Sie gewünschte Warnungen (z. B. fehlgeschlagene Authentifizierungsversuche) im Log Analytics-Arbeitsbereich.
...
- [Konfigurieren von Private Link für Azure Database for MariaDB ](concepts-data-access-security-private-link.md)

- [Konfigurieren von Dienstendpunkten für Azure Database for MariaDB](howto-manage-vnet-portal.md)

- [Konfigurieren von Firewallregeln für Azure Database for MariaDB](concepts-firewall-rules.md)
...
- [Mindern der Datenexfiltrierung für Azure Database for MariaDB](concepts-data-access-security-private-link.md)
...
- [Konfigurieren der Verschlüsselung während der Übertragung für MariaDB: ](howto-configure-ssl.md)
...
**Leitfaden**: Verwenden Sie die rollenbasierte Zugriffssteuerung in Azure (Azure RBAC, Role-Based Access Control), um den Zugriff auf die Verwaltungsebene von Azure Database for MariaDB (Azure-Portal/Azure Resource Manager) zu verwalten. Verwenden Sie für den Zugriff auf die Datenebene (in der Datenbank selbst) SQL-Abfragen, um Benutzer zu erstellen und Benutzerberechtigungen zu konfigurieren.

- [Konfigurieren von Azure RBAC](../role-based-access-control/role-assignments-portal.md)

- [Konfigurieren des Benutzerzugriffs mit SQL für MariaDB](howto-create-users.md)
...
- [Grundlegendes zu Sicherungen für MariaDB](concepts-backup.md)

- [Grundlegendes zur MariaDB-Erstkonfiguration](tutorial-design-database-using-portal.md)
...
- [Grundlegendes zu Sicherung und Wiederherstellung in Azure Database for MariaDB: ](concepts-backup.md)
