...
ms.locfileid: "83656762"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-database-for-mariadb"></a>Integrierte Azure Policy-Richtliniendefinitionen für Azure Database for MariaDB

Diese Seite enthält einen Index der integrierten [Azure Policy](../governance/policy/overview.md)-Richtliniendefinitionen für Azure Database for MariaDB. Weitere Azure Policy-Integrationen für andere Dienste finden Sie unter [Integrierte Azure Policy-Richtliniendefinitionen](../governance/policy/samples/built-in-policies.md).
