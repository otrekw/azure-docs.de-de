---
title: Erstellen einer Azure DB for MariaDB-Instanz mithilfe einer ARM-Vorlage
description: In diesem Artikel erfahren Sie, wie Sie einen Azure Database for MariaDB-Server mithilfe einer Azure Resource Manager-Vorlage erstellen.
author: mgblythe
ms.service: mariadb
ms.topic: quickstart
...
ms.locfileid: "84266422"
---
# <a name="quickstart-use-a-resource-manager-template-to-create-an-azure-database-for-mariadb-server"></a>Schnellstart: Verwenden einer Resource Manager-Vorlage zum Erstellen eines Azure Database for MariaDB-Servers
