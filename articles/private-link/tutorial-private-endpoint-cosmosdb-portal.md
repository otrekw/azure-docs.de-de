...
description: Beginnen Sie mit einem privaten Endpunkt in Azure, um eine private Verbindung mit einem Azure Cosmos-Konto herzustellen.
author: asudbring
ms.author: allensu
...
12. Klicken Sie im Storage-Explorer mit der rechten Maustaste auf **Cosmos DB-Konten**, und wählen Sie dann **Verbindung mit Cosmos DB herstellen** aus.
