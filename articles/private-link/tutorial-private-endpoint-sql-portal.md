---
title: 'Tutorial: Herstellen einer Verbindung mit einem Azure SQL-Server über einen privaten Azure-Endpunkt'
description: Verwenden Sie dieses Tutorial, um sich darüber zu informieren, wie Sie einen Azure SQL-Server mit einem privaten Endpunkt erstellen.
...
ms.locfileid: "92344755"
---
# <a name="tutorial---connect-to-an-azure-sql-server-using-an-azure-private-endpoint"></a>Tutorial: Herstellen einer Verbindung mit einem Azure SQL-Server über einen privaten Azure-Endpunkt
