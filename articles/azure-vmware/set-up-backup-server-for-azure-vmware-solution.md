...
Wechseln Sie zum nächsten Tutorial, um zu erfahren, wie Sie mit Azure Backup Server eine Sicherung von VMware-VMs konfigurieren können, die unter Azure VMware Solution ausgeführt werden.
