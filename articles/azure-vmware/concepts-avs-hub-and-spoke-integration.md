...
In diesem Artikel finden Sie Empfehlungen für die Integration einer Azure VMware Solution-Bereitstellung (AVS-Bereitstellung) in eine vorhandene oder neue [Hub-and-Spoke-Architektur](/azure/architecture/reference-architectures/hybrid-networking/shared-services) in Azure. 
...
ExpressRoute-Verbindungen ermöglichen Datenverkehr zwischen lokalen Systemen, AVS und dem Azure-Netzwerkfabric. Für AVS wird [ExpressRoute Global Reach](../expressroute/expressroute-global-reach.md) verwendet, um diese Konnektivität zu implementieren.
...
Weitere Details zu den AVS-Netzwerk- und -Konnektivitätskonzepten finden Sie in der [AVS-Produktdokumentation](./concepts-networking.md).
