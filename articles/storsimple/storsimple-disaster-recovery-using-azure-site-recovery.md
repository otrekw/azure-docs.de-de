...
Für das Implementieren einer Lösung zur Notfallwiederherstellung, die Azure Site Recovery für auf dem StorSimple-Speicher gehostete Dateifreigaben verwendet, gelten die folgenden Voraussetzungen:
   ...
   - [Ein Azure Site Recovery Services-Tresor](../site-recovery/hyper-v-vmm-azure-tutorial.md) , der in einem Microsoft Azure-Abonnement erstellt wurde.
...
Sehen Sie sich die [Azure Site Recovery-Dokumentation](../site-recovery/index.yml) an, um die ersten Schritte mit Azure Site Recovery auszuführen, bevor Sie die Dateiserver-VM schützen.
...
1. [Aktivieren Sie den Schutz für virtuelle Computer](../site-recovery/hyper-v-azure-tutorial.md) der Dateiserver-VM im Azure Site Recovery-Portal.
