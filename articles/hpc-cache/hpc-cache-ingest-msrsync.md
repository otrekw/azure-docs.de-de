...
Weitere Informationen zum Verschieben von Daten in Blob Storage für Ihre Azure HPC Cache-Instanz finden Sie unter [Verschieben von Daten in Azure Blob Storage](hpc-cache-ingest.md).
