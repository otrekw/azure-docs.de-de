...
* [Firewallregeln](https://docs.microsoft.com/rest/api/datalakeanalytics/firewallrules)
...
* [Zugreifen auf Diagnoseprotokolle für Azure Data Lake Analytics](https://docs.microsoft.com/azure/data-lake-analytics/data-lake-analytics-diagnostic-logs)
...
* [Planen einer Bereitstellung von Azure Multi-Factor Authentication](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-getstarted)
...
* [Schnellstart: Konfigurieren benannter Orte in Azure Active Directory](https://docs.microsoft.com/azure/active-directory/reports-monitoring/quickstart-configure-named-locations)
...
**Leitfaden**: Verwenden Sie Azure Active Directory (Azure AD) als zentrales Authentifizierungs- und Autorisierungssystem. Azure AD verfügt über die rollenbasierte Zugriffssteuerung (Role-Based Access Control, RBAC), um eine präzise Steuerung des Zugriffs eines Clients auf Data Lake Analytics-Ressourcen zu ermöglichen.
...
* [Verwalten der rollenbasierten Zugriffssteuerung](https://docs.microsoft.com/azure/data-lake-analytics/data-lake-analytics-manage-use-portal#manage-role-based-access-control)
...
* [Beispiel für eine Liste mit Vorgängen](https://docs.microsoft.com/rest/api/datalakeanalytics/operations/list)
...
**Leitfaden**: Verwenden Sie die rollenbasierte Zugriffssteuerung, um zu steuern, wie Benutzer mit dem Dienst interagieren.
...
* [Verschlüsselung von Daten in Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-encryption)
...
* [Verwalten von Azure Data Lake Storage Gen1-Ressourcen mit Storage-Explorer](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-in-storage-explorer)

* [Kopieren von Daten aus Azure Storage-Blobs in Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-copy-data-azure-storage-blob)
...
* [Sichern von in Azure Data Lake Storage Gen1 gespeicherten Daten](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-secure-data)
