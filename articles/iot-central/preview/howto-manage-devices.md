...
Unter [Gerätekonnektivität in Azure IoT Central](overview-iot-central-get-connected.md) finden Sie weitere Informationen zu Verbindungszeichenfolgen und zum Verbinden von echten Geräten für Ihre IoT Central-Anwendung.
