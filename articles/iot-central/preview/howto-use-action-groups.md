...
ms.locfileid: "73929897"
---
# <a name="group-multiple-actions-to-run-from-one-or-more-rules-preview-features"></a>Gruppieren mehrerer Aktionen für die Ausführung über eine oder mehrere Regeln (Vorschaufeatures)
