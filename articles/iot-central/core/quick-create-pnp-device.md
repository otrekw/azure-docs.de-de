...
1. Nach einigen Sekunden wird Ihre neue Gerätevorlage angezeigt:
    ...
    ![Gerätevorlage für „MXChip IoT DevKit“](./media/quick-create-pnp-device/devkit-template.png)
...
1. Wählen Sie die Cloudeigenschaften **Kundenname** und **Datum der letzten Wartung** sowie die Eigenschaft **Lüftergeschwindigkeit** aus. Wählen Sie anschließend **Abschnitt hinzufügen** aus:
    ...
    ![Erstellen eines neuen Formulars](media/quick-create-pnp-device/new-form.png)
...
1. Die **Übersicht** enthält einen Plot der simulierten Telemetriedaten:
    ...
    ![Übersicht](./media/quick-create-pnp-device/simulated-telemetry.png)
