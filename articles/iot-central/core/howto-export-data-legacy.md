...
>
> - Informationen zu den neuesten Datenexportfeatures finden Sie unter [Exportieren von IoT-Daten zu Cloudzielen mithilfe des Datenexports](./howto-export-data.md).
