...
> [!div class="checklist"]
> * Verwenden Sie Visual Studio Code, um mit einem Gerätefunktionsmodell ein IoT Plug & Play-Gerät (Vorschauversion) zu erstellen.
...
In diesem Tutorial wurde beschrieben, wie Sie eine Verbindung mit einem IoT Plug & Play-Gerät (Vorschauversion) herstellen, das auf der Grundlage eines Gerätefunktionsmodells im öffentlichen Modellrepository generiert wurde.
