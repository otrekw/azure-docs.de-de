...
Aktivieren Sie die Protokolle mit dem Befehl [`az monitor diagnostic-settings create`](/cli/azure/monitor/diagnostic-settings#az_monitor_diagnostic_settings_create).
...
Sie können die Metrikdefinition Ihres Speicherkontos oder des Queue Storage-Diensts auflisten. Verwenden Sie den Befehl [`az monitor metrics list-definitions`](/cli/azure/monitor/metrics#az_monitor_metrics_list_definitions).
...
Sie können die Metrikwerte Ihres Speicherkontos oder des Queue Storage-Diensts lesen. Verwenden Sie den Befehl [`az monitor metrics list`](/cli/azure/monitor/metrics#az_monitor_metrics_list).
