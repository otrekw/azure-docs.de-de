...
Weitere Informationen zum Verwenden von AzCopy zum Kopieren von Blobdaten finden Sie unter [Übertragen von Daten mit AzCopy und Blob Storage](../common/storage-use-azcopy-v10.md#transfer-data).
