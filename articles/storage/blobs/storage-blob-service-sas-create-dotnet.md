---
title: Erstellen einer Dienst-SAS für einen Container oder ein Blob mit .NET
...
In diesem Artikel wird beschrieben, wie Sie den Speicherkontoschlüssel zum Erstellen einer Dienst-SAS für einen Container oder ein Blob mit der [Azure Storage-Clientbibliothek für .NET](/dotnet/api/overview/azure/storage?view=azure-dotnet) verwenden.
...
Erstellen Sie ein neues [BlobSasBuilder](/dotnet/api/azure.storage.sas.blobsasbuilder)-Element. Rufen Sie dann [ToSasQueryParameters](/dotnet/api/azure.storage.sas.blobsasbuilder.tosasqueryparameters) auf, um die SAS-Tokenzeichenfolge abzurufen. 
