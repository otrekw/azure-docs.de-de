---
title: Upgraden von Azure Data Lake Storage von Gen1 auf Gen2
description: Upgraden von Azure Data Lake Storage von Gen1 auf Gen2
author: normesta
ms.topic: conceptual
ms.author: normesta
ms.date: 11/19/2019
...
ms.locfileid: "74894231"
---
# <a name="upgrade-azure-data-lake-storage-from-gen1-to-gen2"></a>Upgraden von Azure Data Lake Storage von Gen1 auf Gen2
...
| Datenvorgänge: Protokolle  | Ja | Ja | *Jetzt verfügbar* (Vorschau). Siehe [Bekannte Probleme](data-lake-storage-known-issues.md).<br><br> Azure-Überwachungsintegration: *noch nicht verfügbar* |
...
| Entwickler-SDKs | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| BLOB SDK: *jetzt verfügbar*. [Azure Data Lake Storage Gen2 SDK](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *Jetzt verfügbar: .NET, Java, Python (öffentliche Vorschau)*  |
...
| Georedundanz| Lokal redundant (LRS, lokal redundanter Speicher) | Lokal redundant (LRS), zonenredundant (ZRS) georedundant (GRS), georedundant mit Lesezugriff (RA-GRS). [Hier](https://docs.microsoft.com/azure/storage/common/storage-redundancy) finden Sie weitere Informationen dazu.| *Jetzt verfügbar* |
...
| Datenverwaltung                             | Ablaufdatum der Datei                                                                                                                                        | Richtlinien für den Lebenszyklus                                                                                                                                                                                                                                                                                                                                                                                                          | Lebenszyklusrichtlinien: *jetzt verfügbar* (Vorschau). Siehe [Bekannte Probleme](data-lake-storage-known-issues.md).                                                                                                                     |

### <a name="programming-interfaces"></a>Programmierschnittstellen

Diese Tabelle beschreibt, welche APIs für Ihre benutzerdefinierten Anwendungen verfügbar sind. SDK-Unterstützung für Vorgänge auf ACL- und Verzeichnisebene ist noch nicht verfügbar.
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Link](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Jetzt verfügbar* | *Jetzt verfügbar* |
| Java-SDK                | [Link](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Jetzt verfügbar*                                                      | *Jetzt verfügbar*                                     |
| Node.js                | [Link](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Jetzt verfügbar*                                                     | *Jetzt verfügbar*                                                                                           |
| Python SDK                   | [Link](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Jetzt verfügbar*                                                      | *Jetzt verfügbar*                                        |
| REST-API                 | [Link](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Jetzt verfügbar*                                                      | *Jetzt verfügbar*                                                                                                                                               |
| PowerShell | [Link](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Jetzt verfügbar* |
| Befehlszeilenschnittstelle (CLI)                 | [Link](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Jetzt verfügbar*                                                      | *Jetzt verfügbar*                                                               |
| Azure Resource Manager-Vorlagen: Verwaltung             | [Vorlage1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Vorlage2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Vorlage3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Jetzt verfügbar*                                                      | *Jetzt verfügbar*                                          |
...
|                      | [SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Jetzt verfügbar*                                                                                                                                                          | *Jetzt verfügbar*                                                                                                                             |
...
|                      | [Logik-Apps](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *Jetzt verfügbar*                                                                                                                                                          | *Jetzt verfügbar*                                                                                                                             |
| IoT                  | [Event Hubs Capture](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *Jetzt verfügbar*                                                                                                                                                          | *Jetzt verfügbar*                                                                                                                             |
|                      | [Stream Analytics](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *Jetzt verfügbar*                                                                                                                                                          | *Jetzt verfügbar*                                                                                                                             |
| Nutzung          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Jetzt verfügbar*                                                                                                                                                          | *Jetzt verfügbar*                                                                                                                             |
...
| Diagnoseprotokolle                                                                                        | [Link](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Jetzt verfügbar* (Vorschau). Siehe [Bekannte Probleme](data-lake-storage-known-issues.md). <br>Azure-Überwachungsintegration: *noch nicht verfügbar* |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Migration per Lift & Shift**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Verwalteter Clouddienst                                                                                                                | Sowohl Daten als auch ACLs können derzeit kopiert werden.                                                                                                                                                                                                                                                                      |
