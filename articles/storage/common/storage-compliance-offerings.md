---
title: Azure Storage-Complianceangebote | Microsoft-Dokumentation
description: Lesen Sie eine Zusammenfassung der Complianceangebote für Azure Storage für nationale, regionale und branchenspezifische Anforderungen hinsichtlich der Erfassung und Nutzung von Daten.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
Nachfolgend finden Sie Complianceangebote für Azure Storage, um sicherzustellen, dass Ihr Dienst bei der Nutzung des Azure Storage-Diensts die Vorschriften einhält. Die Complianceangebote gelten für die folgenden Azure Storage-Varianten: Blobs (ADLS Gen2), Dateien, Warteschlangen, Tabellen, Datenträger, kalte Speicherebene und Storage Premium.

## <a name="global"></a>Global

* [CSA-STAR-Nachweis](https://www.microsoft.com/trustcenter/compliance/csa-star-attestation)
* [CSA-STAR-Zertifizierung](https://www.microsoft.com/trustcenter/compliance/csa-star-certification)
* [CSA-STAR-Selbsteinschätzung](https://www.microsoft.com/trustcenter/compliance/csa-self-assessment)
...
* [EAR (US Export Administration Regulations)](https://aka.ms/AzureCompliance)
...
* [Section 508 VPATS](https://www.microsoft.com/trustcenter/compliance/accessibility)

## <a name="industry"></a>Branche

* [23 NYCRR Part 500](https://www.microsoft.com/trustcenter/compliance/NYCRR)
* [APRA (Australien)](https://www.microsoft.com/trustcenter/compliance/apra)
...
* [NEN-7510 (Niederlande)](https://www.microsoft.com/trustcenter/compliance/nen-7510)
...
* [BIR 2012 (Niederlande)](https://www.microsoft.com/TrustCenter/Compliance/bir-2012)
* [C5 (Deutschland)](https://www.microsoft.com/TrustCenter/Compliance/C5)
...
* [EU-Modellklauseln](https://www.microsoft.com/trustcenter/compliance/eu-model-clauses)
* [EU-US- Datenschutzschild](https://privacy.microsoft.com/en-US/microsoft-eu-us-privacy-shield)
...
* [IT-Grundschutz-Kompendium (Deutschland)](https://www.microsoft.com/TrustCenter/Compliance/IT-Grundschutz)
...
* [NZ CC Framework (Neuseeland)](https://www.microsoft.com/trustcenter/compliance/nzcc)
* [PASF (UK)](https://aka.ms/AzureCompliance)
* [PDPA (Argentinien)](https://www.microsoft.com/trustcenter/privacy/we-set-and-adhere-to-stringent-standards#argentina)
...
Microsoft Azure und Azure Storage sind weiterhin führend bei Complianceangeboten. Aktuelle Informationen und Details finden Sie im [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
