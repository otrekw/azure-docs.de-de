...
1. Wählen Sie [Azure-Portal](https://portal.azure.com) unter **Datenspeicher** die Option **Blobcontainer** aus.
...
1. Klicken Sie auf **Hinzufügen** und dann auf **Rollenzuweisung hinzufügen**, um eine neue Rolle hinzuzufügen.
...
2. Wählen Sie **Zugriffssteuerung (IAM)** aus, um Zugriffssteuerungseinstellungen für das Speicherkonto anzuzeigen. Wählen Sie die Registerkarte **Rollenzuweisungen** aus, um die Liste mit den Rollenzuweisungen anzuzeigen.
3. Klicken Sie auf **Hinzufügen** und dann auf **Rollenzuweisung hinzufügen**, um eine neue Rolle hinzuzufügen.
4. Wählen Sie im Fenster **Rollenzuweisung hinzufügen** die Rolle **Leser** aus. 
5. Wählen Sie im Feld **Zugriff zuweisen zu** die Option **Azure AD-Benutzer, -Gruppe oder -Dienstprinzipal** aus.
6. Suchen Sie den Sicherheitsprinzipal, dem Sie die Rolle zuweisen möchten.
7. Speichern Sie die Rollenzuweisung.
