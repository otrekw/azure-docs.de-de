...
> * Hochladen einer Datei mit Indextags
...
> [!NOTE]
> Wenn Sie ein Verzeichnis für die Quelle angeben, verfügen alle in das Ziel kopierten Blobs über die gleichen Tags, die Sie im Befehl angeben.
...
> * Kopieren von Blobs in ein anderes Speicherkonto mit Indextags
...
> [!NOTE]
> Wenn die Quellblobs über Indextags verfügen und Sie diese Tags beibehalten möchten, müssen Sie sie erneut auf die Zielblobs anwenden. Informationen zum Festlegen von Indextags finden Sie im Abschnitt [Kopieren von Blobs und Hinzufügen von Indextags](#copy-between-accounts-and-add-index-tags) dieses Artikels.  
...
> [!NOTE]
> Wenn die Quellblobs über Indextags verfügen und Sie diese Tags beibehalten möchten, müssen Sie sie erneut auf die Zielblobs anwenden. Informationen zum Festlegen von Indextags finden Sie unten im Abschnitt **Kopieren von Blobs und Hinzufügen von Indextags**. 

<a id="copy-between-accounts-and-add-index-tags"></a>

### <a name="copy-blobs-to-another-storage-account-with-index-tags"></a>Kopieren von Blobs in ein anderes Speicherkonto mit Indextags

Sie können Blobs in ein anderes Speicherkonto kopieren und dem Zielblob [Blobindextags (Vorschau)](../blobs/storage-manage-find-blobs.md) hinzufügen.
...
> [!NOTE]
> Wenn Sie ein Verzeichnis, einen Container oder ein Konto für die Quelle angeben, verfügen alle in das Ziel kopierten Blobs über die gleichen Tags, die Sie im Befehl angeben. 
