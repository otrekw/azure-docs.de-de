---
title: Problembehandlung bei Datenvorgängen mit Diagnose und Message Analyzer
...
#### <a name="status-code-404-not-found-examples"></a>Beispiele für Statuscode 404 (Nicht gefunden)
...
#### <a name="status-code-409-conflict-examples"></a>Beispiele für Statuscode 409 (Konflikt)
...
#### <a name="status-code-412-precondition-failed-examples"></a>Beispiele für Statuscode 412 (Vorbedingung nicht erfüllt)
...
1. Laden Sie [Message Analyzer](https://docs.microsoft.com/message-analyzer/installing-and-upgrading-message-analyzer) herunter.
