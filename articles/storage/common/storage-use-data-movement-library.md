...
1. Siehe die [.NET Core Installationsanleitung](https://dotnet.microsoft.com/download), um das .NET Core SDK zu installieren. Wählen Sie bei der Auswahl Ihrer Umgebung die Befehlszeilenoption.
