...
ms.locfileid: "102204227"
---
# <a name="how-to-manage-tiered-files"></a>Verwalten von mehrstufigen Dateien

Dieser Artikel enthält Informationen für Benutzer, die Fragen zur Verwaltung ausgelagerter Dateien haben. Informationen zu grundlegenden Fragen zum Cloudtiering finden Sie unter [Häufig gestellte Fragen (FAQ) zu Azure Files](storage-files-faq.md).
