...
1. Wählen Sie im linken Menü **Netzwerk** aus.
1. Wählen Sie unter **Ausgewählte Netzwerke** die Option **Zugriff erlauben von** aus.
1. Vergewissern Sie sich, dass die Server-IP-Adresse oder das virtuelle Netzwerk unter dem **Adressbereich** aufgeführt ist.
