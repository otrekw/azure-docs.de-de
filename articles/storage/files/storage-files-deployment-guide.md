...
2. Verwenden Sie `robocopy` in der Befehlszeile, um Daten in die Azure-Dateifreigabe zu verschieben:
    ...
    Robocopy verfügt über eine Vielzahl von Optionen, mit denen Sie das Kopierverhalten nach Bedarf ändern können. Weitere Informationen finden Sie auf der Handbuchseite zu [Robocopy](/windows-server/administration/windows-commands/robocopy).
...
1. Laden Sie die [neueste Version von AzCopy für Windows](https://aka.ms/downloadazcopy) oder [Linux](../common/storage-use-azcopy-v10.md?toc=/azure/storage/files/toc.json#download-azcopy) herunter.
