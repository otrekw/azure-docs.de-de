...
Sie können die Hilfsprogramme bcp und sqlcmd aus der [Microsoft- sqlcmd-Dokumentation](/sql/tools/sqlcmd-utility?view=sql-server-ver15&preserve-view=true) herunterladen.
