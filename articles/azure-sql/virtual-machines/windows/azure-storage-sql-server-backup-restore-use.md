...
Seit SQL Server 2012 SP1 CU2 können Sie SQL Server-Sicherungen direkt in den Azure Blob Storage-Dienst schreiben. Mit dieser Funktion können Sie Sicherungs- und Wiederherstellungsvorgänge im Azure-Blob-Dienst und in SQL Server-Datenbanken ausführen. Die Sicherung in der Cloud bietet zahlreiche Vorteile: Verfügbarkeit, unbegrenzter georeplizierter Offsitespeicher und problemlose Migration von Daten in die und aus der Cloud. Sie können BACKUP- und RESTORE-Anweisungen mithilfe von T-SQL oder SMO aufrufen.
...
Weitere Sicherungs- und Wiederherstellungsoptionen für SQL Server finden Sie unter [Sicherung und Wiederherstellung für SQL Server auf virtuellen Azure-Computern](backup-restore.md).
