...
## <a name="resister-all-vms-in-a-resource-group"></a>Registrieren aller VMs in einer Ressourcengruppe
...
## <a name="register-specific-vms-in-single-resource-group"></a>Registrieren bestimmter VMs in einer einzelnen Ressourcengruppe
