---
title: 'Mit PowerShell: Synchronisieren von Daten zwischen Azure SQL-Datenbank und SQL Server'
...
In diesem Azure PowerShell-Beispiel wird Azure SQL-Datensynchronisierung zum Synchronisieren von Daten zwischen Azure SQL-Datenbank und SQL Server konfiguriert. 
...
- Erstellen einer Datenbank in einer SQL Server-Instanz als Mitgliedsdatenbank.
...
- Einrichten der Datensynchronisierung
    - Verwenden des Azure-Portals: [Tutorial: Einrichten der SQL-Datensynchronisierung zum Synchronisieren von Daten zwischen einer Datenbank in Azure SQL-Datenbank und einer lokalen SQL Server-Datenbank](../sql-data-sync-sql-server-configure.md)
