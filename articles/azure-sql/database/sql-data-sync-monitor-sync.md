...
![Dashboard zur Überwachung der Datensynchronisierung](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![E-Mail-Benachrichtigungen für die Datensynchronisierung](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
-   [Übersicht über die SQL-Datenbank](../../sql-database/sql-database-technical-overview.md)
