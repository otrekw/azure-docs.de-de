...
- Erfahren Sie, wie Sie [Leistungsprobleme mithilfe der Azure SQL-Analyse überwachen](https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-sql).
