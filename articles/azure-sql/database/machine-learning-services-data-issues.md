...
In diesem Artikel werden einige häufige Probleme beschrieben, die ggf. auftreten können, wenn Sie Daten zwischen R und SQL-Datenbank in [Machine Learning Services (mit R) in Azure SQL-Datenbank](machine-learning-services-overview.md) verschieben. In dieser Übung sammeln Sie praktische Erfahrungen, die Ihnen eine gute Grundlage für die Arbeit mit Daten in Ihrem eigenen Skript bieten.
