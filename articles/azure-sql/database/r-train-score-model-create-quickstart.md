...
![Trainiertes Modell mit zusätzlicher Ausgabe](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. Sagen Sie den Anhalteweg aufgrund dieser neuen Geschwindigkeitswerte vorher.
   ...
   **Ergebnisse**
   ...
   ![Resultset für die Vorhersage des Anhaltewegs](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
