...
Geben Sie die timezoneId-Eigenschaft in Ihrer [Resource Manager-Vorlage](./create-template-quickstart.md) an, um die Zeitzone während der Instanzerstellung festzulegen.
