...
ms.locfileid: "84031291"
---
# <a name="configuring-a-custom-dns-for-azure-sql-managed-instance"></a>Konfigurieren eines benutzerdefinierten DNS für Azure SQL Managed Instance
[!INCLUDE[appliesto-sqlmi](../includes/appliesto-sqlmi.md)]

Eine Azure SQL Managed Instance muss in einem [virtuellen Azure-Netzwerk (VNet)](../../virtual-network/virtual-networks-overview.md) bereitgestellt werden. Es gibt einige Szenarien (z. B. Datenbank-E-Mail, Verbindungsserver für andere SQL-Instanzen in Ihrer Cloud- oder Hybridumgebung), bei denen private Hostnamen von der SQL Managed Instance aufgelöst werden müssen. In diesem Fall müssen Sie einen benutzerdefinierten DNS in Azure konfigurieren. 
