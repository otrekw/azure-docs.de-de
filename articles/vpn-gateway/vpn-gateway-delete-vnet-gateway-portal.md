---
title: 'Löschen eines virtuellen Netzwerk-Gateways: Portal'
titleSuffix: Azure VPN Gateway
description: Erfahren Sie, wie Sie ein virtuelles Netzwerk-Gateway anhand des Azure-Portals löschen.
