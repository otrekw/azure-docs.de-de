...
| prefix                   | Präfix für den Blobnamen unter dem angegebenen Container, der im DataSet zum Filtern von Quellblobs konfiguriert wurde. Blobs, deren Namen mit diesem Präfix beginnen, werden ausgewählt. <br>Nur gültig, wenn die Eigenschaften `wildcardFolderPath` und `wildcardFileName` nicht angegeben sind. | Nein                                                          |
