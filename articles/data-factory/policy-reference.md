...
description: Hier finden Sie eine Liste der integrierten Azure Policy-Richtliniendefinitionen für Data Factory. Diese integrierten Richtliniendefinitionen bieten allgemeine Ansätze für die Verwaltung von Azure-Ressourcen.
ms.author: lle
author: lrtoyou1223
...
ms.locfileid: "102612632"
---
# <a name="azure-policy-built-in-definitions-for-data-factory-preview"></a>Integrierte Azure Policy-Definitionen für Data Factory (Vorschau)
[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

Diese Seite enthält einen Index der integrierten [Azure Policy](../governance/policy/overview.md)-Richtliniendefinitionen für Data Factory. Weitere Azure Policy-Integrationen für andere Dienste finden Sie unter [Integrierte Azure Policy-Richtliniendefinitionen](../governance/policy/samples/built-in-policies.md).
