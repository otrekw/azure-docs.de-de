...
> [!NOTE]
> Ein zugeordnetes Netzwerklaufwerk wird beim Laden von Daten aus einer Netzwerkdateifreigabe nicht unterstützt. Verwenden Sie stattdessen den tatsächlichen Pfad, z. B. ` \\server\share`.
