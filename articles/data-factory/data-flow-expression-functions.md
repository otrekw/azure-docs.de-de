...
Logischer UND-Operator. Entspricht &&:
...
Gibt TRUE zurück, wenn ein beliebiges Element im angegebenen Array als TRUE im bereitgestellten Prädikat ausgewertet wird. Die contains-Funktion erwartet einen Verweis auf ein einzelnes Element in der Prädikatfunktion als „#item“.
...
Gibt immer den Wert FALSE zurück. Verwenden Sie die Funktionssyntax „false()“, falls eine Spalte mit dem Namen „false“ vorhanden ist.
...
Filtert Elemente aus dem Array heraus, die dem bereitgestellten Prädikat nicht entsprechen. Die filter-Funktion erwartet einen Verweis auf ein einzelnes Element in der Prädikatfunktion als „#item“.
...
Wendet basierend auf einer Bedingung einen Wert oder den anderen an. Wenn „Andere“ nicht angegeben ist, gilt der Wert als NULL. Die Werte müssen kompatibel sein (numerisch, Zeichenfolge...).
...
Überprüft, ob der Wert NICHT NULL ist, und gibt ihn zurück – andernfalls die Alternative. Es werden alle Eingaben getestet, bis der erste Wert gefunden wird, der nicht NULL ist.
...
Überprüft, ob die Zeile zum Löschen markiert ist. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Überprüft, ob die Zeile als Fehler markiert ist. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Überprüft, ob die Zeile zum Ignorieren markiert ist. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Überprüft, ob die Zeile zum Einfügen markiert ist. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Überprüft, ob die Zeile bei der Suche übereinstimmt. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Überprüft, ob die Zeile zum Aktualisieren markiert ist. Für Transformationen, die mehrere Eingabestreams akzeptieren, können Sie den (auf 1 basierenden) Index des Streams übergeben. Der Standardwert für den Streamindex ist 1:
...
Operator für Vergleich auf „kleiner als oder gleich“. Identisch mit <= operator
...
Ruft den Levenshtein-Abstand zwischen zwei Zeichenfolgen ab:
...
Ordnet anhand des bereitgestellten Ausdrucks jedes Element des Arrays einem neuen Element zu. Die map-Funktion erwartet einen Verweis auf ein einzelnes Element in der Ausdrucksfunktion als „#item“.
...
Gibt einen NULL-Wert zurück. Verwenden Sie die Funktionssyntax „null()“, wenn eine Spalte mit dem Namen „null“ vorhanden ist. Jeder Vorgang, in dem dieser Ausdruck verwendet wird, hat als Ergebnis NULL:
...
Logischer ODER-Operator. Entspricht ||:
...
Akkumuliert Elemente in einem Array. Die reduce-Funktion erwartet einen Verweis auf einen Akkumulator und ein einzelnes Element in der ersten Ausdrucksfunktion als „#acc“ und „#item“. Außerdem wird erwartet, dass der resultierende Wert als „#result“ in der zweiten Ausdrucksfunktion verwendet wird.
...
Überprüft, ob die Zeichenfolge mit dem angegebenen RegEx-Muster übereinstimmt. <regex> (einfaches öffnendes Anführungszeichen oben) stimmt mit einer Zeichenfolge ohne Escapezeichen überein:
...
Ersetzt alle Vorkommen eines RegEx-Musters durch eine andere Teilzeichenfolge in der angegebenen Zeichenfolge. <regex> (einfaches öffnendes Anführungszeichen oben) stimmt mit einer Zeichenfolge ohne Escapezeichen überein:
...
Unterteilt eine Zeichenfolge basierend auf einem Trennzeichen basierend auf einem regulären Ausdruck und gibt ein Array von Zeichenfolgen zurück:
...
Weist Zeilen in einem Fenster eine sequenzielle Zeilennummerierung zu, beginnend bei 1:
...
Ruft den SOUNDEX-Code für die Zeichenfolge ab:
...
Unterteilt eine Zeichenfolge basierend auf einem Trennzeichen und gibt ein Array von Zeichenfolgen zurück:
...
Subtrahiert Monate von einem Datum oder einem Zeitstempel. Entspricht dem Operator - für Datumsangaben:
...
Wandelt beliebige numerische oder Zeichenfolgenwerte in einen double-Wert um. Ein optionales Java-Dezimalzahlenformat kann für die Umwandlung verwendet werden. Ein optionales Gebietsschemaformat in Form der BCP47-Sprache (beispielsweise „en-US“, „de“ oder „zh-CN“).
...
Ersetzt eine Gruppe von Zeichen durch eine andere Gruppe von Zeichen in der Zeichenfolge. Die Zeichen werden 1:1 ersetzt:
...
Gibt immer den Wert TRUE zurück. Verwenden Sie die Funktionssyntax „true()“, wenn eine Spalte mit dem Namen „true“ vorhanden ist.
