...
#### <a name="example-using-sql-query"></a>Beispiel: Verwenden von SQL-Abfragen
...
#### <a name="example-using-stored-procedure"></a>Beispiel: Verwenden von gespeicherten Prozeduren
