---
title: Kopieren von Daten aus Greenplum mithilfe von Azure Data Factory
...
Der Greenplum-Connector wird für die folgenden Aktivitäten unterstützt:
...
|:--- |:--- |:--- |
| type | Die „type“-Eigenschaft muss auf **Greenplum** festgelegt sein. | Ja |
...
| Eigenschaft | BESCHREIBUNG | Erforderlich |
|:--- |:--- |:--- |
| type | Die type-Eigenschaft des Datasets muss auf **GreenplumTable** festgelegt werden. | Ja |
...
| Eigenschaft | BESCHREIBUNG | Erforderlich |
|:--- |:--- |:--- |
| type | Die „type“-Eigenschaft der Quelle der Kopieraktivität muss auf **GreenplumSource** festgelegt werden. | Ja |
