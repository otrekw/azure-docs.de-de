...
|[Massenkopieren](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Dieses PowerShell-Beispielskript kopiert Daten aus mehreren Tabellen in eine Datenbank in Azure SQL-Datenbank in Azure Synapse Analytics (vormals SQL Data Warehouse). |
