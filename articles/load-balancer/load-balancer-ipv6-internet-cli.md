...
1. [Installieren und konfigurieren Sie die Azure CLI](/cli/azure/install-azure-cli) anhand der Schritte im verlinkten Artikel, und melden Sie sich dann bei Ihrem Azure-Konto an.
