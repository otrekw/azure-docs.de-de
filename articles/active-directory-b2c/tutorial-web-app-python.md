...
:::image type="content" source="media/tutorial-web-app-python/python-flask-web-app-03.png" alt-text="Webbrowser mit Python Flask-Webanwendung und angemeldetem Benutzer":::
