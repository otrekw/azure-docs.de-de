...
Sie können weitere Verwaltungsaufgaben automatisieren, etwa das [Verwalten von Azure AD B2C-Benutzerkonten mit Microsoft Graph](microsoft-graph-operations.md).