...
| setting.enableRememberMe <sup>2</sup>| Nein| Zeigt das Kontrollkästchen [Angemeldet bleiben](custom-policy-keep-me-signed-in.md) an. Mögliche Werte sind `true` oder `false` (Standardwert). |
