...
In diesem Artikel wird beschrieben, wie Sie die Anmeldung für Benutzer einer Azure Active Directory-Organisation (Azure AD-Organisation) mithilfe [benutzerdefinierter Richtlinien](custom-policy-overview.md) in Azure Active Directory B2C (Azure AD B2C) aktivieren.
