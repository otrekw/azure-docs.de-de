...
In einem verwandten Artikel [erstellen Sie einen RESTful-Dienst](rest-api-claims-exchange-dotnet.md), der mit Azure Active Directory B2C (Azure AD B2C) interagiert.
...
>[!NOTE]
>Sie können Ihren RESTful-Dienst auch unter Verwendung der [HTTP-Standardauthentifizierung](secure-rest-api-dotnet-basic-auth.md) schützen. Die HTTP-Standardauthentifizierung gilt jedoch als unsicherer als die Authentifizierung über ein Clientzertifikat. Unsere Empfehlung: Schützen Sie den RESTful-Dienst wie in diesem Artikel beschrieben mit der Clientzertifikatauthentifizierung.
...
* Führen Sie die Schritte im Artikel zum [Integrieren von REST-API-Anspruchsaustauschvorgängen](rest-api-claims-exchange-dotnet.md) aus.
...
7. Geben Sie im Feld **Kennwort** das Kennwort des Zertifikats ein.
    ...
    ![Hochladen des Richtlinienschlüssels auf der Seite „Schlüssel erstellen“ im Azure-Portal](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-upload.png)
...
5. Fügen Sie den folgenden XML-Codeausschnitt unmittelbar hinter dem schließenden `<Metadata>`-Element hinzu:
    ...
    ![Festlegen der ClientCertificate-Authentifizierungs-XML-Elemente](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-tech-profile.png)
...
1. Öffnen Sie **Azure AD B2C-Einstellungen**, und wählen Sie **Framework für die Identitätsfunktion** aus.
    ...
    >[!NOTE]
    >Für „Jetzt ausführen“ muss mindestens eine Anwendung vorab im Mandanten registriert werden. Informationen zum Registrieren von Anwendungen finden Sie in den Artikeln [Erste Schritte](tutorial-create-tenant.md) bzw. [Anwendungsregistrierung](tutorial-register-applications.md) zu Azure AD B2C.
...
3. Testen Sie den Prozess, indem Sie **Test** in das Feld **Vorname** eingeben.
    ...
    ![Hervorgehobenes Textfeld für den Vornamen mit Fehler bei der Eingabeüberprüfung](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-test.png)
...
![Hinzufügen des Zertifikatüberprüfungscodes](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-code.png)
...
Informationen zum Beheben von Problemen bei diesem Schritt finden Sie unter [Erfassen von Protokollen mithilfe von Application Insights](troubleshoot-with-application-insights.md).
