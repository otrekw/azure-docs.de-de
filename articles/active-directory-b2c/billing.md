...
1. Klicken Sie auf **Erstellen**.
    ![Seite zum Erstellen der Azure AD-B2C-Ressource im Azure-Portal](./media/billing/portal-01-create-b2c-resource-page.png)
...
![Seite mit Einstellungen für die B2C-Ressource im Azure-Portal](./media/billing/portal-02-b2c-resource-overview.png)
