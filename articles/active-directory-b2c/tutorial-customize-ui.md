...
description: Hier erfahren Sie, wie Sie die Benutzeroberfläche Ihrer Anwendungen in Azure Active Directory B2C mithilfe des Azure-Portals anpassen.
services: B2C
author: mmacy
manager: celestedg
