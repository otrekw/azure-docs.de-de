...
In diesem Artikel erfahren Sie, wie Sie die Anmeldung für Benutzer eines Twitter-Kontos mithilfe [benutzerdefinierter Richtlinien](custom-policy-overview.md) in Azure Active Directory B2C (Azure AD B2C) aktivieren.
