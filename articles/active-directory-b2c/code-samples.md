...
| [javascript-nodejs-webapp](https://github.com/AzureADQuickStarts/active-directory-b2c-javascript-nodejs-webapp) | Ein Node.js-Server, der das schnelle und einfache Einrichten eines REST-API-Diensts per OAuth2-Protokoll ermöglicht. |
