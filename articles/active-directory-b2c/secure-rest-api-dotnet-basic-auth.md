---
title: Schützen eines RESTful-Diensts unter Verwendung der HTTP-Standardauthentifizierung
...
In einem [thematisch ähnlichen Azure AD B2C-Artikel](rest-api-claims-exchange-dotnet.md) haben wir einen RESTful-Dienst (Web-API) erstellt, der sich ohne Authentifizierung in Azure Active Directory B2C-User Journeys (Azure AD B2C) integriert.
...
Führen Sie die Schritte im Artikel [Integrieren von Anspruchsaustauschvorgängen der REST-API in Ihre Azure AD B2C-User Journey](rest-api-claims-exchange-dotnet.md) durch.
...
1. Klicken Sie mit der rechten Maustaste auf den Ordner *App_Start*, wählen Sie **Hinzufügen** aus, und klicken Sie dann auf **Klasse**.
   ...
   ![Hinzufügen der Klasse „ClientAuthMiddleware.cs“ im Ordner „App_Start“](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)

2. Geben Sie im Feld **Name** die Zeichenfolge **ClientAuthMiddleware.cs** ein.

   ![Erstellen einer neuen C#-Klasse im Dialogfeld „Neues Element hinzufügen“ in Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
1. Klicken Sie mit der rechten Maustaste auf das Projekt, wählen Sie **Hinzufügen** > **Neues Element** aus, und suchen Sie dann nach **OWIN**.
   ...
   ![Erstellen einer OWIN-Startup-Klasse im Dialogfeld „Neues Element hinzufügen“ in Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup.png)
...
![Hinzufügen des Autorisierungstags zum Controller](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
...
5. Fügen Sie den folgenden XML-Codeausschnitt unmittelbar hinter dem schließenden `<Metadata>`-Element hinzu:
    ...
    ![Hinzufügen von Standardauthentifizierungs-XML-Elementen zu TechnicalProfile](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-add-1.png)
...
3. Testen Sie den Prozess, indem Sie **Test** in das Feld **Vorname** eingeben.
    ...
    ![Testen der Eingabevalidierung für den Vornamen in Ihrer Identitäts-API](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-test.png)
...
* [Verwenden Sie zum Sichern Ihrer RESTful-API Clientzertifikate.](secure-rest-api-dotnet-certificate-auth.md)
