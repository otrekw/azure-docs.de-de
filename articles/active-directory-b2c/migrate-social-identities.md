...
Dieser Artikel ist eine Fortsetzung des Artikels „Azure Active Directory B2C: Benutzermigration“ und konzentriert sich auf die Migration von Identitäten sozialer Netzwerke. Bevor Sie beginnen, lesen Sie [Azure Active Directory B2C: Benutzermigration](user-migration.md).
...
Weitere Informationen zum Verwenden der Beispiel-App finden Sie unter [Azure Active Directory B2C: Benutzermigration](user-migration.md)
