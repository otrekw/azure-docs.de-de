...
Führen Sie die Schritte unter [Erste Schritte mit benutzerdefinierten Richtlinien in Azure Active Directory B2C](custom-policy-get-started.md) aus. In diesem Artikel wird davon ausgegangen, dass Sie das Startpaket für die benutzerdefinierte Richtlinie verwenden. Aber das Startpaket ist nicht erforderlich.
...
> [!IMPORTANT]
> Ändern Sie den Instrumentierungsschlüssel im technischen Profil `AzureInsights-Common` in die GUID, die von Ihrer Application Insights-Ressource bereitgestellt wurde.
