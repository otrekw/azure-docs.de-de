...
### <a name="querying-data-sources-using-openrowset"></a>Abfragen von Datenquellen mit OPENROWSET
...
### <a name="reading-external-files-with-external-table"></a>Lesen von externen Dateien mit EXTERNAL TABLE
