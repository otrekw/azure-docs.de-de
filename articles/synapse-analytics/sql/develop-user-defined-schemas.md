...
Wenn präzisere Berechtigungen erforderlich sind, können Sie Datenbankrollen verwenden. Weitere Informationen zu Datenbankrollen finden Sie im Artikel [Verwalten von Datenbankrollen und Benutzern](/sql/relational-databases/security/authentication-access/database-level-roles).
