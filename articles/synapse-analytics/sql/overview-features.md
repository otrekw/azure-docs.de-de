...
| **[Workloadverwaltung, Ressourcenklassen und Gleichzeitigkeitssteuerung](../sql-data-warehouse/resource-classes-for-workload-management.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json)** | Ja, mithilfe von Aktionen zum Hochskalieren und Herunterskalieren | Ja, mithilfe des [Azure-Portals oder der T-SQL-Prozedur](https://docs.microsoft.com/azure/synapse-analytics/sql/data-processed#cost-control) |
