...
- Scala-Plug-In (kann über das [IntelliJ-Plug-In-Repository](/hdinsight/spark/apache-spark-intellij-tool-plugin#install-scala-plugin-for-intellij-idea.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json) installiert werden)
...
2. Klicken Sie mit der rechten Maustaste auf einen Arbeitsbereich, und wählen Sie **Arbeitsbereich starten** aus. Daraufhin wird eine Website geöffnet.
    ...
    ![Spark-Auftrag Anzeigen von Anwendungsdetails](./media/intellij-tool-synapse/launch-workspace-synapse.png)
