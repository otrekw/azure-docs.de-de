---
title: 'Apache Spark für Azure Synapse Analytics: Versionsunterstützung'
description: Unterstützte Versionen von Spark, Scala, Python
...
ms.locfileid: "83696765"
---
# <a name="supported-language-and-runtime-versions-for-apache-spark-and-dependent-components"></a>Unterstützte Sprach- und Runtimeversionen für Apache Spark und abhängige Komponenten  

Der Apache Spark in Azure Synapse Analytics-Dienst unterstützt mehrere verschiedene Laufzeiten und Dienste, deren Versionen in diesem Dokument aufgeführt werden.

## <a name="spark-version"></a>Spark-Version

Spark 2.4 ist die zurzeit unterstützte Version.

## <a name="operating-system-version"></a>Betriebssystemversion

Apache Spark in Azure Synapse wird unter Ubuntu, Version 16.04 ausgeführt.

## <a name="java-version"></a>Java-Version

Apache Spark in Azure Synapse enthält Java-Version 1.8.0_222.

## <a name="scala-version"></a>Scala-Version

Apache Spark in Azure Synapse enthält Scala 2.11.12.

## <a name="net-core-version"></a>.NET Core-Version

Apache Spark in Azure Synapse enthält .NET Core 3.0.

## <a name="net-support-for-apache-spark"></a>.NET-Unterstützung für Apache Spark

Azure Synapse enthält .NET-Unterstützung für Apache Spark 0.11.0.

## <a name="delta-lake"></a>Delta Lake

Synapse Analytics enthält Unterstützung für Delta Lake 0.6.0.

## <a name="python-version"></a>Python-Version

Apache Spark in Azure Synapse enthält eine Installation von Python, Version 3.6.1.
