...
Informationen zur Syntax finden Sie unter [ALTER TABLE](/sql/t-sql/statements/alter-table-transact-sql) und [CREATE TABLE](/sql/t-sql/statements/create-table-azure-sql-data-warehouse). 
