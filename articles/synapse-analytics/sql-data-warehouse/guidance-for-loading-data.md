...
description: Dieser Artikel enthält Empfehlungen und Leistungsoptimierungen für das Laden von Daten in SQL Analytics.
...
Wie bereits erwähnt erzielt das Laden mit PolyBase den höchsten Durchsatz bei SQL Data Warehouse. Wenn Sie PolyBase nicht zum Laden verwenden können und die SqlBulkCopy-API (oder BCP) verwenden müssen, sollten Sie eine Erhöhung der Batchgröße für einen besseren Durchsatz in Betracht ziehen. Eine gute Faustregel ist eine Batchgröße zwischen 100 KB und 1 Mio. Zeilen.
