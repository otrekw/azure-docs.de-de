...
Eine ausführliche Diskussion der Columnstore-Arbeitsspeicheranforderungen, finden Sie im Video [SQL Analytics scaling: configuration and guidance (Skalieren von SQL Analytics: Konfiguration und Anleitungen, in englischer Sprache)](https://channel9.msdn.com/Events/Ignite/2016/BRK3291).
...
Weitere Möglichkeiten zum Verbessern der Leistung für SQL Analytics finden Sie unter der [Übersicht über die Leistung](cheat-sheet.md).
