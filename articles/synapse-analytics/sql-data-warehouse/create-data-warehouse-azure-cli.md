...
Verwenden Sie den Befehl [az synapse sql pool create](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_create), um den SQL-Pool zu erstellen:
...
Weitere Informationen zu den Parameteroptionen finden Sie unter [az synapse sql pool](/cli/azure/synapse/sql/pool).

Ihre SQL-Pools können Sie mithilfe des Befehls [az synapse sql pool list](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_list) anzeigen:

```azurecli
az synapse sql pool list --resource-group myResourceGroup --workspace-name testsynapseworkspace
```

Verwenden Sie den Befehl [az synapse sql pool update](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_update), um einen vorhandenen Pool zu aktualisieren:
...
Verwenden Sie den Befehl [az synapse sql pool pause](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_pause), um Ihren Pool anzuhalten:
...
Verwenden Sie den Befehl [az synapse sql pool resume](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_resume), um einen angehaltenen Pool zu starten:
...
Wenn Sie einen vorhandenen SQL-Pool entfernen möchten, verwenden Sie den Befehl [az synapse sql pool delete](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_delete):
