...
Ja, verwaltete Service Fabric-Cluster, die verfügbarkeitszonenübergreifend sind, werden in Azure-Regionen unterstützt, die Verfügbarkeitszonen unterstützen. Weitere Informationen finden Sie unter [Verfügbarkeitszonenübergreifende verwaltete Service Fabric-Cluster](.\service-fabric-cross-availability-zones.md).
...
Ja, Sie können zwischen automatischen und manuellen Upgrades wählen. Weitere Informationen finden Sie unter [Clusterupgrades](./service-fabric-cluster-upgrade.md).
