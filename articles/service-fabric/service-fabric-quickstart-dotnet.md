...
>
> [Einrichten von Windows 10 oder Windows Server für Container](https://docs.microsoft.com/virtualization/windowscontainers/quick-start/set-up-environment?tabs=Windows-10-Client)
