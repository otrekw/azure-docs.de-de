...
#### <a name="connect-using-certificate-thumbprint"></a>Herstellen einer Verbindung mithilfe des Zertifikatfingerabdrucks
...
Weitere Informationen zum AAD-Tokenabruf finden Sie unter [Microsoft.IdentityModel.Clients.ActiveDirectory](/dotnet/api/microsoft.identitymodel.clients.activedirectory).
