---
title: Beschreibungen zum XML-Schema des Azure Service Fabric-Dienstmodells
description: Hier finden Sie eine Beschreibung des XML-Schemas des Service Fabric-Dienstmodells, einschließlich Speicherort und Zusammenfassung der Komponenten.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639189"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Dokumentation zum XML-Schema des Dienstmodells
In diesem Artikel finden Sie Informationen zur Schemadatei „ServiceFabricServiceModel.xsd“, die mit dem Service Fabric SDK installiert wird.  Die Schemadatei wird standardmäßig in *C:\Programme\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd* installiert.

## <a name="namespace-bindings"></a>Namespacebindungen

|Präfix|Namespace-URI|
|---|---|
|xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Komponentenzusammenfassung 
Die folgenden Komponenten werden in ServiceFabricServiceModel.xsd definiert:
- [257 Elemente](service-fabric-service-model-schema-elements.md)
- [112 komplexe Typen](service-fabric-service-model-schema-complex-types.md)
- [1 einfacher Typ](service-fabric-service-model-schema-simple-types.md)
- [3 Elementgruppen](service-fabric-service-model-schema-element-groups.md)
- [16 Attributgruppen](service-fabric-service-model-schema-attribute-groups.md)
