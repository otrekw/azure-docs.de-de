...
* Docker muss im Linux-Modus ausgeführt werden
...
5. Der Start des Clusters dauert einen Moment. Sie können mithilfe des folgenden Befehls Protokolle anzeigen oder zum Dashboard wechseln, um sich über die Integrität der Cluster zu informieren (`http://localhost:19080`):
