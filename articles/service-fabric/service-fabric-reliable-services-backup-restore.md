...
Bei der Anforderung zum Durchführen einer inkrementellen Sicherung kann der Fehler `FabricMissingFullBackupException` auftreten. Diese Ausnahme gibt an, dass einer der folgenden Fälle vorliegt:
